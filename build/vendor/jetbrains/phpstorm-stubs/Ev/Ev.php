...
abstract class EvWatcher
{
     ...
     */
    public function feed(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $revents)
    {
    }
    /**
     ...
     * @param int $revents Bit mask of watcher received events.
     */
    public function invoke(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $revents)
    {
    }
    /**
     ...
     */
    public function keepalive(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $value = \true)
    {
    }
    /**
     ...
     */
    public function setCallback(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback)
    {
    }
    /**
     * Starts the watcher.
...
final class EvCheck extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     * @param callable $callback
...
final class EvChild extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $pid, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $trace, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     ...
     *      activate the watcher when the process is stopped or continued.
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $pid, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $trace)
    {
    }
}
/**
...
final class EvEmbed extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(\EvLoop $other, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     * Configures the watcher.
...
final class EvIo extends \EvWatcher
{
     ...
     */
    #[\JetBrains\PhpStorm\Immutable]
    #[\JetBrains\PhpStorm\ExpectedValues(flags: [\Ev::READ, \Ev::WRITE])]
    public $events;
    /**
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $fd, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $events, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     * Configures the watcher.
     ...
     * @param int $events Ev::READ and/or Ev::WRITE. See the bit masks.
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $fd, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $events)
    {
    }
    /**
...
final class EvPeriodic extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $offset, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $interval, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $reschedule_cb, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     ...
     * @return void
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $offset, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $interval, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $reschedule_cb = null)
    {
    }
}
/**
...
final class EvSignal extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $signum, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     * Configures the watcher.
     ...
     * @param int $signum Signal number. See the constants exported by pcntl extension. See also signal(7) man page.
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $signum)
    {
    }
    /**
...
final class EvStat extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $path, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $interval, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     ...
     *      as 0.0 to let libev choose a suitable value.
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $path, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $interval)
    {
    }
    /**
...
final class EvTimer extends \EvWatcher
{
     ...
     * @param int $priority
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $after, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $repeat, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $data = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $priority = 0)
    {
    }
    /**
     ...
     *      until stopped manually.
     */
    public function set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $after, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'float'], default: '')] $repeat)
    {
    }
    /**
...
final class EvLoop
{
     ...
     */
    #[\JetBrains\PhpStorm\Immutable]
    #[\JetBrains\PhpStorm\ExpectedValues(flags: [\Ev::BACKEND_ALL, \Ev::BACKEND_DEVPOLL, \Ev::BACKEND_EPOLL, \Ev::BACKEND_KQUEUE, \Ev::BACKEND_MASK, \Ev::BACKEND_POLL, \Ev::BACKEND_PORT, \Ev::BACKEND_SELECT])]
    public $backend;
    /**
