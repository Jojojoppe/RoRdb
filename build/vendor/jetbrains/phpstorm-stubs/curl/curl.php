...
class CURLFile
{
     ...
     * @since 5.5
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filename, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $mime_type = '', #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $posted_filename = '')
    {
    }
    /**
     * Get file name
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setMimeType(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $mime_type) : void
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setPostFilename(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $posted_filename) : void
    {
    }
    /**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle|false'], default: 'resource|false')]
...
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle|false'], default: 'resource|false')]
function curl_copy_handle(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle)
{
}
/**
 ...
 * </tr>
 */
#[\JetBrains\PhpStorm\ArrayShape(["version_number" => "string", "version" => "string", "ssl_version_number" => "int", "ssl_version" => "string", "libz_version" => "string", "host" => "string", "age" => "int", "features" => "int", "protocols" => "array"])]
#[\JetBrains\PhpStorm\Pure]
function curl_version(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $age = null) : array|false
{
}
/**
 ...
 */
function curl_setopt(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, int $option, mixed $value) : bool
{
}
/**
 ...
 * @since 5.1.3
 */
function curl_setopt_array(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, array $options) : bool
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
function curl_share_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlShareHandle'], default: 'resource')] $share_handle) : void
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlShareHandle'], default: 'resource')]
 ...
 * @since 5.5
 */
function curl_share_setopt(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlShareHandle'], default: 'resource')] $share_handle, int $option, mixed $value) : bool
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function curl_unescape(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, string $string) : string|false
{
}
/**
 ...
 */
function curl_exec(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : string|bool
{
}
/**
...
function curl_getinfo(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, ?int $option) : mixed
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function curl_error(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : string
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function curl_errno(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function curl_escape(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, string $string) : string|false
{
}
/**
 * (PHP 5 >= 5.5.0) <br/>
 ...
 * @return void
 */
function curl_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : void
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')]
 ...
 * code.
 */
function curl_multi_add_handle(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : int
{
}
/**
...
function curl_multi_remove_handle(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle)
{
}
/**
 ...
 */
function curl_multi_select(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, float $timeout = 1.0) : int
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
function curl_multi_setopt(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, int $option, mixed $value) : bool
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
function curl_pause(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle, int $flags) : int
{
}
/**
 * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
function curl_reset(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : void
{
}
/**
 ...
 * </p>
 */
function curl_multi_exec(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] &$still_running = 0, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] &$still_running) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function curl_multi_getcontent(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlHandle'], default: 'resource')] $handle) : ?string
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function curl_multi_info_read(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle, &$queued_messages) : array|false
{
}
/**
 ...
 * @return void
 */
function curl_multi_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle) : void
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function curl_multi_errno(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlMultiHandle'], default: 'resource')] $multi_handle) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function curl_share_errno(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'CurlShareHandle'], default: 'resource')] $share_handle) : int
{
}
/**
 * Return string describing the given error code
