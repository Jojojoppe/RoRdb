 ...
 */
function preg_replace_callback(array|string $pattern, callable $callback, array|string $subject, int $limit = -1, &$count, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.4')] int $flags = 0) : array|string|null
{
}
/**
 ...
 */
function preg_replace_callback_array(array $pattern, array|string $subject, int $limit = -1, &$count, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.4')] int $flags = 0) : array|string|null
{
}
/**
 * Perform a regular expression search and replace
