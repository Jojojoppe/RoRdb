...
class finfo
{
     ...
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $magic_database)
    {
    }
    /**
     ...
     */
    public function set_flags(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL fileinfo &gt;= 0.1.0)<br/>
    ...
    public function file(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filename = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = \FILEINFO_NONE, $context = null) : string|false
    {
    }
    /**
    ...
    #[\JetBrains\PhpStorm\Pure]
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function buffer(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $string = null, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = \FILEINFO_NONE, $context = null) : string|false
    {
    }
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'finfo|false'], default: 'resource|false')]
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function finfo_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'finfo'], default: 'resource')] $finfo) : bool
{
}
/**
 * (PHP &gt;= 5.3.0, PECL fileinfo &gt;= 0.1.0)<br/>
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function finfo_set_flags(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'finfo'], default: 'resource')] $finfo, int $flags) : bool
{
}
/**
 * (PHP &gt;= 5.3.0, PECL fileinfo &gt;= 0.1.0)<br/>
 ...
 * <i>filename</i> argument, or <b>FALSE</b> if an error occurred.
 */
function finfo_file(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'finfo'], default: 'resource')] $finfo, string $filename, int $flags, $context) : string|false
{
}
/**
 * (PHP 5 &gt;= 5.3.0, PECL fileinfo &gt;= 0.1.0)<br/>
 ...
 * argument, or <b>FALSE</b> if an error occurred.
 */
function finfo_buffer(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'finfo'], default: 'resource')] $finfo, string $string, int $flags = \FILEINFO_NONE, $context) : string|false
{
}
/**
