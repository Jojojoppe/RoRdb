 ...
 * @since 5.5
 */
function socket_sendmsg(\Socket $socket, array $message, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.5', to: '7.4')] int $flags, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $flags = 0) : int|false
{
}
/**
 ...
 * @since 5.5
 */
function socket_recvmsg(\Socket $socket, array &$message, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.5', to: '7.4')] int $flags, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $flags = 0) : int|false
{
}
/**
 ...
 * @since 5.5
 */
function socket_cmsg_space(int $level, int $type, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $num = 0) : ?int
{
}
/**
