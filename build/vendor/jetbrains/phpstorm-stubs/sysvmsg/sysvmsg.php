 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue|false"], default: "resource|false")]
 ...
 * </p>
 */
function msg_send(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue"], default: "resource")] $queue, int $message_type, $message, bool $serialize = \true, bool $blocking = \true, &$error_code) : bool
{
}
/**
 ...
 * </p>
 */
function msg_receive(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue"], default: "resource")] $queue, int $desired_message_type, &$received_message_type, int $max_message_size, mixed &$message, bool $unserialize = \true, int $flags = 0, &$error_code) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function msg_remove_queue(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue"], default: "resource")] $queue) : bool
{
}
/**
 ...
 * </table>
 */
function msg_stat_queue(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue"], default: "resource")] $queue) : array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function msg_set_queue(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvMessageQueue"], default: "resource")] $queue, array $data) : bool
{
}
/**
