...
class Imagick implements \Iterator, \Countable
{
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: "%class%->roundCornersImage(%parametersList%)")]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["minima" => "float", "maxima" => "float"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["kurtosis" => "float", "skewness" => "float"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: "%class%->getImageLength()")]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["width" => "int", "height" => "int"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["x" => "float", "y" => "float"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["minima" => "int", "maxima" => "int"])]
    #[\JetBrains\PhpStorm\Deprecated]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["mean" => "float", "standardDeviation" => "float"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["min" => "int", "max" => "int"])]
    #[\JetBrains\PhpStorm\Deprecated]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["width" => "int", "height" => "int", "x" => "int", "y" => "int"])]
    #[\JetBrains\PhpStorm\Pure]
    ...
    #[\JetBrains\PhpStorm\ArrayShape(["quantumDepthLong" => "int", "quantumDepthString" => "string"])]
     ...
     * @throws ImagickException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["columns" => "int", "rows" => "int"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     */
    #[\JetBrains\PhpStorm\ArrayShape(["versionNumber" => "int", "versionString" => "string"])]
...
class ImagickPixelIterator implements \Iterator
{
     ...
     * @throws ImagickException
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: "%class%->getPixelIterator(%parametersList%)")]
     ...
     * @throws ImagickException
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: "%class%->getPixelRegionIterator(%parametersList%)")]
...
class ImagickPixel
{
     ...
     */
    #[\JetBrains\PhpStorm\ArrayShape(["hue" => "float", "saturation" => "float", "luminosity" => "float"])]
    #[\JetBrains\PhpStorm\Pure]
     ...
     * @throws ImagickPixelException on error.
     */
    #[\JetBrains\PhpStorm\ArrayShape(["r" => "int|float", "g" => "int|float", "b" => "int|float", "a" => "int|float"])]
    #[\JetBrains\PhpStorm\Pure]
