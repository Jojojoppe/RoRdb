...
class mysqli
{
     ...
     * @var int
     */
    #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'string|int'], default: '')]
     ...
     * @var int|string
     */
    #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'int|string'], default: '')]
    public $insert_id;
    /**
     * @var string
     */
     ...
     */
    #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'array'], default: '')]
    public $error_list;
    public $stat;
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function begin_transaction(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $name = null) : bool
    {
    }
    /**
     ...
     * @removed 5.4
     */
    #[\JetBrains\PhpStorm\Deprecated(since: '5.3')]
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function release_savepoint(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function rollback(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')] $name = null) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function savepoint(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function refresh(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags) : bool
    {
    }
}
/**
...
class mysqli_result implements \IteratorAggregate
{
     ...
     * @var array
     */
    #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'array|null'], default: '')]
    public $lengths;
    /**
     * @var int
     */
     ...
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] \mysqli $mysql = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $result_mode = 0)
    {
    }
    /**
...
class mysqli_stmt
{
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function execute(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] ?array $params = null) : bool
    {
    }
    /**
 ...
 * @return bool
 */
function mysqli_stmt_execute(\mysqli_stmt $statement, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] ?array $params = null) : bool
{
}
/**
 * Executes a prepared Query
 ...
 */
#[\JetBrains\PhpStorm\Deprecated(since: '5.3')]
function mysqli_execute(\mysqli_stmt $statement, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] ?array $params = null) : bool
{
}
/**
 * Returns the next field in the result set
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '?string')]
function mysqli_get_client_info(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.1')] \mysqli $mysql, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] ?\mysqli $mysql = null)
{
}
/**
 ...
 * @return int
 */
function mysqli_get_client_version(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.3')] $link) : int
{
}
/**
 ...
 */
function mysqli_multi_query(\mysqli $mysql, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] string $query = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] string $query) : bool
{
}
/**
 * Prepare next result from multi_query
 ...
 * @return bool
 */
function mysqli_real_query(\mysqli $mysql, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] string $query = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] string $query) : bool
{
}
/**
 * Get result from async query
 ...
 * @return bool true on success or false on failure.
 */
function mysqli_stmt_bind_param(\mysqli_stmt $statement, string $types, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed &$vars, mixed &...$vars) : bool
{
}
/**
 * Binds variables to a prepared statement for result storage
 ...
 * @return bool
 */
function mysqli_stmt_bind_result(\mysqli_stmt $statement, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed &$vars, mixed &...$vars) : bool
{
}
/**
 * Fetch results from a prepared statement into the bound variables
 ...
 * @return bool This function always returns TRUE value.
 */
function mysqli_ssl_set(\mysqli $mysql, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $key, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $certificate, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $ca_certificate, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $ca_path, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $cipher_algos) : bool
{
}
/**
 * Closes a prepared statement
 ...
 * @return string
 */
function mysqli_escape_string(\mysqli $mysql, string $string, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $resultmode = null) : string
{
}
/**
 ...
 * @return bool
 */
function mysqli_set_opt(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] \mysqli $mysql, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $option, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] $value) : bool
{
}
/**
 * <p>
