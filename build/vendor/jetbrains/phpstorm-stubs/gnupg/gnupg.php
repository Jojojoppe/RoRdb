 ...
 * @return bool Returns true on success or false on failure.
 */
function gnupg_setsignmode($res, #[\JetBrains\PhpStorm\ExpectedValues([\GNUPG_SIG_MODE_NORMAL | \GNUPG_SIG_MODE_DETACH | \GNUPG_SIG_MODE_CLEAR])] $signmode)
{
}
/**
 * Encrypts and signs a given text
 ...
 */
function gnupg_seterrormode($res, #[\JetBrains\PhpStorm\ExpectedValues([\GNUPG_ERROR_WARNING | \GNUPG_ERROR_EXCEPTION | \GNUPG_ERROR_SILENT])] $errnmode)
{
}
