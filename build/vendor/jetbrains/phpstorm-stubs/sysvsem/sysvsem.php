 ...
 * error.
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSemaphore|false"], default: "resource|false")]
 ...
 */
function sem_acquire(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSemaphore"], default: "resource")] $semaphore, bool $non_blocking = \false) : bool
{
}
/**
 * Release a semaphore
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function sem_release(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSemaphore"], default: "resource")] $semaphore) : bool
{
}
/**
 * Remove a semaphore
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function sem_remove(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSemaphore"], default: "resource")] $semaphore) : bool
{
}
/**
 * @since 8.0
