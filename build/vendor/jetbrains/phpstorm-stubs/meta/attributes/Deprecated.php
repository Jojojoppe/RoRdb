...
namespace RoRdb\JetBrains\PhpStorm;
...
class Deprecated
{
    public const PHP_VERSIONS = ["5.3", "5.4", "5.5", "5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0", "8.1"];
    /**
     ...
     */
    public function __construct($reason = "", $replacement = "", #[\JetBrains\PhpStorm\ExpectedValues(self::PHP_VERSIONS)] $since = "5.6")
    {
    }
}
