 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'nl2br(hebrev(%parameter0%))', since: '7.4')]
 ...
 * @see NumberFormatter
 */
#[\JetBrains\PhpStorm\Deprecated(reason: 'Use the NumberFormatter functionality', since: '7.4')]
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function strip_tags(string $string, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.4" => "string[]|string|null"], default: "string|null")] $allowed_tags = null) : string
{
}
/**
 ...
 */
function setlocale(int $category, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] $locales, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $rest, ...$rest) : string|false
{
}
/**
