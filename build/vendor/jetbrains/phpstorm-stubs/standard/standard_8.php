 ...
 * @return void
 */
function ob_implicit_flush(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "bool"], default: "int")] $enable = \true) : void
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function min(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] mixed $value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed $values, mixed ...$values) : mixed
{
}
/**
 * Find highest value
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function max(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] mixed $value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] mixed $values, mixed ...$values) : mixed
{
}
/**
 ...
 * table.
 */
function extract(array &$array, #[\JetBrains\PhpStorm\ExpectedValues(flags: [\EXTR_OVERWRITE, \EXTR_SKIP, \EXTR_PREFIX_SAME, \EXTR_PREFIX_ALL, \EXTR_PREFIX_INVALID, \EXTR_PREFIX_IF_EXISTS, \EXTR_REFS])] int $flags, string $prefix) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function compact(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] $var_name, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $var_names, ...$var_names) : array
{
}
/**
 ...
 * @return bool true on success or false on failure.
 */
function array_multisort(&$array, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $sort_order = \SORT_ASC, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $sort_flags = \SORT_REGULAR, &...$rest) : bool
{
}
/**
 ...
 */
function array_push(array &$array, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] $values, mixed ...$values) : int
{
}
/**
 ...
 * @return int the number of elements in the array.
 */
function array_unshift(array &$array, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] $values, mixed ...$values) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function array_merge(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.3')] $array, array ...$arrays) : array
{
}
