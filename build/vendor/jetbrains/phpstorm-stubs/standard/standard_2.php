...
use RoRdb\JetBrains\PhpStorm\Internal\ReturnTypeContract as TypeContract;
 ...
 * @return void
 */
function parse_str(string $string, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] &$result = [], #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] &$result) : void
{
}
/**
 ...
 */
function sscanf(string $string, string $format, #[\JetBrains\PhpStorm\Internal\ReturnTypeContract(exists: "int|null", notExists: "array|null")] mixed &...$vars) : array|int|null
{
}
/**
 ...
 * parameters must be passed by reference.
 */
function fscanf($stream, string $format, #[\JetBrains\PhpStorm\Internal\ReturnTypeContract(exists: "int|false|null", notExists: "array|false|null")] mixed &...$vars) : array|int|false|null
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\ArrayShape(["scheme" => "string", "host" => "string", "port" => "int", "user" => "string", "pass" => "string", "query" => "string", "path" => "string", "fragment" => "string"])]
#[\JetBrains\PhpStorm\Pure]
 ...
 * </tr>
 */
#[\JetBrains\PhpStorm\ArrayShape(["command" => "string", "pid" => "int", "running" => "bool", "signaled" => "bool", "stopped" => "bool", "exitcode" => "int", "termsig" => "int", "stopsig" => "int"])]
