 ...
 */
function stream_select(?array &$read, ?array &$write, ?array &$except, ?int $seconds, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'int|null'], default: 'int')] $microseconds) : int|false
{
}
/**
 ...
 */
function fputcsv($stream, array $fields, string $separator = ",", string $enclosure = '"', string $escape = "\\", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] string $eol = \PHP_EOL) : int|false
{
}
/**
 ...
 * @see stream_set_blocking()
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "stream_set_blocking(%parametersList%)", since: 5.3)]
 ...
 * </p>
 */
#[\JetBrains\PhpStorm\ArrayShape(["timed_out" => "bool", "blocked" => "bool", "eof" => "bool", "unread_bytes" => "int", "stream_type" => "string", "wrapper_type" => "string", "wrapper_data" => "mixed", "mode" => "string", "seekable" => "bool", "uri" => "string", "crypto" => "array", "mediatype" => "string"])]
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function get_headers(string $url, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: 'int')] $associative = \false, $context = null) : array|false
{
}
/**
