 ...
 * yet.
 */
#[\JetBrains\PhpStorm\ArrayShape(["type" => "int", "message" => "string", "file" => "string", "line" => "int"])]
 ...
 * @see call_user_func()
 */
#[\JetBrains\PhpStorm\Deprecated(reason: "use call_user_func() instead", since: "5.3")]
 ...
 * @return void
 */
function var_dump(mixed $value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] mixed ...$values) : void
{
}
/**
 ...
 * @return void
 */
function debug_zval_dump(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] mixed $value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $values, mixed ...$values) : void
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function hrtime(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3', to: '7.4')] bool $as_number, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] bool $as_number = \false) : array|int|float|false
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function ini_get_all(?string $extension, bool $details = \true) : array|false
{
}
/**
 ...
 */
function ini_set(string $option, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'string|int|float|bool|null'], default: 'string')] $value) : string|false
{
}
/**
 * Alias:
 ...
 * @return string|false
 */
function ini_alter(string $option, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'string|int|float|bool|null'], default: 'string')] $value) : string|false
{
}
/**
 ...
 * @return void
 */
function header(string $header, bool $replace = \true, int $response_code) : void
{
}
/**
