...
class php_user_filter
{
    ...
    public function filter($in, $out, &$consumed, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $closing) : int
    {
    }
    /**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function htmlspecialchars(string $string, int $flags = \ENT_QUOTES | \ENT_SUBSTITUTE, ?string $encoding = 'UTF-8', bool $double_encode = \true) : string
{
}
/**
 ...
 * @return bool true on success or false on failure.
 */
function phpinfo(#[\JetBrains\PhpStorm\ExpectedValues(flags: [\INFO_GENERAL, \INFO_CREDITS, \INFO_CONFIGURATION, \INFO_MODULES, \INFO_ENVIRONMENT, \INFO_VARIABLES, \INFO_LICENSE, \INFO_ALL])] int $flags = \INFO_ALL) : bool
{
}
/**
