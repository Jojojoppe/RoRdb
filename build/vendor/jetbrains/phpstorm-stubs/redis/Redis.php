...
class Redis
{
     ...
     * @return bool TRUE on success, FALSE on error
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->connect(%parametersList%)')]
     ...
     * @return bool
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->pconnect(%parametersList%)')]
     ...
     * @return int Number of keys deleted
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: "%class%->del(%parametersList%)")]
     ...
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->lLen(%parametersList%)')]
     ...
     * @return mixed|bool the element at this index
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->lIndex(%parametersList%)')]
     ...
     * @return array
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->lRange(%parametersList%)')]
     ...
     * @param int       $stop
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->lTrim(%parametersList%)')]
     ...
     * @param int $count
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->lRem(%parametersList%)')]
     ...
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->sRem(%parametersList%)')]
     ...
     * @param string|mixed $value
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->sIsMember(%parametersList%)')]
     ...
     * @return array   An array of elements, the contents of the set
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->sMembers(%parametersList%)')]
     ...
     * @param   string  $dstKey
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->rename(%parametersList%)')]
     ...
     * @return  bool
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->expire(%parametersList%)')]
     ...
     * @link    https://redis.io/commands/keys
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->keys(%parametersList%)')]
     ...
     * </pre>
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->mGet(%parametersList%)')]
     ...
     * @return int Number of deleted values
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zRem(%parametersList%)')]
     ...
     * @param float  $end
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zRemRangeByScore(%parametersList%)')]
     ...
     * @param int    $end
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zRemRangeByRank(%parametersList%)')]
     ...
     * @return int
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zCard(%parametersList%)')]
     ...
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zUnionStore(%parametersList%)')]
     ...
     * @param string $aggregateFunction
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->zInterStore(%parametersList%)')]
     ...
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->eval(%parametersList%)')]
     ...
     * @param int    $numKeys
     */
    #[\JetBrains\PhpStorm\Deprecated(replacement: '%class%->evalSha(%parametersList%)')]
