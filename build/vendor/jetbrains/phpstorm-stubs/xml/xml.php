...
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")]
 ...
 */
function xml_set_object(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, object $object) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_element_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $start_handler, $end_handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_character_data_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_processing_instruction_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_default_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_unparsed_entity_decl_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_notation_decl_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_external_entity_ref_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_start_namespace_decl_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function xml_set_end_namespace_decl_handler(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, $handler) : bool
{
}
/**
 ...
 * </p>
 */
function xml_parse(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, string $data, bool $is_final = \false) : int
{
}
/**
 ...
 * operators such as ===.
 */
function xml_parse_into_struct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, string $data, &$values, &$index) : int
{
}
/**
...
function xml_get_error_code(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser)
{
}
/**
...
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "int"], default: "int|false")]
function xml_get_current_line_number(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser)
{
}
/**
...
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "int"], default: "int|false")]
function xml_get_current_column_number(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser)
{
}
/**
...
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "int"], default: "int|false")]
function xml_get_current_byte_index(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser)
{
}
/**
 * Free an XML parser
 ...
 */
function xml_parser_free(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser) : bool
{
}
/**
 ...
 */
function xml_parser_set_option(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, int $option, $value) : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function xml_parser_get_option(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "XMLParser"], default: "resource")] $parser, int $option) : string|int
{
}
