 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'IMAP\\Connection|false'], default: 'resource|false')]
 ...
 */
function imap_reopen(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox, int $flags = 0, int $retries = 0) : bool
{
}
/**
 ...
 */
function imap_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $flags = 0) : bool
{
}
/**
 ...
 */
function imap_num_msg(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : int|false
{
}
/**
 ...
 * integer.
 */
function imap_num_recent(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : int
{
}
/**
 ...
 */
function imap_headers(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : array|false
{
}
/**
 ...
 * </dl>
 */
function imap_headerinfo(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, int $from_length = 0, int $subject_length = 0, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(to: '7.4')] $default_host = null) : \stdClass|false
{
}
/**
 ...
 */
function imap_body(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0) : string|false
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'stdClass|false'], default: 'object')]
function imap_bodystruct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, string $section)
{
}
/**
 ...
 * text string.
 */
function imap_fetchbody(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, string $section, int $flags = 0) : string|false
{
}
/**
 ...
 * @since 5.3.6
 */
function imap_fetchmime(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, string $section, int $flags = 0) : string|false
{
}
/**
 ...
 * @since 5.1.3
 */
function imap_savebody(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, $file, int $message_num, string $section = "", int $flags = 0) : bool
{
}
/**
 ...
 */
function imap_fetchheader(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0) : string|false
{
}
/**
 ...
 * </table>
 */
function imap_fetchstructure(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0) : \stdClass|false
{
}
/**
 * Clears IMAP cache
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_gc(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] int $flags = 0, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $flags) : bool
{
}
/**
 ...
 */
function imap_expunge(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b>.
 */
function imap_delete(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $message_num, int $flags = 0) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_undelete(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $message_num, int $flags = 0) : bool
{
}
/**
 ...
 */
function imap_check(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : \stdClass|false
{
}
/**
 ...
 */
function imap_listscan(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content) : array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_mail_copy(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $message_nums, string $mailbox, int $flags = 0) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_mail_move(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $message_nums, string $mailbox, int $flags = 0) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_createmailbox(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_renamemailbox(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $from, string $to) : bool
{
}
/**
 * Delete a mailbox
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_deletemailbox(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_subscribe(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_unsubscribe(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_append(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $folder, string $message, ?string $options = null, ?string $internal_date = null) : bool
{
}
/**
 ...
 */
function imap_ping(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'stdClass|false'], default: 'object')]
function imap_status(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox, int $flags)
{
}
/**
 * @param $stream_id
 ...
 * Returns <b>FALSE</b> on failure.
 */
function imap_mailboxmsginfo(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap) : \stdClass
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_setflag_full(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $sequence, string $flag, int $options = \NIL) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_clearflag_full(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $sequence, string $flag, int $options = 0) : bool
{
}
/**
 ...
 * parameters.
 */
function imap_sort(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $criteria, bool $reverse, int $flags = 0, ?string $search_criteria = null, ?string $charset = 'NIL') : array|false
{
}
/**
 ...
 */
function imap_uid(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num) : int|false
{
}
/**
 ...
 * <i>uid</i>.
 */
function imap_msgno(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_uid) : int
{
}
/**
 ...
 */
function imap_list(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 ...
 */
function imap_lsub(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 ...
 */
function imap_fetch_overview(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $sequence, int $flags = 0) : array|false
{
}
/**
 ...
 * </p>
 */
function imap_search(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $criteria, int $flags = \SE_FREE, string $charset = \NIL) : array|false
{
}
/**
 ...
 * </p>
 */
function imap_thread(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $flags = \SE_FREE) : array|false
{
}
/**
 ...
 */
function imap_get_quota(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $quota_root) : array|false
{
}
/**
 ...
 * from the server.
 */
function imap_get_quotaroot(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : array|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_set_quota(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $quota_root, int $mailbox_size) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imap_setacl(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox, string $user_id, string $rights) : bool
{
}
/**
 ...
 */
function imap_getacl(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : array|false
{
}
/**
 * @param $stream_id
 ...
 * @return array|false
 */
function imap_listmailbox(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 ...
 * </p>
 */
function imap_getmailboxes(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 ...
 * @param $content
 */
function imap_scanmailbox(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content) : array|false
{
}
/**
 ...
 * @return array|false
 */
function imap_listsubscribed(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 * List all the subscribed mailboxes
 ...
 * Only used by UW-IMAPD.
 */
function imap_getsubscribed(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern) : array|false
{
}
/**
 * (PHP 4, PHP 5)<br/>
 ...
 */
function imap_fetchtext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, int $message_num, int $flags = 0) : string|false
{
}
/**
 * Alias of <b>imap_listscan</b>
 ...
 * @param $content
 */
function imap_scan(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $reference, string $pattern, string $content) : array|false
{
}
/**
 ...
 * @param $mailbox
 */
function imap_create(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $mailbox) : bool
{
}
/**
 ...
 * @param $to
 */
function imap_rename(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\IMAP\\Connection'], default: 'resource')] $imap, string $from, string $to) : bool
{
}
/**
