 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function mktime(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] int $hour = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $hour, ?int $minute = null, ?int $second = null, ?int $month = null, ?int $day = null, ?int $year = null, #[\JetBrains\PhpStorm\Deprecated('Use the new timezone handling functions instead', since: '5.3')] #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.0')] $is_dst = -1) : int|false
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
function gmmktime(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] int $hour = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $hour, ?int $minute = null, ?int $second = null, ?int $month = null, ?int $day = null, ?int $year = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.0')] $is_dst = null) : int|false
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "DateTime"], default: "DateTime|false")]
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "DateTime"], default: "DateTime|false")]
function date_timezone_set(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "DateTime"], default: "DateTimeInterface")] $object, \DateTimeZone $timezone)
{
}
/**
 * Alias:
 ...
 */
#[\JetBrains\PhpStorm\Pure(\true)]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "DateInterval"], default: "DateInterval|false")]
