 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(reason: "Use a foreach loop instead", since: "7.2")]
 ...
 */
function define(string $constant_name, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'mixed'], default: 'null|array|bool|int|float|string')] $value, #[\JetBrains\PhpStorm\Deprecated] bool $case_insensitive = \false) : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function get_defined_functions(bool $exclude_disabled = \true) : array
{
}
/**
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(reason: "Use anonymous functions instead", since: "7.2")]
 ...
 * @since 7.3
 */
#[\JetBrains\PhpStorm\ArrayShape(["runs" => "int", "collected" => "int", "threshold" => "int", "roots" => "int"])]
#[\JetBrains\PhpStorm\Pure]
