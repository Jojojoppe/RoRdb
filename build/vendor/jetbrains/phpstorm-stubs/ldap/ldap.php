...
use RoRdb\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as PhpVersionAware;
use RoRdb\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as Available;
/**
 ...
 * @since 7.2
 */
function ldap_exop_passwd(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.1', to: '7.1')] string $user = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.2')] string $user, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] string $user = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.1', to: '7.1')] string $old_password = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.2')] string $old_password, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] string $old_password = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.1', to: '7.1')] string $new_password = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.2')] string $new_password, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] string $new_password = "", #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] &$controls = []) : string|bool
{
}
/**
 ...
 * @since 7.3
 */
function ldap_exop_refresh(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, int $ttl) : int|false
{
}
/**
 ...
 * @since 7.2
 */
function ldap_exop_whoami(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : string|false
{
}
/**
 ...
 * @since 7.2
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|bool'], default: 'resource|bool')]
function ldap_exop(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $request_oid, ?string $request_data, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [], &$response_data, &$response_oid)
{
}
/**
 ...
 * @since 7.2
 */
function ldap_parse_exop(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.4')] &$response_data, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] &$response_data = '', #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.4')] &$response_oid, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] &$response_oid = '') : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Connection|false'], default: 'resource|false')]
 ...
 * @return bool
 */
function ldap_close(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : bool
{
}
/**
 ...
 */
function ldap_bind(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, ?string $dn, ?string $password) : bool
{
}
/**
 * Bind to LDAP directory
 ...
 * @since 7.3
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_bind_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, ?string $dn, ?string $password, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_sasl_bind(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, $binddn = null, $password = null, $sasl_mech = null, $sasl_realm = null, $sasl_authc_id = null, $sasl_authz_id = null, $props = null) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_unbind(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : bool
{
}
/**
 * Read an entry
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|array|false'], default: 'resource|false')]
function ldap_read(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, array|string $base, array|string $filter, array $attributes, int $attributes_only, int $sizelimit = -1, int $timelimit = -1, int $deref, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 * Single-level search
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|array|false'], default: 'resource|false')]
function ldap_list(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, array|string $base, array|string $filter, array $attributes, int $attributes_only, int $sizelimit = -1, int $timelimit = -1, int $deref, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 * Search LDAP tree
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_free_result(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result) : bool
{
}
/**
...
function ldap_count_entries(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result)
{
}
/**
 ...
 * <b>FALSE</b> on error.
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\ResultEntry|false'], default: 'resource|false')]
function ldap_first_entry(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result)
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\ResultEntry|false'], default: 'resource|false')]
function ldap_next_entry(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry)
{
}
/**
 ...
 * </pre>
 */
function ldap_get_entries(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result) : array|false
{
}
/**
 ...
 * error.
 */
function ldap_first_attribute(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry) : string|false
{
}
/**
 ...
 * error.
 */
function ldap_next_attribute(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry) : string|false
{
}
/**
 ...
 */
function ldap_get_attributes(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry) : array
{
}
/**
 ...
 */
function ldap_get_values(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry, string $attribute) : array|false
{
}
/**
 ...
 */
function ldap_get_values_len(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry, string $attribute) : array|false
{
}
/**
 ...
 */
function ldap_get_dn(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry) : string|false
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_add(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Add entries to LDAP directory
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_add_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_delete(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Delete an entry from a directory
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_delete_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * @since 7.0
 */
function ldap_modify(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_add(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Add attribute values to current attributes
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_mod_add_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 * Replace attribute values with new ones
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_replace(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Replace attribute values with new ones
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_mod_replace_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_mod_del(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Delete attribute values from current attributes
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_mod_del_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $entry, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * link.
 */
function ldap_errno(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : int
{
}
/**
 ...
 */
function ldap_error(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : string
{
}
/**
 ...
 */
function ldap_compare(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, string $attribute, string $value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : int|bool
{
}
/**
 ...
 * @return bool
 */
#[\JetBrains\PhpStorm\Deprecated(since: "7.0")]
function ldap_sort(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, $result, string $sortfilter) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_rename(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * Modify the name of an entry
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Result|false'], default: 'resource|false')]
function ldap_rename_ext(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, string $new_rdn, string $new_parent, bool $delete_old_rdn, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = [])
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_get_option(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, int $option, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] &$value, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] &$value = null) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function ldap_set_option(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\Connection|null'], default: 'resource')] $ldap, int $option, $value) : bool
{
}
/**
 ...
 * @return resource
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\ResultEntry|false'], default: 'resource')]
function ldap_first_reference(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result)
{
}
/**
 * Get next reference
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'LDAP\\ResultEntry|false'], default: 'resource')]
function ldap_next_reference(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry)
{
}
/**
 ...
 * @return bool
 */
function ldap_parse_reference(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\ResultEntry'], default: 'resource')] $entry, &$referrals) : bool
{
}
/**
 ...
 * @return bool
 */
function ldap_parse_result(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result, &$error_code, &$matched_dn, &$error_message, &$referrals, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] &$controls = []) : bool
{
}
/**
 * Start TLS
 ...
 * @return bool
 */
function ldap_start_tls(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap) : bool
{
}
/**
 ...
 * @return bool
 */
function ldap_set_rebind_proc(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, ?callable $callback) : bool
{
}
/**
...
function ldap_control_paged_result(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, int $pagesize, $iscritical = \false, $cookie = "") : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Deprecated(since: "7.4")]
function ldap_control_paged_result_response(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, $result, &$cookie = null, &$estimated = null) : bool
{
}
/**
 ...
 * @since 5.4
 */
function ldap_modify_batch(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, string $dn, array $modifications_info, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "null|array"], default: "array")] $controls = []) : bool
{
}
/**
 * @param resource $ldap
 ...
 * @since 8.0
 */
function ldap_count_references(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Connection'], default: 'resource')] $ldap, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'RoRdb\\LDAP\\Result'], default: 'resource')] $result) : int
{
}
