 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imagechar(\GdImage $image, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font, int $x, int $y, string $char, int $color) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function imagecharup(\GdImage $image, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font, int $x, int $y, string $char, int $color) : bool
{
}
/**
 ...
 * @return bool true on success or false on failure.
 */
function imagefilledpolygon(\GdImage $image, array $points, #[\JetBrains\PhpStorm\Deprecated(since: "8.1")] int $num_points_or_color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] ?int $color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] ?int $color = null) : bool
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function imagefontwidth(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font) : int
{
}
/**
 * Get font height
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function imagefontheight(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font) : int
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|false'], default: 'int|false')]
 ...
 * @return bool true on success or false on failure.
 */
function imagepolygon(\GdImage $image, array $points, int $num_points_or_color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] ?int $color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] ?int $color = null) : bool
{
}
/**
 * Draw a rectangle
 ...
 * @return bool true on success or false on failure.
 */
function imagestring(\GdImage $image, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font, int $x, int $y, string $string, int $color) : bool
{
}
/**
 ...
 * @return bool true on success or false on failure.
 */
function imagestringup(\GdImage $image, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.1' => 'GdFont|int'], default: 'int')] $font, int $x, int $y, string $string, int $color) : bool
{
}
/**
 * Get image width
 ...
 * @see imageline()
 */
#[\JetBrains\PhpStorm\Deprecated("Use combination of imagesetstyle() and imageline() instead")]
 ...
 */
#[\JetBrains\PhpStorm\Deprecated(reason: "Use imagecreatefromjpeg() and imagewbmp() instead", since: "7.2")]
 ...
 * @see imagewbmp()
 */
#[\JetBrains\PhpStorm\Deprecated("Use imagecreatefrompng() and imagewbmp() instead", since: "7.2")]
 ...
 * @see imagewbmp()
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "imagewbmp(%parametersList%)", since: "7.3")]
 ...
 * @return bool true on success or false on failure.
 */
function imagefilter(\GdImage $image, int $filter, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $arg2 = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $arg3 = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $arg4 = null, ...$args) : bool
{
}
/**
 ...
 * @see imageplygon()
 */
function imageopenpolygon(\GdImage $image, array $points, #[\JetBrains\PhpStorm\Deprecated(since: "8.1")] int $num_points_or_color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] ?int $color, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] ?int $color = null) : bool
{
}
/**
 ...
 * @since 5.5
 */
function imageaffinematrixget(int $type, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] $options = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] $options) : array|false
{
}
/**
