...
function hash(string $algo, string $data, bool $binary = \false, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] array $options = null) : string|false
{
}
/**
 ...
 */
#[\JetBrains\PhpStorm\Pure]
function hash_file(string $algo, string $filename, bool $binary = \false, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] array $options = null) : string|false
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 */
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")]
function hash_init(string $algo, int $flags = 0, string $key, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable('8.1')] array $options = null)
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 */
function hash_update(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")] $context, string $data) : bool
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 */
function hash_update_stream(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")] $context, $stream, int $length = -1) : int
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 */
function hash_update_file(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")] $context, string $filename, $stream_context) : bool
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 * binary representation of the message digest is returned.
 */
function hash_final(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")] $context, bool $binary = \false) : string
{
}
/**
...
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")]
function hash_copy(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["7.2" => "HashContext"], default: "resource")] $context)
{
}
/**
 * (PHP 5 &gt;= 5.1.2, PECL hash &gt;= 1.1)<br/>
 ...
 */
#[\JetBrains\PhpStorm\Pure]
#[\JetBrains\PhpStorm\Deprecated(since: '8.1')]
...
final class HashContext
{
     ...
     * @param array $data
     */
    public function __unserialize(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'array'], default: '')] $data) : void
    {
    }
}
// End of hash v.1.0
