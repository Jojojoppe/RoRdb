 ...
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory|false"], default: "resource|false")]
 ...
 */
function shm_remove(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm) : bool
{
}
/**
 ...
 */
function shm_detach(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm) : bool
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function shm_put_var(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm, int $key, mixed $value) : bool
{
}
/**
 ...
 */
function shm_has_var(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm, int $key) : bool
{
}
/**
 ...
 */
function shm_get_var(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm, int $key) : mixed
{
}
/**
 ...
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
function shm_remove_var(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "SysvSharedMemory"], default: "resource")] $shm, int $key) : bool
{
}
/**
 * @since 8.0
