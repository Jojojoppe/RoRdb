...
function mb_strlen(string $string, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|null'], default: 'string')] $encoding)
{
}
/**
 ...
 */
function mb_convert_variables(string $to_encoding, array|string $from_encoding, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.4')] &$vars, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] mixed &$var, mixed &...$vars) : string|false
{
}
/**
...
function mb_decode_numericentity(string $string, array $map, ?string $encoding = null, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2', to: '7.4')] $is_hex = \false)
{
}
/**
 * Send encoded mail
 ...
 * @return bool|int
 */
#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(["8.0" => "bool"], default: "false|int")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_regex_encoding(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'mb_ereg(%parametersList%)', since: '7.3')]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_eregi(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'mb_ereg_replace(%parametersList%)', since: '7.3')]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_eregi_replace(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'mb_split(%parametersList%)', since: '7.3')]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_ereg_match(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated("use mb_ereg_search instead", replacement: "mb_ereg_search(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_ereg_search_pos(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'mb_ereg_search_regs(%parametersList%)', since: '7.3')]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_ereg_search_init(%parametersList%)", since: "7.3")]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'mb_ereg_search_getregs(%parametersList%)', since: '7.3')]
 ...
 * @removed 8.0
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_ereg_search_getpos()", since: "7.3")]
 ...
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: "mb_ereg_search_setpos(%parametersList%)", since: "7.3")]
#[\JetBrains\PhpStorm\Pure]
