...
class SQLite3
{
    ...
    public function open(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $filename, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = \SQLITE3_OPEN_READWRITE | \SQLITE3_OPEN_CREATE, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $encryptionKey = null) : void
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function exec(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query) : bool
    {
    }
    /**
     ...
     * "versionNumber".
     */
    #[\JetBrains\PhpStorm\ArrayShape(["versionString" => "string", "versionNumber" => "int"])]
    #[\JetBrains\PhpStorm\Internal\TentativeType]
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function busyTimeout(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $milliseconds) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function loadExtension(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public static function escapeString(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $string) : string
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function prepare(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query) : \SQLite3Stmt|false
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function query(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query) : \SQLite3Result|false
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function querySingle(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $query, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $entireRow = \false) : mixed
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function createFunction(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $callback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $argCount = -1, int $flags = 0) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function createAggregate(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $stepCallback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $finalCallback, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $argCount = -1) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function createCollation(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $name, callable $callback) : bool
    {
    }
    /**
     ...
     */
    public function openBlob(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $table, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $column, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $rowid, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $database = 'main', #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.2')] int $flags = \SQLITE3_OPEN_READONLY)
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function enableExceptions(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'bool'], default: '')] $enable = \false) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function enableExtendedResultCodes(bool $enable = \true) : bool
    {
    }
    /**
...
class SQLite3Stmt
{
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function bindParam(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|int'], default: '')] $param, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] &$var, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $type = \SQLITE3_TEXT) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function bindValue(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string|int'], default: '')] $param, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $value, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $type = \SQLITE3_TEXT) : bool
    {
    }
    #[\JetBrains\PhpStorm\Internal\TentativeType]
     ...
     * @param string $query
     */
    private function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'SQLite3'], default: '')] $sqlite3, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] string $query)
    {
    }
    /**
...
class SQLite3Result
{
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function columnName(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $column) : string|false
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function columnType(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $column) : int|false
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function fetchArray(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = \SQLITE3_BOTH) : array|false
    {
    }
    /**
