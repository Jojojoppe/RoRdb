 ...
 */
function xdiff_file_patch(string $file, string $patch, string $dest, #[\JetBrains\PhpStorm\ExpectedValues([\XDIFF_PATCH_NORMAL | \XDIFF_PATCH_REVERSE | \XDIFF_PATCH_IGNORESPACE])] int $flags = \XDIFF_PATCH_NORMAL)
{
}
/**
 ...
 * @return string|false the patched string, or false on error.
 */
function xdiff_string_patch(string $str, string $patch, #[\JetBrains\PhpStorm\ExpectedValues([\XDIFF_PATCH_NORMAL | \XDIFF_PATCH_REVERSE | \XDIFF_PATCH_IGNORESPACE])] ?int $flags, ?string &$error)
{
}
/**
