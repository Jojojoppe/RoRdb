...
#[\JetBrains\PhpStorm\Deprecated(replacement: 'newrelic_capture_params()')]
 ...
 * @return null
 */
function newrelic_notice_error(string|\Throwable|\Exception|int $messageOrExceptionOrCode, string $errstr = null, string $errfile = null, int $errline = null, string $errcontext = null)
{
}
/**
 ...
 * @return void
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'newrelic_accept_distributed_trace_headers()')]
 ...
 */
#[\JetBrains\PhpStorm\Deprecated(replacement: 'newrelic_insert_distributed_trace_headers()')]
