...
class RecursiveCallbackFilterIterator extends \CallbackFilterIterator implements \RecursiveIterator
{
     ...
     */
    public function __construct(\RecursiveIterator $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $callback)
    {
    }
    /**
...
class RecursiveIteratorIterator implements \OuterIterator
{
     ...
     * @since 5.1.3
     */
    public function __construct(\Traversable $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = self::LEAVES_ONLY, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0)
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function getSubIterator(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int|null'], default: '')] $level) : ?\RecursiveIterator
    {
    }
    /**
     * Get inner iterator
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setMaxDepth(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $maxDepth = -1) : void
    {
    }
    /**
     * Get max depth
...
class IteratorIterator implements \OuterIterator
{
     ...
     */
    public function __construct(\Traversable $iterator, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] ?string $class = '')
    {
    }
    /**
...
class LimitIterator extends \IteratorIterator
{
     ...
     */
    public function __construct(\Iterator $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $offset = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $limit = -1)
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function seek(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $offset) : int
    {
    }
    /**
...
class CachingIterator extends \IteratorIterator implements \ArrayAccess, \Countable, \Stringable
{
     ...
     */
    public function __construct(\Iterator $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = self::CALL_TOSTRING)
    {
    }
    /**
     * Rewind the iterator
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function offsetSet($key, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $value) : void
    {
    }
    /**
...
class RegexIterator extends \FilterIterator
{
     ...
     */
    public function __construct(\Iterator $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $pattern, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = self::MATCH, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $pregFlags = 0)
    {
    }
    /**
     * Get accept status
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setMode(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode) : void
    {
    }
    /**
     * Get flags
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setPregFlags(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $pregFlags) : void
    {
    }
}
/**
...
class RecursiveRegexIterator extends \RegexIterator implements \RecursiveIterator
{
     ...
     * @param int $pregFlags [optional] The regular expression flags. These flags depend on the operation mode parameter
     */
    public function __construct(\RecursiveIterator $iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $pattern, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = self::MATCH, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $pregFlags = 0)
    {
    }
    /**
...
class RecursiveTreeIterator extends \RecursiveIteratorIterator
{
     ...
     */
    public function __construct($iterator, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = self::BYPASS_KEY, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $cachingIteratorFlags = \CachingIterator::CATCH_GET_CHILD, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $mode = self::SELF_FIRST)
    {
    }
    /**
     * Rewind iterator
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setPostfix(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '7.3')] string $postfix) : void
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setPrefixPart(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $part, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $value) : void
    {
    }
    /**
     * Get current entry
...
class ArrayObject implements \IteratorAggregate, \ArrayAccess, \Serializable, \Countable
{
     ...
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'object|array'], default: '')] $array = [], #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $iteratorClass = "ArrayIterator")
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function offsetExists(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $key) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function offsetGet(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $key) : mixed
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function offsetSet(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $key, #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $value) : void
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function offsetUnset(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $key) : void
    {
    }
    /**
     * Appends the value
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function append(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')] $value) : void
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function asort(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $flags = \SORT_REGULAR) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function ksort(#[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '8.0')] int $flags = \SORT_REGULAR) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function uasort(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $callback) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function uksort(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'callable'], default: '')] $callback) : bool
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function exchangeArray(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'object|array'], default: '')] $array) : array
    {
    }
    /**
     ...
     */
    #[\JetBrains\PhpStorm\Internal\TentativeType]
    public function setIteratorClass(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'string'], default: '')] $iteratorClass) : void
    {
    }
    /**
...
class ArrayIterator implements \SeekableIterator, \ArrayAccess, \Serializable, \Countable
{
     ...
     */
    public function __construct(#[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'object|array'], default: '')] $array = [], #[\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware(['8.0' => 'int'], default: '')] $flags = 0, #[\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable(from: '5.3', to: '7.1')] $iterator_class = null)
    {
    }
    /**
