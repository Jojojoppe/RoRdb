...
use RoRdb\Safe\Exceptions\YazException;
/**
...
{
    \error_clear_last();
    $result = \RoRdb\yaz_ccl_parse($id, $query, $result);
    if ($result === \false) {
...
function yaz_connect(string $zurl, $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $result = \RoRdb\yaz_connect($zurl, $options);
    } else {
        $result = \RoRdb\yaz_connect($zurl);
    }
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \RoRdb\yaz_database($id, $databases);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\yaz_element($id, $elementset);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\yaz_search($id, $type, $query);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
