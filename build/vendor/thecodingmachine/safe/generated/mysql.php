...
use RoRdb\Safe\Exceptions\MysqlException;
/**
...
{
    \error_clear_last();
    $result = \RoRdb\mysql_create_db($database_name, $link_identifier);
    if ($result === \false) {
        throw MysqlException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\mysql_drop_db($database_name, $link_identifier);
    if ($result === \false) {
        throw MysqlException::createFromPhpError();
    }
}
