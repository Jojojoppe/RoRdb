...
use RoRdb\Safe\Exceptions\IngresiiException;
/**
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_autocommit($link);
    if ($result === \false) {
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_close($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_commit($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_connect(string $database = null, string $username = null, string $password = null, array $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $result = \RoRdb\ingres_connect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \RoRdb\ingres_connect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \RoRdb\ingres_connect($database, $username);
    } elseif ($database !== null) {
        $result = \RoRdb\ingres_connect($database);
    } else {
        $result = \RoRdb\ingres_connect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
function ingres_execute($result, array $params = null, string $types = null) : void
{
    \error_clear_last();
    if ($types !== null) {
        $result = \RoRdb\ingres_execute($result, $params, $types);
    } elseif ($params !== null) {
        $result = \RoRdb\ingres_execute($result, $params);
    } else {
        $result = \RoRdb\ingres_execute($result);
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_field_name($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_field_type($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_free_result($result);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_pconnect(string $database = null, string $username = null, string $password = null, array $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $result = \RoRdb\ingres_pconnect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \RoRdb\ingres_pconnect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \RoRdb\ingres_pconnect($database, $username);
    } elseif ($database !== null) {
        $result = \RoRdb\ingres_pconnect($database);
    } else {
        $result = \RoRdb\ingres_pconnect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_result_seek($result, $position);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_rollback($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ingres_set_environment($link, $options);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
