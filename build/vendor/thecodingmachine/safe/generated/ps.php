...
namespace RoRdb\Safe;

use RoRdb\Safe\Exceptions\PsException;
/**
...
{
    \error_clear_last();
    $result = \RoRdb\ps_add_launchlink($psdoc, $llx, $lly, $urx, $ury, $filename);
    if ($result === \false) {
...
{
    \error_clear_last();
    $result = \RoRdb\ps_add_locallink($psdoc, $llx, $lly, $urx, $ury, $page, $dest);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_add_note($psdoc, $llx, $lly, $urx, $ury, $contents, $title, $icon, $open);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_add_pdflink($psdoc, $llx, $lly, $urx, $ury, $filename, $page, $dest);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_add_weblink($psdoc, $llx, $lly, $urx, $ury, $url);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_arc($psdoc, $x, $y, $radius, $alpha, $beta);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_arcn($psdoc, $x, $y, $radius, $alpha, $beta);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_begin_page($psdoc, $width, $height);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_begin_pattern($psdoc, $width, $height, $xstep, $ystep, $painttype);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ps_begin_template($psdoc, $width, $height);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ps_circle($psdoc, $x, $y, $radius);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_close_image($psdoc, $imageid);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_closepath_stroke($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_closepath($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_continue_text($psdoc, $text);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_curveto($psdoc, $x1, $y1, $x2, $y2, $x3, $y3);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_end_page($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_end_pattern($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_end_template($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_fill_stroke($psdoc);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
function ps_get_parameter($psdoc, string $name, float $modifier = null) : string
{
    \error_clear_last();
    if ($modifier !== null) {
        $result = \RoRdb\ps_get_parameter($psdoc, $name, $modifier);
    } else {
        $result = \RoRdb\ps_get_parameter($psdoc, $name);
    }
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \RoRdb\ps_hyphenate($psdoc, $text);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ps_include_file($psdoc, $file);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_lineto($psdoc, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_moveto($psdoc, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
function ps_open_file($psdoc, string $filename = null) : void
{
    \error_clear_last();
    if ($filename !== null) {
        $result = \RoRdb\ps_open_file($psdoc, $filename);
    } else {
        $result = \RoRdb\ps_open_file($psdoc);
    }
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \RoRdb\ps_place_image($psdoc, $imageid, $x, $y, $scale);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_rect($psdoc, $x, $y, $width, $height);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_rotate($psdoc, $rot);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_scale($psdoc, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_border_color($psdoc, $red, $green, $blue);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_border_dash($psdoc, $black, $white);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_border_style($psdoc, $style, $width);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_info($p, $key, $val);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_parameter($psdoc, $name, $value);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_text_pos($psdoc, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_set_value($psdoc, $name, $value);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setcolor($psdoc, $type, $colorspace, $c1, $c2, $c3, $c4);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setdash($psdoc, $on, $off);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setflat($psdoc, $value);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setfont($psdoc, $fontid, $size);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setgray($psdoc, $gray);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setlinecap($psdoc, $type);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setlinejoin($psdoc, $type);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setlinewidth($psdoc, $width);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setmiterlimit($psdoc, $value);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setoverprintmode($psdoc, $mode);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_setpolydash($psdoc, $arr);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_shading_pattern($psdoc, $shadingid, $optlist);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ps_shading($psdoc, $type, $x0, $y0, $x1, $y1, $c1, $c2, $c3, $c4, $optlist);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ps_shfill($psdoc, $shadingid);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_show_xy($psdoc, $text, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_show_xy2($psdoc, $text, $len, $xcoor, $ycoor);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_show($psdoc, $text);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_show2($psdoc, $text, $len);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_symbol($psdoc, $ord);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \RoRdb\ps_translate($psdoc, $x, $y);
    if ($result === \false) {
        throw PsException::createFromPhpError();
    }
}
