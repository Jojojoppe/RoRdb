...
use RoRdb\Safe\Exceptions\SsdeepException;
/**
...
{
    \error_clear_last();
    $result = \RoRdb\ssdeep_fuzzy_compare($signature1, $signature2);
    if ($result === \false) {
...
{
    \error_clear_last();
    $result = \RoRdb\ssdeep_fuzzy_hash_filename($file_name);
    if ($result === \false) {
        throw SsdeepException::createFromPhpError();
    }
    return $result;
...
{
    \error_clear_last();
    $result = \RoRdb\ssdeep_fuzzy_hash($to_hash);
    if ($result === \false) {
        throw SsdeepException::createFromPhpError();
    }
    return $result;
