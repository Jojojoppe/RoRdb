...
class ListRuntimeEntitySchemasResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRuntimeEntitySchemasResponse::class, 'RoRdb\\Google_Service_Connectors_ListRuntimeEntitySchemasResponse');
