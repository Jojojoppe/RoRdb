 ...
 * the License.
 */
namespace RoRdb\Google\Service\Connectors\Resource;

use RoRdb\Google\Service\Connectors\Connection;
use RoRdb\Google\Service\Connectors\ConnectionSchemaMetadata;
use RoRdb\Google\Service\Connectors\ListConnectionsResponse;
use RoRdb\Google\Service\Connectors\Operation;
use RoRdb\Google\Service\Connectors\Policy;
use RoRdb\Google\Service\Connectors\SetIamPolicyRequest;
use RoRdb\Google\Service\Connectors\TestIamPermissionsRequest;
use RoRdb\Google\Service\Connectors\TestIamPermissionsResponse;
/**
...
\class_alias(ProjectsLocationsConnections::class, 'RoRdb\\Google_Service_Connectors_Resource_ProjectsLocationsConnections');
