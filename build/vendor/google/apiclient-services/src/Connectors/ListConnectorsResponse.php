...
class ListConnectorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListConnectorsResponse::class, 'RoRdb\\Google_Service_Connectors_ListConnectorsResponse');
