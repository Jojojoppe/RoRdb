...
class ListConnectorVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListConnectorVersionsResponse::class, 'RoRdb\\Google_Service_Connectors_ListConnectorVersionsResponse');
