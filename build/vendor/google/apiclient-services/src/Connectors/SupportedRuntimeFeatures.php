...
class SupportedRuntimeFeatures extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SupportedRuntimeFeatures::class, 'RoRdb\\Google_Service_Connectors_SupportedRuntimeFeatures');
