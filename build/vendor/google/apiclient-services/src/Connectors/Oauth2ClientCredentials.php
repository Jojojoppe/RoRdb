...
class Oauth2ClientCredentials extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(Oauth2ClientCredentials::class, 'RoRdb\\Google_Service_Connectors_Oauth2ClientCredentials');
