...
class ConfigVariableTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigVariableTemplate::class, 'RoRdb\\Google_Service_Connectors_ConfigVariableTemplate');
