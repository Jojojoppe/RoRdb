...
class ListRuntimeActionSchemasResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRuntimeActionSchemasResponse::class, 'RoRdb\\Google_Service_Connectors_ListRuntimeActionSchemasResponse');
