...
class UrlNotificationMetadata extends \RoRdb\Google\Model
{
...
\class_alias(UrlNotificationMetadata::class, 'RoRdb\\Google_Service_Indexing_UrlNotificationMetadata');
