 ...
 * the License.
 */
namespace RoRdb\Google\Service\Indexing;

class PublishUrlNotificationResponse extends \RoRdb\Google\Model
{
...
\class_alias(PublishUrlNotificationResponse::class, 'RoRdb\\Google_Service_Indexing_PublishUrlNotificationResponse');
