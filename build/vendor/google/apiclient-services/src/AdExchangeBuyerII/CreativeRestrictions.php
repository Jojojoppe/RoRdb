...
class CreativeRestrictions extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeRestrictions::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_CreativeRestrictions');
