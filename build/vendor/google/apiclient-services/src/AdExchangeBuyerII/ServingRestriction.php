...
class ServingRestriction extends \RoRdb\Google\Collection
{
...
\class_alias(ServingRestriction::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ServingRestriction');
