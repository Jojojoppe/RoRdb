...
class ImpressionMetricsRow extends \RoRdb\Google\Model
{
...
\class_alias(ImpressionMetricsRow::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ImpressionMetricsRow');
