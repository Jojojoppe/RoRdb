...
class ListFilteredBidRequestsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFilteredBidRequestsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListFilteredBidRequestsResponse');
