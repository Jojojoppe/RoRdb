...
class FilteredBidDetailRow extends \RoRdb\Google\Model
{
...
\class_alias(FilteredBidDetailRow::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_FilteredBidDetailRow');
