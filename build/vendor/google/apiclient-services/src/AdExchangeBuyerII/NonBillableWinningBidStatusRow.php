...
class NonBillableWinningBidStatusRow extends \RoRdb\Google\Model
{
...
\class_alias(NonBillableWinningBidStatusRow::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_NonBillableWinningBidStatusRow');
