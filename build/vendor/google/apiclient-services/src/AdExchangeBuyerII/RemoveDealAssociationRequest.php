...
class RemoveDealAssociationRequest extends \RoRdb\Google\Model
{
...
\class_alias(RemoveDealAssociationRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_RemoveDealAssociationRequest');
