...
class ListFilterSetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFilterSetsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListFilterSetsResponse');
