...
class ListBidMetricsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBidMetricsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListBidMetricsResponse');
