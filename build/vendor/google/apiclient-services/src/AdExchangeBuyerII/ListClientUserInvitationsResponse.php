...
class ListClientUserInvitationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListClientUserInvitationsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListClientUserInvitationsResponse');
