...
class ListFilteredBidsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFilteredBidsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListFilteredBidsResponse');
