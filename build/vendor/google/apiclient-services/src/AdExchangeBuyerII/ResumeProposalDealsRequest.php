...
class ResumeProposalDealsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ResumeProposalDealsRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ResumeProposalDealsRequest');
