...
class CreativeSpecification extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeSpecification::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_CreativeSpecification');
