...
class ListBidResponseErrorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBidResponseErrorsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListBidResponseErrorsResponse');
