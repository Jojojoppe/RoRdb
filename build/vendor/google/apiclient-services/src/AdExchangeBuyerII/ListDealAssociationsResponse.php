...
class ListDealAssociationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDealAssociationsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListDealAssociationsResponse');
