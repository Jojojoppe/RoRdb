...
class ListImpressionMetricsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListImpressionMetricsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListImpressionMetricsResponse');
