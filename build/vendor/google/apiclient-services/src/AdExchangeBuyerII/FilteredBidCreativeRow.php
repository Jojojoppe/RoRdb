...
class FilteredBidCreativeRow extends \RoRdb\Google\Model
{
...
\class_alias(FilteredBidCreativeRow::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_FilteredBidCreativeRow');
