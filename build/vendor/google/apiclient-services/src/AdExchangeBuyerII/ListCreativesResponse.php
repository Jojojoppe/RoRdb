...
class ListCreativesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCreativesResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListCreativesResponse');
