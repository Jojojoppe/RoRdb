...
class ListLosingBidsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListLosingBidsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListLosingBidsResponse');
