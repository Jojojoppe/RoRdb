...
class ListNonBillableWinningBidsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListNonBillableWinningBidsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_ListNonBillableWinningBidsResponse');
