...
class AddDealAssociationRequest extends \RoRdb\Google\Model
{
...
\class_alias(AddDealAssociationRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_AddDealAssociationRequest');
