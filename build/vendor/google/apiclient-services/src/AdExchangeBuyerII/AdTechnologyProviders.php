...
class AdTechnologyProviders extends \RoRdb\Google\Collection
{
...
\class_alias(AdTechnologyProviders::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_AdTechnologyProviders');
