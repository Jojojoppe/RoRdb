...
class NonGuaranteedFixedPriceTerms extends \RoRdb\Google\Collection
{
...
\class_alias(NonGuaranteedFixedPriceTerms::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_NonGuaranteedFixedPriceTerms');
