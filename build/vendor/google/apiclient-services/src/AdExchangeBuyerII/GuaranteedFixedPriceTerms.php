...
class GuaranteedFixedPriceTerms extends \RoRdb\Google\Collection
{
...
\class_alias(GuaranteedFixedPriceTerms::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_GuaranteedFixedPriceTerms');
