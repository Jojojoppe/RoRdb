...
class BidResponseWithoutBidsStatusRow extends \RoRdb\Google\Model
{
...
\class_alias(BidResponseWithoutBidsStatusRow::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_BidResponseWithoutBidsStatusRow');
