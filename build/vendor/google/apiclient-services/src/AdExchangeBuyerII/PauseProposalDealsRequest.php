...
class PauseProposalDealsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(PauseProposalDealsRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_PauseProposalDealsRequest');
