...
class NonGuaranteedAuctionTerms extends \RoRdb\Google\Collection
{
...
\class_alias(NonGuaranteedAuctionTerms::class, 'RoRdb\\Google_Service_AdExchangeBuyerII_NonGuaranteedAuctionTerms');
