...
class GoogleCloudPolicysimulatorV1ReplayConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudPolicysimulatorV1ReplayConfig::class, 'RoRdb\\Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1ReplayConfig');
