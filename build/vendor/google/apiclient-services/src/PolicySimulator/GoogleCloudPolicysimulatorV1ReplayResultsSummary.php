...
class GoogleCloudPolicysimulatorV1ReplayResultsSummary extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudPolicysimulatorV1ReplayResultsSummary::class, 'RoRdb\\Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1ReplayResultsSummary');
