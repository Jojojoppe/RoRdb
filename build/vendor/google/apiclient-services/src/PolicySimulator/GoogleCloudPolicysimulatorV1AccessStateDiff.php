...
class GoogleCloudPolicysimulatorV1AccessStateDiff extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudPolicysimulatorV1AccessStateDiff::class, 'RoRdb\\Google_Service_PolicySimulator_GoogleCloudPolicysimulatorV1AccessStateDiff');
