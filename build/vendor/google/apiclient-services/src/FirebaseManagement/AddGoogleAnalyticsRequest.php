...
class AddGoogleAnalyticsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AddGoogleAnalyticsRequest::class, 'RoRdb\\Google_Service_FirebaseManagement_AddGoogleAnalyticsRequest');
