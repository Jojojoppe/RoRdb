 ...
 * the License.
 */
namespace RoRdb\Google\Service\AdExperienceReport;
...
\class_alias(ViolatingSitesResponse::class, 'RoRdb\\Google_Service_AdExperienceReport_ViolatingSitesResponse');
