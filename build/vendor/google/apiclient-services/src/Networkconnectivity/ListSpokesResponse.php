...
class ListSpokesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListSpokesResponse::class, 'RoRdb\\Google_Service_Networkconnectivity_ListSpokesResponse');
