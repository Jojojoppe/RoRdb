...
class LinkedRouterApplianceInstances extends \RoRdb\Google\Collection
{
...
\class_alias(LinkedRouterApplianceInstances::class, 'RoRdb\\Google_Service_Networkconnectivity_LinkedRouterApplianceInstances');
