...
class GetReportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetReportsResponse::class, 'RoRdb\\Google_Service_AnalyticsReporting_GetReportsResponse');
