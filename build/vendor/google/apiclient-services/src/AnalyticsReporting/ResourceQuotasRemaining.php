...
class ResourceQuotasRemaining extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ResourceQuotasRemaining::class, 'RoRdb\\Google_Service_AnalyticsReporting_ResourceQuotasRemaining');
