...
class OrFiltersForSegment extends \RoRdb\Google\Collection
{
...
\class_alias(OrFiltersForSegment::class, 'RoRdb\\Google_Service_AnalyticsReporting_OrFiltersForSegment');
