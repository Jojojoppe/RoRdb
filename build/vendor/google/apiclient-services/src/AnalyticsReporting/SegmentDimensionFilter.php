...
class SegmentDimensionFilter extends \RoRdb\Google\Collection
{
...
\class_alias(SegmentDimensionFilter::class, 'RoRdb\\Google_Service_AnalyticsReporting_SegmentDimensionFilter');
