...
class UserActivitySession extends \RoRdb\Google\Collection
{
...
\class_alias(UserActivitySession::class, 'RoRdb\\Google_Service_AnalyticsReporting_UserActivitySession');
