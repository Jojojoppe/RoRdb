...
class SearchUserActivityResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchUserActivityResponse::class, 'RoRdb\\Google_Service_AnalyticsReporting_SearchUserActivityResponse');
