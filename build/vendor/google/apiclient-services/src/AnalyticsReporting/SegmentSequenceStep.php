...
class SegmentSequenceStep extends \RoRdb\Google\Collection
{
...
\class_alias(SegmentSequenceStep::class, 'RoRdb\\Google_Service_AnalyticsReporting_SegmentSequenceStep');
