...
class ConfigManagementSyncState extends \RoRdb\Google\Collection
{
...
\class_alias(ConfigManagementSyncState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementSyncState');
