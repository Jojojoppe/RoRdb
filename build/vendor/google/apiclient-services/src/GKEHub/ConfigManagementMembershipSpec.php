...
class ConfigManagementMembershipSpec extends \RoRdb\Google\Model
{
...
\class_alias(ConfigManagementMembershipSpec::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementMembershipSpec');
