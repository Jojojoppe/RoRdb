...
class PolicyControllerPolicyControllerHubState extends \RoRdb\Google\Model
{
    /**
     * @var string[]
     */
...
\class_alias(PolicyControllerPolicyControllerHubState::class, 'RoRdb\\Google_Service_GKEHub_PolicyControllerPolicyControllerHubState');
