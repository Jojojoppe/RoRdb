...
class ConfigManagementSyncError extends \RoRdb\Google\Collection
{
...
\class_alias(ConfigManagementSyncError::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementSyncError');
