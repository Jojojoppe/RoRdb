...
class ConfigManagementPolicyController extends \RoRdb\Google\Collection
{
...
\class_alias(ConfigManagementPolicyController::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementPolicyController');
