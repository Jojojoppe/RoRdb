...
class ConfigManagementErrorResource extends \RoRdb\Google\Model
{
...
\class_alias(ConfigManagementErrorResource::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementErrorResource');
