...
class ConfigManagementConfigSyncDeploymentState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigManagementConfigSyncDeploymentState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementConfigSyncDeploymentState');
