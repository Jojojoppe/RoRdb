...
class GenerateConnectManifestResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GenerateConnectManifestResponse::class, 'RoRdb\\Google_Service_GKEHub_GenerateConnectManifestResponse');
