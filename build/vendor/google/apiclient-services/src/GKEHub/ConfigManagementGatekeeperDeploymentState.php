...
class ConfigManagementGatekeeperDeploymentState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigManagementGatekeeperDeploymentState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementGatekeeperDeploymentState');
