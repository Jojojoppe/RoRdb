...
class ConfigManagementConfigSyncState extends \RoRdb\Google\Model
{
...
\class_alias(ConfigManagementConfigSyncState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementConfigSyncState');
