...
class ConfigManagementPolicyControllerState extends \RoRdb\Google\Model
{
...
\class_alias(ConfigManagementPolicyControllerState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementPolicyControllerState');
