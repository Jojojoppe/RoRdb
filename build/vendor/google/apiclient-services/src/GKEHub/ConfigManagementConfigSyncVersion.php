...
class ConfigManagementConfigSyncVersion extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigManagementConfigSyncVersion::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementConfigSyncVersion');
