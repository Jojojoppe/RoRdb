...
class ConfigManagementMembershipState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigManagementMembershipState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementMembershipState');
