...
class PolicyControllerMembershipState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PolicyControllerMembershipState::class, 'RoRdb\\Google_Service_GKEHub_PolicyControllerMembershipState');
