...
class ConfigManagementOperatorState extends \RoRdb\Google\Collection
{
...
\class_alias(ConfigManagementOperatorState::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementOperatorState');
