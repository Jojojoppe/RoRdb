...
class MultiClusterIngressFeatureSpec extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MultiClusterIngressFeatureSpec::class, 'RoRdb\\Google_Service_GKEHub_MultiClusterIngressFeatureSpec');
