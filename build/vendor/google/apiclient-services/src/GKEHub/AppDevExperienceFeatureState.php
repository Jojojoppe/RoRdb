...
class AppDevExperienceFeatureState extends \RoRdb\Google\Model
{
...
\class_alias(AppDevExperienceFeatureState::class, 'RoRdb\\Google_Service_GKEHub_AppDevExperienceFeatureState');
