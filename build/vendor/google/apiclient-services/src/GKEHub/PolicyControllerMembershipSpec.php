...
class PolicyControllerMembershipSpec extends \RoRdb\Google\Model
{
...
\class_alias(PolicyControllerMembershipSpec::class, 'RoRdb\\Google_Service_GKEHub_PolicyControllerMembershipSpec');
