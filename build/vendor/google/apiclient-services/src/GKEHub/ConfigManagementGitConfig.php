...
class ConfigManagementGitConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ConfigManagementGitConfig::class, 'RoRdb\\Google_Service_GKEHub_ConfigManagementGitConfig');
