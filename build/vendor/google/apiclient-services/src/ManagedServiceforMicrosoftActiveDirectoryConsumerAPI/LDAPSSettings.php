...
class LDAPSSettings extends \RoRdb\Google\Model
{
...
\class_alias(LDAPSSettings::class, 'RoRdb\\Google_Service_ManagedServiceforMicrosoftActiveDirectoryConsumerAPI_LDAPSSettings');
