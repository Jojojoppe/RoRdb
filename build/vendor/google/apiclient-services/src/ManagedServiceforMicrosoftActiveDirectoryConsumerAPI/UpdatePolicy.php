...
class UpdatePolicy extends \RoRdb\Google\Collection
{
...
\class_alias(UpdatePolicy::class, 'RoRdb\\Google_Service_ManagedServiceforMicrosoftActiveDirectoryConsumerAPI_UpdatePolicy');
