...
class Certificate extends \RoRdb\Google\Collection
{
...
\class_alias(Certificate::class, 'RoRdb\\Google_Service_ManagedServiceforMicrosoftActiveDirectoryConsumerAPI_Certificate');
