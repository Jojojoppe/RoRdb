...
class CheckDataAccessResponse extends \RoRdb\Google\Model
{
...
\class_alias(CheckDataAccessResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_CheckDataAccessResponse');
