...
class CheckDataAccessRequest extends \RoRdb\Google\Model
{
...
\class_alias(CheckDataAccessRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_CheckDataAccessRequest');
