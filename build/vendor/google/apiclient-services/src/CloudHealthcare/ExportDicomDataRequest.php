...
class ExportDicomDataRequest extends \RoRdb\Google\Model
{
...
\class_alias(ExportDicomDataRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_ExportDicomDataRequest');
