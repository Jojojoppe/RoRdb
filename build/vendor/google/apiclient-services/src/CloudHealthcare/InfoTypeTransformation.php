...
class InfoTypeTransformation extends \RoRdb\Google\Collection
{
...
\class_alias(InfoTypeTransformation::class, 'RoRdb\\Google_Service_CloudHealthcare_InfoTypeTransformation');
