...
class AttributeDefinition extends \RoRdb\Google\Collection
{
...
\class_alias(AttributeDefinition::class, 'RoRdb\\Google_Service_CloudHealthcare_AttributeDefinition');
