...
class ListMessagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListMessagesResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListMessagesResponse');
