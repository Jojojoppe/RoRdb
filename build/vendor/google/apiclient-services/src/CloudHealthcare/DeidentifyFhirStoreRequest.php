...
class DeidentifyFhirStoreRequest extends \RoRdb\Google\Model
{
...
\class_alias(DeidentifyFhirStoreRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_DeidentifyFhirStoreRequest');
