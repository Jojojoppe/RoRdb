...
class DeidentifyDatasetRequest extends \RoRdb\Google\Model
{
...
\class_alias(DeidentifyDatasetRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_DeidentifyDatasetRequest');
