...
class ImportResourcesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ImportResourcesRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_ImportResourcesRequest');
