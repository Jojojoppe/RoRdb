...
class ListUserDataMappingsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUserDataMappingsResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListUserDataMappingsResponse');
