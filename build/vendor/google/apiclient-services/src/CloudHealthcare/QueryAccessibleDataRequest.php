...
class QueryAccessibleDataRequest extends \RoRdb\Google\Model
{
...
\class_alias(QueryAccessibleDataRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_QueryAccessibleDataRequest');
