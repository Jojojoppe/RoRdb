...
class EvaluateUserConsentsRequest extends \RoRdb\Google\Model
{
...
\class_alias(EvaluateUserConsentsRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_EvaluateUserConsentsRequest');
