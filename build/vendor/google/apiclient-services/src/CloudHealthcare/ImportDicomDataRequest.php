...
class ImportDicomDataRequest extends \RoRdb\Google\Model
{
...
\class_alias(ImportDicomDataRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_ImportDicomDataRequest');
