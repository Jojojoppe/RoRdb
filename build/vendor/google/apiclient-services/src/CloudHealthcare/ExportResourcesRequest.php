...
class ExportResourcesRequest extends \RoRdb\Google\Model
{
...
\class_alias(ExportResourcesRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_ExportResourcesRequest');
