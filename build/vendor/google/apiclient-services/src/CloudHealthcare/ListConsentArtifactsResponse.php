...
class ListConsentArtifactsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListConsentArtifactsResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListConsentArtifactsResponse');
