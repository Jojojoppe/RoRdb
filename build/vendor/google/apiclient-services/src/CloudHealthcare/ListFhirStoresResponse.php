...
class ListFhirStoresResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFhirStoresResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListFhirStoresResponse');
