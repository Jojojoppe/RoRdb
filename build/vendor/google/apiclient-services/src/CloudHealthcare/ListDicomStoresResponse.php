...
class ListDicomStoresResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDicomStoresResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListDicomStoresResponse');
