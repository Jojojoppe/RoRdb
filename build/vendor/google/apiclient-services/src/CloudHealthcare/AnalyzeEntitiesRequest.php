...
class AnalyzeEntitiesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AnalyzeEntitiesRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_AnalyzeEntitiesRequest');
