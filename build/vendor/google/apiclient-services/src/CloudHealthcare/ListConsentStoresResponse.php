...
class ListConsentStoresResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListConsentStoresResponse::class, 'RoRdb\\Google_Service_CloudHealthcare_ListConsentStoresResponse');
