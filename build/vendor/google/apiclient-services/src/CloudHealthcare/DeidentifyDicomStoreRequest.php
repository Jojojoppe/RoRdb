...
class DeidentifyDicomStoreRequest extends \RoRdb\Google\Model
{
...
\class_alias(DeidentifyDicomStoreRequest::class, 'RoRdb\\Google_Service_CloudHealthcare_DeidentifyDicomStoreRequest');
