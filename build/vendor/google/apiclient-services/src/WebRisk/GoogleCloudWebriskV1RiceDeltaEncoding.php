...
class GoogleCloudWebriskV1RiceDeltaEncoding extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudWebriskV1RiceDeltaEncoding::class, 'RoRdb\\Google_Service_WebRisk_GoogleCloudWebriskV1RiceDeltaEncoding');
