 ...
 * the License.
 */
namespace RoRdb\Google\Service\ApiKeysService\Resource;

use RoRdb\Google\Service\ApiKeysService\Operation;
use RoRdb\Google\Service\ApiKeysService\V2CloneKeyRequest;
use RoRdb\Google\Service\ApiKeysService\V2GetKeyStringResponse;
use RoRdb\Google\Service\ApiKeysService\V2Key;
use RoRdb\Google\Service\ApiKeysService\V2ListKeysResponse;
use RoRdb\Google\Service\ApiKeysService\V2UndeleteKeyRequest;
/**
 ...
 *  </code>
 */
class ProjectsLocationsKeys extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsKeys::class, 'RoRdb\\Google_Service_ApiKeysService_Resource_ProjectsLocationsKeys');
