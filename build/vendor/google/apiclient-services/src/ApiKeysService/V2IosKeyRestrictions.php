...
class V2IosKeyRestrictions extends \RoRdb\Google\Collection
{
...
\class_alias(V2IosKeyRestrictions::class, 'RoRdb\\Google_Service_ApiKeysService_V2IosKeyRestrictions');
