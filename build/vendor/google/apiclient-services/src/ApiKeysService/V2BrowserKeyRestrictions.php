...
class V2BrowserKeyRestrictions extends \RoRdb\Google\Collection
{
...
\class_alias(V2BrowserKeyRestrictions::class, 'RoRdb\\Google_Service_ApiKeysService_V2BrowserKeyRestrictions');
