 ...
 * the License.
 */
namespace RoRdb\Google\Service\Workflows\Resource;

use RoRdb\Google\Service\Workflows\ListOperationsResponse;
use RoRdb\Google\Service\Workflows\Operation;
use RoRdb\Google\Service\Workflows\WorkflowsEmpty;
/**
...
\class_alias(ProjectsLocationsOperations::class, 'RoRdb\\Google_Service_Workflows_Resource_ProjectsLocationsOperations');
