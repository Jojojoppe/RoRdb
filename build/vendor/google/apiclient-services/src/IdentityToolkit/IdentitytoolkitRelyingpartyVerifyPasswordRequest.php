...
class IdentitytoolkitRelyingpartyVerifyPasswordRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IdentitytoolkitRelyingpartyVerifyPasswordRequest::class, 'RoRdb\\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyPasswordRequest');
