...
class IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse');
