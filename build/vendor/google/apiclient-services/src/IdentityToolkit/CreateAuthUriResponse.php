...
class CreateAuthUriResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreateAuthUriResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_CreateAuthUriResponse');
