 ...
 * the License.
 */
namespace RoRdb\Google\Service\IdentityToolkit\Resource;

use RoRdb\Google\Service\IdentityToolkit\CreateAuthUriResponse;
use RoRdb\Google\Service\IdentityToolkit\DeleteAccountResponse;
use RoRdb\Google\Service\IdentityToolkit\DownloadAccountResponse;
use RoRdb\Google\Service\IdentityToolkit\EmailLinkSigninResponse;
use RoRdb\Google\Service\IdentityToolkit\GetAccountInfoResponse;
use RoRdb\Google\Service\IdentityToolkit\GetOobConfirmationCodeResponse;
use RoRdb\Google\Service\IdentityToolkit\GetRecaptchaParamResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyCreateAuthUriRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyDeleteAccountRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyDownloadAccountRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyEmailLinkSigninRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetAccountInfoRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetProjectConfigResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyGetPublicKeysResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyResetPasswordRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySendVerificationCodeRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySendVerificationCodeResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetAccountInfoRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetProjectConfigRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySetProjectConfigResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignOutUserRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignOutUserResponse;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartySignupNewUserRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyUploadAccountRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyAssertionRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyCustomTokenRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPasswordRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest;
use RoRdb\Google\Service\IdentityToolkit\IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse;
use RoRdb\Google\Service\IdentityToolkit\Relyingparty as RelyingpartyModel;
use RoRdb\Google\Service\IdentityToolkit\ResetPasswordResponse;
use RoRdb\Google\Service\IdentityToolkit\SetAccountInfoResponse;
use RoRdb\Google\Service\IdentityToolkit\SignupNewUserResponse;
use RoRdb\Google\Service\IdentityToolkit\UploadAccountResponse;
use RoRdb\Google\Service\IdentityToolkit\VerifyAssertionResponse;
use RoRdb\Google\Service\IdentityToolkit\VerifyCustomTokenResponse;
use RoRdb\Google\Service\IdentityToolkit\VerifyPasswordResponse;
/**
 ...
 *  </code>
 */
class Relyingparty extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Relyingparty::class, 'RoRdb\\Google_Service_IdentityToolkit_Resource_Relyingparty');
