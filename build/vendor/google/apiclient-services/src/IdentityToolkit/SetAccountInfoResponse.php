...
class SetAccountInfoResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SetAccountInfoResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_SetAccountInfoResponse');
