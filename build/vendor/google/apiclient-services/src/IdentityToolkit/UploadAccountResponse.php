...
class UploadAccountResponse extends \RoRdb\Google\Collection
{
...
\class_alias(UploadAccountResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_UploadAccountResponse');
