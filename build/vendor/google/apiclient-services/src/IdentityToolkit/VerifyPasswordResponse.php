...
class VerifyPasswordResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VerifyPasswordResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_VerifyPasswordResponse');
