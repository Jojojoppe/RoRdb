...
class IdentitytoolkitRelyingpartySignupNewUserRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IdentitytoolkitRelyingpartySignupNewUserRequest::class, 'RoRdb\\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySignupNewUserRequest');
