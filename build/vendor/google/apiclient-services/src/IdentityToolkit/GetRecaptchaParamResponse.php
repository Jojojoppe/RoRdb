...
class GetRecaptchaParamResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GetRecaptchaParamResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_GetRecaptchaParamResponse');
