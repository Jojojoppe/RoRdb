...
class IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest::class, 'RoRdb\\Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest');
