...
class VerifyAssertionResponse extends \RoRdb\Google\Collection
{
...
\class_alias(VerifyAssertionResponse::class, 'RoRdb\\Google_Service_IdentityToolkit_VerifyAssertionResponse');
