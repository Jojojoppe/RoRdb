 ...
 * the License.
 */
namespace RoRdb\Google\Service\DomainsRDAP;

class RdapResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RdapResponse::class, 'RoRdb\\Google_Service_DomainsRDAP_RdapResponse');
