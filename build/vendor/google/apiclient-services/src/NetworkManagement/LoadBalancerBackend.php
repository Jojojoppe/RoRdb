...
class LoadBalancerBackend extends \RoRdb\Google\Collection
{
...
\class_alias(LoadBalancerBackend::class, 'RoRdb\\Google_Service_NetworkManagement_LoadBalancerBackend');
