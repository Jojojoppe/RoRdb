...
class ServiceAccountDelegationInfo extends \RoRdb\Google\Model
{
...
\class_alias(ServiceAccountDelegationInfo::class, 'RoRdb\\Google_Service_ServiceControl_ServiceAccountDelegationInfo');
