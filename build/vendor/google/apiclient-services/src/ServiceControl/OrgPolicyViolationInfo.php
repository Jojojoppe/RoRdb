...
class OrgPolicyViolationInfo extends \RoRdb\Google\Collection
{
...
\class_alias(OrgPolicyViolationInfo::class, 'RoRdb\\Google_Service_ServiceControl_OrgPolicyViolationInfo');
