...
* @author Google, Inc.
*/
class PolicyTroubleshooter extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->iam = new PolicyTroubleshooter\Resource\Iam($this, $this->serviceName, 'iam', ['methods' => ['troubleshoot' => ['path' => 'v1/iam:troubleshoot', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(PolicyTroubleshooter::class, 'RoRdb\\Google_Service_PolicyTroubleshooter');
