...
class GoogleAdsHomeservicesLocalservicesV1PhoneLead extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAdsHomeservicesLocalservicesV1PhoneLead::class, 'RoRdb\\Google_Service_Localservices_GoogleAdsHomeservicesLocalservicesV1PhoneLead');
