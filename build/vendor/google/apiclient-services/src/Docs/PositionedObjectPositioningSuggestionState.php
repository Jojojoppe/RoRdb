...
class PositionedObjectPositioningSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PositionedObjectPositioningSuggestionState::class, 'RoRdb\\Google_Service_Docs_PositionedObjectPositioningSuggestionState');
