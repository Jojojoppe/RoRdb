...
class ParagraphStyleSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ParagraphStyleSuggestionState::class, 'RoRdb\\Google_Service_Docs_ParagraphStyleSuggestionState');
