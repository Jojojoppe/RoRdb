...
class ReplaceNamedRangeContentRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReplaceNamedRangeContentRequest::class, 'RoRdb\\Google_Service_Docs_ReplaceNamedRangeContentRequest');
