...
class TableCellStyleSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TableCellStyleSuggestionState::class, 'RoRdb\\Google_Service_Docs_TableCellStyleSuggestionState');
