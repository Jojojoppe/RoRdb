...
class NestingLevelSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(NestingLevelSuggestionState::class, 'RoRdb\\Google_Service_Docs_NestingLevelSuggestionState');
