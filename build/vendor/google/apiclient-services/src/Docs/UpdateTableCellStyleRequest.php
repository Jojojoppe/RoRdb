...
class UpdateTableCellStyleRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateTableCellStyleRequest::class, 'RoRdb\\Google_Service_Docs_UpdateTableCellStyleRequest');
