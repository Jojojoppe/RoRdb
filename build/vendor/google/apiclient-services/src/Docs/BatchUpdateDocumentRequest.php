...
class BatchUpdateDocumentRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateDocumentRequest::class, 'RoRdb\\Google_Service_Docs_BatchUpdateDocumentRequest');
