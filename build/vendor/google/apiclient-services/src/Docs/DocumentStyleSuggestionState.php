...
class DocumentStyleSuggestionState extends \RoRdb\Google\Model
{
...
\class_alias(DocumentStyleSuggestionState::class, 'RoRdb\\Google_Service_Docs_DocumentStyleSuggestionState');
