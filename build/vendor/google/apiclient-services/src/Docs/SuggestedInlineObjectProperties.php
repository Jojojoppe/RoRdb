...
class SuggestedInlineObjectProperties extends \RoRdb\Google\Model
{
...
\class_alias(SuggestedInlineObjectProperties::class, 'RoRdb\\Google_Service_Docs_SuggestedInlineObjectProperties');
