...
class NamedStylesSuggestionState extends \RoRdb\Google\Collection
{
...
\class_alias(NamedStylesSuggestionState::class, 'RoRdb\\Google_Service_Docs_NamedStylesSuggestionState');
