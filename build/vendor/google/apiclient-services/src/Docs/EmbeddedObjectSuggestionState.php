...
class EmbeddedObjectSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(EmbeddedObjectSuggestionState::class, 'RoRdb\\Google_Service_Docs_EmbeddedObjectSuggestionState');
