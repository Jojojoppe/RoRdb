...
class PositionedObjectPositioning extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PositionedObjectPositioning::class, 'RoRdb\\Google_Service_Docs_PositionedObjectPositioning');
