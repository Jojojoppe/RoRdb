...
class TextStyleSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TextStyleSuggestionState::class, 'RoRdb\\Google_Service_Docs_TextStyleSuggestionState');
