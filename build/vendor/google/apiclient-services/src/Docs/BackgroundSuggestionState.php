...
class BackgroundSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(BackgroundSuggestionState::class, 'RoRdb\\Google_Service_Docs_BackgroundSuggestionState');
