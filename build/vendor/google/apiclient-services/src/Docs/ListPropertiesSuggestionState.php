...
class ListPropertiesSuggestionState extends \RoRdb\Google\Collection
{
...
\class_alias(ListPropertiesSuggestionState::class, 'RoRdb\\Google_Service_Docs_ListPropertiesSuggestionState');
