...
class UpdateSectionStyleRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateSectionStyleRequest::class, 'RoRdb\\Google_Service_Docs_UpdateSectionStyleRequest');
