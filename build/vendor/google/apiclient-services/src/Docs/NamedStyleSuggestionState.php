...
class NamedStyleSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NamedStyleSuggestionState::class, 'RoRdb\\Google_Service_Docs_NamedStyleSuggestionState');
