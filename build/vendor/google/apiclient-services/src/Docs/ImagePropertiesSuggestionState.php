...
class ImagePropertiesSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ImagePropertiesSuggestionState::class, 'RoRdb\\Google_Service_Docs_ImagePropertiesSuggestionState');
