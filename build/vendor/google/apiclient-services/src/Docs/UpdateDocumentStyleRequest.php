...
class UpdateDocumentStyleRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateDocumentStyleRequest::class, 'RoRdb\\Google_Service_Docs_UpdateDocumentStyleRequest');
