...
class InsertSectionBreakRequest extends \RoRdb\Google\Model
{
...
\class_alias(InsertSectionBreakRequest::class, 'RoRdb\\Google_Service_Docs_InsertSectionBreakRequest');
