...
class InsertInlineImageRequest extends \RoRdb\Google\Model
{
...
\class_alias(InsertInlineImageRequest::class, 'RoRdb\\Google_Service_Docs_InsertInlineImageRequest');
