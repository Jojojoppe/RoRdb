...
class BatchUpdateDocumentResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateDocumentResponse::class, 'RoRdb\\Google_Service_Docs_BatchUpdateDocumentResponse');
