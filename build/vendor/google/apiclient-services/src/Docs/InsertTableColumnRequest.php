...
class InsertTableColumnRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(InsertTableColumnRequest::class, 'RoRdb\\Google_Service_Docs_InsertTableColumnRequest');
