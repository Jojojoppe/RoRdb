...
class SheetsChartReferenceSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SheetsChartReferenceSuggestionState::class, 'RoRdb\\Google_Service_Docs_SheetsChartReferenceSuggestionState');
