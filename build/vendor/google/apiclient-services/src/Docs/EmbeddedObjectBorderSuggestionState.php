...
class EmbeddedObjectBorderSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(EmbeddedObjectBorderSuggestionState::class, 'RoRdb\\Google_Service_Docs_EmbeddedObjectBorderSuggestionState');
