...
class UpdateTableRowStyleRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateTableRowStyleRequest::class, 'RoRdb\\Google_Service_Docs_UpdateTableRowStyleRequest');
