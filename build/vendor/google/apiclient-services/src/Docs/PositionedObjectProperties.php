...
class PositionedObjectProperties extends \RoRdb\Google\Model
{
...
\class_alias(PositionedObjectProperties::class, 'RoRdb\\Google_Service_Docs_PositionedObjectProperties');
