...
class CropPropertiesSuggestionState extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(CropPropertiesSuggestionState::class, 'RoRdb\\Google_Service_Docs_CropPropertiesSuggestionState');
