...
class CreateCollectdTimeSeriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreateCollectdTimeSeriesResponse::class, 'RoRdb\\Google_Service_Monitoring_CreateCollectdTimeSeriesResponse');
