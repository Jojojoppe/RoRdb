...
class ListMetricDescriptorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListMetricDescriptorsResponse::class, 'RoRdb\\Google_Service_Monitoring_ListMetricDescriptorsResponse');
