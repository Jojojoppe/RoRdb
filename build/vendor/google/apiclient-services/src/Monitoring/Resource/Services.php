...
use RoRdb\Google\Service\Monitoring\ListServicesResponse;
use RoRdb\Google\Service\Monitoring\MonitoringEmpty;
use RoRdb\Google\Service\Monitoring\Service;
/**
...
\class_alias(Services::class, 'RoRdb\\Google_Service_Monitoring_Resource_Services');
