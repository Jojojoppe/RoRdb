...
class ListServiceLevelObjectivesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListServiceLevelObjectivesResponse::class, 'RoRdb\\Google_Service_Monitoring_ListServiceLevelObjectivesResponse');
