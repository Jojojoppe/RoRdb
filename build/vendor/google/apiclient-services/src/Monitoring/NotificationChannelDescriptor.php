...
class NotificationChannelDescriptor extends \RoRdb\Google\Collection
{
...
\class_alias(NotificationChannelDescriptor::class, 'RoRdb\\Google_Service_Monitoring_NotificationChannelDescriptor');
