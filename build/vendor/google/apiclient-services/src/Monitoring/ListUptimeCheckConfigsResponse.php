...
class ListUptimeCheckConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUptimeCheckConfigsResponse::class, 'RoRdb\\Google_Service_Monitoring_ListUptimeCheckConfigsResponse');
