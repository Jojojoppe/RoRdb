...
class ListUptimeCheckIpsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUptimeCheckIpsResponse::class, 'RoRdb\\Google_Service_Monitoring_ListUptimeCheckIpsResponse');
