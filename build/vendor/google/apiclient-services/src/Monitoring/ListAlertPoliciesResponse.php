...
class ListAlertPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAlertPoliciesResponse::class, 'RoRdb\\Google_Service_Monitoring_ListAlertPoliciesResponse');
