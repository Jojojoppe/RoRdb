...
class ListTimeSeriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTimeSeriesResponse::class, 'RoRdb\\Google_Service_Monitoring_ListTimeSeriesResponse');
