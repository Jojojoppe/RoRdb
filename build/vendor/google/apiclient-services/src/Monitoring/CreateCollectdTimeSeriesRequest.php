...
class CreateCollectdTimeSeriesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(CreateCollectdTimeSeriesRequest::class, 'RoRdb\\Google_Service_Monitoring_CreateCollectdTimeSeriesRequest');
