...
class QueryTimeSeriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(QueryTimeSeriesResponse::class, 'RoRdb\\Google_Service_Monitoring_QueryTimeSeriesResponse');
