...
class CreateTimeSeriesSummary extends \RoRdb\Google\Collection
{
...
\class_alias(CreateTimeSeriesSummary::class, 'RoRdb\\Google_Service_Monitoring_CreateTimeSeriesSummary');
