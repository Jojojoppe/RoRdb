 ...
 * the License.
 */
namespace RoRdb\Google\Service\PostmasterTools;

class ListTrafficStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTrafficStatsResponse::class, 'RoRdb\\Google_Service_PostmasterTools_ListTrafficStatsResponse');
