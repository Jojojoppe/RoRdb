...
class ModelOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ModelOperationMetadata::class, 'RoRdb\\Google_Service_FirebaseML_ModelOperationMetadata');
