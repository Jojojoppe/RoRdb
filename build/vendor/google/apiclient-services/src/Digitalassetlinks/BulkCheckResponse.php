 ...
 * the License.
 */
namespace RoRdb\Google\Service\Digitalassetlinks;

class BulkCheckResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BulkCheckResponse::class, 'RoRdb\\Google_Service_Digitalassetlinks_BulkCheckResponse');
