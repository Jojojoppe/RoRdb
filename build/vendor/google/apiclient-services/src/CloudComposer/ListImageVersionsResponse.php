...
class ListImageVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListImageVersionsResponse::class, 'RoRdb\\Google_Service_CloudComposer_ListImageVersionsResponse');
