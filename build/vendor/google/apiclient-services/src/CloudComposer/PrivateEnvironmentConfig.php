...
class PrivateEnvironmentConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PrivateEnvironmentConfig::class, 'RoRdb\\Google_Service_CloudComposer_PrivateEnvironmentConfig');
