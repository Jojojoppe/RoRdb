 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudComposer;

class WebServerNetworkAccessControl extends \RoRdb\Google\Collection
{
...
\class_alias(WebServerNetworkAccessControl::class, 'RoRdb\\Google_Service_CloudComposer_WebServerNetworkAccessControl');
