...
class SecondaryIpRangeSpec extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SecondaryIpRangeSpec::class, 'RoRdb\\Google_Service_ServiceNetworking_SecondaryIpRangeSpec');
