...
class ValidateConsumerConfigRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ValidateConsumerConfigRequest::class, 'RoRdb\\Google_Service_ServiceNetworking_ValidateConsumerConfigRequest');
