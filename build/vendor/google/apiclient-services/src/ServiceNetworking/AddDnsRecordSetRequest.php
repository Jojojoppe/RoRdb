...
class AddDnsRecordSetRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AddDnsRecordSetRequest::class, 'RoRdb\\Google_Service_ServiceNetworking_AddDnsRecordSetRequest');
