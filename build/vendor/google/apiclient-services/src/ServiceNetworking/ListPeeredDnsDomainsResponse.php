...
class ListPeeredDnsDomainsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPeeredDnsDomainsResponse::class, 'RoRdb\\Google_Service_ServiceNetworking_ListPeeredDnsDomainsResponse');
