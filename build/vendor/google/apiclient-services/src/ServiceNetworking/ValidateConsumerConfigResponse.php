...
class ValidateConsumerConfigResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ValidateConsumerConfigResponse::class, 'RoRdb\\Google_Service_ServiceNetworking_ValidateConsumerConfigResponse');
