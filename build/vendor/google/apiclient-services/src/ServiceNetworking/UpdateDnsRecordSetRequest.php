...
class UpdateDnsRecordSetRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateDnsRecordSetRequest::class, 'RoRdb\\Google_Service_ServiceNetworking_UpdateDnsRecordSetRequest');
