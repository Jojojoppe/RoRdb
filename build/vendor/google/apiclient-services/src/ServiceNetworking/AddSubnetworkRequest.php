...
class AddSubnetworkRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddSubnetworkRequest::class, 'RoRdb\\Google_Service_ServiceNetworking_AddSubnetworkRequest');
