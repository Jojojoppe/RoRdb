...
class ComposeRequestSourceObjects extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ComposeRequestSourceObjects::class, 'RoRdb\\Google_Service_Storage_ComposeRequestSourceObjects');
