...
class BucketLifecycleRuleCondition extends \RoRdb\Google\Collection
{
...
\class_alias(BucketLifecycleRuleCondition::class, 'RoRdb\\Google_Service_Storage_BucketLifecycleRuleCondition');
