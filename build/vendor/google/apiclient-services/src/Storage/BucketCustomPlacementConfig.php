...
class BucketCustomPlacementConfig extends \RoRdb\Google\Collection
{
...
\class_alias(BucketCustomPlacementConfig::class, 'RoRdb\\Google_Service_Storage_BucketCustomPlacementConfig');
