...
class ListEndpointPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListEndpointPoliciesResponse::class, 'RoRdb\\Google_Service_NetworkServices_ListEndpointPoliciesResponse');
