...
class FirstDerivativeElevationGrid extends \RoRdb\Google\Collection
{
...
\class_alias(FirstDerivativeElevationGrid::class, 'RoRdb\\Google_Service_SemanticTile_FirstDerivativeElevationGrid');
