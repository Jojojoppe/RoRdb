...
class SecondDerivativeElevationGrid extends \RoRdb\Google\Model
{
...
\class_alias(SecondDerivativeElevationGrid::class, 'RoRdb\\Google_Service_SemanticTile_SecondDerivativeElevationGrid');
