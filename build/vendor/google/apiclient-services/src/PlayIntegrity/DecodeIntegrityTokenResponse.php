 ...
 * the License.
 */
namespace RoRdb\Google\Service\PlayIntegrity;

class DecodeIntegrityTokenResponse extends \RoRdb\Google\Model
{
...
\class_alias(DecodeIntegrityTokenResponse::class, 'RoRdb\\Google_Service_PlayIntegrity_DecodeIntegrityTokenResponse');
