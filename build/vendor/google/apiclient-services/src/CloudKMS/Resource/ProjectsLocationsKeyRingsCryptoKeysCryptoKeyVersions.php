 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudKMS\Resource;

use RoRdb\Google\Service\CloudKMS\AsymmetricDecryptRequest;
use RoRdb\Google\Service\CloudKMS\AsymmetricDecryptResponse;
use RoRdb\Google\Service\CloudKMS\AsymmetricSignRequest;
use RoRdb\Google\Service\CloudKMS\AsymmetricSignResponse;
use RoRdb\Google\Service\CloudKMS\CryptoKeyVersion;
use RoRdb\Google\Service\CloudKMS\DestroyCryptoKeyVersionRequest;
use RoRdb\Google\Service\CloudKMS\ImportCryptoKeyVersionRequest;
use RoRdb\Google\Service\CloudKMS\ListCryptoKeyVersionsResponse;
use RoRdb\Google\Service\CloudKMS\MacSignRequest;
use RoRdb\Google\Service\CloudKMS\MacSignResponse;
use RoRdb\Google\Service\CloudKMS\MacVerifyRequest;
use RoRdb\Google\Service\CloudKMS\MacVerifyResponse;
use RoRdb\Google\Service\CloudKMS\PublicKey;
use RoRdb\Google\Service\CloudKMS\RestoreCryptoKeyVersionRequest;
/**
 ...
 *  </code>
 */
class ProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersions::class, 'RoRdb\\Google_Service_CloudKMS_Resource_ProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersions');
