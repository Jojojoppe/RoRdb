...
class ListImportJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListImportJobsResponse::class, 'RoRdb\\Google_Service_CloudKMS_ListImportJobsResponse');
