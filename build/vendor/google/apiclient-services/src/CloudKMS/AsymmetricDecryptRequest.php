...
class AsymmetricDecryptRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AsymmetricDecryptRequest::class, 'RoRdb\\Google_Service_CloudKMS_AsymmetricDecryptRequest');
