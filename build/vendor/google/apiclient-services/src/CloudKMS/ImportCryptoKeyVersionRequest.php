...
class ImportCryptoKeyVersionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ImportCryptoKeyVersionRequest::class, 'RoRdb\\Google_Service_CloudKMS_ImportCryptoKeyVersionRequest');
