...
class ListCryptoKeysResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCryptoKeysResponse::class, 'RoRdb\\Google_Service_CloudKMS_ListCryptoKeysResponse');
