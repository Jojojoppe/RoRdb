...
class AsymmetricDecryptResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AsymmetricDecryptResponse::class, 'RoRdb\\Google_Service_CloudKMS_AsymmetricDecryptResponse');
