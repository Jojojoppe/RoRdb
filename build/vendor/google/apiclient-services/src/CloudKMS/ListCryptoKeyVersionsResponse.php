...
class ListCryptoKeyVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCryptoKeyVersionsResponse::class, 'RoRdb\\Google_Service_CloudKMS_ListCryptoKeyVersionsResponse');
