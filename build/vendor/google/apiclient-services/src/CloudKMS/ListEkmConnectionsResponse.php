...
class ListEkmConnectionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListEkmConnectionsResponse::class, 'RoRdb\\Google_Service_CloudKMS_ListEkmConnectionsResponse');
