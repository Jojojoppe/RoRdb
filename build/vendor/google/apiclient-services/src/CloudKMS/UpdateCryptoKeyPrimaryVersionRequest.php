...
class UpdateCryptoKeyPrimaryVersionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateCryptoKeyPrimaryVersionRequest::class, 'RoRdb\\Google_Service_CloudKMS_UpdateCryptoKeyPrimaryVersionRequest');
