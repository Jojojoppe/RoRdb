...
class ExternalProtectionLevelOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ExternalProtectionLevelOptions::class, 'RoRdb\\Google_Service_CloudKMS_ExternalProtectionLevelOptions');
