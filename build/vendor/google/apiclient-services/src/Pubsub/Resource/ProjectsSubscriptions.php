 ...
 * the License.
 */
namespace RoRdb\Google\Service\Pubsub\Resource;

use RoRdb\Google\Service\Pubsub\AcknowledgeRequest;
use RoRdb\Google\Service\Pubsub\DetachSubscriptionResponse;
use RoRdb\Google\Service\Pubsub\ListSubscriptionsResponse;
use RoRdb\Google\Service\Pubsub\ModifyAckDeadlineRequest;
use RoRdb\Google\Service\Pubsub\ModifyPushConfigRequest;
use RoRdb\Google\Service\Pubsub\Policy;
use RoRdb\Google\Service\Pubsub\PubsubEmpty;
use RoRdb\Google\Service\Pubsub\PullRequest;
use RoRdb\Google\Service\Pubsub\PullResponse;
use RoRdb\Google\Service\Pubsub\SeekRequest;
use RoRdb\Google\Service\Pubsub\SeekResponse;
use RoRdb\Google\Service\Pubsub\SetIamPolicyRequest;
use RoRdb\Google\Service\Pubsub\Subscription;
use RoRdb\Google\Service\Pubsub\TestIamPermissionsRequest;
use RoRdb\Google\Service\Pubsub\TestIamPermissionsResponse;
use RoRdb\Google\Service\Pubsub\UpdateSubscriptionRequest;
/**
 ...
 *  </code>
 */
class ProjectsSubscriptions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsSubscriptions::class, 'RoRdb\\Google_Service_Pubsub_Resource_ProjectsSubscriptions');
