...
class ModifyAckDeadlineRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyAckDeadlineRequest::class, 'RoRdb\\Google_Service_Pubsub_ModifyAckDeadlineRequest');
