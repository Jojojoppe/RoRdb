...
class GoogleCloudResourcesettingsV1Value extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudResourcesettingsV1Value::class, 'RoRdb\\Google_Service_ResourceSettings_GoogleCloudResourcesettingsV1Value');
