 ...
 * the License.
 */
namespace RoRdb\Google\Service\Speech;

class LongRunningRecognizeResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LongRunningRecognizeResponse::class, 'RoRdb\\Google_Service_Speech_LongRunningRecognizeResponse');
