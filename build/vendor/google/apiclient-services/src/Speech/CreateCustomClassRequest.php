...
class CreateCustomClassRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateCustomClassRequest::class, 'RoRdb\\Google_Service_Speech_CreateCustomClassRequest');
