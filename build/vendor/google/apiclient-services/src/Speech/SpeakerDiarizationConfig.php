...
class SpeakerDiarizationConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SpeakerDiarizationConfig::class, 'RoRdb\\Google_Service_Speech_SpeakerDiarizationConfig');
