...
class ListCustomClassesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCustomClassesResponse::class, 'RoRdb\\Google_Service_Speech_ListCustomClassesResponse');
