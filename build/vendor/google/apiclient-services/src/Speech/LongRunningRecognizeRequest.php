...
class LongRunningRecognizeRequest extends \RoRdb\Google\Model
{
...
\class_alias(LongRunningRecognizeRequest::class, 'RoRdb\\Google_Service_Speech_LongRunningRecognizeRequest');
