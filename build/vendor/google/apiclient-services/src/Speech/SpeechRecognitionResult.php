...
class SpeechRecognitionResult extends \RoRdb\Google\Collection
{
...
\class_alias(SpeechRecognitionResult::class, 'RoRdb\\Google_Service_Speech_SpeechRecognitionResult');
