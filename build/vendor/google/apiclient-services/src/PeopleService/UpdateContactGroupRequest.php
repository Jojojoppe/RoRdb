...
class UpdateContactGroupRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateContactGroupRequest::class, 'RoRdb\\Google_Service_PeopleService_UpdateContactGroupRequest');
