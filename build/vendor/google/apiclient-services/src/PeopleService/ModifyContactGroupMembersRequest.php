...
class ModifyContactGroupMembersRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyContactGroupMembersRequest::class, 'RoRdb\\Google_Service_PeopleService_ModifyContactGroupMembersRequest');
