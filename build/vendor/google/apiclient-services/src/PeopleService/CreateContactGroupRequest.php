...
class CreateContactGroupRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateContactGroupRequest::class, 'RoRdb\\Google_Service_PeopleService_CreateContactGroupRequest');
