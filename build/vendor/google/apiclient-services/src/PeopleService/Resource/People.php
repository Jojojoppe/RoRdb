 ...
 * the License.
 */
namespace RoRdb\Google\Service\PeopleService\Resource;

use RoRdb\Google\Service\PeopleService\BatchCreateContactsRequest;
use RoRdb\Google\Service\PeopleService\BatchCreateContactsResponse;
use RoRdb\Google\Service\PeopleService\BatchDeleteContactsRequest;
use RoRdb\Google\Service\PeopleService\BatchUpdateContactsRequest;
use RoRdb\Google\Service\PeopleService\BatchUpdateContactsResponse;
use RoRdb\Google\Service\PeopleService\DeleteContactPhotoResponse;
use RoRdb\Google\Service\PeopleService\GetPeopleResponse;
use RoRdb\Google\Service\PeopleService\ListDirectoryPeopleResponse;
use RoRdb\Google\Service\PeopleService\PeopleEmpty;
use RoRdb\Google\Service\PeopleService\Person;
use RoRdb\Google\Service\PeopleService\SearchDirectoryPeopleResponse;
use RoRdb\Google\Service\PeopleService\SearchResponse;
use RoRdb\Google\Service\PeopleService\UpdateContactPhotoRequest;
use RoRdb\Google\Service\PeopleService\UpdateContactPhotoResponse;
/**
 ...
 *  </code>
 */
class People extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(People::class, 'RoRdb\\Google_Service_PeopleService_Resource_People');
