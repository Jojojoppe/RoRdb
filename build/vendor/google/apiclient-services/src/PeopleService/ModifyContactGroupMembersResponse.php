...
class ModifyContactGroupMembersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyContactGroupMembersResponse::class, 'RoRdb\\Google_Service_PeopleService_ModifyContactGroupMembersResponse');
