...
class ContactGroupMembership extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContactGroupMembership::class, 'RoRdb\\Google_Service_PeopleService_ContactGroupMembership');
