...
class BatchCreateContactsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchCreateContactsResponse::class, 'RoRdb\\Google_Service_PeopleService_BatchCreateContactsResponse');
