...
class BatchUpdateIngressRulesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateIngressRulesResponse::class, 'RoRdb\\Google_Service_Appengine_BatchUpdateIngressRulesResponse');
