...
class BatchUpdateIngressRulesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateIngressRulesRequest::class, 'RoRdb\\Google_Service_Appengine_BatchUpdateIngressRulesRequest');
