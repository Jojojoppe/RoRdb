...
class ListAuthorizedCertificatesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAuthorizedCertificatesResponse::class, 'RoRdb\\Google_Service_Appengine_ListAuthorizedCertificatesResponse');
