...
class CreateVersionMetadataV1Beta extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateVersionMetadataV1Beta::class, 'RoRdb\\Google_Service_Appengine_CreateVersionMetadataV1Beta');
