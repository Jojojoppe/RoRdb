...
class GoogleAppengineV1betaLocationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAppengineV1betaLocationMetadata::class, 'RoRdb\\Google_Service_Appengine_GoogleAppengineV1betaLocationMetadata');
