...
class ListIngressRulesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListIngressRulesResponse::class, 'RoRdb\\Google_Service_Appengine_ListIngressRulesResponse');
