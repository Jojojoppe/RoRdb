...
class StandardSchedulerSettings extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(StandardSchedulerSettings::class, 'RoRdb\\Google_Service_Appengine_StandardSchedulerSettings');
