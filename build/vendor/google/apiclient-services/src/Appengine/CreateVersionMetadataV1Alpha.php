...
class CreateVersionMetadataV1Alpha extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateVersionMetadataV1Alpha::class, 'RoRdb\\Google_Service_Appengine_CreateVersionMetadataV1Alpha');
