...
class AuthorizedCertificate extends \RoRdb\Google\Collection
{
...
\class_alias(AuthorizedCertificate::class, 'RoRdb\\Google_Service_Appengine_AuthorizedCertificate');
