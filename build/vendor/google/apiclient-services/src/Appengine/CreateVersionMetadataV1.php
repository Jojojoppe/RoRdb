...
class CreateVersionMetadataV1 extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateVersionMetadataV1::class, 'RoRdb\\Google_Service_Appengine_CreateVersionMetadataV1');
