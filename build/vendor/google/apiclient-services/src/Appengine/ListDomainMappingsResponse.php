...
class ListDomainMappingsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDomainMappingsResponse::class, 'RoRdb\\Google_Service_Appengine_ListDomainMappingsResponse');
