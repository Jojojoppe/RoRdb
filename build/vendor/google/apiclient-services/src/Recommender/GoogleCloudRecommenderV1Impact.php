...
class GoogleCloudRecommenderV1Impact extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRecommenderV1Impact::class, 'RoRdb\\Google_Service_Recommender_GoogleCloudRecommenderV1Impact');
