...
class GoogleCloudRecommenderV1Operation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRecommenderV1Operation::class, 'RoRdb\\Google_Service_Recommender_GoogleCloudRecommenderV1Operation');
