 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudRedis\Resource;

use RoRdb\Google\Service\CloudRedis\ExportInstanceRequest;
use RoRdb\Google\Service\CloudRedis\FailoverInstanceRequest;
use RoRdb\Google\Service\CloudRedis\ImportInstanceRequest;
use RoRdb\Google\Service\CloudRedis\Instance;
use RoRdb\Google\Service\CloudRedis\InstanceAuthString;
use RoRdb\Google\Service\CloudRedis\ListInstancesResponse;
use RoRdb\Google\Service\CloudRedis\Operation;
use RoRdb\Google\Service\CloudRedis\RescheduleMaintenanceRequest;
use RoRdb\Google\Service\CloudRedis\UpgradeInstanceRequest;
/**
...
\class_alias(ProjectsLocationsInstances::class, 'RoRdb\\Google_Service_CloudRedis_Resource_ProjectsLocationsInstances');
