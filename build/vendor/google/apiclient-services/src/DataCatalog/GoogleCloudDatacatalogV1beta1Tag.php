...
class GoogleCloudDatacatalogV1beta1Tag extends \RoRdb\Google\Model
{
    public $column;
...
\class_alias(GoogleCloudDatacatalogV1beta1Tag::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1Tag');
