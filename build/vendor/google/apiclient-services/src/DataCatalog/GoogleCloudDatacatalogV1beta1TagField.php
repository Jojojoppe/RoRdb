...
class GoogleCloudDatacatalogV1beta1TagField extends \RoRdb\Google\Model
{
    public $boolValue;
    public $displayName;
    public $doubleValue;
...
\class_alias(GoogleCloudDatacatalogV1beta1TagField::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1TagField');
