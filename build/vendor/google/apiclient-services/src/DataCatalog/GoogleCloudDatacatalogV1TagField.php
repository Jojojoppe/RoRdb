...
class GoogleCloudDatacatalogV1TagField extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudDatacatalogV1TagField::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1TagField');
