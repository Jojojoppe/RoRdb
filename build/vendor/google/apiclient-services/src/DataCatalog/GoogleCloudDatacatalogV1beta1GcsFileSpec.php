...
class GoogleCloudDatacatalogV1beta1GcsFileSpec extends \RoRdb\Google\Model
{
    public $filePath;
...
\class_alias(GoogleCloudDatacatalogV1beta1GcsFileSpec::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1GcsFileSpec');
