...
class GoogleCloudDatacatalogV1DataplexExternalTable extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1DataplexExternalTable::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1DataplexExternalTable');
