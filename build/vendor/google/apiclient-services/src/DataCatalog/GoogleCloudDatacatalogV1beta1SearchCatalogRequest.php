...
class GoogleCloudDatacatalogV1beta1SearchCatalogRequest extends \RoRdb\Google\Model
{
    public $orderBy;
    public $pageSize;
    public $pageToken;
...
\class_alias(GoogleCloudDatacatalogV1beta1SearchCatalogRequest::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1SearchCatalogRequest');
