...
class GoogleCloudDatacatalogV1UsageSignal extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1UsageSignal::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1UsageSignal');
