...
class GoogleCloudDatacatalogV1DataplexSpec extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1DataplexSpec::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1DataplexSpec');
