...
class GoogleCloudDatacatalogV1GcsFileSpec extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1GcsFileSpec::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1GcsFileSpec');
