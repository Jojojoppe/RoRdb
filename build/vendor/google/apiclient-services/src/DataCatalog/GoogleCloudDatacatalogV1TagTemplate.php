...
class GoogleCloudDatacatalogV1TagTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1TagTemplate::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1TagTemplate');
