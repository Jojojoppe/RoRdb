 ...
 * the License.
 */
namespace RoRdb\Google\Service\DataCatalog\Resource;

use RoRdb\Google\Service\DataCatalog\DatacatalogEmpty;
use RoRdb\Google\Service\DataCatalog\GetIamPolicyRequest;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1Contacts;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1Entry;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1EntryOverview;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1ListEntriesResponse;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1ModifyEntryContactsRequest;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1ModifyEntryOverviewRequest;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1StarEntryRequest;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1StarEntryResponse;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1UnstarEntryRequest;
use RoRdb\Google\Service\DataCatalog\GoogleCloudDatacatalogV1UnstarEntryResponse;
use RoRdb\Google\Service\DataCatalog\Policy;
use RoRdb\Google\Service\DataCatalog\TestIamPermissionsRequest;
use RoRdb\Google\Service\DataCatalog\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsLocationsEntryGroupsEntries extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsEntryGroupsEntries::class, 'RoRdb\\Google_Service_DataCatalog_Resource_ProjectsLocationsEntryGroupsEntries');
