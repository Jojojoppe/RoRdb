...
class GoogleCloudDatacatalogV1Tag extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1Tag::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1Tag');
