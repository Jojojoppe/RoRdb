...
class GoogleCloudDatacatalogV1BigQueryTableSpec extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1BigQueryTableSpec::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1BigQueryTableSpec');
