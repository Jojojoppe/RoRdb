...
class GoogleCloudDatacatalogV1RenameTagTemplateFieldRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatacatalogV1RenameTagTemplateFieldRequest::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1RenameTagTemplateFieldRequest');
