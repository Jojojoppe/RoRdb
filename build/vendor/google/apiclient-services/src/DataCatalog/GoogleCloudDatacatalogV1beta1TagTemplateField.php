...
class GoogleCloudDatacatalogV1beta1TagTemplateField extends \RoRdb\Google\Model
{
    public $description;
    public $displayName;
    public $isRequired;
...
\class_alias(GoogleCloudDatacatalogV1beta1TagTemplateField::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1TagTemplateField');
