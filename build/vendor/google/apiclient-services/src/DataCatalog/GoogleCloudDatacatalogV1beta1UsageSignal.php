...
class GoogleCloudDatacatalogV1beta1UsageSignal extends \RoRdb\Google\Model
{
    public $updateTime;
...
\class_alias(GoogleCloudDatacatalogV1beta1UsageSignal::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1UsageSignal');
