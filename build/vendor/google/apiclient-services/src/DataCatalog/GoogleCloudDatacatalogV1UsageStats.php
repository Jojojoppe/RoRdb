...
class GoogleCloudDatacatalogV1UsageStats extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(GoogleCloudDatacatalogV1UsageStats::class, 'RoRdb\\Google_Service_DataCatalog_GoogleCloudDatacatalogV1UsageStats');
