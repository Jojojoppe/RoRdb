...
class GoogleFactcheckingFactchecktoolsV1alpha1ClaimReview extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFactcheckingFactchecktoolsV1alpha1ClaimReview::class, 'RoRdb\\Google_Service_FactCheckTools_GoogleFactcheckingFactchecktoolsV1alpha1ClaimReview');
