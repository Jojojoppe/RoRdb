...
class GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating::class, 'RoRdb\\Google_Service_FactCheckTools_GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating');
