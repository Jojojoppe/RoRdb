...
class ApplicationDataTransfer extends \RoRdb\Google\Collection
{
...
\class_alias(ApplicationDataTransfer::class, 'RoRdb\\Google_Service_DataTransfer_ApplicationDataTransfer');
