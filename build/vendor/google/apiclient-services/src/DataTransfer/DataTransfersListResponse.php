 ...
 * the License.
 */
namespace RoRdb\Google\Service\DataTransfer;

class DataTransfersListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DataTransfersListResponse::class, 'RoRdb\\Google_Service_DataTransfer_DataTransfersListResponse');
