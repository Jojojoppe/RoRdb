...
class DeployedClusterState extends \RoRdb\Google\Collection
{
...
\class_alias(DeployedClusterState::class, 'RoRdb\\Google_Service_GameServices_DeployedClusterState');
