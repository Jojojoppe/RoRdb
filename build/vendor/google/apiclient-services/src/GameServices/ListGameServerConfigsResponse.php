...
class ListGameServerConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGameServerConfigsResponse::class, 'RoRdb\\Google_Service_GameServices_ListGameServerConfigsResponse');
