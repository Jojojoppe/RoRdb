...
class PreviewRealmUpdateResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PreviewRealmUpdateResponse::class, 'RoRdb\\Google_Service_GameServices_PreviewRealmUpdateResponse');
