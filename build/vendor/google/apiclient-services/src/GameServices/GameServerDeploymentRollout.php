...
class GameServerDeploymentRollout extends \RoRdb\Google\Collection
{
...
\class_alias(GameServerDeploymentRollout::class, 'RoRdb\\Google_Service_GameServices_GameServerDeploymentRollout');
