...
class ListGameServerDeploymentsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGameServerDeploymentsResponse::class, 'RoRdb\\Google_Service_GameServices_ListGameServerDeploymentsResponse');
