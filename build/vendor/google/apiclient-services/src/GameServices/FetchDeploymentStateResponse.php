...
class FetchDeploymentStateResponse extends \RoRdb\Google\Collection
{
...
\class_alias(FetchDeploymentStateResponse::class, 'RoRdb\\Google_Service_GameServices_FetchDeploymentStateResponse');
