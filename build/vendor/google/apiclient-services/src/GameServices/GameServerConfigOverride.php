...
class GameServerConfigOverride extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GameServerConfigOverride::class, 'RoRdb\\Google_Service_GameServices_GameServerConfigOverride');
