...
class KubernetesClusterState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(KubernetesClusterState::class, 'RoRdb\\Google_Service_GameServices_KubernetesClusterState');
