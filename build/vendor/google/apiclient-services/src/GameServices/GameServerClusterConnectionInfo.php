...
class GameServerClusterConnectionInfo extends \RoRdb\Google\Model
{
...
\class_alias(GameServerClusterConnectionInfo::class, 'RoRdb\\Google_Service_GameServices_GameServerClusterConnectionInfo');
