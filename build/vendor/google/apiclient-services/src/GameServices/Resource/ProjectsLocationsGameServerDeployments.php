 ...
 * the License.
 */
namespace RoRdb\Google\Service\GameServices\Resource;

use RoRdb\Google\Service\GameServices\FetchDeploymentStateRequest;
use RoRdb\Google\Service\GameServices\FetchDeploymentStateResponse;
use RoRdb\Google\Service\GameServices\GameServerDeployment;
use RoRdb\Google\Service\GameServices\GameServerDeploymentRollout;
use RoRdb\Google\Service\GameServices\ListGameServerDeploymentsResponse;
use RoRdb\Google\Service\GameServices\Operation;
use RoRdb\Google\Service\GameServices\Policy;
use RoRdb\Google\Service\GameServices\PreviewGameServerDeploymentRolloutResponse;
use RoRdb\Google\Service\GameServices\SetIamPolicyRequest;
use RoRdb\Google\Service\GameServices\TestIamPermissionsRequest;
use RoRdb\Google\Service\GameServices\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsLocationsGameServerDeployments extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsGameServerDeployments::class, 'RoRdb\\Google_Service_GameServices_Resource_ProjectsLocationsGameServerDeployments');
