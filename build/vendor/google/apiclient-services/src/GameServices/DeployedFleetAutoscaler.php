...
class DeployedFleetAutoscaler extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeployedFleetAutoscaler::class, 'RoRdb\\Google_Service_GameServices_DeployedFleetAutoscaler');
