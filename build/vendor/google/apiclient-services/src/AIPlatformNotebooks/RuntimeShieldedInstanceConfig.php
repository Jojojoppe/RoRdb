...
class RuntimeShieldedInstanceConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(RuntimeShieldedInstanceConfig::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_RuntimeShieldedInstanceConfig');
