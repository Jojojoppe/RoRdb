...
class ShieldedInstanceConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ShieldedInstanceConfig::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_ShieldedInstanceConfig');
