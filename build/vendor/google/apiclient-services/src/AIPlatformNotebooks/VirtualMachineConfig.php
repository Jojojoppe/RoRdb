...
class VirtualMachineConfig extends \RoRdb\Google\Collection
{
...
\class_alias(VirtualMachineConfig::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_VirtualMachineConfig');
