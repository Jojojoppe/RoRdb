...
class RuntimeSoftwareConfig extends \RoRdb\Google\Collection
{
...
\class_alias(RuntimeSoftwareConfig::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_RuntimeSoftwareConfig');
