...
class UpgradeHistoryEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpgradeHistoryEntry::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_UpgradeHistoryEntry');
