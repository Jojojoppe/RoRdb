...
class IsInstanceUpgradeableResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IsInstanceUpgradeableResponse::class, 'RoRdb\\Google_Service_AIPlatformNotebooks_IsInstanceUpgradeableResponse');
