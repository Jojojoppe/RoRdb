...
class UnclaimDevicesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UnclaimDevicesRequest::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_UnclaimDevicesRequest');
