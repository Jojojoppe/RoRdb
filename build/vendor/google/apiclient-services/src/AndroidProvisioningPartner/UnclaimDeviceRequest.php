...
class UnclaimDeviceRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UnclaimDeviceRequest::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_UnclaimDeviceRequest');
