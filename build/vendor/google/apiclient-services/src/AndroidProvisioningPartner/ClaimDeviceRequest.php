...
class ClaimDeviceRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ClaimDeviceRequest::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_ClaimDeviceRequest');
