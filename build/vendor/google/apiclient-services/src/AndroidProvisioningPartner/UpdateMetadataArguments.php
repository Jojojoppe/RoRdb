...
class UpdateMetadataArguments extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateMetadataArguments::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_UpdateMetadataArguments');
