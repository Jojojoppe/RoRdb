...
class OperationPerDevice extends \RoRdb\Google\Model
{
...
\class_alias(OperationPerDevice::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_OperationPerDevice');
