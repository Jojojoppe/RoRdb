 ...
 * the License.
 */
namespace RoRdb\Google\Service\AndroidProvisioningPartner\Resource;

use RoRdb\Google\Service\AndroidProvisioningPartner\AndroiddeviceprovisioningEmpty;
use RoRdb\Google\Service\AndroidProvisioningPartner\ClaimDeviceRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\ClaimDeviceResponse;
use RoRdb\Google\Service\AndroidProvisioningPartner\ClaimDevicesRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\Device;
use RoRdb\Google\Service\AndroidProvisioningPartner\DeviceMetadata;
use RoRdb\Google\Service\AndroidProvisioningPartner\FindDevicesByDeviceIdentifierRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\FindDevicesByDeviceIdentifierResponse;
use RoRdb\Google\Service\AndroidProvisioningPartner\FindDevicesByOwnerRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\FindDevicesByOwnerResponse;
use RoRdb\Google\Service\AndroidProvisioningPartner\Operation;
use RoRdb\Google\Service\AndroidProvisioningPartner\UnclaimDeviceRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\UnclaimDevicesRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\UpdateDeviceMetadataInBatchRequest;
use RoRdb\Google\Service\AndroidProvisioningPartner\UpdateDeviceMetadataRequest;
/**
 ...
 *  </code>
 */
class PartnersDevices extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(PartnersDevices::class, 'RoRdb\\Google_Service_AndroidProvisioningPartner_Resource_PartnersDevices');
