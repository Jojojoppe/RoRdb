...
class ReportRequestTimeRange extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReportRequestTimeRange::class, 'RoRdb\\Google_Service_Doubleclicksearch_ReportRequestTimeRange');
