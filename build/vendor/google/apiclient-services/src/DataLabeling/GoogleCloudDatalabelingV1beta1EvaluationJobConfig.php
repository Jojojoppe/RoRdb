...
class GoogleCloudDatalabelingV1beta1EvaluationJobConfig extends \RoRdb\Google\Model
{
    /**
     * @var string[]
     */
...
\class_alias(GoogleCloudDatalabelingV1beta1EvaluationJobConfig::class, 'RoRdb\\Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1EvaluationJobConfig');
