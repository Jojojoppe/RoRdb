...
class GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse::class, 'RoRdb\\Google_Service_DataLabeling_GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse');
