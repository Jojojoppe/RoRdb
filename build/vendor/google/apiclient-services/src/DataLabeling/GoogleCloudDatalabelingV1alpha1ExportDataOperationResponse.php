...
class GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse::class, 'RoRdb\\Google_Service_DataLabeling_GoogleCloudDatalabelingV1alpha1ExportDataOperationResponse');
