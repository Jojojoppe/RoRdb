...
class DeploymentOccurrence extends \RoRdb\Google\Collection
{
...
\class_alias(DeploymentOccurrence::class, 'RoRdb\\Google_Service_ContainerAnalysis_DeploymentOccurrence');
