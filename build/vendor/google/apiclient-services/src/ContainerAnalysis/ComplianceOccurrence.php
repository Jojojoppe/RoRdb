...
class ComplianceOccurrence extends \RoRdb\Google\Collection
{
...
\class_alias(ComplianceOccurrence::class, 'RoRdb\\Google_Service_ContainerAnalysis_ComplianceOccurrence');
