...
class DSSEAttestationOccurrence extends \RoRdb\Google\Model
{
...
\class_alias(DSSEAttestationOccurrence::class, 'RoRdb\\Google_Service_ContainerAnalysis_DSSEAttestationOccurrence');
