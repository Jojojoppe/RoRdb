...
class ListScanConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListScanConfigsResponse::class, 'RoRdb\\Google_Service_ContainerAnalysis_ListScanConfigsResponse');
