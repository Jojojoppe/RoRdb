...
class CloudRepoSourceContext extends \RoRdb\Google\Model
{
...
\class_alias(CloudRepoSourceContext::class, 'RoRdb\\Google_Service_ContainerAnalysis_CloudRepoSourceContext');
