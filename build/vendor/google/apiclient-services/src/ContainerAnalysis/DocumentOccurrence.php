...
class DocumentOccurrence extends \RoRdb\Google\Collection
{
...
\class_alias(DocumentOccurrence::class, 'RoRdb\\Google_Service_ContainerAnalysis_DocumentOccurrence');
