 ...
 * the License.
 */
namespace RoRdb\Google\Service\ContainerAnalysis\Resource;

use RoRdb\Google\Service\ContainerAnalysis\BatchCreateOccurrencesRequest;
use RoRdb\Google\Service\ContainerAnalysis\BatchCreateOccurrencesResponse;
use RoRdb\Google\Service\ContainerAnalysis\ContaineranalysisEmpty;
use RoRdb\Google\Service\ContainerAnalysis\GetIamPolicyRequest;
use RoRdb\Google\Service\ContainerAnalysis\ListOccurrencesResponse;
use RoRdb\Google\Service\ContainerAnalysis\Note;
use RoRdb\Google\Service\ContainerAnalysis\Occurrence;
use RoRdb\Google\Service\ContainerAnalysis\Policy;
use RoRdb\Google\Service\ContainerAnalysis\SetIamPolicyRequest;
use RoRdb\Google\Service\ContainerAnalysis\TestIamPermissionsRequest;
use RoRdb\Google\Service\ContainerAnalysis\TestIamPermissionsResponse;
use RoRdb\Google\Service\ContainerAnalysis\VulnerabilityOccurrencesSummary;
/**
 ...
 *  </code>
 */
class ProjectsOccurrences extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsOccurrences::class, 'RoRdb\\Google_Service_ContainerAnalysis_Resource_ProjectsOccurrences');
