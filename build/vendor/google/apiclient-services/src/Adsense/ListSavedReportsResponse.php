...
class ListSavedReportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListSavedReportsResponse::class, 'RoRdb\\Google_Service_Adsense_ListSavedReportsResponse');
