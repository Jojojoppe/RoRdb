 ...
 * the License.
 */
namespace RoRdb\Google\Service\Adsense;

class ListLinkedCustomChannelsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListLinkedCustomChannelsResponse::class, 'RoRdb\\Google_Service_Adsense_ListLinkedCustomChannelsResponse');
