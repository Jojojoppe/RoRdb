...
class ListUrlChannelsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUrlChannelsResponse::class, 'RoRdb\\Google_Service_Adsense_ListUrlChannelsResponse');
