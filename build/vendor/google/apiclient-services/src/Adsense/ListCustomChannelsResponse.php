...
class ListCustomChannelsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCustomChannelsResponse::class, 'RoRdb\\Google_Service_Adsense_ListCustomChannelsResponse');
