...
class BatchUpdateFormRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateFormRequest::class, 'RoRdb\\Google_Service_Forms_BatchUpdateFormRequest');
