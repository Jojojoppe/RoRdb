...
class BatchUpdateFormResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateFormResponse::class, 'RoRdb\\Google_Service_Forms_BatchUpdateFormResponse');
