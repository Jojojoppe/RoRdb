...
class AdUnitContentAdsSettings extends \RoRdb\Google\Model
{
...
\class_alias(AdUnitContentAdsSettings::class, 'RoRdb\\Google_Service_AdSenseHost_AdUnitContentAdsSettings');
