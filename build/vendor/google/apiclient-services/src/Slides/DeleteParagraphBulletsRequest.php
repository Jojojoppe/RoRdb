...
class DeleteParagraphBulletsRequest extends \RoRdb\Google\Model
{
...
\class_alias(DeleteParagraphBulletsRequest::class, 'RoRdb\\Google_Service_Slides_DeleteParagraphBulletsRequest');
