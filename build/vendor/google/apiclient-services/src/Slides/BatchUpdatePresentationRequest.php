...
class BatchUpdatePresentationRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdatePresentationRequest::class, 'RoRdb\\Google_Service_Slides_BatchUpdatePresentationRequest');
