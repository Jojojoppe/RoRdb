...
class UpdateTableCellPropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateTableCellPropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateTableCellPropertiesRequest');
