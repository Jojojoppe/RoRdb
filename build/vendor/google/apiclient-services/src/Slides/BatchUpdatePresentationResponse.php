...
class BatchUpdatePresentationResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdatePresentationResponse::class, 'RoRdb\\Google_Service_Slides_BatchUpdatePresentationResponse');
