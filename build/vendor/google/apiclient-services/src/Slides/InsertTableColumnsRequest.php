...
class InsertTableColumnsRequest extends \RoRdb\Google\Model
{
...
\class_alias(InsertTableColumnsRequest::class, 'RoRdb\\Google_Service_Slides_InsertTableColumnsRequest');
