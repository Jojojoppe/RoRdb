...
class DeleteTableColumnRequest extends \RoRdb\Google\Model
{
...
\class_alias(DeleteTableColumnRequest::class, 'RoRdb\\Google_Service_Slides_DeleteTableColumnRequest');
