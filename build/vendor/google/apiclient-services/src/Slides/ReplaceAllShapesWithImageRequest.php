...
class ReplaceAllShapesWithImageRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReplaceAllShapesWithImageRequest::class, 'RoRdb\\Google_Service_Slides_ReplaceAllShapesWithImageRequest');
