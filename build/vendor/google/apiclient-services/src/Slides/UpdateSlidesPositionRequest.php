...
class UpdateSlidesPositionRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateSlidesPositionRequest::class, 'RoRdb\\Google_Service_Slides_UpdateSlidesPositionRequest');
