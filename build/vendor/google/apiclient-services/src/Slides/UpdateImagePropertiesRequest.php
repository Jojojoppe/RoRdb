...
class UpdateImagePropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateImagePropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateImagePropertiesRequest');
