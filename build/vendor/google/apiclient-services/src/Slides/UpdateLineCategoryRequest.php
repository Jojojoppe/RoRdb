...
class UpdateLineCategoryRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateLineCategoryRequest::class, 'RoRdb\\Google_Service_Slides_UpdateLineCategoryRequest');
