...
class ReplaceAllShapesWithSheetsChartResponse extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ReplaceAllShapesWithSheetsChartResponse::class, 'RoRdb\\Google_Service_Slides_ReplaceAllShapesWithSheetsChartResponse');
