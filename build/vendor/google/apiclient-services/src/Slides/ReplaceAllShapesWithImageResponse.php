...
class ReplaceAllShapesWithImageResponse extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ReplaceAllShapesWithImageResponse::class, 'RoRdb\\Google_Service_Slides_ReplaceAllShapesWithImageResponse');
