...
class UpdateSlidePropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateSlidePropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateSlidePropertiesRequest');
