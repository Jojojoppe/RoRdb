...
class UpdateVideoPropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateVideoPropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateVideoPropertiesRequest');
