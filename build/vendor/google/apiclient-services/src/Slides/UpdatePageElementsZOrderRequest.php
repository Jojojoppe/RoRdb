...
class UpdatePageElementsZOrderRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdatePageElementsZOrderRequest::class, 'RoRdb\\Google_Service_Slides_UpdatePageElementsZOrderRequest');
