...
class LayoutPlaceholderIdMapping extends \RoRdb\Google\Model
{
...
\class_alias(LayoutPlaceholderIdMapping::class, 'RoRdb\\Google_Service_Slides_LayoutPlaceholderIdMapping');
