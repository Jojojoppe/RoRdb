...
class UpdateParagraphStyleRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateParagraphStyleRequest::class, 'RoRdb\\Google_Service_Slides_UpdateParagraphStyleRequest');
