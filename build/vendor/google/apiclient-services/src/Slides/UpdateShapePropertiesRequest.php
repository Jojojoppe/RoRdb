...
class UpdateShapePropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateShapePropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateShapePropertiesRequest');
