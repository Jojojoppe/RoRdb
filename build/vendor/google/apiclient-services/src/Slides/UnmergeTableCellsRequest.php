...
class UnmergeTableCellsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UnmergeTableCellsRequest::class, 'RoRdb\\Google_Service_Slides_UnmergeTableCellsRequest');
