...
class UpdateLinePropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateLinePropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateLinePropertiesRequest');
