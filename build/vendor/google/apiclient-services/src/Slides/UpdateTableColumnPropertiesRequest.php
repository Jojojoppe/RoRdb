...
class UpdateTableColumnPropertiesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateTableColumnPropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateTableColumnPropertiesRequest');
