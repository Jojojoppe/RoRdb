...
class UpdateTableRowPropertiesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateTableRowPropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateTableRowPropertiesRequest');
