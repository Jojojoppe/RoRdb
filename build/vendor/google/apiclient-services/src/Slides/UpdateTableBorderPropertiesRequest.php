...
class UpdateTableBorderPropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateTableBorderPropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdateTableBorderPropertiesRequest');
