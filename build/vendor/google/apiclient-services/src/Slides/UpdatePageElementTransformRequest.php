...
class UpdatePageElementTransformRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdatePageElementTransformRequest::class, 'RoRdb\\Google_Service_Slides_UpdatePageElementTransformRequest');
