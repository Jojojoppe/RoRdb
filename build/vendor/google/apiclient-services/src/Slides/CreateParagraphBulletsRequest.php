...
class CreateParagraphBulletsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateParagraphBulletsRequest::class, 'RoRdb\\Google_Service_Slides_CreateParagraphBulletsRequest');
