...
class UpdatePagePropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdatePagePropertiesRequest::class, 'RoRdb\\Google_Service_Slides_UpdatePagePropertiesRequest');
