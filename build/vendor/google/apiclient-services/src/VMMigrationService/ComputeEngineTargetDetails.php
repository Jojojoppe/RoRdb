...
class ComputeEngineTargetDetails extends \RoRdb\Google\Collection
{
...
\class_alias(ComputeEngineTargetDetails::class, 'RoRdb\\Google_Service_VMMigrationService_ComputeEngineTargetDetails');
