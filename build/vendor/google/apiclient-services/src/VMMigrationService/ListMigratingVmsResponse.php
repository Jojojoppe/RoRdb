...
class ListMigratingVmsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListMigratingVmsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListMigratingVmsResponse');
