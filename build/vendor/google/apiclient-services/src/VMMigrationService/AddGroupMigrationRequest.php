...
class AddGroupMigrationRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AddGroupMigrationRequest::class, 'RoRdb\\Google_Service_VMMigrationService_AddGroupMigrationRequest');
