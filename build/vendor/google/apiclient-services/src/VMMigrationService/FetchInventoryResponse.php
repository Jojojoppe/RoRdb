...
class FetchInventoryResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FetchInventoryResponse::class, 'RoRdb\\Google_Service_VMMigrationService_FetchInventoryResponse');
