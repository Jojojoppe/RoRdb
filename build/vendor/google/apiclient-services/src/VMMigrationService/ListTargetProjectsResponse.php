...
class ListTargetProjectsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTargetProjectsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListTargetProjectsResponse');
