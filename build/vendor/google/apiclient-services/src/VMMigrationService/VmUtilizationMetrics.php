...
class VmUtilizationMetrics extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(VmUtilizationMetrics::class, 'RoRdb\\Google_Service_VMMigrationService_VmUtilizationMetrics');
