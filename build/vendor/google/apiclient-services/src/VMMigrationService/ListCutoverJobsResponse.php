...
class ListCutoverJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCutoverJobsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListCutoverJobsResponse');
