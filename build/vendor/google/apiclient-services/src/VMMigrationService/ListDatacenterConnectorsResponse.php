...
class ListDatacenterConnectorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDatacenterConnectorsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListDatacenterConnectorsResponse');
