...
class ComputeEngineTargetDefaults extends \RoRdb\Google\Collection
{
...
\class_alias(ComputeEngineTargetDefaults::class, 'RoRdb\\Google_Service_VMMigrationService_ComputeEngineTargetDefaults');
