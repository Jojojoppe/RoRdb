...
class ListCloneJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCloneJobsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListCloneJobsResponse');
