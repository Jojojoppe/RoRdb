...
class ListUtilizationReportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUtilizationReportsResponse::class, 'RoRdb\\Google_Service_VMMigrationService_ListUtilizationReportsResponse');
