...
class ReplaceServicePerimetersRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReplaceServicePerimetersRequest::class, 'RoRdb\\Google_Service_AccessContextManager_ReplaceServicePerimetersRequest');
