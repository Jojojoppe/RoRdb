...
class VpcAccessibleServices extends \RoRdb\Google\Collection
{
...
\class_alias(VpcAccessibleServices::class, 'RoRdb\\Google_Service_AccessContextManager_VpcAccessibleServices');
