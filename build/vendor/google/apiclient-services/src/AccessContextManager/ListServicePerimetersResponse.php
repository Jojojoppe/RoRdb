...
class ListServicePerimetersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListServicePerimetersResponse::class, 'RoRdb\\Google_Service_AccessContextManager_ListServicePerimetersResponse');
