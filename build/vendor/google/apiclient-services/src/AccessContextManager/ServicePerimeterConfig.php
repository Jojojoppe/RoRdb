...
class ServicePerimeterConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ServicePerimeterConfig::class, 'RoRdb\\Google_Service_AccessContextManager_ServicePerimeterConfig');
