...
class ListAccessPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAccessPoliciesResponse::class, 'RoRdb\\Google_Service_AccessContextManager_ListAccessPoliciesResponse');
