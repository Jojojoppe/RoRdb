...
class CommitServicePerimetersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CommitServicePerimetersResponse::class, 'RoRdb\\Google_Service_AccessContextManager_CommitServicePerimetersResponse');
