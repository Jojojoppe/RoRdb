...
class ReplaceServicePerimetersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReplaceServicePerimetersResponse::class, 'RoRdb\\Google_Service_AccessContextManager_ReplaceServicePerimetersResponse');
