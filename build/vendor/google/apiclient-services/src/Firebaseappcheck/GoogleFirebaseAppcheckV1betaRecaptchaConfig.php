...
class GoogleFirebaseAppcheckV1betaRecaptchaConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirebaseAppcheckV1betaRecaptchaConfig::class, 'RoRdb\\Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaRecaptchaConfig');
