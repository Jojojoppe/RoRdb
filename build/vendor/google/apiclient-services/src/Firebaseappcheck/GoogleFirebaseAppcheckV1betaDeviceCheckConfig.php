...
class GoogleFirebaseAppcheckV1betaDeviceCheckConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirebaseAppcheckV1betaDeviceCheckConfig::class, 'RoRdb\\Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaDeviceCheckConfig');
