...
class GoogleFirebaseAppcheckV1betaAppCheckToken extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirebaseAppcheckV1betaAppCheckToken::class, 'RoRdb\\Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1betaAppCheckToken');
