...
class GoogleCloudOrgpolicyV2Constraint extends \RoRdb\Google\Model
{
...
\class_alias(GoogleCloudOrgpolicyV2Constraint::class, 'RoRdb\\Google_Service_OrgPolicyAPI_GoogleCloudOrgpolicyV2Constraint');
