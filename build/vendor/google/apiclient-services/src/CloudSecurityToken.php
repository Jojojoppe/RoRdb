 ...
 * @author Google, Inc.
 */
class CloudSecurityToken extends \RoRdb\Google\Service
{
    public $v1;
    /**
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->v1 = new CloudSecurityToken\Resource\V1($this, $this->serviceName, 'v1', ['methods' => ['introspect' => ['path' => 'v1/introspect', 'httpMethod' => 'POST', 'parameters' => []], 'token' => ['path' => 'v1/token', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(CloudSecurityToken::class, 'RoRdb\\Google_Service_CloudSecurityToken');
