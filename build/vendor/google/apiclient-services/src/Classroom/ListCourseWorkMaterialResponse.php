...
class ListCourseWorkMaterialResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCourseWorkMaterialResponse::class, 'RoRdb\\Google_Service_Classroom_ListCourseWorkMaterialResponse');
