 ...
 * the License.
 */
namespace RoRdb\Google\Service\Classroom;

class ModifyAnnouncementAssigneesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ModifyAnnouncementAssigneesRequest::class, 'RoRdb\\Google_Service_Classroom_ModifyAnnouncementAssigneesRequest');
