...
class ModifyAttachmentsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyAttachmentsRequest::class, 'RoRdb\\Google_Service_Classroom_ModifyAttachmentsRequest');
