...
class ListGuardianInvitationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGuardianInvitationsResponse::class, 'RoRdb\\Google_Service_Classroom_ListGuardianInvitationsResponse');
