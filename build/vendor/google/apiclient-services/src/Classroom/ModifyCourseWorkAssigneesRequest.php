...
class ModifyCourseWorkAssigneesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ModifyCourseWorkAssigneesRequest::class, 'RoRdb\\Google_Service_Classroom_ModifyCourseWorkAssigneesRequest');
