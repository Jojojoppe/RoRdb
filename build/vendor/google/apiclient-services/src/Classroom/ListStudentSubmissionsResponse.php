...
class ListStudentSubmissionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListStudentSubmissionsResponse::class, 'RoRdb\\Google_Service_Classroom_ListStudentSubmissionsResponse');
