 ...
 * @author Google, Inc.
 */
class Docs extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->documents = new Docs\Resource\Documents($this, $this->serviceName, 'documents', ['methods' => ['batchUpdate' => ['path' => 'v1/documents/{documentId}:batchUpdate', 'httpMethod' => 'POST', 'parameters' => ['documentId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'create' => ['path' => 'v1/documents', 'httpMethod' => 'POST', 'parameters' => []], 'get' => ['path' => 'v1/documents/{documentId}', 'httpMethod' => 'GET', 'parameters' => ['documentId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'suggestionsViewMode' => ['location' => 'query', 'type' => 'string']]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Docs::class, 'RoRdb\\Google_Service_Docs');
