...
class AccountBidderLocation extends \RoRdb\Google\Model
{
    public $bidProtocol;
    public $maximumQps;
    public $region;
...
\class_alias(AccountBidderLocation::class, 'RoRdb\\Google_Service_AdExchangeBuyer_AccountBidderLocation');
