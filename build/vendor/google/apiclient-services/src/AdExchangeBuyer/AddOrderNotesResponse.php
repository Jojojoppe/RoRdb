...
class AddOrderNotesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AddOrderNotesResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyer_AddOrderNotesResponse');
