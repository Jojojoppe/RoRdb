...
class GetOrderNotesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetOrderNotesResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyer_GetOrderNotesResponse');
