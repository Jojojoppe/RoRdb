...
class AddOrderDealsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AddOrderDealsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyer_AddOrderDealsResponse');
