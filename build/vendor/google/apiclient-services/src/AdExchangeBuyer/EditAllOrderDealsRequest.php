...
class EditAllOrderDealsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(EditAllOrderDealsRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest');
