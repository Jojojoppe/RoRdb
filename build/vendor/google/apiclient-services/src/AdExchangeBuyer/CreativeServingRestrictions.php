...
class CreativeServingRestrictions extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeServingRestrictions::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreativeServingRestrictions');
