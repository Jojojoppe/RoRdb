...
class GetOrderDealsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetOrderDealsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyer_GetOrderDealsResponse');
