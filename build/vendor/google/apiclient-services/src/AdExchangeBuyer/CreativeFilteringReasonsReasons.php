...
class CreativeFilteringReasonsReasons extends \RoRdb\Google\Model
{
...
\class_alias(CreativeFilteringReasonsReasons::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreativeFilteringReasonsReasons');
