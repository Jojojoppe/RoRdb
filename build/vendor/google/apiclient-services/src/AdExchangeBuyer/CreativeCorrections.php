...
class CreativeCorrections extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeCorrections::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreativeCorrections');
