...
class DeleteOrderDealsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(DeleteOrderDealsRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_DeleteOrderDealsRequest');
