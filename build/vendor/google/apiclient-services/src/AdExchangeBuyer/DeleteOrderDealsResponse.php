...
class DeleteOrderDealsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DeleteOrderDealsResponse::class, 'RoRdb\\Google_Service_AdExchangeBuyer_DeleteOrderDealsResponse');
