...
class TargetingValueDemogAgeCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(TargetingValueDemogAgeCriteria::class, 'RoRdb\\Google_Service_AdExchangeBuyer_TargetingValueDemogAgeCriteria');
