...
class TargetingValueDayPartTargeting extends \RoRdb\Google\Collection
{
...
\class_alias(TargetingValueDayPartTargeting::class, 'RoRdb\\Google_Service_AdExchangeBuyer_TargetingValueDayPartTargeting');
