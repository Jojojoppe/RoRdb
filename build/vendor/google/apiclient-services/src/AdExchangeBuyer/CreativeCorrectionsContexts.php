...
class CreativeCorrectionsContexts extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeCorrectionsContexts::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreativeCorrectionsContexts');
