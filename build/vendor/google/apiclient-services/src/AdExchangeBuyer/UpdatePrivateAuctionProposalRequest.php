...
class UpdatePrivateAuctionProposalRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdatePrivateAuctionProposalRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_UpdatePrivateAuctionProposalRequest');
