...
class TargetingValueDemogGenderCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(TargetingValueDemogGenderCriteria::class, 'RoRdb\\Google_Service_AdExchangeBuyer_TargetingValueDemogGenderCriteria');
