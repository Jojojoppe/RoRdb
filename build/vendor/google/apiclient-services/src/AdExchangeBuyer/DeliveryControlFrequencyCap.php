...
class DeliveryControlFrequencyCap extends \RoRdb\Google\Model
{
...
\class_alias(DeliveryControlFrequencyCap::class, 'RoRdb\\Google_Service_AdExchangeBuyer_DeliveryControlFrequencyCap');
