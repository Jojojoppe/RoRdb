...
class PerformanceReportList extends \RoRdb\Google\Collection
{
...
\class_alias(PerformanceReportList::class, 'RoRdb\\Google_Service_AdExchangeBuyer_PerformanceReportList');
