...
class CreativeAdTechnologyProviders extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeAdTechnologyProviders::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreativeAdTechnologyProviders');
