...
class PublisherProvidedForecast extends \RoRdb\Google\Collection
{
...
\class_alias(PublisherProvidedForecast::class, 'RoRdb\\Google_Service_AdExchangeBuyer_PublisherProvidedForecast');
