...
class TargetingValueCreativeSize extends \RoRdb\Google\Collection
{
...
\class_alias(TargetingValueCreativeSize::class, 'RoRdb\\Google_Service_AdExchangeBuyer_TargetingValueCreativeSize');
