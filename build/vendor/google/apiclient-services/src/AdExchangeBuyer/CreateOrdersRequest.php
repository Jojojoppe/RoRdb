...
class CreateOrdersRequest extends \RoRdb\Google\Collection
{
...
\class_alias(CreateOrdersRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_CreateOrdersRequest');
