...
class AddOrderDealsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddOrderDealsRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_AddOrderDealsRequest');
