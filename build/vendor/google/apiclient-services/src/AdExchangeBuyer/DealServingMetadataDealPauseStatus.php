...
class DealServingMetadataDealPauseStatus extends \RoRdb\Google\Model
{
...
\class_alias(DealServingMetadataDealPauseStatus::class, 'RoRdb\\Google_Service_AdExchangeBuyer_DealServingMetadataDealPauseStatus');
