...
class AddOrderNotesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddOrderNotesRequest::class, 'RoRdb\\Google_Service_AdExchangeBuyer_AddOrderNotesRequest');
