...
class PublisherProfileApiProto extends \RoRdb\Google\Collection
{
...
\class_alias(PublisherProfileApiProto::class, 'RoRdb\\Google_Service_AdExchangeBuyer_PublisherProfileApiProto');
