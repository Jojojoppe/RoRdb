...
class DealTermsRubiconNonGuaranteedTerms extends \RoRdb\Google\Model
{
...
\class_alias(DealTermsRubiconNonGuaranteedTerms::class, 'RoRdb\\Google_Service_AdExchangeBuyer_DealTermsRubiconNonGuaranteedTerms');
