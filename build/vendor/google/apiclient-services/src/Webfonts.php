 ...
 * @author Google, Inc.
 */
class Webfonts extends \RoRdb\Google\Service
{
    public $webfonts;
    /**
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->webfonts = new Webfonts\Resource\Webfonts($this, $this->serviceName, 'webfonts', ['methods' => ['list' => ['path' => 'v1/webfonts', 'httpMethod' => 'GET', 'parameters' => ['sort' => ['location' => 'query', 'type' => 'string']]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Webfonts::class, 'RoRdb\\Google_Service_Webfonts');
