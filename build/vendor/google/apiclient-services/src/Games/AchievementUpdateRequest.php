...
class AchievementUpdateRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AchievementUpdateRequest::class, 'RoRdb\\Google_Service_Games_AchievementUpdateRequest');
