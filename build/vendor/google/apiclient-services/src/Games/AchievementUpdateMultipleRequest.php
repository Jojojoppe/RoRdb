...
class AchievementUpdateMultipleRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AchievementUpdateMultipleRequest::class, 'RoRdb\\Google_Service_Games_AchievementUpdateMultipleRequest');
