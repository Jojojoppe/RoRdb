...
class PlayerScoreSubmissionList extends \RoRdb\Google\Collection
{
...
\class_alias(PlayerScoreSubmissionList::class, 'RoRdb\\Google_Service_Games_PlayerScoreSubmissionList');
