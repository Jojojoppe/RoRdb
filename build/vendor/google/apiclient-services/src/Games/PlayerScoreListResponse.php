...
class PlayerScoreListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlayerScoreListResponse::class, 'RoRdb\\Google_Service_Games_PlayerScoreListResponse');
