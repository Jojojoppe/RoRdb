...
class AchievementUpdateResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AchievementUpdateResponse::class, 'RoRdb\\Google_Service_Games_AchievementUpdateResponse');
