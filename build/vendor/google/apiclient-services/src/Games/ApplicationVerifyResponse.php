...
class ApplicationVerifyResponse extends \RoRdb\Google\Model
{
...
\class_alias(ApplicationVerifyResponse::class, 'RoRdb\\Google_Service_Games_ApplicationVerifyResponse');
