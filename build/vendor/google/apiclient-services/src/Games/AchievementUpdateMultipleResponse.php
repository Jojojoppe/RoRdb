...
class AchievementUpdateMultipleResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AchievementUpdateMultipleResponse::class, 'RoRdb\\Google_Service_Games_AchievementUpdateMultipleResponse');
