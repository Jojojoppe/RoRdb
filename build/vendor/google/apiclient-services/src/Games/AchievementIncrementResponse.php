...
class AchievementIncrementResponse extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(AchievementIncrementResponse::class, 'RoRdb\\Google_Service_Games_AchievementIncrementResponse');
