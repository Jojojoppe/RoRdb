...
class GoogleChromeManagementV1DisplayInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleChromeManagementV1DisplayInfo::class, 'RoRdb\\Google_Service_ChromeManagement_GoogleChromeManagementV1DisplayInfo');
