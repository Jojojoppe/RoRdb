...
class GoogleChromeManagementV1NetworkStatusReport extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleChromeManagementV1NetworkStatusReport::class, 'RoRdb\\Google_Service_ChromeManagement_GoogleChromeManagementV1NetworkStatusReport');
