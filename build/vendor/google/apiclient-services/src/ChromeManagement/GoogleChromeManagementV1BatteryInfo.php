...
class GoogleChromeManagementV1BatteryInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleChromeManagementV1BatteryInfo::class, 'RoRdb\\Google_Service_ChromeManagement_GoogleChromeManagementV1BatteryInfo');
