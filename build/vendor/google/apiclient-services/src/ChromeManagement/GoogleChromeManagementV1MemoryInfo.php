...
class GoogleChromeManagementV1MemoryInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleChromeManagementV1MemoryInfo::class, 'RoRdb\\Google_Service_ChromeManagement_GoogleChromeManagementV1MemoryInfo');
