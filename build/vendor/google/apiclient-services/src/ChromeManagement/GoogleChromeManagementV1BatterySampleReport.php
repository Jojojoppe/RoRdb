...
class GoogleChromeManagementV1BatterySampleReport extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleChromeManagementV1BatterySampleReport::class, 'RoRdb\\Google_Service_ChromeManagement_GoogleChromeManagementV1BatterySampleReport');
