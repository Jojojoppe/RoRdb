...
class BuildBazelRemoteExecutionV2SymlinkNode extends \RoRdb\Google\Model
{
    public $name;
...
\class_alias(BuildBazelRemoteExecutionV2SymlinkNode::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2SymlinkNode');
