...
class GoogleDevtoolsRemoteworkersV1test2FileMetadata extends \RoRdb\Google\Model
{
    public $contents;
...
\class_alias(GoogleDevtoolsRemoteworkersV1test2FileMetadata::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemoteworkersV1test2FileMetadata');
