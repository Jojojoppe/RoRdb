...
class GoogleDevtoolsRemotebuildbotCommandEvents extends \RoRdb\Google\Model
{
    public $cmUsage;
...
\class_alias(GoogleDevtoolsRemotebuildbotCommandEvents::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandEvents');
