...
class BuildBazelRemoteExecutionV2OutputFile extends \RoRdb\Google\Model
{
    public $contents;
...
\class_alias(BuildBazelRemoteExecutionV2OutputFile::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2OutputFile');
