...
class GoogleDevtoolsRemoteworkersV1test2Blob extends \RoRdb\Google\Model
{
    public $contents;
...
\class_alias(GoogleDevtoolsRemoteworkersV1test2Blob::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemoteworkersV1test2Blob');
