...
class GoogleDevtoolsRemotebuildbotCommandDurations extends \RoRdb\Google\Model
{
    public $casRelease;
...
\class_alias(GoogleDevtoolsRemotebuildbotCommandDurations::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemotebuildbotCommandDurations');
