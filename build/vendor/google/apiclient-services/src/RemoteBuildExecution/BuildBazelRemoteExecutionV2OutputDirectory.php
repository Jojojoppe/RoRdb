...
class BuildBazelRemoteExecutionV2OutputDirectory extends \RoRdb\Google\Model
{
    public $path;
...
\class_alias(BuildBazelRemoteExecutionV2OutputDirectory::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2OutputDirectory');
