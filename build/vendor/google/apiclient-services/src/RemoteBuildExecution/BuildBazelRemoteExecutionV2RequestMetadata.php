...
class BuildBazelRemoteExecutionV2RequestMetadata extends \RoRdb\Google\Model
{
    public $actionId;
...
\class_alias(BuildBazelRemoteExecutionV2RequestMetadata::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2RequestMetadata');
