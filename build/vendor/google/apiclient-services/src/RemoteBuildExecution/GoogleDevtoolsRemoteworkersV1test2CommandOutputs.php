...
class GoogleDevtoolsRemoteworkersV1test2CommandOutputs extends \RoRdb\Google\Model
{
    public $exitCode;
...
\class_alias(GoogleDevtoolsRemoteworkersV1test2CommandOutputs::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemoteworkersV1test2CommandOutputs');
