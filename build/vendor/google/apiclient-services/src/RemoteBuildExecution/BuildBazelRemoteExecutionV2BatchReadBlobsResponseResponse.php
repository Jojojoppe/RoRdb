...
class BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse extends \RoRdb\Google\Model
{
    public $data;
...
\class_alias(BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse');
