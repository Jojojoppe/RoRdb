...
class BuildBazelRemoteExecutionV2ExecuteResponse extends \RoRdb\Google\Model
{
    public $cachedResult;
    public $message;
...
\class_alias(BuildBazelRemoteExecutionV2ExecuteResponse::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2ExecuteResponse');
