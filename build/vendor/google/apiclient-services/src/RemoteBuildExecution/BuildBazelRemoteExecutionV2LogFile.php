...
class BuildBazelRemoteExecutionV2LogFile extends \RoRdb\Google\Model
{
...
\class_alias(BuildBazelRemoteExecutionV2LogFile::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2LogFile');
