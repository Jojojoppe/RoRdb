...
class BuildBazelRemoteExecutionV2Command extends \RoRdb\Google\Collection
{
...
\class_alias(BuildBazelRemoteExecutionV2Command::class, 'RoRdb\\Google_Service_RemoteBuildExecution_BuildBazelRemoteExecutionV2Command');
