...
class GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest extends \RoRdb\Google\Model
{
    public $parent;
    public $poolId;
...
\class_alias(GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest::class, 'RoRdb\\Google_Service_RemoteBuildExecution_GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest');
