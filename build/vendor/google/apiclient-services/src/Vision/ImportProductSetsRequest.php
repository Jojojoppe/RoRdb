...
class ImportProductSetsRequest extends \RoRdb\Google\Model
{
...
\class_alias(ImportProductSetsRequest::class, 'RoRdb\\Google_Service_Vision_ImportProductSetsRequest');
