...
class GoogleCloudVisionV1p4beta1OutputConfig extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudVisionV1p4beta1OutputConfig::class, 'RoRdb\\Google_Service_Vision_GoogleCloudVisionV1p4beta1OutputConfig');
