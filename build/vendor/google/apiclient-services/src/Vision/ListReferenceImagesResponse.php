...
class ListReferenceImagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListReferenceImagesResponse::class, 'RoRdb\\Google_Service_Vision_ListReferenceImagesResponse');
