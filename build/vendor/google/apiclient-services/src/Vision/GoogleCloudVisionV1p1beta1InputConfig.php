...
class GoogleCloudVisionV1p1beta1InputConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudVisionV1p1beta1InputConfig::class, 'RoRdb\\Google_Service_Vision_GoogleCloudVisionV1p1beta1InputConfig');
