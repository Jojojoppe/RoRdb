...
class ListProductSetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListProductSetsResponse::class, 'RoRdb\\Google_Service_Vision_ListProductSetsResponse');
