...
class AsyncAnnotateFileRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AsyncAnnotateFileRequest::class, 'RoRdb\\Google_Service_Vision_AsyncAnnotateFileRequest');
