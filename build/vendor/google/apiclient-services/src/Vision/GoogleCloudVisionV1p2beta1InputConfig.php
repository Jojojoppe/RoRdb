...
class GoogleCloudVisionV1p2beta1InputConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudVisionV1p2beta1InputConfig::class, 'RoRdb\\Google_Service_Vision_GoogleCloudVisionV1p2beta1InputConfig');
