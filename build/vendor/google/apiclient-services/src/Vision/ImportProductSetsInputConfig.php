...
class ImportProductSetsInputConfig extends \RoRdb\Google\Model
{
...
\class_alias(ImportProductSetsInputConfig::class, 'RoRdb\\Google_Service_Vision_ImportProductSetsInputConfig');
