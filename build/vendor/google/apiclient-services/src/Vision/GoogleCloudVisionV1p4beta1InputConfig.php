...
class GoogleCloudVisionV1p4beta1InputConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudVisionV1p4beta1InputConfig::class, 'RoRdb\\Google_Service_Vision_GoogleCloudVisionV1p4beta1InputConfig');
