...
class AsyncBatchAnnotateImagesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AsyncBatchAnnotateImagesRequest::class, 'RoRdb\\Google_Service_Vision_AsyncBatchAnnotateImagesRequest');
