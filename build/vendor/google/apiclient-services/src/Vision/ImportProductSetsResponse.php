...
class ImportProductSetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ImportProductSetsResponse::class, 'RoRdb\\Google_Service_Vision_ImportProductSetsResponse');
