...
class UpdateDimensionGroupRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateDimensionGroupRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateDimensionGroupRequest');
