...
class BasicSeriesDataPointStyleOverride extends \RoRdb\Google\Model
{
...
\class_alias(BasicSeriesDataPointStyleOverride::class, 'RoRdb\\Google_Service_Sheets_BasicSeriesDataPointStyleOverride');
