...
class BatchGetValuesByDataFilterResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterResponse::class, 'RoRdb\\Google_Service_Sheets_BatchGetValuesByDataFilterResponse');
