...
class BatchUpdateValuesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateValuesResponse::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateValuesResponse');
