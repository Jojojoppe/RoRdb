...
class IterativeCalculationSettings extends \RoRdb\Google\Model
{
...
\class_alias(IterativeCalculationSettings::class, 'RoRdb\\Google_Service_Sheets_IterativeCalculationSettings');
