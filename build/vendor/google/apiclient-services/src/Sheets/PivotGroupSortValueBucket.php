...
class PivotGroupSortValueBucket extends \RoRdb\Google\Collection
{
...
\class_alias(PivotGroupSortValueBucket::class, 'RoRdb\\Google_Service_Sheets_PivotGroupSortValueBucket');
