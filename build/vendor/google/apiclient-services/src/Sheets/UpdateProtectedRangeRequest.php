...
class UpdateProtectedRangeRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateProtectedRangeRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateProtectedRangeRequest');
