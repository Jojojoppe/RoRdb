...
class DataSourceObjectReference extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DataSourceObjectReference::class, 'RoRdb\\Google_Service_Sheets_DataSourceObjectReference');
