...
class AddProtectedRangeResponse extends \RoRdb\Google\Model
{
...
\class_alias(AddProtectedRangeResponse::class, 'RoRdb\\Google_Service_Sheets_AddProtectedRangeResponse');
