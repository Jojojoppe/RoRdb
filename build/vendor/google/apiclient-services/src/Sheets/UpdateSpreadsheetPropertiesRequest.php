...
class UpdateSpreadsheetPropertiesRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateSpreadsheetPropertiesRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateSpreadsheetPropertiesRequest');
