...
class BatchUpdateValuesByDataFilterResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterResponse::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');
