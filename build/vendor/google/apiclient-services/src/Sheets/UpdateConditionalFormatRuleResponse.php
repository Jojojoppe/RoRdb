...
class UpdateConditionalFormatRuleResponse extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UpdateConditionalFormatRuleResponse::class, 'RoRdb\\Google_Service_Sheets_UpdateConditionalFormatRuleResponse');
