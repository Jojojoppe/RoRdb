...
class BatchGetValuesByDataFilterRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterRequest::class, 'RoRdb\\Google_Service_Sheets_BatchGetValuesByDataFilterRequest');
