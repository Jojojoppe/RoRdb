...
class DataSourceRefreshSchedule extends \RoRdb\Google\Model
{
...
\class_alias(DataSourceRefreshSchedule::class, 'RoRdb\\Google_Service_Sheets_DataSourceRefreshSchedule');
