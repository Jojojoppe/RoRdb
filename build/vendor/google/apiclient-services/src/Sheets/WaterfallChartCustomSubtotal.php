...
class WaterfallChartCustomSubtotal extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(WaterfallChartCustomSubtotal::class, 'RoRdb\\Google_Service_Sheets_WaterfallChartCustomSubtotal');
