...
class SearchDeveloperMetadataRequest extends \RoRdb\Google\Collection
{
...
\class_alias(SearchDeveloperMetadataRequest::class, 'RoRdb\\Google_Service_Sheets_SearchDeveloperMetadataRequest');
