...
class BatchUpdateSpreadsheetRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetRequest::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateSpreadsheetRequest');
