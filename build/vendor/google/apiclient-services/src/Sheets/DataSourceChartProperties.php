...
class DataSourceChartProperties extends \RoRdb\Google\Model
{
...
\class_alias(DataSourceChartProperties::class, 'RoRdb\\Google_Service_Sheets_DataSourceChartProperties');
