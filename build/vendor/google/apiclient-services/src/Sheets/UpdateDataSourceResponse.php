...
class UpdateDataSourceResponse extends \RoRdb\Google\Model
{
...
\class_alias(UpdateDataSourceResponse::class, 'RoRdb\\Google_Service_Sheets_UpdateDataSourceResponse');
