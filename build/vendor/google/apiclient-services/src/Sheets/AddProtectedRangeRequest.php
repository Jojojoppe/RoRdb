...
class AddProtectedRangeRequest extends \RoRdb\Google\Model
{
...
\class_alias(AddProtectedRangeRequest::class, 'RoRdb\\Google_Service_Sheets_AddProtectedRangeRequest');
