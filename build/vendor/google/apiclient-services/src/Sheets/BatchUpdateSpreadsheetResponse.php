...
class BatchUpdateSpreadsheetResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetResponse::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateSpreadsheetResponse');
