...
class DataSourceSheetDimensionRange extends \RoRdb\Google\Collection
{
...
\class_alias(DataSourceSheetDimensionRange::class, 'RoRdb\\Google_Service_Sheets_DataSourceSheetDimensionRange');
