...
class UpdateDimensionPropertiesRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateDimensionPropertiesRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateDimensionPropertiesRequest');
