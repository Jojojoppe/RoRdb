...
class CopySheetToAnotherSpreadsheetRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CopySheetToAnotherSpreadsheetRequest::class, 'RoRdb\\Google_Service_Sheets_CopySheetToAnotherSpreadsheetRequest');
