...
class BatchClearValuesByDataFilterRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchClearValuesByDataFilterRequest::class, 'RoRdb\\Google_Service_Sheets_BatchClearValuesByDataFilterRequest');
