...
class DeleteProtectedRangeRequest extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DeleteProtectedRangeRequest::class, 'RoRdb\\Google_Service_Sheets_DeleteProtectedRangeRequest');
