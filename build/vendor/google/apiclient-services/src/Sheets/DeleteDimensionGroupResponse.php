...
class DeleteDimensionGroupResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DeleteDimensionGroupResponse::class, 'RoRdb\\Google_Service_Sheets_DeleteDimensionGroupResponse');
