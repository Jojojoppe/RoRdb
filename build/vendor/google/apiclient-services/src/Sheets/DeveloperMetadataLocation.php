...
class DeveloperMetadataLocation extends \RoRdb\Google\Model
{
...
\class_alias(DeveloperMetadataLocation::class, 'RoRdb\\Google_Service_Sheets_DeveloperMetadataLocation');
