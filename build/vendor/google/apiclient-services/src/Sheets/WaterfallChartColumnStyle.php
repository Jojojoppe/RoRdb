...
class WaterfallChartColumnStyle extends \RoRdb\Google\Model
{
...
\class_alias(WaterfallChartColumnStyle::class, 'RoRdb\\Google_Service_Sheets_WaterfallChartColumnStyle');
