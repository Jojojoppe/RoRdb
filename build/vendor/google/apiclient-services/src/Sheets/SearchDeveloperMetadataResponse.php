...
class SearchDeveloperMetadataResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchDeveloperMetadataResponse::class, 'RoRdb\\Google_Service_Sheets_SearchDeveloperMetadataResponse');
