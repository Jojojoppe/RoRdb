...
class RefreshDataSourceResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RefreshDataSourceResponse::class, 'RoRdb\\Google_Service_Sheets_RefreshDataSourceResponse');
