...
class DeleteDuplicatesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'RoRdb\\Google_Service_Sheets_DeleteDuplicatesRequest');
