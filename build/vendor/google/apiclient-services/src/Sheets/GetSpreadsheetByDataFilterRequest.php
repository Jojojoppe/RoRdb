...
class GetSpreadsheetByDataFilterRequest extends \RoRdb\Google\Collection
{
...
\class_alias(GetSpreadsheetByDataFilterRequest::class, 'RoRdb\\Google_Service_Sheets_GetSpreadsheetByDataFilterRequest');
