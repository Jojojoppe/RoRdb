...
class BatchClearValuesByDataFilterResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchClearValuesByDataFilterResponse::class, 'RoRdb\\Google_Service_Sheets_BatchClearValuesByDataFilterResponse');
