...
class BatchClearValuesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchClearValuesResponse::class, 'RoRdb\\Google_Service_Sheets_BatchClearValuesResponse');
