...
class UpdateDeveloperMetadataRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateDeveloperMetadataRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateDeveloperMetadataRequest');
