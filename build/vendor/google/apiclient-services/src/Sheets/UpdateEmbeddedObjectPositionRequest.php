...
class UpdateEmbeddedObjectPositionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateEmbeddedObjectPositionRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateEmbeddedObjectPositionRequest');
