...
class DataSourceSheetProperties extends \RoRdb\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'RoRdb\\Google_Service_Sheets_DataSourceSheetProperties');
