...
class RefreshDataSourceRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RefreshDataSourceRequest::class, 'RoRdb\\Google_Service_Sheets_RefreshDataSourceRequest');
