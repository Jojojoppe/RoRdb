...
class AutoResizeDimensionsRequest extends \RoRdb\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'RoRdb\\Google_Service_Sheets_AutoResizeDimensionsRequest');
