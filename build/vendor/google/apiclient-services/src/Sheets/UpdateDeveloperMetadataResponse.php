...
class UpdateDeveloperMetadataResponse extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateDeveloperMetadataResponse::class, 'RoRdb\\Google_Service_Sheets_UpdateDeveloperMetadataResponse');
