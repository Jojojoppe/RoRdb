...
class BatchUpdateValuesByDataFilterRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterRequest::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateValuesByDataFilterRequest');
