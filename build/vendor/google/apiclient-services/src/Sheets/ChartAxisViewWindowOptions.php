...
class ChartAxisViewWindowOptions extends \RoRdb\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'RoRdb\\Google_Service_Sheets_ChartAxisViewWindowOptions');
