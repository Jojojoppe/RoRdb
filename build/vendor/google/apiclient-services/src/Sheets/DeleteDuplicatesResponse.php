...
class DeleteDuplicatesResponse extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DeleteDuplicatesResponse::class, 'RoRdb\\Google_Service_Sheets_DeleteDuplicatesResponse');
