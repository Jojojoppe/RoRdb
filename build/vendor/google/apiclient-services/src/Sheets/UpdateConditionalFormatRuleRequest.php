...
class UpdateConditionalFormatRuleRequest extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UpdateConditionalFormatRuleRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateConditionalFormatRuleRequest');
