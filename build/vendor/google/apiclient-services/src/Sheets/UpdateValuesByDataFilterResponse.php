...
class UpdateValuesByDataFilterResponse extends \RoRdb\Google\Model
{
...
\class_alias(UpdateValuesByDataFilterResponse::class, 'RoRdb\\Google_Service_Sheets_UpdateValuesByDataFilterResponse');
