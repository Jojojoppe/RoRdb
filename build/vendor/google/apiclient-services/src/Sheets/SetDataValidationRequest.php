...
class SetDataValidationRequest extends \RoRdb\Google\Model
{
...
\class_alias(SetDataValidationRequest::class, 'RoRdb\\Google_Service_Sheets_SetDataValidationRequest');
