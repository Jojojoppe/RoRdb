...
class MatchedDeveloperMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'RoRdb\\Google_Service_Sheets_MatchedDeveloperMetadata');
