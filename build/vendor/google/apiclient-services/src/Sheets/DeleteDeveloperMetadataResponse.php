...
class DeleteDeveloperMetadataResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DeleteDeveloperMetadataResponse::class, 'RoRdb\\Google_Service_Sheets_DeleteDeveloperMetadataResponse');
