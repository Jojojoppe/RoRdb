...
class CreateDeveloperMetadataResponse extends \RoRdb\Google\Model
{
...
\class_alias(CreateDeveloperMetadataResponse::class, 'RoRdb\\Google_Service_Sheets_CreateDeveloperMetadataResponse');
