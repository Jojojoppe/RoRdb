...
class AddDimensionGroupResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AddDimensionGroupResponse::class, 'RoRdb\\Google_Service_Sheets_AddDimensionGroupResponse');
