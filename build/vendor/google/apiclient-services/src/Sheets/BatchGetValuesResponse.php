...
class BatchGetValuesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetValuesResponse::class, 'RoRdb\\Google_Service_Sheets_BatchGetValuesResponse');
