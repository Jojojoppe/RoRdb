...
class UpdateEmbeddedObjectPositionResponse extends \RoRdb\Google\Model
{
...
\class_alias(UpdateEmbeddedObjectPositionResponse::class, 'RoRdb\\Google_Service_Sheets_UpdateEmbeddedObjectPositionResponse');
