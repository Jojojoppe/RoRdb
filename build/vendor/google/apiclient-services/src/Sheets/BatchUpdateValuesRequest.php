...
class BatchUpdateValuesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'RoRdb\\Google_Service_Sheets_BatchUpdateValuesRequest');
