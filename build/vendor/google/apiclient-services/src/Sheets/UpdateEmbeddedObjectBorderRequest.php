...
class UpdateEmbeddedObjectBorderRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateEmbeddedObjectBorderRequest::class, 'RoRdb\\Google_Service_Sheets_UpdateEmbeddedObjectBorderRequest');
