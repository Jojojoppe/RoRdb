...
class ListProjectBillingInfoResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListProjectBillingInfoResponse::class, 'RoRdb\\Google_Service_Cloudbilling_ListProjectBillingInfoResponse');
