...
class ListBillingAccountsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBillingAccountsResponse::class, 'RoRdb\\Google_Service_Cloudbilling_ListBillingAccountsResponse');
