...
class ListForwardingAddressesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListForwardingAddressesResponse::class, 'RoRdb\\Google_Service_Gmail_ListForwardingAddressesResponse');
