 ...
 * the License.
 */
namespace RoRdb\Google\Service\Gmail\Resource;

use RoRdb\Google\Service\Gmail\BatchDeleteMessagesRequest;
use RoRdb\Google\Service\Gmail\BatchModifyMessagesRequest;
use RoRdb\Google\Service\Gmail\ListMessagesResponse;
use RoRdb\Google\Service\Gmail\Message;
use RoRdb\Google\Service\Gmail\ModifyMessageRequest;
/**
 ...
 *  </code>
 */
class UsersMessages extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(UsersMessages::class, 'RoRdb\\Google_Service_Gmail_Resource_UsersMessages');
