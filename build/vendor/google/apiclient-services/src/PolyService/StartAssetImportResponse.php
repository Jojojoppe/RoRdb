 ...
 * the License.
 */
namespace RoRdb\Google\Service\PolyService;

class StartAssetImportResponse extends \RoRdb\Google\Collection
{
...
\class_alias(StartAssetImportResponse::class, 'RoRdb\\Google_Service_PolyService_StartAssetImportResponse');
