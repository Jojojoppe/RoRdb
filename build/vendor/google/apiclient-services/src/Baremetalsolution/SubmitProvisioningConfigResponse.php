...
class SubmitProvisioningConfigResponse extends \RoRdb\Google\Model
{
...
\class_alias(SubmitProvisioningConfigResponse::class, 'RoRdb\\Google_Service_Baremetalsolution_SubmitProvisioningConfigResponse');
