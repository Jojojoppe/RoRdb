...
class SubmitProvisioningConfigRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubmitProvisioningConfigRequest::class, 'RoRdb\\Google_Service_Baremetalsolution_SubmitProvisioningConfigRequest');
