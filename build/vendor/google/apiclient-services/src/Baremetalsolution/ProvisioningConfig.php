...
class ProvisioningConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ProvisioningConfig::class, 'RoRdb\\Google_Service_Baremetalsolution_ProvisioningConfig');
