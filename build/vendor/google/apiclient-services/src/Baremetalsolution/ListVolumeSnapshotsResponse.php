...
class ListVolumeSnapshotsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListVolumeSnapshotsResponse::class, 'RoRdb\\Google_Service_Baremetalsolution_ListVolumeSnapshotsResponse');
