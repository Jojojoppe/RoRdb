...
class ListProvisioningQuotasResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListProvisioningQuotasResponse::class, 'RoRdb\\Google_Service_Baremetalsolution_ListProvisioningQuotasResponse');
