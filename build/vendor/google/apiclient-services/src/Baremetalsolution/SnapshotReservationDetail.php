...
class SnapshotReservationDetail extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SnapshotReservationDetail::class, 'RoRdb\\Google_Service_Baremetalsolution_SnapshotReservationDetail');
