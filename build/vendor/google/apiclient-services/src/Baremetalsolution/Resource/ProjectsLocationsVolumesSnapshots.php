 ...
 * the License.
 */
namespace RoRdb\Google\Service\Baremetalsolution\Resource;

use RoRdb\Google\Service\Baremetalsolution\BaremetalsolutionEmpty;
use RoRdb\Google\Service\Baremetalsolution\ListVolumeSnapshotsResponse;
use RoRdb\Google\Service\Baremetalsolution\Operation;
use RoRdb\Google\Service\Baremetalsolution\RestoreVolumeSnapshotRequest;
use RoRdb\Google\Service\Baremetalsolution\VolumeSnapshot;
/**
 ...
 *  </code>
 */
class ProjectsLocationsVolumesSnapshots extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsVolumesSnapshots::class, 'RoRdb\\Google_Service_Baremetalsolution_Resource_ProjectsLocationsVolumesSnapshots');
