 ...
 * @author Google, Inc.
 */
class Keep extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->media = new Keep\Resource\Media($this, $this->serviceName, 'media', ['methods' => ['download' => ['path' => 'v1/{+name}', 'httpMethod' => 'GET', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'mimeType' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->notes = new Keep\Resource\Notes($this, $this->serviceName, 'notes', ['methods' => ['create' => ['path' => 'v1/notes', 'httpMethod' => 'POST', 'parameters' => []], 'delete' => ['path' => 'v1/{+name}', 'httpMethod' => 'DELETE', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'get' => ['path' => 'v1/{+name}', 'httpMethod' => 'GET', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'list' => ['path' => 'v1/notes', 'httpMethod' => 'GET', 'parameters' => ['filter' => ['location' => 'query', 'type' => 'string'], 'pageSize' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->notes_permissions = new Keep\Resource\NotesPermissions($this, $this->serviceName, 'permissions', ['methods' => ['batchCreate' => ['path' => 'v1/{+parent}/permissions:batchCreate', 'httpMethod' => 'POST', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'batchDelete' => ['path' => 'v1/{+parent}/permissions:batchDelete', 'httpMethod' => 'POST', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Keep::class, 'RoRdb\\Google_Service_Keep');
