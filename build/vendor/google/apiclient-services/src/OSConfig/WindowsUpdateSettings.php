...
class WindowsUpdateSettings extends \RoRdb\Google\Collection
{
...
\class_alias(WindowsUpdateSettings::class, 'RoRdb\\Google_Service_OSConfig_WindowsUpdateSettings');
