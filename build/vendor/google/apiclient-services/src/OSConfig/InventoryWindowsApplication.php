...
class InventoryWindowsApplication extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InventoryWindowsApplication::class, 'RoRdb\\Google_Service_OSConfig_InventoryWindowsApplication');
