...
class OSPolicyResourcePackageResourceRPM extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(OSPolicyResourcePackageResourceRPM::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourcePackageResourceRPM');
