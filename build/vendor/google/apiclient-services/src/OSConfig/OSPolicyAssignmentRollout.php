...
class OSPolicyAssignmentRollout extends \RoRdb\Google\Model
{
...
\class_alias(OSPolicyAssignmentRollout::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyAssignmentRollout');
