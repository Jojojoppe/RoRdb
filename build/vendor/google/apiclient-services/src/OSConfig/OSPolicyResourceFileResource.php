...
class OSPolicyResourceFileResource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OSPolicyResourceFileResource::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourceFileResource');
