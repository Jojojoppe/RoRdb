...
class OSPolicyAssignmentOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OSPolicyAssignmentOperationMetadata::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyAssignmentOperationMetadata');
