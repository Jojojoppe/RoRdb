...
class GoogleCloudOsconfigV1OSPolicyAssignmentOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudOsconfigV1OSPolicyAssignmentOperationMetadata::class, 'RoRdb\\Google_Service_OSConfig_GoogleCloudOsconfigV1OSPolicyAssignmentOperationMetadata');
