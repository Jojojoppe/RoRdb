...
class ListInventoriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListInventoriesResponse::class, 'RoRdb\\Google_Service_OSConfig_ListInventoriesResponse');
