...
class ListPatchJobInstanceDetailsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPatchJobInstanceDetailsResponse::class, 'RoRdb\\Google_Service_OSConfig_ListPatchJobInstanceDetailsResponse');
