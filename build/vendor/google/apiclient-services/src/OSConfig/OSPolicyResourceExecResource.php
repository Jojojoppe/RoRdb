...
class OSPolicyResourceExecResource extends \RoRdb\Google\Model
{
...
\class_alias(OSPolicyResourceExecResource::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourceExecResource');
