...
class InventorySoftwarePackage extends \RoRdb\Google\Model
{
...
\class_alias(InventorySoftwarePackage::class, 'RoRdb\\Google_Service_OSConfig_InventorySoftwarePackage');
