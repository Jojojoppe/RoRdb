...
class OSPolicyResourcePackageResourceMSI extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyResourcePackageResourceMSI::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourcePackageResourceMSI');
