...
class PatchJobInstanceDetailsSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PatchJobInstanceDetailsSummary::class, 'RoRdb\\Google_Service_OSConfig_PatchJobInstanceDetailsSummary');
