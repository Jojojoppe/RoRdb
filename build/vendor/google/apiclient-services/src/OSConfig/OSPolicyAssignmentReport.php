...
class OSPolicyAssignmentReport extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyAssignmentReport::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyAssignmentReport');
