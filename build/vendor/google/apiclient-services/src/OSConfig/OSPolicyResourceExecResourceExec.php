...
class OSPolicyResourceExecResourceExec extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyResourceExecResourceExec::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourceExecResourceExec');
