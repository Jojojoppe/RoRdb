...
class OSPolicyResourcePackageResource extends \RoRdb\Google\Model
{
...
\class_alias(OSPolicyResourcePackageResource::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourcePackageResource');
