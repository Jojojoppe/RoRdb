...
class OSPolicyAssignmentReportOSPolicyCompliance extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyAssignmentReportOSPolicyCompliance::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyAssignmentReportOSPolicyCompliance');
