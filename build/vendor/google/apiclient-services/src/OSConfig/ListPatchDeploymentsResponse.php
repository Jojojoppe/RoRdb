...
class ListPatchDeploymentsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPatchDeploymentsResponse::class, 'RoRdb\\Google_Service_OSConfig_ListPatchDeploymentsResponse');
