...
class PatchJobInstanceDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PatchJobInstanceDetails::class, 'RoRdb\\Google_Service_OSConfig_PatchJobInstanceDetails');
