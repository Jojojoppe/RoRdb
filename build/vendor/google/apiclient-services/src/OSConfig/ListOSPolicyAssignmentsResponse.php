...
class ListOSPolicyAssignmentsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListOSPolicyAssignmentsResponse::class, 'RoRdb\\Google_Service_OSConfig_ListOSPolicyAssignmentsResponse');
