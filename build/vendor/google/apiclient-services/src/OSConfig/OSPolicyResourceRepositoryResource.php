...
class OSPolicyResourceRepositoryResource extends \RoRdb\Google\Model
{
...
\class_alias(OSPolicyResourceRepositoryResource::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourceRepositoryResource');
