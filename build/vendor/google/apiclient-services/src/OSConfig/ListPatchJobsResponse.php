...
class ListPatchJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPatchJobsResponse::class, 'RoRdb\\Google_Service_OSConfig_ListPatchJobsResponse');
