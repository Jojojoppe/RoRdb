...
class InventoryWindowsUpdatePackage extends \RoRdb\Google\Collection
{
...
\class_alias(InventoryWindowsUpdatePackage::class, 'RoRdb\\Google_Service_OSConfig_InventoryWindowsUpdatePackage');
