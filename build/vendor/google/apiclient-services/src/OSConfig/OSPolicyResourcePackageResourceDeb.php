...
class OSPolicyResourcePackageResourceDeb extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(OSPolicyResourcePackageResourceDeb::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourcePackageResourceDeb');
