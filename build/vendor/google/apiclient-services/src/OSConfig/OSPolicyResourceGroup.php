...
class OSPolicyResourceGroup extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyResourceGroup::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyResourceGroup');
