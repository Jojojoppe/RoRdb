...
class OSPolicyAssignmentInstanceFilter extends \RoRdb\Google\Collection
{
...
\class_alias(OSPolicyAssignmentInstanceFilter::class, 'RoRdb\\Google_Service_OSConfig_OSPolicyAssignmentInstanceFilter');
