...
* @author Google, Inc.
*/
class TrafficDirectorService extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->discovery = new TrafficDirectorService\Resource\Discovery($this, $this->serviceName, 'discovery', ['methods' => ['client_status' => ['path' => 'v2/discovery:client_status', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(TrafficDirectorService::class, 'RoRdb\\Google_Service_TrafficDirectorService');
