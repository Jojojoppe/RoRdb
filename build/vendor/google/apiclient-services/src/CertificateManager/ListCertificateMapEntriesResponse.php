 ...
 * the License.
 */
namespace RoRdb\Google\Service\CertificateManager;

class ListCertificateMapEntriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCertificateMapEntriesResponse::class, 'RoRdb\\Google_Service_CertificateManager_ListCertificateMapEntriesResponse');
