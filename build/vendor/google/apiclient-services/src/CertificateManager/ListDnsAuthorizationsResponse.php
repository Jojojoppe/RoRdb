...
class ListDnsAuthorizationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDnsAuthorizationsResponse::class, 'RoRdb\\Google_Service_CertificateManager_ListDnsAuthorizationsResponse');
