...
class ListCertificateMapsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCertificateMapsResponse::class, 'RoRdb\\Google_Service_CertificateManager_ListCertificateMapsResponse');
