...
class ManagedCertificate extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedCertificate::class, 'RoRdb\\Google_Service_CertificateManager_ManagedCertificate');
