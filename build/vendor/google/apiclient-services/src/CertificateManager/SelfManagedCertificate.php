...
class SelfManagedCertificate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SelfManagedCertificate::class, 'RoRdb\\Google_Service_CertificateManager_SelfManagedCertificate');
