...
class AttestationOccurrence extends \RoRdb\Google\Collection
{
...
\class_alias(AttestationOccurrence::class, 'RoRdb\\Google_Service_BinaryAuthorization_AttestationOccurrence');
