...
class ValidateAttestationOccurrenceRequest extends \RoRdb\Google\Model
{
...
\class_alias(ValidateAttestationOccurrenceRequest::class, 'RoRdb\\Google_Service_BinaryAuthorization_ValidateAttestationOccurrenceRequest');
