...
class UserOwnedGrafeasNote extends \RoRdb\Google\Collection
{
...
\class_alias(UserOwnedGrafeasNote::class, 'RoRdb\\Google_Service_BinaryAuthorization_UserOwnedGrafeasNote');
