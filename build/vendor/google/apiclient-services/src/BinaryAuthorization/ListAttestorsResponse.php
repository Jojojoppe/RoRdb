...
class ListAttestorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAttestorsResponse::class, 'RoRdb\\Google_Service_BinaryAuthorization_ListAttestorsResponse');
