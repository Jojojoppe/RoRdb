...
class BatchUpdatePhotosRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUpdatePhotosRequest::class, 'RoRdb\\Google_Service_StreetViewPublish_BatchUpdatePhotosRequest');
