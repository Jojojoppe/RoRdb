...
class TenantProjectPolicy extends \RoRdb\Google\Collection
{
...
\class_alias(TenantProjectPolicy::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_TenantProjectPolicy');
