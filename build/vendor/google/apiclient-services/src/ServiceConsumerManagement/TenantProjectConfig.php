...
class TenantProjectConfig extends \RoRdb\Google\Collection
{
...
\class_alias(TenantProjectConfig::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_TenantProjectConfig');
