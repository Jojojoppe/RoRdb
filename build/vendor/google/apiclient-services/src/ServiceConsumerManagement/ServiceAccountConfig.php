...
class ServiceAccountConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ServiceAccountConfig::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_ServiceAccountConfig');
