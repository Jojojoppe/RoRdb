...
class ListTenancyUnitsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTenancyUnitsResponse::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_ListTenancyUnitsResponse');
