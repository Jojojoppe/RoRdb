...
class AuthenticationRule extends \RoRdb\Google\Collection
{
...
\class_alias(AuthenticationRule::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_AuthenticationRule');
