...
class V1Beta1QuotaOverride extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(V1Beta1QuotaOverride::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_V1Beta1QuotaOverride');
