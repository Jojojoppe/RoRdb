...
class MetricDescriptor extends \RoRdb\Google\Collection
{
...
\class_alias(MetricDescriptor::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_MetricDescriptor');
