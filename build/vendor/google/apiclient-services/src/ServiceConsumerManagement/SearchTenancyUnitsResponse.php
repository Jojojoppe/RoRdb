...
class SearchTenancyUnitsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchTenancyUnitsResponse::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_SearchTenancyUnitsResponse');
