...
class DocumentationRule extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DocumentationRule::class, 'RoRdb\\Google_Service_ServiceConsumerManagement_DocumentationRule');
