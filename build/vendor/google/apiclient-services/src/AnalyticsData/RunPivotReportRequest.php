...
class RunPivotReportRequest extends \RoRdb\Google\Collection
{
...
\class_alias(RunPivotReportRequest::class, 'RoRdb\\Google_Service_AnalyticsData_RunPivotReportRequest');
