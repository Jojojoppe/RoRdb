...
class CheckCompatibilityRequest extends \RoRdb\Google\Collection
{
...
\class_alias(CheckCompatibilityRequest::class, 'RoRdb\\Google_Service_AnalyticsData_CheckCompatibilityRequest');
