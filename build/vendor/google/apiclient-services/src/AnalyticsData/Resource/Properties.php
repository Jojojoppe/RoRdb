 ...
 * the License.
 */
namespace RoRdb\Google\Service\AnalyticsData\Resource;

use RoRdb\Google\Service\AnalyticsData\BatchRunPivotReportsRequest;
use RoRdb\Google\Service\AnalyticsData\BatchRunPivotReportsResponse;
use RoRdb\Google\Service\AnalyticsData\BatchRunReportsRequest;
use RoRdb\Google\Service\AnalyticsData\BatchRunReportsResponse;
use RoRdb\Google\Service\AnalyticsData\CheckCompatibilityRequest;
use RoRdb\Google\Service\AnalyticsData\CheckCompatibilityResponse;
use RoRdb\Google\Service\AnalyticsData\Metadata;
use RoRdb\Google\Service\AnalyticsData\RunPivotReportRequest;
use RoRdb\Google\Service\AnalyticsData\RunPivotReportResponse;
use RoRdb\Google\Service\AnalyticsData\RunRealtimeReportRequest;
use RoRdb\Google\Service\AnalyticsData\RunRealtimeReportResponse;
use RoRdb\Google\Service\AnalyticsData\RunReportRequest;
use RoRdb\Google\Service\AnalyticsData\RunReportResponse;
/**
 ...
 *  </code>
 */
class Properties extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Properties::class, 'RoRdb\\Google_Service_AnalyticsData_Resource_Properties');
