...
class CheckCompatibilityResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CheckCompatibilityResponse::class, 'RoRdb\\Google_Service_AnalyticsData_CheckCompatibilityResponse');
