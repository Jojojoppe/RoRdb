...
class SchemaRestrictionResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SchemaRestrictionResponse::class, 'RoRdb\\Google_Service_AnalyticsData_SchemaRestrictionResponse');
