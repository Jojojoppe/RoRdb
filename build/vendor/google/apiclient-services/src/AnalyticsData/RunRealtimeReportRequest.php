...
class RunRealtimeReportRequest extends \RoRdb\Google\Collection
{
...
\class_alias(RunRealtimeReportRequest::class, 'RoRdb\\Google_Service_AnalyticsData_RunRealtimeReportRequest');
