...
class DimensionCompatibility extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DimensionCompatibility::class, 'RoRdb\\Google_Service_AnalyticsData_DimensionCompatibility');
