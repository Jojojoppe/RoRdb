...
class RunPivotReportResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RunPivotReportResponse::class, 'RoRdb\\Google_Service_AnalyticsData_RunPivotReportResponse');
