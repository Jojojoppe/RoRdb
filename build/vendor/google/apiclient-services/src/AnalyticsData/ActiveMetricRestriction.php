...
class ActiveMetricRestriction extends \RoRdb\Google\Collection
{
...
\class_alias(ActiveMetricRestriction::class, 'RoRdb\\Google_Service_AnalyticsData_ActiveMetricRestriction');
