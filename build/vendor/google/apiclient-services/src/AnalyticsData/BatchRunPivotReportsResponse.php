 ...
 * the License.
 */
namespace RoRdb\Google\Service\AnalyticsData;

class BatchRunPivotReportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchRunPivotReportsResponse::class, 'RoRdb\\Google_Service_AnalyticsData_BatchRunPivotReportsResponse');
