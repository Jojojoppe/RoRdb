...
class RunRealtimeReportResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RunRealtimeReportResponse::class, 'RoRdb\\Google_Service_AnalyticsData_RunRealtimeReportResponse');
