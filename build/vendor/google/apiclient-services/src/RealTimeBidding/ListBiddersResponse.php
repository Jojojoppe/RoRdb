...
class ListBiddersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBiddersResponse::class, 'RoRdb\\Google_Service_RealTimeBidding_ListBiddersResponse');
