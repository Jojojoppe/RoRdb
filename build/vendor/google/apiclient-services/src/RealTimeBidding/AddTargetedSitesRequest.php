...
class AddTargetedSitesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddTargetedSitesRequest::class, 'RoRdb\\Google_Service_RealTimeBidding_AddTargetedSitesRequest');
