...
class CreativeServingDecision extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeServingDecision::class, 'RoRdb\\Google_Service_RealTimeBidding_CreativeServingDecision');
