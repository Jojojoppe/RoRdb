...
class ListPretargetingConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPretargetingConfigsResponse::class, 'RoRdb\\Google_Service_RealTimeBidding_ListPretargetingConfigsResponse');
