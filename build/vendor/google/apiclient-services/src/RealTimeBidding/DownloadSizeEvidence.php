...
class DownloadSizeEvidence extends \RoRdb\Google\Collection
{
...
\class_alias(DownloadSizeEvidence::class, 'RoRdb\\Google_Service_RealTimeBidding_DownloadSizeEvidence');
