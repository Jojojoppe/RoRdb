...
class AddTargetedAppsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddTargetedAppsRequest::class, 'RoRdb\\Google_Service_RealTimeBidding_AddTargetedAppsRequest');
