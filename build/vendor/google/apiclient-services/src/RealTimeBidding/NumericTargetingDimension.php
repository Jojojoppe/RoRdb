...
class NumericTargetingDimension extends \RoRdb\Google\Collection
{
...
\class_alias(NumericTargetingDimension::class, 'RoRdb\\Google_Service_RealTimeBidding_NumericTargetingDimension');
