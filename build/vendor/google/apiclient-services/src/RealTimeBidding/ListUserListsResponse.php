...
class ListUserListsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUserListsResponse::class, 'RoRdb\\Google_Service_RealTimeBidding_ListUserListsResponse');
