...
class DestinationNotWorkingEvidence extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DestinationNotWorkingEvidence::class, 'RoRdb\\Google_Service_RealTimeBidding_DestinationNotWorkingEvidence');
