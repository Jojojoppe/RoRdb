...
class DestinationNotCrawlableEvidence extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DestinationNotCrawlableEvidence::class, 'RoRdb\\Google_Service_RealTimeBidding_DestinationNotCrawlableEvidence');
