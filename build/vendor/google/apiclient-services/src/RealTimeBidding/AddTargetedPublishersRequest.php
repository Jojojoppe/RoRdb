...
class AddTargetedPublishersRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AddTargetedPublishersRequest::class, 'RoRdb\\Google_Service_RealTimeBidding_AddTargetedPublishersRequest');
