...
class StringTargetingDimension extends \RoRdb\Google\Collection
{
...
\class_alias(StringTargetingDimension::class, 'RoRdb\\Google_Service_RealTimeBidding_StringTargetingDimension');
