...
class PostgreSqlConnectionProfile extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PostgreSqlConnectionProfile::class, 'RoRdb\\Google_Service_DatabaseMigrationService_PostgreSqlConnectionProfile');
