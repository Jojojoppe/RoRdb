...
class CloudSqlConnectionProfile extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CloudSqlConnectionProfile::class, 'RoRdb\\Google_Service_DatabaseMigrationService_CloudSqlConnectionProfile');
