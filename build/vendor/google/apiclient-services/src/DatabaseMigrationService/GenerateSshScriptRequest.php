...
class GenerateSshScriptRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GenerateSshScriptRequest::class, 'RoRdb\\Google_Service_DatabaseMigrationService_GenerateSshScriptRequest');
