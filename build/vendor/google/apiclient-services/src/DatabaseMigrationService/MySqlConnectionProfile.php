...
class MySqlConnectionProfile extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MySqlConnectionProfile::class, 'RoRdb\\Google_Service_DatabaseMigrationService_MySqlConnectionProfile');
