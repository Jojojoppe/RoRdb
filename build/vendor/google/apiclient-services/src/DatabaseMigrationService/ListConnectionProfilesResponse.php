...
class ListConnectionProfilesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListConnectionProfilesResponse::class, 'RoRdb\\Google_Service_DatabaseMigrationService_ListConnectionProfilesResponse');
