...
class LivingAreaAccessibility extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(LivingAreaAccessibility::class, 'RoRdb\\Google_Service_MyBusinessLodging_LivingAreaAccessibility');
