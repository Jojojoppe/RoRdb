...
class SustainabilityCertifications extends \RoRdb\Google\Collection
{
...
\class_alias(SustainabilityCertifications::class, 'RoRdb\\Google_Service_MyBusinessLodging_SustainabilityCertifications');
