...
class ResolveServiceRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ResolveServiceRequest::class, 'RoRdb\\Google_Service_ServiceDirectory_ResolveServiceRequest');
