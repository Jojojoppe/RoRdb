...
class GoogleCloudChannelV1EduData extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1EduData::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1EduData');
