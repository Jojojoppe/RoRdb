...
class GoogleCloudChannelV1Customer extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1Customer::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1Customer');
