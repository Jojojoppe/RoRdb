...
class GoogleCloudChannelV1AssociationInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1AssociationInfo::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1AssociationInfo');
