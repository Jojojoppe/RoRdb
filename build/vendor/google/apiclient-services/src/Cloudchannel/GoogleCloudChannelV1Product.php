...
class GoogleCloudChannelV1Product extends \RoRdb\Google\Model
{
...
\class_alias(GoogleCloudChannelV1Product::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1Product');
