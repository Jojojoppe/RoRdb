...
class GoogleCloudChannelV1alpha1AssociationInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1alpha1AssociationInfo::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1alpha1AssociationInfo');
