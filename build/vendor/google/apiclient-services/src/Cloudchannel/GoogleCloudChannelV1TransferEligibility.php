...
class GoogleCloudChannelV1TransferEligibility extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1TransferEligibility::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1TransferEligibility');
