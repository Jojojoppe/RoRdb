...
class GoogleCloudChannelV1CloudIdentityInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1CloudIdentityInfo::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1CloudIdentityInfo');
