...
class GoogleCloudChannelV1ImportCustomerRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1ImportCustomerRequest::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1ImportCustomerRequest');
