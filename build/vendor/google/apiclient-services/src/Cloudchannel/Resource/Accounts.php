...
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1CheckCloudIdentityAccountsExistResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListSubscribersResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListTransferableOffersRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListTransferableOffersResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListTransferableSkusRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListTransferableSkusResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1RegisterSubscriberRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1RegisterSubscriberResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1UnregisterSubscriberRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1UnregisterSubscriberResponse;
/**
...
\class_alias(Accounts::class, 'RoRdb\\Google_Service_Cloudchannel_Resource_Accounts');
