...
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1Customer;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ImportCustomerRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListCustomersResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListPurchasableOffersResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListPurchasableSkusResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ProvisionCloudIdentityRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1TransferEntitlementsRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1TransferEntitlementsToGoogleRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleLongrunningOperation;
use RoRdb\Google\Service\Cloudchannel\GoogleProtobufEmpty;
/**
 ...
 *  </code>
 */
class AccountsCustomers extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(AccountsCustomers::class, 'RoRdb\\Google_Service_Cloudchannel_Resource_AccountsCustomers');
