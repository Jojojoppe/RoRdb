 ...
 * the License.
 */
namespace RoRdb\Google\Service\Cloudchannel\Resource;

use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ActivateEntitlementRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1CancelEntitlementRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ChangeOfferRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ChangeParametersRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ChangeRenewalSettingsRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1CreateEntitlementRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1Entitlement;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1ListEntitlementsResponse;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1Offer;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1StartPaidServiceRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleCloudChannelV1SuspendEntitlementRequest;
use RoRdb\Google\Service\Cloudchannel\GoogleLongrunningOperation;
/**
 ...
 *  </code>
 */
class AccountsCustomersEntitlements extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(AccountsCustomersEntitlements::class, 'RoRdb\\Google_Service_Cloudchannel_Resource_AccountsCustomersEntitlements');
