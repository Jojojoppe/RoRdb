...
class GoogleCloudChannelV1Plan extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudChannelV1Plan::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1Plan');
