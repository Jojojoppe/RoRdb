...
class GoogleCloudChannelV1RenewalSettings extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudChannelV1RenewalSettings::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1RenewalSettings');
