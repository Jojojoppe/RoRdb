...
class GoogleCloudChannelV1PriceTier extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudChannelV1PriceTier::class, 'RoRdb\\Google_Service_Cloudchannel_GoogleCloudChannelV1PriceTier');
