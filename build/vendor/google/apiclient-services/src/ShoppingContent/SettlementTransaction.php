...
class SettlementTransaction extends \RoRdb\Google\Model
{
...
\class_alias(SettlementTransaction::class, 'RoRdb\\Google_Service_ShoppingContent_SettlementTransaction');
