...
class DatafeedsCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedsCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedsCustomBatchRequestEntry');
