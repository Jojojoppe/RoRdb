...
class ReturnPolicyOnlineReturnReasonCategoryInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnPolicyOnlineReturnReasonCategoryInfo::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnPolicyOnlineReturnReasonCategoryInfo');
