...
class TestOrderPickupDetails extends \RoRdb\Google\Collection
{
...
\class_alias(TestOrderPickupDetails::class, 'RoRdb\\Google_Service_ShoppingContent_TestOrderPickupDetails');
