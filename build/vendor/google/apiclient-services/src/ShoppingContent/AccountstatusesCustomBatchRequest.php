...
class AccountstatusesCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AccountstatusesCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_AccountstatusesCustomBatchRequest');
