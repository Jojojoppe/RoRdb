...
class RepricingRuleStatsBasedRule extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleStatsBasedRule::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleStatsBasedRule');
