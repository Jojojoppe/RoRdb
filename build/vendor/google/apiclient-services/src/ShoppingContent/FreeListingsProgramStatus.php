...
class FreeListingsProgramStatus extends \RoRdb\Google\Collection
{
...
\class_alias(FreeListingsProgramStatus::class, 'RoRdb\\Google_Service_ShoppingContent_FreeListingsProgramStatus');
