...
class PubsubNotificationSettings extends \RoRdb\Google\Collection
{
...
\class_alias(PubsubNotificationSettings::class, 'RoRdb\\Google_Service_ShoppingContent_PubsubNotificationSettings');
