...
class DatafeedFetchSchedule extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedFetchSchedule::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedFetchSchedule');
