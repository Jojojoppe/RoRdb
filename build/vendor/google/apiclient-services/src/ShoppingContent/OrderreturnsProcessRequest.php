...
class OrderreturnsProcessRequest extends \RoRdb\Google\Collection
{
...
\class_alias(OrderreturnsProcessRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrderreturnsProcessRequest');
