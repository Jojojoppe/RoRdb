...
class AccountstatusesCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccountstatusesCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_AccountstatusesCustomBatchResponse');
