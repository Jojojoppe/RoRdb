...
class OrderCustomerMarketingRightsInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderCustomerMarketingRightsInfo::class, 'RoRdb\\Google_Service_ShoppingContent_OrderCustomerMarketingRightsInfo');
