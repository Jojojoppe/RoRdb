...
class ShippingsettingsCustomBatchResponseEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ShippingsettingsCustomBatchResponseEntry::class, 'RoRdb\\Google_Service_ShoppingContent_ShippingsettingsCustomBatchResponseEntry');
