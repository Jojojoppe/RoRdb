...
class AccounttaxCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccounttaxCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_AccounttaxCustomBatchRequestEntry');
