...
class MerchantOrderReturnItem extends \RoRdb\Google\Collection
{
...
\class_alias(MerchantOrderReturnItem::class, 'RoRdb\\Google_Service_ShoppingContent_MerchantOrderReturnItem');
