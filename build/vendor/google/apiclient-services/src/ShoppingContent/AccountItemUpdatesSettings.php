...
class AccountItemUpdatesSettings extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountItemUpdatesSettings::class, 'RoRdb\\Google_Service_ShoppingContent_AccountItemUpdatesSettings');
