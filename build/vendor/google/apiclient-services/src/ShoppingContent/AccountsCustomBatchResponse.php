...
class AccountsCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccountsCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_AccountsCustomBatchResponse');
