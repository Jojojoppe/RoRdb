...
class OrdersRefundItemRequest extends \RoRdb\Google\Collection
{
...
\class_alias(OrdersRefundItemRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersRefundItemRequest');
