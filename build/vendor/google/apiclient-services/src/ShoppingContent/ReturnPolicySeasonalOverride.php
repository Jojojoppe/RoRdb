...
class ReturnPolicySeasonalOverride extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnPolicySeasonalOverride::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnPolicySeasonalOverride');
