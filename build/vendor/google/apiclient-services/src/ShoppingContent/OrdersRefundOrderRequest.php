...
class OrdersRefundOrderRequest extends \RoRdb\Google\Model
{
...
\class_alias(OrdersRefundOrderRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersRefundOrderRequest');
