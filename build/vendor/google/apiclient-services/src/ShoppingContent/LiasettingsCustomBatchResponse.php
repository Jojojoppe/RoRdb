...
class LiasettingsCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LiasettingsCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_LiasettingsCustomBatchResponse');
