...
class PosCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(PosCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_PosCustomBatchRequest');
