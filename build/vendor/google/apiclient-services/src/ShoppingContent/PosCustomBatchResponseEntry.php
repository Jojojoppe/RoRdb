...
class PosCustomBatchResponseEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PosCustomBatchResponseEntry::class, 'RoRdb\\Google_Service_ShoppingContent_PosCustomBatchResponseEntry');
