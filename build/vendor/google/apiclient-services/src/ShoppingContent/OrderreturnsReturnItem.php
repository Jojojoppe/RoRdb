...
class OrderreturnsReturnItem extends \RoRdb\Google\Model
{
...
\class_alias(OrderreturnsReturnItem::class, 'RoRdb\\Google_Service_ShoppingContent_OrderreturnsReturnItem');
