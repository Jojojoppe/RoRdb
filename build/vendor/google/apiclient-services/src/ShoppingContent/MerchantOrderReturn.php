...
class MerchantOrderReturn extends \RoRdb\Google\Collection
{
...
\class_alias(MerchantOrderReturn::class, 'RoRdb\\Google_Service_ShoppingContent_MerchantOrderReturn');
