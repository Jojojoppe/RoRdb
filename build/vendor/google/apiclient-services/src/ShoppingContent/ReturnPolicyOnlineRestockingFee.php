...
class ReturnPolicyOnlineRestockingFee extends \RoRdb\Google\Model
{
...
\class_alias(ReturnPolicyOnlineRestockingFee::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnPolicyOnlineRestockingFee');
