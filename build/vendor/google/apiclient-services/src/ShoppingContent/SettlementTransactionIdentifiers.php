...
class SettlementTransactionIdentifiers extends \RoRdb\Google\Collection
{
...
\class_alias(SettlementTransactionIdentifiers::class, 'RoRdb\\Google_Service_ShoppingContent_SettlementTransactionIdentifiers');
