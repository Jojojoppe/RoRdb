...
class ProductsCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ProductsCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ProductsCustomBatchResponse');
