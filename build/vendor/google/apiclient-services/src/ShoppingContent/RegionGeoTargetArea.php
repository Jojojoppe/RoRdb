...
class RegionGeoTargetArea extends \RoRdb\Google\Collection
{
...
\class_alias(RegionGeoTargetArea::class, 'RoRdb\\Google_Service_ShoppingContent_RegionGeoTargetArea');
