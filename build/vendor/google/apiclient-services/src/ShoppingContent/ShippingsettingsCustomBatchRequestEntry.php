...
class ShippingsettingsCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ShippingsettingsCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_ShippingsettingsCustomBatchRequestEntry');
