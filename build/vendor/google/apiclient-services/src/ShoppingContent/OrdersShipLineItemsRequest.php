...
class OrdersShipLineItemsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(OrdersShipLineItemsRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersShipLineItemsRequest');
