...
class DatafeedstatusesCustomBatchResponseEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedstatusesCustomBatchResponseEntry::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedstatusesCustomBatchResponseEntry');
