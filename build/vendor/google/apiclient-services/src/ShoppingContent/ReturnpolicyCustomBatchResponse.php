...
class ReturnpolicyCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReturnpolicyCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchResponse');
