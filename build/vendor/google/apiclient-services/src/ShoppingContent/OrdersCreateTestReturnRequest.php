...
class OrdersCreateTestReturnRequest extends \RoRdb\Google\Collection
{
...
\class_alias(OrdersCreateTestReturnRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersCreateTestReturnRequest');
