...
class AccountsCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AccountsCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_AccountsCustomBatchRequest');
