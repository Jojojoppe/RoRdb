...
class OrdersSetLineItemMetadataRequest extends \RoRdb\Google\Collection
{
...
\class_alias(OrdersSetLineItemMetadataRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersSetLineItemMetadataRequest');
