...
class AccountAutomaticImprovements extends \RoRdb\Google\Model
{
...
\class_alias(AccountAutomaticImprovements::class, 'RoRdb\\Google_Service_ShoppingContent_AccountAutomaticImprovements');
