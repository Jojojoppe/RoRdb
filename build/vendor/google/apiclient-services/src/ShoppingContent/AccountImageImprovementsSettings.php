...
class AccountImageImprovementsSettings extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountImageImprovementsSettings::class, 'RoRdb\\Google_Service_ShoppingContent_AccountImageImprovementsSettings');
