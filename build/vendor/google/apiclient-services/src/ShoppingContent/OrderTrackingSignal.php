...
class OrderTrackingSignal extends \RoRdb\Google\Collection
{
...
\class_alias(OrderTrackingSignal::class, 'RoRdb\\Google_Service_ShoppingContent_OrderTrackingSignal');
