...
class ReturnpolicyCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnpolicyCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchRequestEntry');
