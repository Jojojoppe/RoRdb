...
class ProductstatusesCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ProductstatusesCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_ProductstatusesCustomBatchRequest');
