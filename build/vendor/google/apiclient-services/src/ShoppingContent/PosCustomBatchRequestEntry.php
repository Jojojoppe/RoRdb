...
class PosCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PosCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_PosCustomBatchRequestEntry');
