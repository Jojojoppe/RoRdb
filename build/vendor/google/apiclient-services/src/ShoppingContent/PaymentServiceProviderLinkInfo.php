...
class PaymentServiceProviderLinkInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PaymentServiceProviderLinkInfo::class, 'RoRdb\\Google_Service_ShoppingContent_PaymentServiceProviderLinkInfo');
