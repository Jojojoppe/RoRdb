...
class AccountsLinkRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AccountsLinkRequest::class, 'RoRdb\\Google_Service_ShoppingContent_AccountsLinkRequest');
