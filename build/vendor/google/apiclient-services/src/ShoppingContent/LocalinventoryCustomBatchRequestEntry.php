...
class LocalinventoryCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LocalinventoryCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_LocalinventoryCustomBatchRequestEntry');
