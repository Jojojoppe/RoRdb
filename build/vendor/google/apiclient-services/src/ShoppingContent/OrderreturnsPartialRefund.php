...
class OrderreturnsPartialRefund extends \RoRdb\Google\Model
{
...
\class_alias(OrderreturnsPartialRefund::class, 'RoRdb\\Google_Service_ShoppingContent_OrderreturnsPartialRefund');
