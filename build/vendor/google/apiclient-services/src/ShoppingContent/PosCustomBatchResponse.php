...
class PosCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PosCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_PosCustomBatchResponse');
