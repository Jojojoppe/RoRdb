...
class OrdersUpdateLineItemShippingDetailsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersUpdateLineItemShippingDetailsRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersUpdateLineItemShippingDetailsRequest');
