...
class RepricingRuleEligibleOfferMatcher extends \RoRdb\Google\Model
{
...
\class_alias(RepricingRuleEligibleOfferMatcher::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleEligibleOfferMatcher');
