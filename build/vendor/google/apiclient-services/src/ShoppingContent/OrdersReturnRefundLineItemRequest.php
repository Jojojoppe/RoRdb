...
class OrdersReturnRefundLineItemRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersReturnRefundLineItemRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersReturnRefundLineItemRequest');
