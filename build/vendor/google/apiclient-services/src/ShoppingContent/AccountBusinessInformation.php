...
class AccountBusinessInformation extends \RoRdb\Google\Model
{
...
\class_alias(AccountBusinessInformation::class, 'RoRdb\\Google_Service_ShoppingContent_AccountBusinessInformation');
