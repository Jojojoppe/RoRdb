...
class VerifyPhoneNumberResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VerifyPhoneNumberResponse::class, 'RoRdb\\Google_Service_ShoppingContent_VerifyPhoneNumberResponse');
