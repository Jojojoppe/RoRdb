...
class UnitInvoiceAdditionalCharge extends \RoRdb\Google\Model
{
...
\class_alias(UnitInvoiceAdditionalCharge::class, 'RoRdb\\Google_Service_ShoppingContent_UnitInvoiceAdditionalCharge');
