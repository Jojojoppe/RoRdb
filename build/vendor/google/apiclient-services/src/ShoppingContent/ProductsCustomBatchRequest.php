...
class ProductsCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ProductsCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_ProductsCustomBatchRequest');
