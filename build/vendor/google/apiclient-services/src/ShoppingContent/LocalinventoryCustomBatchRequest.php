...
class LocalinventoryCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(LocalinventoryCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_LocalinventoryCustomBatchRequest');
