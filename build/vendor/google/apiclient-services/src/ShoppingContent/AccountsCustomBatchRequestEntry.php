...
class AccountsCustomBatchRequestEntry extends \RoRdb\Google\Collection
{
...
\class_alias(AccountsCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_AccountsCustomBatchRequestEntry');
