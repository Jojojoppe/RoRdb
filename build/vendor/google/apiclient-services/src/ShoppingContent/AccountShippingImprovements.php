...
class AccountShippingImprovements extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountShippingImprovements::class, 'RoRdb\\Google_Service_ShoppingContent_AccountShippingImprovements');
