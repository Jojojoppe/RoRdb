...
class OrderTrackingSignalShippingInfo extends \RoRdb\Google\Model
{
...
\class_alias(OrderTrackingSignalShippingInfo::class, 'RoRdb\\Google_Service_ShoppingContent_OrderTrackingSignalShippingInfo');
