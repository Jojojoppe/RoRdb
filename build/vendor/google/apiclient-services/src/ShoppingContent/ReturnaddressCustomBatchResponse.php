...
class ReturnaddressCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReturnaddressCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnaddressCustomBatchResponse');
