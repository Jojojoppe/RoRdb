...
class SettlementTransactionAmount extends \RoRdb\Google\Model
{
...
\class_alias(SettlementTransactionAmount::class, 'RoRdb\\Google_Service_ShoppingContent_SettlementTransactionAmount');
