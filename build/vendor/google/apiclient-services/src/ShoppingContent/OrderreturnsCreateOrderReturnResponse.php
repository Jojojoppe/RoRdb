...
class OrderreturnsCreateOrderReturnResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderreturnsCreateOrderReturnResponse::class, 'RoRdb\\Google_Service_ShoppingContent_OrderreturnsCreateOrderReturnResponse');
