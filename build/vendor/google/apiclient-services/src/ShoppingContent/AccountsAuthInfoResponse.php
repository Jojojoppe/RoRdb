...
class AccountsAuthInfoResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccountsAuthInfoResponse::class, 'RoRdb\\Google_Service_ShoppingContent_AccountsAuthInfoResponse');
