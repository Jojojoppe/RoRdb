...
class VerifyPhoneNumberRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VerifyPhoneNumberRequest::class, 'RoRdb\\Google_Service_ShoppingContent_VerifyPhoneNumberRequest');
