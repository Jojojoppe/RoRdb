...
class ReturnaddressCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReturnaddressCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnaddressCustomBatchRequest');
