...
class LiasettingsCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiasettingsCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_LiasettingsCustomBatchRequestEntry');
