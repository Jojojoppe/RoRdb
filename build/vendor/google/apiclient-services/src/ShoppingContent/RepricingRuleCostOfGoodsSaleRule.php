...
class RepricingRuleCostOfGoodsSaleRule extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleCostOfGoodsSaleRule::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleCostOfGoodsSaleRule');
