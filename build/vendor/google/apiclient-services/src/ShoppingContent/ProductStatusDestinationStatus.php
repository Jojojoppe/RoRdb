...
class ProductStatusDestinationStatus extends \RoRdb\Google\Collection
{
...
\class_alias(ProductStatusDestinationStatus::class, 'RoRdb\\Google_Service_ShoppingContent_ProductStatusDestinationStatus');
