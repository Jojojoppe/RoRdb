...
class MinimumOrderValueTable extends \RoRdb\Google\Collection
{
...
\class_alias(MinimumOrderValueTable::class, 'RoRdb\\Google_Service_ShoppingContent_MinimumOrderValueTable');
