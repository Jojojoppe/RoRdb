...
class DatafeedsCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DatafeedsCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedsCustomBatchResponse');
