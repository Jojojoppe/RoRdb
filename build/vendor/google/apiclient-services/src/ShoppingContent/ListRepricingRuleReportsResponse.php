...
class ListRepricingRuleReportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRepricingRuleReportsResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ListRepricingRuleReportsResponse');
