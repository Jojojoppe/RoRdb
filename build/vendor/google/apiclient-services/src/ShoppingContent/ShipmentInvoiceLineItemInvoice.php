...
class ShipmentInvoiceLineItemInvoice extends \RoRdb\Google\Collection
{
...
\class_alias(ShipmentInvoiceLineItemInvoice::class, 'RoRdb\\Google_Service_ShoppingContent_ShipmentInvoiceLineItemInvoice');
