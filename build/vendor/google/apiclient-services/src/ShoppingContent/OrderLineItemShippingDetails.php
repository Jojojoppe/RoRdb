...
class OrderLineItemShippingDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderLineItemShippingDetails::class, 'RoRdb\\Google_Service_ShoppingContent_OrderLineItemShippingDetails');
