...
class AccountGoogleMyBusinessLink extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountGoogleMyBusinessLink::class, 'RoRdb\\Google_Service_ShoppingContent_AccountGoogleMyBusinessLink');
