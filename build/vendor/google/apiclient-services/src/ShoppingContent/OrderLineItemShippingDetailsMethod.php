...
class OrderLineItemShippingDetailsMethod extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderLineItemShippingDetailsMethod::class, 'RoRdb\\Google_Service_ShoppingContent_OrderLineItemShippingDetailsMethod');
