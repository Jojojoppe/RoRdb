...
class LiasettingsCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(LiasettingsCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_LiasettingsCustomBatchRequest');
