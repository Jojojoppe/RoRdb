...
class ListReturnPolicyOnlineResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListReturnPolicyOnlineResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ListReturnPolicyOnlineResponse');
