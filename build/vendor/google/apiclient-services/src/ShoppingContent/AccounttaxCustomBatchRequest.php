...
class AccounttaxCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(AccounttaxCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_AccounttaxCustomBatchRequest');
