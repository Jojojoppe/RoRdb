...
class TransitTableTransitTimeRowTransitTimeValue extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TransitTableTransitTimeRowTransitTimeValue::class, 'RoRdb\\Google_Service_ShoppingContent_TransitTableTransitTimeRowTransitTimeValue');
