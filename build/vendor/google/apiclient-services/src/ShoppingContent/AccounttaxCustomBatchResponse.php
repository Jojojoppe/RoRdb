...
class AccounttaxCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccounttaxCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_AccounttaxCustomBatchResponse');
