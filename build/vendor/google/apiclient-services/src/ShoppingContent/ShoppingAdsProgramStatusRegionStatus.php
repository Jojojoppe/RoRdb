...
class ShoppingAdsProgramStatusRegionStatus extends \RoRdb\Google\Collection
{
...
\class_alias(ShoppingAdsProgramStatusRegionStatus::class, 'RoRdb\\Google_Service_ShoppingContent_ShoppingAdsProgramStatusRegionStatus');
