...
class ReturnaddressCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnaddressCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnaddressCustomBatchRequestEntry');
