...
class ListAccountReturnCarrierResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAccountReturnCarrierResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ListAccountReturnCarrierResponse');
