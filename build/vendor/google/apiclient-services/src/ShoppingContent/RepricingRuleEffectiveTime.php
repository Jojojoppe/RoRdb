...
class RepricingRuleEffectiveTime extends \RoRdb\Google\Collection
{
...
\class_alias(RepricingRuleEffectiveTime::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleEffectiveTime');
