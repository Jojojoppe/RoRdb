...
class WarehouseBasedDeliveryTime extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(WarehouseBasedDeliveryTime::class, 'RoRdb\\Google_Service_ShoppingContent_WarehouseBasedDeliveryTime');
