...
class RequestPhoneVerificationRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RequestPhoneVerificationRequest::class, 'RoRdb\\Google_Service_ShoppingContent_RequestPhoneVerificationRequest');
