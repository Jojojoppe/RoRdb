...
class OrderreturnsRefundOperation extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(OrderreturnsRefundOperation::class, 'RoRdb\\Google_Service_ShoppingContent_OrderreturnsRefundOperation');
