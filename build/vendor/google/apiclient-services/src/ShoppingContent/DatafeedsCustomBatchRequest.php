...
class DatafeedsCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(DatafeedsCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedsCustomBatchRequest');
