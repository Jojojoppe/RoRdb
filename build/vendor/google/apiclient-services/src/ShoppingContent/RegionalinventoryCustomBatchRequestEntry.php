...
class RegionalinventoryCustomBatchRequestEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RegionalinventoryCustomBatchRequestEntry::class, 'RoRdb\\Google_Service_ShoppingContent_RegionalinventoryCustomBatchRequestEntry');
