...
class LocalinventoryCustomBatchResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LocalinventoryCustomBatchResponse::class, 'RoRdb\\Google_Service_ShoppingContent_LocalinventoryCustomBatchResponse');
