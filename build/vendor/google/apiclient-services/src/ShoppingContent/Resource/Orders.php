 ...
 * the License.
 */
namespace RoRdb\Google\Service\ShoppingContent\Resource;

use RoRdb\Google\Service\ShoppingContent\CaptureOrderRequest;
use RoRdb\Google\Service\ShoppingContent\CaptureOrderResponse;
use RoRdb\Google\Service\ShoppingContent\Order;
use RoRdb\Google\Service\ShoppingContent\OrdersAcknowledgeRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersAcknowledgeResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersAdvanceTestOrderResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelLineItemRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelLineItemResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelTestOrderByCustomerRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersCancelTestOrderByCustomerResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersCreateTestOrderRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersCreateTestOrderResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersCreateTestReturnRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersCreateTestReturnResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersGetByMerchantOrderIdResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersGetTestOrderTemplateResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersInStoreRefundLineItemRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersInStoreRefundLineItemResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersListResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersRefundItemRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersRefundItemResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersRefundOrderRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersRefundOrderResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersRejectReturnLineItemRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersRejectReturnLineItemResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersReturnRefundLineItemRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersReturnRefundLineItemResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersSetLineItemMetadataRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersSetLineItemMetadataResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersShipLineItemsRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersShipLineItemsResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateLineItemShippingDetailsRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateLineItemShippingDetailsResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateMerchantOrderIdRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateMerchantOrderIdResponse;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateShipmentRequest;
use RoRdb\Google\Service\ShoppingContent\OrdersUpdateShipmentResponse;
/**
 ...
 *  </code>
 */
class Orders extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Orders::class, 'RoRdb\\Google_Service_ShoppingContent_Resource_Orders');
