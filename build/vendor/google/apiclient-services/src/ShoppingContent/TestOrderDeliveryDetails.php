...
class TestOrderDeliveryDetails extends \RoRdb\Google\Model
{
...
\class_alias(TestOrderDeliveryDetails::class, 'RoRdb\\Google_Service_ShoppingContent_TestOrderDeliveryDetails');
