...
class AccountImageImprovements extends \RoRdb\Google\Model
{
...
\class_alias(AccountImageImprovements::class, 'RoRdb\\Google_Service_ShoppingContent_AccountImageImprovements');
