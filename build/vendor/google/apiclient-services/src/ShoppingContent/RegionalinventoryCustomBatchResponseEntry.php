...
class RegionalinventoryCustomBatchResponseEntry extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RegionalinventoryCustomBatchResponseEntry::class, 'RoRdb\\Google_Service_ShoppingContent_RegionalinventoryCustomBatchResponseEntry');
