...
class ReturnpolicyCustomBatchRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReturnpolicyCustomBatchRequest::class, 'RoRdb\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchRequest');
