...
class RepricingRuleReportBuyboxWinningRuleStats extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleReportBuyboxWinningRuleStats::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleReportBuyboxWinningRuleStats');
