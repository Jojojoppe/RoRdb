...
class LiaOnDisplayToOrderSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiaOnDisplayToOrderSettings::class, 'RoRdb\\Google_Service_ShoppingContent_LiaOnDisplayToOrderSettings');
