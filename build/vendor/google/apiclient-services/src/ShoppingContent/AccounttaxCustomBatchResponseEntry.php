...
class AccounttaxCustomBatchResponseEntry extends \RoRdb\Google\Model
{
...
\class_alias(AccounttaxCustomBatchResponseEntry::class, 'RoRdb\\Google_Service_ShoppingContent_AccounttaxCustomBatchResponseEntry');
