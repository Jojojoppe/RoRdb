...
class RepricingRuleReport extends \RoRdb\Google\Collection
{
...
\class_alias(RepricingRuleReport::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleReport');
