...
class DatafeedStatusError extends \RoRdb\Google\Collection
{
...
\class_alias(DatafeedStatusError::class, 'RoRdb\\Google_Service_ShoppingContent_DatafeedStatusError');
