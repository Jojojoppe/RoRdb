...
class RepricingRuleRestrictionBoundary extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleRestrictionBoundary::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleRestrictionBoundary');
