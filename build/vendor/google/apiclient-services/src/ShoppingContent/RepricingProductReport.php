...
class RepricingProductReport extends \RoRdb\Google\Collection
{
...
\class_alias(RepricingProductReport::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingProductReport');
