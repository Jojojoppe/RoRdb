...
class BuyOnGoogleProgramStatus extends \RoRdb\Google\Collection
{
...
\class_alias(BuyOnGoogleProgramStatus::class, 'RoRdb\\Google_Service_ShoppingContent_BuyOnGoogleProgramStatus');
