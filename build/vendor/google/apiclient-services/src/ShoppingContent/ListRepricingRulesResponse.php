...
class ListRepricingRulesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRepricingRulesResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ListRepricingRulesResponse');
