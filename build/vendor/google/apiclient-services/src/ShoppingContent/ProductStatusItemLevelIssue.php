...
class ProductStatusItemLevelIssue extends \RoRdb\Google\Collection
{
...
\class_alias(ProductStatusItemLevelIssue::class, 'RoRdb\\Google_Service_ShoppingContent_ProductStatusItemLevelIssue');
