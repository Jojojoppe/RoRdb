...
class OrderLineItemAdjustment extends \RoRdb\Google\Model
{
...
\class_alias(OrderLineItemAdjustment::class, 'RoRdb\\Google_Service_ShoppingContent_OrderLineItemAdjustment');
