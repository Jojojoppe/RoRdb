...
class FreeListingsProgramStatusRegionStatus extends \RoRdb\Google\Collection
{
...
\class_alias(FreeListingsProgramStatusRegionStatus::class, 'RoRdb\\Google_Service_ShoppingContent_FreeListingsProgramStatusRegionStatus');
