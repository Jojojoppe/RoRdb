...
class RegionPostalCodeArea extends \RoRdb\Google\Collection
{
...
\class_alias(RegionPostalCodeArea::class, 'RoRdb\\Google_Service_ShoppingContent_RegionPostalCodeArea');
