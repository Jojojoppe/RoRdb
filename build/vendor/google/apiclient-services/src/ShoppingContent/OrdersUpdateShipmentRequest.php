...
class OrdersUpdateShipmentRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersUpdateShipmentRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersUpdateShipmentRequest');
