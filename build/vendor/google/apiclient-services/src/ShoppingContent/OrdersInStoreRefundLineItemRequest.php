...
class OrdersInStoreRefundLineItemRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersInStoreRefundLineItemRequest::class, 'RoRdb\\Google_Service_ShoppingContent_OrdersInStoreRefundLineItemRequest');
