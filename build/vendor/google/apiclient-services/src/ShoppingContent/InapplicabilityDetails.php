...
class InapplicabilityDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InapplicabilityDetails::class, 'RoRdb\\Google_Service_ShoppingContent_InapplicabilityDetails');
