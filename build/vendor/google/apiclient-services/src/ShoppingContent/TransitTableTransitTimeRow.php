...
class TransitTableTransitTimeRow extends \RoRdb\Google\Collection
{
...
\class_alias(TransitTableTransitTimeRow::class, 'RoRdb\\Google_Service_ShoppingContent_TransitTableTransitTimeRow');
