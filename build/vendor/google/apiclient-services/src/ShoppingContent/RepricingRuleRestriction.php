...
class RepricingRuleRestriction extends \RoRdb\Google\Model
{
...
\class_alias(RepricingRuleRestriction::class, 'RoRdb\\Google_Service_ShoppingContent_RepricingRuleRestriction');
