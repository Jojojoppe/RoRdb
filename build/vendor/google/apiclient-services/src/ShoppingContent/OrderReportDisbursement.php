...
class OrderReportDisbursement extends \RoRdb\Google\Model
{
...
\class_alias(OrderReportDisbursement::class, 'RoRdb\\Google_Service_ShoppingContent_OrderReportDisbursement');
