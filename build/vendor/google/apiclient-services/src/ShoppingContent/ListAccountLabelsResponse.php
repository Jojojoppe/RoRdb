...
class ListAccountLabelsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAccountLabelsResponse::class, 'RoRdb\\Google_Service_ShoppingContent_ListAccountLabelsResponse');
