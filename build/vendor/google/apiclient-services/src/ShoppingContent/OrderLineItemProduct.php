...
class OrderLineItemProduct extends \RoRdb\Google\Collection
{
...
\class_alias(OrderLineItemProduct::class, 'RoRdb\\Google_Service_ShoppingContent_OrderLineItemProduct');
