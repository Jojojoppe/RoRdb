...
class TestOrderLineItemProduct extends \RoRdb\Google\Collection
{
...
\class_alias(TestOrderLineItemProduct::class, 'RoRdb\\Google_Service_ShoppingContent_TestOrderLineItemProduct');
