...
class AccountStatusProducts extends \RoRdb\Google\Collection
{
...
\class_alias(AccountStatusProducts::class, 'RoRdb\\Google_Service_ShoppingContent_AccountStatusProducts');
