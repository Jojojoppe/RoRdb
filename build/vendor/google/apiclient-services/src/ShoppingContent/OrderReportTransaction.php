...
class OrderReportTransaction extends \RoRdb\Google\Model
{
...
\class_alias(OrderReportTransaction::class, 'RoRdb\\Google_Service_ShoppingContent_OrderReportTransaction');
