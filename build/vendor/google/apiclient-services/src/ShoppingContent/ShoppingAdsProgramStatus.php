...
class ShoppingAdsProgramStatus extends \RoRdb\Google\Collection
{
...
\class_alias(ShoppingAdsProgramStatus::class, 'RoRdb\\Google_Service_ShoppingContent_ShoppingAdsProgramStatus');
