...
class AnnotateTextResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AnnotateTextResponse::class, 'RoRdb\\Google_Service_CloudNaturalLanguage_AnnotateTextResponse');
