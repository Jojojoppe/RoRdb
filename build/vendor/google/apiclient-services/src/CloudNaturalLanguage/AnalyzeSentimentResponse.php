...
class AnalyzeSentimentResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AnalyzeSentimentResponse::class, 'RoRdb\\Google_Service_CloudNaturalLanguage_AnalyzeSentimentResponse');
