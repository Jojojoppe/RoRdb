 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudNaturalLanguage\Resource;

use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeEntitiesRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeEntitiesResponse;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeEntitySentimentRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeEntitySentimentResponse;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeSentimentRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeSentimentResponse;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeSyntaxRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\AnalyzeSyntaxResponse;
use RoRdb\Google\Service\CloudNaturalLanguage\AnnotateTextRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\AnnotateTextResponse;
use RoRdb\Google\Service\CloudNaturalLanguage\ClassifyTextRequest;
use RoRdb\Google\Service\CloudNaturalLanguage\ClassifyTextResponse;
/**
 ...
 *  </code>
 */
class Documents extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Documents::class, 'RoRdb\\Google_Service_CloudNaturalLanguage_Resource_Documents');
