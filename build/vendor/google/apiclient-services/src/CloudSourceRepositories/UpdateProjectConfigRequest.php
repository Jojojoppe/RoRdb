...
class UpdateProjectConfigRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateProjectConfigRequest::class, 'RoRdb\\Google_Service_CloudSourceRepositories_UpdateProjectConfigRequest');
