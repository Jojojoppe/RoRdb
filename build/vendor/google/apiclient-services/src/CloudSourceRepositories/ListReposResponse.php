...
class ListReposResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListReposResponse::class, 'RoRdb\\Google_Service_CloudSourceRepositories_ListReposResponse');
