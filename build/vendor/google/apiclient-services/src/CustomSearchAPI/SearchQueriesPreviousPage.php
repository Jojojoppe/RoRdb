 ...
 * the License.
 */
namespace RoRdb\Google\Service\CustomSearchAPI;

class SearchQueriesPreviousPage extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SearchQueriesPreviousPage::class, 'RoRdb\\Google_Service_CustomSearchAPI_SearchQueriesPreviousPage');
