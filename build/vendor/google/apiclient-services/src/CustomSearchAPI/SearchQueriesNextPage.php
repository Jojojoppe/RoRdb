...
class SearchQueriesNextPage extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SearchQueriesNextPage::class, 'RoRdb\\Google_Service_CustomSearchAPI_SearchQueriesNextPage');
