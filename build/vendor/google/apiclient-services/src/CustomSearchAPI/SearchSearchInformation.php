...
class SearchSearchInformation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SearchSearchInformation::class, 'RoRdb\\Google_Service_CustomSearchAPI_SearchSearchInformation');
