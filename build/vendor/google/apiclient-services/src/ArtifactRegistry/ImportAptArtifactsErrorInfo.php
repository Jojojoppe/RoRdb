...
class ImportAptArtifactsErrorInfo extends \RoRdb\Google\Model
{
...
\class_alias(ImportAptArtifactsErrorInfo::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportAptArtifactsErrorInfo');
