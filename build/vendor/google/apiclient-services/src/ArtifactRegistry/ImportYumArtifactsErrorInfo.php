...
class ImportYumArtifactsErrorInfo extends \RoRdb\Google\Model
{
...
\class_alias(ImportYumArtifactsErrorInfo::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportYumArtifactsErrorInfo');
