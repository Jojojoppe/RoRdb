...
class ImportAptArtifactsGcsSource extends \RoRdb\Google\Collection
{
...
\class_alias(ImportAptArtifactsGcsSource::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportAptArtifactsGcsSource');
