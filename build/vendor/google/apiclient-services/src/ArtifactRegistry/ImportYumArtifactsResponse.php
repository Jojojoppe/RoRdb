...
class ImportYumArtifactsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ImportYumArtifactsResponse::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportYumArtifactsResponse');
