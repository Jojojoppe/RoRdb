...
class ImportAptArtifactsRequest extends \RoRdb\Google\Model
{
...
\class_alias(ImportAptArtifactsRequest::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportAptArtifactsRequest');
