...
class UploadYumArtifactResponse extends \RoRdb\Google\Collection
{
...
\class_alias(UploadYumArtifactResponse::class, 'RoRdb\\Google_Service_ArtifactRegistry_UploadYumArtifactResponse');
