...
class ListDockerImagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDockerImagesResponse::class, 'RoRdb\\Google_Service_ArtifactRegistry_ListDockerImagesResponse');
