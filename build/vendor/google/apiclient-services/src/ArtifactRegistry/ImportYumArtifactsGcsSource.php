...
class ImportYumArtifactsGcsSource extends \RoRdb\Google\Collection
{
...
\class_alias(ImportYumArtifactsGcsSource::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportYumArtifactsGcsSource');
