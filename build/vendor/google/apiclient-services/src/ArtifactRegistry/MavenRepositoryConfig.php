...
class MavenRepositoryConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(MavenRepositoryConfig::class, 'RoRdb\\Google_Service_ArtifactRegistry_MavenRepositoryConfig');
