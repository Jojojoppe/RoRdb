...
class ImportYumArtifactsRequest extends \RoRdb\Google\Model
{
...
\class_alias(ImportYumArtifactsRequest::class, 'RoRdb\\Google_Service_ArtifactRegistry_ImportYumArtifactsRequest');
