...
class UploadAptArtifactResponse extends \RoRdb\Google\Collection
{
...
\class_alias(UploadAptArtifactResponse::class, 'RoRdb\\Google_Service_ArtifactRegistry_UploadAptArtifactResponse');
