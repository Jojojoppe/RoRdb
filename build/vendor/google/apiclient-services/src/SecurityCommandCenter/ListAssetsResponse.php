...
class ListAssetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAssetsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_ListAssetsResponse');
