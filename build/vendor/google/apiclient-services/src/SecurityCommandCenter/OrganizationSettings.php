...
class OrganizationSettings extends \RoRdb\Google\Model
{
...
\class_alias(OrganizationSettings::class, 'RoRdb\\Google_Service_SecurityCommandCenter_OrganizationSettings');
