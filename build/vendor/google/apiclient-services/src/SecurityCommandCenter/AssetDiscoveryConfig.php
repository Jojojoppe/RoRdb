...
class AssetDiscoveryConfig extends \RoRdb\Google\Collection
{
...
\class_alias(AssetDiscoveryConfig::class, 'RoRdb\\Google_Service_SecurityCommandCenter_AssetDiscoveryConfig');
