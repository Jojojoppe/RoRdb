...
class ListBigQueryExportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBigQueryExportsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_ListBigQueryExportsResponse');
