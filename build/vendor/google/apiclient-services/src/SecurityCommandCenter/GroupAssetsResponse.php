...
class GroupAssetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GroupAssetsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_GroupAssetsResponse');
