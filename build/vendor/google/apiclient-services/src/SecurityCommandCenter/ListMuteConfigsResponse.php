...
class ListMuteConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListMuteConfigsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_ListMuteConfigsResponse');
