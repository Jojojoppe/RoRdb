...
class ListFindingsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFindingsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_ListFindingsResponse');
