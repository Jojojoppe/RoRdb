...
class GroupFindingsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GroupFindingsResponse::class, 'RoRdb\\Google_Service_SecurityCommandCenter_GroupFindingsResponse');
