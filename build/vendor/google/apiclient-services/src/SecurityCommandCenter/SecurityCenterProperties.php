...
class SecurityCenterProperties extends \RoRdb\Google\Collection
{
...
\class_alias(SecurityCenterProperties::class, 'RoRdb\\Google_Service_SecurityCommandCenter_SecurityCenterProperties');
