...
class SecuritycenterResource extends \RoRdb\Google\Collection
{
...
\class_alias(SecuritycenterResource::class, 'RoRdb\\Google_Service_SecurityCommandCenter_SecuritycenterResource');
