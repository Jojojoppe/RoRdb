...
class ListPlaceActionLinksResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPlaceActionLinksResponse::class, 'RoRdb\\Google_Service_MyBusinessPlaceActions_ListPlaceActionLinksResponse');
