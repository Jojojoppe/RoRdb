...
class GoogleSecuritySafebrowsingV4RawHashes extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleSecuritySafebrowsingV4RawHashes::class, 'RoRdb\\Google_Service_Safebrowsing_GoogleSecuritySafebrowsingV4RawHashes');
