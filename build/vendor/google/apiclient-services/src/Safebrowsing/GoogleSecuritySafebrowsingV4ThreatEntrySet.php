...
class GoogleSecuritySafebrowsingV4ThreatEntrySet extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleSecuritySafebrowsingV4ThreatEntrySet::class, 'RoRdb\\Google_Service_Safebrowsing_GoogleSecuritySafebrowsingV4ThreatEntrySet');
