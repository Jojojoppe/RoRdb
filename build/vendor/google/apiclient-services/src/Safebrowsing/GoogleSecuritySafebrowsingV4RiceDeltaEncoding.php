...
class GoogleSecuritySafebrowsingV4RiceDeltaEncoding extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleSecuritySafebrowsingV4RiceDeltaEncoding::class, 'RoRdb\\Google_Service_Safebrowsing_GoogleSecuritySafebrowsingV4RiceDeltaEncoding');
