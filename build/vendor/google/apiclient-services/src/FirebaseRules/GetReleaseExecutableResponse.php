...
class GetReleaseExecutableResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GetReleaseExecutableResponse::class, 'RoRdb\\Google_Service_FirebaseRules_GetReleaseExecutableResponse');
