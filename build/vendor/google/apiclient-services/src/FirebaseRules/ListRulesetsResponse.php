...
class ListRulesetsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRulesetsResponse::class, 'RoRdb\\Google_Service_FirebaseRules_ListRulesetsResponse');
