...
class EntityAdWordsLinkEntity extends \RoRdb\Google\Model
{
...
\class_alias(EntityAdWordsLinkEntity::class, 'RoRdb\\Google_Service_Analytics_EntityAdWordsLinkEntity');
