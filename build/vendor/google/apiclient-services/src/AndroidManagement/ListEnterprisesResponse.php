...
class ListEnterprisesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListEnterprisesResponse::class, 'RoRdb\\Google_Service_AndroidManagement_ListEnterprisesResponse');
