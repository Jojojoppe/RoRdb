...
class OncCertificateProvider extends \RoRdb\Google\Collection
{
...
\class_alias(OncCertificateProvider::class, 'RoRdb\\Google_Service_AndroidManagement_OncCertificateProvider');
