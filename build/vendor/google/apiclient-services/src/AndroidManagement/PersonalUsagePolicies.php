...
class PersonalUsagePolicies extends \RoRdb\Google\Collection
{
...
\class_alias(PersonalUsagePolicies::class, 'RoRdb\\Google_Service_AndroidManagement_PersonalUsagePolicies');
