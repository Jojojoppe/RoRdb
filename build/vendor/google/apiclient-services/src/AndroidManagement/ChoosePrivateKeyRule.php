...
class ChoosePrivateKeyRule extends \RoRdb\Google\Collection
{
...
\class_alias(ChoosePrivateKeyRule::class, 'RoRdb\\Google_Service_AndroidManagement_ChoosePrivateKeyRule');
