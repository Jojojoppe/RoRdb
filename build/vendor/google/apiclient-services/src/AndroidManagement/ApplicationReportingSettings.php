...
class ApplicationReportingSettings extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ApplicationReportingSettings::class, 'RoRdb\\Google_Service_AndroidManagement_ApplicationReportingSettings');
