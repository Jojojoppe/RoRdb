...
class StatusReportingSettings extends \RoRdb\Google\Model
{
...
\class_alias(StatusReportingSettings::class, 'RoRdb\\Google_Service_AndroidManagement_StatusReportingSettings');
