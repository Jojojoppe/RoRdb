...
class CrossProfilePolicies extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CrossProfilePolicies::class, 'RoRdb\\Google_Service_AndroidManagement_CrossProfilePolicies');
