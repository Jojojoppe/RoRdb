...
class PolicyEnforcementRule extends \RoRdb\Google\Model
{
...
\class_alias(PolicyEnforcementRule::class, 'RoRdb\\Google_Service_AndroidManagement_PolicyEnforcementRule');
