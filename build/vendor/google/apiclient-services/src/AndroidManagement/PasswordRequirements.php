...
class PasswordRequirements extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(PasswordRequirements::class, 'RoRdb\\Google_Service_AndroidManagement_PasswordRequirements');
