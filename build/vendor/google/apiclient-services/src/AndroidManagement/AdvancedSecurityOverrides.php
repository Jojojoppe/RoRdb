...
class AdvancedSecurityOverrides extends \RoRdb\Google\Collection
{
...
\class_alias(AdvancedSecurityOverrides::class, 'RoRdb\\Google_Service_AndroidManagement_AdvancedSecurityOverrides');
