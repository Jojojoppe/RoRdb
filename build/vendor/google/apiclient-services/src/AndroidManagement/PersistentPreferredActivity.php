...
class PersistentPreferredActivity extends \RoRdb\Google\Collection
{
...
\class_alias(PersistentPreferredActivity::class, 'RoRdb\\Google_Service_AndroidManagement_PersistentPreferredActivity');
