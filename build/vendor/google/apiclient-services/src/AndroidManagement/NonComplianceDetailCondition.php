...
class NonComplianceDetailCondition extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NonComplianceDetailCondition::class, 'RoRdb\\Google_Service_AndroidManagement_NonComplianceDetailCondition');
