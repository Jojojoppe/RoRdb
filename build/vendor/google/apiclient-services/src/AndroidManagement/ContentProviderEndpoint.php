...
class ContentProviderEndpoint extends \RoRdb\Google\Collection
{
...
\class_alias(ContentProviderEndpoint::class, 'RoRdb\\Google_Service_AndroidManagement_ContentProviderEndpoint');
