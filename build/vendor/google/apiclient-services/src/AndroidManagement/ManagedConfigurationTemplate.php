...
class ManagedConfigurationTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string[]
     */
...
\class_alias(ManagedConfigurationTemplate::class, 'RoRdb\\Google_Service_AndroidManagement_ManagedConfigurationTemplate');
