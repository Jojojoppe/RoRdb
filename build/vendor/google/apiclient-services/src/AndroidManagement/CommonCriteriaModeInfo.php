...
class CommonCriteriaModeInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CommonCriteriaModeInfo::class, 'RoRdb\\Google_Service_AndroidManagement_CommonCriteriaModeInfo');
