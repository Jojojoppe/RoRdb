...
class ListGroupStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGroupStatsResponse::class, 'RoRdb\\Google_Service_Clouderrorreporting_ListGroupStatsResponse');
