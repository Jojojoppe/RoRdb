...
class ListEventsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListEventsResponse::class, 'RoRdb\\Google_Service_Clouderrorreporting_ListEventsResponse');
