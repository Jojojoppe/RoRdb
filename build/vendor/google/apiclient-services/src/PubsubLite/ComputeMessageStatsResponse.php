...
class ComputeMessageStatsResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ComputeMessageStatsResponse::class, 'RoRdb\\Google_Service_PubsubLite_ComputeMessageStatsResponse');
