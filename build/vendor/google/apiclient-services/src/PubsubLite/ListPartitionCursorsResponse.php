...
class ListPartitionCursorsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPartitionCursorsResponse::class, 'RoRdb\\Google_Service_PubsubLite_ListPartitionCursorsResponse');
