...
class SeekSubscriptionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SeekSubscriptionRequest::class, 'RoRdb\\Google_Service_PubsubLite_SeekSubscriptionRequest');
