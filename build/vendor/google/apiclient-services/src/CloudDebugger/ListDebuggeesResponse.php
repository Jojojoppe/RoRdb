...
class ListDebuggeesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDebuggeesResponse::class, 'RoRdb\\Google_Service_CloudDebugger_ListDebuggeesResponse');
