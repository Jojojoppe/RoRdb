...
class SetBreakpointResponse extends \RoRdb\Google\Model
{
...
\class_alias(SetBreakpointResponse::class, 'RoRdb\\Google_Service_CloudDebugger_SetBreakpointResponse');
