...
class ListBreakpointsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBreakpointsResponse::class, 'RoRdb\\Google_Service_CloudDebugger_ListBreakpointsResponse');
