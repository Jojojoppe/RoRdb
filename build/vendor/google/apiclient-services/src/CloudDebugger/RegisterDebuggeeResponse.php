...
class RegisterDebuggeeResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RegisterDebuggeeResponse::class, 'RoRdb\\Google_Service_CloudDebugger_RegisterDebuggeeResponse');
