...
class GetBreakpointResponse extends \RoRdb\Google\Model
{
...
\class_alias(GetBreakpointResponse::class, 'RoRdb\\Google_Service_CloudDebugger_GetBreakpointResponse');
