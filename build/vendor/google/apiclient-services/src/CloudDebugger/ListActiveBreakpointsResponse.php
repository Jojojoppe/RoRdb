...
class ListActiveBreakpointsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListActiveBreakpointsResponse::class, 'RoRdb\\Google_Service_CloudDebugger_ListActiveBreakpointsResponse');
