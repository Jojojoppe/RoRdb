...
class RegisterDebuggeeRequest extends \RoRdb\Google\Model
{
...
\class_alias(RegisterDebuggeeRequest::class, 'RoRdb\\Google_Service_CloudDebugger_RegisterDebuggeeRequest');
