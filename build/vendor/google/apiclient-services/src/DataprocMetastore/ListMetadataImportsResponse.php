 ...
 * the License.
 */
namespace RoRdb\Google\Service\DataprocMetastore;

class ListMetadataImportsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListMetadataImportsResponse::class, 'RoRdb\\Google_Service_DataprocMetastore_ListMetadataImportsResponse');
