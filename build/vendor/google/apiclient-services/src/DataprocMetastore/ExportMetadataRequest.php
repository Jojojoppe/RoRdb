...
class ExportMetadataRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ExportMetadataRequest::class, 'RoRdb\\Google_Service_DataprocMetastore_ExportMetadataRequest');
