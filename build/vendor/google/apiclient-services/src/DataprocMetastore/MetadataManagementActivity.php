...
class MetadataManagementActivity extends \RoRdb\Google\Collection
{
...
\class_alias(MetadataManagementActivity::class, 'RoRdb\\Google_Service_DataprocMetastore_MetadataManagementActivity');
