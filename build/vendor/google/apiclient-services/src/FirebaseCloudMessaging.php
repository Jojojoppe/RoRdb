 ...
 * @author Google, Inc.
 */
class FirebaseCloudMessaging extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->projects_messages = new FirebaseCloudMessaging\Resource\ProjectsMessages($this, $this->serviceName, 'messages', ['methods' => ['send' => ['path' => 'v1/{+parent}/messages:send', 'httpMethod' => 'POST', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(FirebaseCloudMessaging::class, 'RoRdb\\Google_Service_FirebaseCloudMessaging');
