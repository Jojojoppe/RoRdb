...
class ListClientTlsPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListClientTlsPoliciesResponse::class, 'RoRdb\\Google_Service_NetworkSecurity_ListClientTlsPoliciesResponse');
