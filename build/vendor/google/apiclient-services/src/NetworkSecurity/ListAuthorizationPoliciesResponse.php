...
class ListAuthorizationPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAuthorizationPoliciesResponse::class, 'RoRdb\\Google_Service_NetworkSecurity_ListAuthorizationPoliciesResponse');
