...
class ListServerTlsPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListServerTlsPoliciesResponse::class, 'RoRdb\\Google_Service_NetworkSecurity_ListServerTlsPoliciesResponse');
