...
class WriteLogEntriesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(WriteLogEntriesRequest::class, 'RoRdb\\Google_Service_Logging_WriteLogEntriesRequest');
