...
class TailLogEntriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(TailLogEntriesResponse::class, 'RoRdb\\Google_Service_Logging_TailLogEntriesResponse');
