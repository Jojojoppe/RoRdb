 ...
 * the License.
 */
namespace RoRdb\Google\Service\Logging\Resource;

use RoRdb\Google\Service\Logging\CopyLogEntriesRequest;
use RoRdb\Google\Service\Logging\ListLogEntriesRequest;
use RoRdb\Google\Service\Logging\ListLogEntriesResponse;
use RoRdb\Google\Service\Logging\Operation;
use RoRdb\Google\Service\Logging\TailLogEntriesRequest;
use RoRdb\Google\Service\Logging\TailLogEntriesResponse;
use RoRdb\Google\Service\Logging\WriteLogEntriesRequest;
use RoRdb\Google\Service\Logging\WriteLogEntriesResponse;
/**
 ...
 *  </code>
 */
class Entries extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Entries::class, 'RoRdb\\Google_Service_Logging_Resource_Entries');
