...
use RoRdb\Google\Service\Logging\CmekSettings;
use RoRdb\Google\Service\Logging\Settings;
/**
...
\class_alias(BillingAccounts::class, 'RoRdb\\Google_Service_Logging_Resource_BillingAccounts');
