 ...
 * the License.
 */
namespace RoRdb\Google\Service\Logging;
...
\class_alias(ListMonitoredResourceDescriptorsResponse::class, 'RoRdb\\Google_Service_Logging_ListMonitoredResourceDescriptorsResponse');
