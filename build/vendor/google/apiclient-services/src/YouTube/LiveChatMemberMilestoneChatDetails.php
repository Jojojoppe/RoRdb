...
class LiveChatMemberMilestoneChatDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatMemberMilestoneChatDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatMemberMilestoneChatDetails');
