...
class LiveStreamContentDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveStreamContentDetails::class, 'RoRdb\\Google_Service_YouTube_LiveStreamContentDetails');
