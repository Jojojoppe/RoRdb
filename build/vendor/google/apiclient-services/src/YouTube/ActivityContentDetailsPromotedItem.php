...
class ActivityContentDetailsPromotedItem extends \RoRdb\Google\Collection
{
...
\class_alias(ActivityContentDetailsPromotedItem::class, 'RoRdb\\Google_Service_YouTube_ActivityContentDetailsPromotedItem');
