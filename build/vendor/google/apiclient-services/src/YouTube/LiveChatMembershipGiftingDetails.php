...
class LiveChatMembershipGiftingDetails extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(LiveChatMembershipGiftingDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatMembershipGiftingDetails');
