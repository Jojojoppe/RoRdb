...
class LiveBroadcastListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LiveBroadcastListResponse::class, 'RoRdb\\Google_Service_YouTube_LiveBroadcastListResponse');
