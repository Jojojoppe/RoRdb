...
class LiveChatSuperStickerDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatSuperStickerDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatSuperStickerDetails');
