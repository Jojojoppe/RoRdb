...
class ActivityContentDetailsPlaylistItem extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ActivityContentDetailsPlaylistItem::class, 'RoRdb\\Google_Service_YouTube_ActivityContentDetailsPlaylistItem');
