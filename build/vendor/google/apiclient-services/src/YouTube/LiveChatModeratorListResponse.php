...
class LiveChatModeratorListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LiveChatModeratorListResponse::class, 'RoRdb\\Google_Service_YouTube_LiveChatModeratorListResponse');
