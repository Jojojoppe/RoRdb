...
class LiveChatNewSponsorDetails extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(LiveChatNewSponsorDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatNewSponsorDetails');
