...
class ChannelContentOwnerDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ChannelContentOwnerDetails::class, 'RoRdb\\Google_Service_YouTube_ChannelContentOwnerDetails');
