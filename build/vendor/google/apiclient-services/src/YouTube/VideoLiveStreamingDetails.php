...
class VideoLiveStreamingDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VideoLiveStreamingDetails::class, 'RoRdb\\Google_Service_YouTube_VideoLiveStreamingDetails');
