...
class LiveChatMessageRetractedDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatMessageRetractedDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatMessageRetractedDetails');
