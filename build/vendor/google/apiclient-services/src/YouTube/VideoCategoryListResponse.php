...
class VideoCategoryListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(VideoCategoryListResponse::class, 'RoRdb\\Google_Service_YouTube_VideoCategoryListResponse');
