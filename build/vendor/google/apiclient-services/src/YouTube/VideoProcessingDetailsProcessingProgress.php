...
class VideoProcessingDetailsProcessingProgress extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VideoProcessingDetailsProcessingProgress::class, 'RoRdb\\Google_Service_YouTube_VideoProcessingDetailsProcessingProgress');
