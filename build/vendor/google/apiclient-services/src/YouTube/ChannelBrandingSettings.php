...
class ChannelBrandingSettings extends \RoRdb\Google\Collection
{
...
\class_alias(ChannelBrandingSettings::class, 'RoRdb\\Google_Service_YouTube_ChannelBrandingSettings');
