...
class MembershipsDurationAtLevel extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MembershipsDurationAtLevel::class, 'RoRdb\\Google_Service_YouTube_MembershipsDurationAtLevel');
