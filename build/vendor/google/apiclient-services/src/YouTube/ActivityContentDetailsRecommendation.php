...
class ActivityContentDetailsRecommendation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ActivityContentDetailsRecommendation::class, 'RoRdb\\Google_Service_YouTube_ActivityContentDetailsRecommendation');
