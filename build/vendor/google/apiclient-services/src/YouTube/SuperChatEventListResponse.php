...
class SuperChatEventListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SuperChatEventListResponse::class, 'RoRdb\\Google_Service_YouTube_SuperChatEventListResponse');
