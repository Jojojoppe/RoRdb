...
class LiveChatFanFundingEventDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatFanFundingEventDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatFanFundingEventDetails');
