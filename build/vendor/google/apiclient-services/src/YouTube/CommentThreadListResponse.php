...
class CommentThreadListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CommentThreadListResponse::class, 'RoRdb\\Google_Service_YouTube_CommentThreadListResponse');
