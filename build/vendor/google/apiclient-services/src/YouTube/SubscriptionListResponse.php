...
class SubscriptionListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SubscriptionListResponse::class, 'RoRdb\\Google_Service_YouTube_SubscriptionListResponse');
