...
class LiveChatUserBannedMessageDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatUserBannedMessageDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatUserBannedMessageDetails');
