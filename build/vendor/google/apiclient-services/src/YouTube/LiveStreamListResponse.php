...
class LiveStreamListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LiveStreamListResponse::class, 'RoRdb\\Google_Service_YouTube_LiveStreamListResponse');
