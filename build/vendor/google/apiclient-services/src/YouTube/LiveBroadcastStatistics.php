...
class LiveBroadcastStatistics extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveBroadcastStatistics::class, 'RoRdb\\Google_Service_YouTube_LiveBroadcastStatistics');
