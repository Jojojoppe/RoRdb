...
class ChannelConversionPings extends \RoRdb\Google\Collection
{
...
\class_alias(ChannelConversionPings::class, 'RoRdb\\Google_Service_YouTube_ChannelConversionPings');
