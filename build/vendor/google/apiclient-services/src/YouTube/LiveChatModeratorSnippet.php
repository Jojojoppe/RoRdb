...
class LiveChatModeratorSnippet extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatModeratorSnippet::class, 'RoRdb\\Google_Service_YouTube_LiveChatModeratorSnippet');
