...
class PlaylistItemContentDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PlaylistItemContentDetails::class, 'RoRdb\\Google_Service_YouTube_PlaylistItemContentDetails');
