...
class LiveChatSuperChatDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatSuperChatDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatSuperChatDetails');
