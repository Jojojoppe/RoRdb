...
class LiveBroadcastContentDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveBroadcastContentDetails::class, 'RoRdb\\Google_Service_YouTube_LiveBroadcastContentDetails');
