...
class LiveStreamHealthStatus extends \RoRdb\Google\Collection
{
...
\class_alias(LiveStreamHealthStatus::class, 'RoRdb\\Google_Service_YouTube_LiveStreamHealthStatus');
