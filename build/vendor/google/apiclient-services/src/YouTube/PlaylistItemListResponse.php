...
class PlaylistItemListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlaylistItemListResponse::class, 'RoRdb\\Google_Service_YouTube_PlaylistItemListResponse');
