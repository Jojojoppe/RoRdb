...
class LiveChatMessageListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LiveChatMessageListResponse::class, 'RoRdb\\Google_Service_YouTube_LiveChatMessageListResponse');
