...
class VideoAbuseReportReasonSnippet extends \RoRdb\Google\Collection
{
...
\class_alias(VideoAbuseReportReasonSnippet::class, 'RoRdb\\Google_Service_YouTube_VideoAbuseReportReasonSnippet');
