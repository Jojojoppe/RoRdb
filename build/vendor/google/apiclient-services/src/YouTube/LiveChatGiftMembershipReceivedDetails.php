...
class LiveChatGiftMembershipReceivedDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatGiftMembershipReceivedDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatGiftMembershipReceivedDetails');
