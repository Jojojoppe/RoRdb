...
class VideoSuggestionsTagSuggestion extends \RoRdb\Google\Collection
{
...
\class_alias(VideoSuggestionsTagSuggestion::class, 'RoRdb\\Google_Service_YouTube_VideoSuggestionsTagSuggestion');
