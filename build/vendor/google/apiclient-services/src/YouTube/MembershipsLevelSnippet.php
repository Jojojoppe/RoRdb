...
class MembershipsLevelSnippet extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MembershipsLevelSnippet::class, 'RoRdb\\Google_Service_YouTube_MembershipsLevelSnippet');
