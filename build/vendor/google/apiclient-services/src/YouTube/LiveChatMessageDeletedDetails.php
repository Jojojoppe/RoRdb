...
class LiveChatMessageDeletedDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiveChatMessageDeletedDetails::class, 'RoRdb\\Google_Service_YouTube_LiveChatMessageDeletedDetails');
