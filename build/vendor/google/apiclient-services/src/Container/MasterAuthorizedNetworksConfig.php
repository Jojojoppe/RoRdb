...
class MasterAuthorizedNetworksConfig extends \RoRdb\Google\Collection
{
...
\class_alias(MasterAuthorizedNetworksConfig::class, 'RoRdb\\Google_Service_Container_MasterAuthorizedNetworksConfig');
