...
class SecurityBulletinEvent extends \RoRdb\Google\Collection
{
...
\class_alias(SecurityBulletinEvent::class, 'RoRdb\\Google_Service_Container_SecurityBulletinEvent');
