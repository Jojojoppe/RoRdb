...
class LoggingComponentConfig extends \RoRdb\Google\Collection
{
...
\class_alias(LoggingComponentConfig::class, 'RoRdb\\Google_Service_Container_LoggingComponentConfig');
