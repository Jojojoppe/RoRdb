...
class GetJSONWebKeysResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetJSONWebKeysResponse::class, 'RoRdb\\Google_Service_Container_GetJSONWebKeysResponse');
