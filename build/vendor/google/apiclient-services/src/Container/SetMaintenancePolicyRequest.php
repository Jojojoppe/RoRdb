...
class SetMaintenancePolicyRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SetMaintenancePolicyRequest::class, 'RoRdb\\Google_Service_Container_SetMaintenancePolicyRequest');
