...
class GetOpenIDConfigResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetOpenIDConfigResponse::class, 'RoRdb\\Google_Service_Container_GetOpenIDConfigResponse');
