...
class AutoprovisioningNodePoolDefaults extends \RoRdb\Google\Collection
{
...
\class_alias(AutoprovisioningNodePoolDefaults::class, 'RoRdb\\Google_Service_Container_AutoprovisioningNodePoolDefaults');
