...
class SetNetworkPolicyRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SetNetworkPolicyRequest::class, 'RoRdb\\Google_Service_Container_SetNetworkPolicyRequest');
