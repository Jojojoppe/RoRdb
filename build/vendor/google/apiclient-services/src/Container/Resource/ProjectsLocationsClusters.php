 ...
 * the License.
 */
namespace RoRdb\Google\Service\Container\Resource;

use RoRdb\Google\Service\Container\Cluster;
use RoRdb\Google\Service\Container\CompleteIPRotationRequest;
use RoRdb\Google\Service\Container\CreateClusterRequest;
use RoRdb\Google\Service\Container\GetJSONWebKeysResponse;
use RoRdb\Google\Service\Container\ListClustersResponse;
use RoRdb\Google\Service\Container\Operation;
use RoRdb\Google\Service\Container\SetAddonsConfigRequest;
use RoRdb\Google\Service\Container\SetLabelsRequest;
use RoRdb\Google\Service\Container\SetLegacyAbacRequest;
use RoRdb\Google\Service\Container\SetLocationsRequest;
use RoRdb\Google\Service\Container\SetLoggingServiceRequest;
use RoRdb\Google\Service\Container\SetMaintenancePolicyRequest;
use RoRdb\Google\Service\Container\SetMasterAuthRequest;
use RoRdb\Google\Service\Container\SetMonitoringServiceRequest;
use RoRdb\Google\Service\Container\SetNetworkPolicyRequest;
use RoRdb\Google\Service\Container\StartIPRotationRequest;
use RoRdb\Google\Service\Container\UpdateClusterRequest;
use RoRdb\Google\Service\Container\UpdateMasterRequest;
/**
 ...
 *  </code>
 */
class ProjectsLocationsClusters extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsClusters::class, 'RoRdb\\Google_Service_Container_Resource_ProjectsLocationsClusters');
