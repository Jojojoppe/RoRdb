...
class SetNodePoolManagementRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SetNodePoolManagementRequest::class, 'RoRdb\\Google_Service_Container_SetNodePoolManagementRequest');
