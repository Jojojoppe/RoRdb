...
class ResourceUsageExportConfig extends \RoRdb\Google\Model
{
...
\class_alias(ResourceUsageExportConfig::class, 'RoRdb\\Google_Service_Container_ResourceUsageExportConfig');
