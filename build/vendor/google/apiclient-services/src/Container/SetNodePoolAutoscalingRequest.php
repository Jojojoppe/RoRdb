...
class SetNodePoolAutoscalingRequest extends \RoRdb\Google\Model
{
...
\class_alias(SetNodePoolAutoscalingRequest::class, 'RoRdb\\Google_Service_Container_SetNodePoolAutoscalingRequest');
