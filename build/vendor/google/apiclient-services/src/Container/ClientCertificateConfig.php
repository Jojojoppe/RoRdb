...
class ClientCertificateConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ClientCertificateConfig::class, 'RoRdb\\Google_Service_Container_ClientCertificateConfig');
