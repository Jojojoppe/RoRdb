...
class ListUsableSubnetworksResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUsableSubnetworksResponse::class, 'RoRdb\\Google_Service_Container_ListUsableSubnetworksResponse');
