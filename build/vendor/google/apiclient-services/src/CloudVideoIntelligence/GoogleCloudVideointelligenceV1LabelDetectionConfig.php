...
class GoogleCloudVideointelligenceV1LabelDetectionConfig extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(GoogleCloudVideointelligenceV1LabelDetectionConfig::class, 'RoRdb\\Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1LabelDetectionConfig');
