...
class ListGlossariesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGlossariesResponse::class, 'RoRdb\\Google_Service_Translate_ListGlossariesResponse');
