...
class BatchDocumentOutputConfig extends \RoRdb\Google\Model
{
...
\class_alias(BatchDocumentOutputConfig::class, 'RoRdb\\Google_Service_Translate_BatchDocumentOutputConfig');
