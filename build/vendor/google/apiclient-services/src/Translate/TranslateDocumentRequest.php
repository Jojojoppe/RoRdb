...
class TranslateDocumentRequest extends \RoRdb\Google\Model
{
...
\class_alias(TranslateDocumentRequest::class, 'RoRdb\\Google_Service_Translate_TranslateDocumentRequest');
