...
class BatchTranslateTextRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchTranslateTextRequest::class, 'RoRdb\\Google_Service_Translate_BatchTranslateTextRequest');
