...
class BatchTranslateDocumentRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchTranslateDocumentRequest::class, 'RoRdb\\Google_Service_Translate_BatchTranslateDocumentRequest');
