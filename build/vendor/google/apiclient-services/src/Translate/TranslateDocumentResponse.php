...
class TranslateDocumentResponse extends \RoRdb\Google\Model
{
...
\class_alias(TranslateDocumentResponse::class, 'RoRdb\\Google_Service_Translate_TranslateDocumentResponse');
