 ...
 * @author Google, Inc.
 */
class DriveActivity extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->activity = new DriveActivity\Resource\Activity($this, $this->serviceName, 'activity', ['methods' => ['query' => ['path' => 'v2/activity:query', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(DriveActivity::class, 'RoRdb\\Google_Service_DriveActivity');
