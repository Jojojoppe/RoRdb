...
class BusinessCallsInsights extends \RoRdb\Google\Model
{
...
\class_alias(BusinessCallsInsights::class, 'RoRdb\\Google_Service_MyBusinessBusinessCalls_BusinessCallsInsights');
