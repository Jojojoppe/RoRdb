 ...
 * the License.
 */
namespace RoRdb\Google\Service\MyBusinessBusinessCalls;

class ListBusinessCallsInsightsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBusinessCallsInsightsResponse::class, 'RoRdb\\Google_Service_MyBusinessBusinessCalls_ListBusinessCallsInsightsResponse');
