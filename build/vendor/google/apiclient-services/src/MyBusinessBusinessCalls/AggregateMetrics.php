...
class AggregateMetrics extends \RoRdb\Google\Collection
{
...
\class_alias(AggregateMetrics::class, 'RoRdb\\Google_Service_MyBusinessBusinessCalls_AggregateMetrics');
