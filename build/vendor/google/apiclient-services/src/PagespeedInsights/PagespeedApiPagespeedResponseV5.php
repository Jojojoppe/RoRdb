...
class PagespeedApiPagespeedResponseV5 extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PagespeedApiPagespeedResponseV5::class, 'RoRdb\\Google_Service_PagespeedInsights_PagespeedApiPagespeedResponseV5');
