...
class LighthouseAuditResultV5 extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LighthouseAuditResultV5::class, 'RoRdb\\Google_Service_PagespeedInsights_LighthouseAuditResultV5');
