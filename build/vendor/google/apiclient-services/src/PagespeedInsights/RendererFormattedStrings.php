...
class RendererFormattedStrings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RendererFormattedStrings::class, 'RoRdb\\Google_Service_PagespeedInsights_RendererFormattedStrings');
