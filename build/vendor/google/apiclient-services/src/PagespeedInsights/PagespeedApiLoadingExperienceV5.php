...
class PagespeedApiLoadingExperienceV5 extends \RoRdb\Google\Model
{
...
\class_alias(PagespeedApiLoadingExperienceV5::class, 'RoRdb\\Google_Service_PagespeedInsights_PagespeedApiLoadingExperienceV5');
