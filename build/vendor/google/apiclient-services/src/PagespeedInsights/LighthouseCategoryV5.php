...
class LighthouseCategoryV5 extends \RoRdb\Google\Collection
{
...
\class_alias(LighthouseCategoryV5::class, 'RoRdb\\Google_Service_PagespeedInsights_LighthouseCategoryV5');
