...
class BatchEnableServicesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchEnableServicesResponse::class, 'RoRdb\\Google_Service_ServiceUsage_BatchEnableServicesResponse');
