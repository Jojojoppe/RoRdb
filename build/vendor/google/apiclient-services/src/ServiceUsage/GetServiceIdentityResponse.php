...
class GetServiceIdentityResponse extends \RoRdb\Google\Model
{
...
\class_alias(GetServiceIdentityResponse::class, 'RoRdb\\Google_Service_ServiceUsage_GetServiceIdentityResponse');
