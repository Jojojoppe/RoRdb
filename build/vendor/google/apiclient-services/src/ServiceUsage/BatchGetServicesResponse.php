...
class BatchGetServicesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetServicesResponse::class, 'RoRdb\\Google_Service_ServiceUsage_BatchGetServicesResponse');
