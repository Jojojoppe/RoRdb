...
class DisableServiceResponse extends \RoRdb\Google\Model
{
...
\class_alias(DisableServiceResponse::class, 'RoRdb\\Google_Service_ServiceUsage_DisableServiceResponse');
