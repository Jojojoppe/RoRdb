 ...
 * the License.
 */
namespace RoRdb\Google\Service\FirebaseCloudMessaging;

class AndroidNotification extends \RoRdb\Google\Collection
{
...
\class_alias(AndroidNotification::class, 'RoRdb\\Google_Service_FirebaseCloudMessaging_AndroidNotification');
