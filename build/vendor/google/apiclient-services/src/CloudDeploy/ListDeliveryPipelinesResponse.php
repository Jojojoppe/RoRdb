 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudDeploy;

class ListDeliveryPipelinesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDeliveryPipelinesResponse::class, 'RoRdb\\Google_Service_CloudDeploy_ListDeliveryPipelinesResponse');
