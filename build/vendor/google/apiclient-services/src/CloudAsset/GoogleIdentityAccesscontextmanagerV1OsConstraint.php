...
class GoogleIdentityAccesscontextmanagerV1OsConstraint extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleIdentityAccesscontextmanagerV1OsConstraint::class, 'RoRdb\\Google_Service_CloudAsset_GoogleIdentityAccesscontextmanagerV1OsConstraint');
