...
class WindowsQuickFixEngineeringPackage extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(WindowsQuickFixEngineeringPackage::class, 'RoRdb\\Google_Service_CloudAsset_WindowsQuickFixEngineeringPackage');
