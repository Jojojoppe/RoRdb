...
class IamPolicyAnalysisOutputConfig extends \RoRdb\Google\Model
{
...
\class_alias(IamPolicyAnalysisOutputConfig::class, 'RoRdb\\Google_Service_CloudAsset_IamPolicyAnalysisOutputConfig');
