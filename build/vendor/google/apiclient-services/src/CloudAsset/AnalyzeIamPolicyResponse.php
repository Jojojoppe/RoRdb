...
class AnalyzeIamPolicyResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AnalyzeIamPolicyResponse::class, 'RoRdb\\Google_Service_CloudAsset_AnalyzeIamPolicyResponse');
