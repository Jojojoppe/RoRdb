...
class ListSavedQueriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListSavedQueriesResponse::class, 'RoRdb\\Google_Service_CloudAsset_ListSavedQueriesResponse');
