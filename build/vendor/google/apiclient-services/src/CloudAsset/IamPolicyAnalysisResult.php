...
class IamPolicyAnalysisResult extends \RoRdb\Google\Collection
{
...
\class_alias(IamPolicyAnalysisResult::class, 'RoRdb\\Google_Service_CloudAsset_IamPolicyAnalysisResult');
