...
class IamPolicySearchResult extends \RoRdb\Google\Collection
{
...
\class_alias(IamPolicySearchResult::class, 'RoRdb\\Google_Service_CloudAsset_IamPolicySearchResult');
