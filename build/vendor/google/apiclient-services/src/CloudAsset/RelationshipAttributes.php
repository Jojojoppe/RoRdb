...
class RelationshipAttributes extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RelationshipAttributes::class, 'RoRdb\\Google_Service_CloudAsset_RelationshipAttributes');
