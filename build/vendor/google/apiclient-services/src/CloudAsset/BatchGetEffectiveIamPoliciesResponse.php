...
class BatchGetEffectiveIamPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetEffectiveIamPoliciesResponse::class, 'RoRdb\\Google_Service_CloudAsset_BatchGetEffectiveIamPoliciesResponse');
