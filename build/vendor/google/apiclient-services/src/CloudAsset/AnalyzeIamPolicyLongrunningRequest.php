...
class AnalyzeIamPolicyLongrunningRequest extends \RoRdb\Google\Model
{
...
\class_alias(AnalyzeIamPolicyLongrunningRequest::class, 'RoRdb\\Google_Service_CloudAsset_AnalyzeIamPolicyLongrunningRequest');
