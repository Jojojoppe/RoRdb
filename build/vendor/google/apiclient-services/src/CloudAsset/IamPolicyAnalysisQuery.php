...
class IamPolicyAnalysisQuery extends \RoRdb\Google\Model
{
...
\class_alias(IamPolicyAnalysisQuery::class, 'RoRdb\\Google_Service_CloudAsset_IamPolicyAnalysisQuery');
