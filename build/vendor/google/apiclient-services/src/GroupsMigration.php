 ...
 * @author Google, Inc.
 */
class GroupsMigration extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->archive = new GroupsMigration\Resource\Archive($this, $this->serviceName, 'archive', ['methods' => ['insert' => ['path' => 'groups/v1/groups/{groupId}/archive', 'httpMethod' => 'POST', 'parameters' => ['groupId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(GroupsMigration::class, 'RoRdb\\Google_Service_GroupsMigration');
