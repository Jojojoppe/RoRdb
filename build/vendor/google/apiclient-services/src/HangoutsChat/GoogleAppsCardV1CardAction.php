...
class GoogleAppsCardV1CardAction extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1CardAction::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1CardAction');
