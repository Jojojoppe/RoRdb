...
class GoogleAppsCardV1Card extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleAppsCardV1Card::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1Card');
