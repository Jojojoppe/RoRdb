...
class GoogleAppsCardV1SwitchControl extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1SwitchControl::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1SwitchControl');
