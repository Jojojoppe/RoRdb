...
class GoogleAppsCardV1DateTimePicker extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1DateTimePicker::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1DateTimePicker');
