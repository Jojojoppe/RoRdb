...
class GoogleAppsCardV1DecoratedText extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1DecoratedText::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1DecoratedText');
