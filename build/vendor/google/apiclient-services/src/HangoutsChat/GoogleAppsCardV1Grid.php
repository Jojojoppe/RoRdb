...
class GoogleAppsCardV1Grid extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleAppsCardV1Grid::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1Grid');
