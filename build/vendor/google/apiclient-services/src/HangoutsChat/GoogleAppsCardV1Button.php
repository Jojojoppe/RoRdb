...
class GoogleAppsCardV1Button extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1Button::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1Button');
