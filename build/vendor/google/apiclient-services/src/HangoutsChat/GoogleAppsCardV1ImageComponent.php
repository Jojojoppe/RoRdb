...
class GoogleAppsCardV1ImageComponent extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsCardV1ImageComponent::class, 'RoRdb\\Google_Service_HangoutsChat_GoogleAppsCardV1ImageComponent');
