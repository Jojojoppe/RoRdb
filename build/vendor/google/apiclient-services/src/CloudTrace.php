 ...
 * @author Google, Inc.
 */
class CloudTrace extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->projects_traces = new CloudTrace\Resource\ProjectsTraces($this, $this->serviceName, 'traces', ['methods' => ['batchWrite' => ['path' => 'v2/{+name}/traces:batchWrite', 'httpMethod' => 'POST', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
        $this->projects_traces_spans = new CloudTrace\Resource\ProjectsTracesSpans($this, $this->serviceName, 'spans', ['methods' => ['createSpan' => ['path' => 'v2/{+name}', 'httpMethod' => 'POST', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(CloudTrace::class, 'RoRdb\\Google_Service_CloudTrace');
