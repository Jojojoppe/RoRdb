 ...
 * @author Google, Inc.
 */
class AbusiveExperienceReport extends \RoRdb\Google\Service
{
    public $sites;
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->sites = new AbusiveExperienceReport\Resource\Sites($this, $this->serviceName, 'sites', ['methods' => ['get' => ['path' => 'v1/{+name}', 'httpMethod' => 'GET', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
        $this->violatingSites = new AbusiveExperienceReport\Resource\ViolatingSites($this, $this->serviceName, 'violatingSites', ['methods' => ['list' => ['path' => 'v1/violatingSites', 'httpMethod' => 'GET', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(AbusiveExperienceReport::class, 'RoRdb\\Google_Service_AbusiveExperienceReport');
