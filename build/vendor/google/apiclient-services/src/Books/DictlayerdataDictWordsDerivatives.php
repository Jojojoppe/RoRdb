...
class DictlayerdataDictWordsDerivatives extends \RoRdb\Google\Model
{
...
\class_alias(DictlayerdataDictWordsDerivatives::class, 'RoRdb\\Google_Service_Books_DictlayerdataDictWordsDerivatives');
