...
class UsersettingsNotification extends \RoRdb\Google\Model
{
...
\class_alias(UsersettingsNotification::class, 'RoRdb\\Google_Service_Books_UsersettingsNotification');
