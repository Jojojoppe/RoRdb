...
class BooksVolumesRecommendedRateResponse extends \RoRdb\Google\Model
{
...
\class_alias(BooksVolumesRecommendedRateResponse::class, 'RoRdb\\Google_Service_Books_BooksVolumesRecommendedRateResponse');
