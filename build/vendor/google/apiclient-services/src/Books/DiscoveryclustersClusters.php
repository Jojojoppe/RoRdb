...
class DiscoveryclustersClusters extends \RoRdb\Google\Collection
{
...
\class_alias(DiscoveryclustersClusters::class, 'RoRdb\\Google_Service_Books_DiscoveryclustersClusters');
