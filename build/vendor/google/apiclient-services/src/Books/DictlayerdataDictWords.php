...
class DictlayerdataDictWords extends \RoRdb\Google\Collection
{
...
\class_alias(DictlayerdataDictWords::class, 'RoRdb\\Google_Service_Books_DictlayerdataDictWords');
