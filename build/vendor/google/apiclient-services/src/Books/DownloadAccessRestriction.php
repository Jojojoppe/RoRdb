...
class DownloadAccessRestriction extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DownloadAccessRestriction::class, 'RoRdb\\Google_Service_Books_DownloadAccessRestriction');
