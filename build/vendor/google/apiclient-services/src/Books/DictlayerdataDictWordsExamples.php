...
class DictlayerdataDictWordsExamples extends \RoRdb\Google\Model
{
...
\class_alias(DictlayerdataDictWordsExamples::class, 'RoRdb\\Google_Service_Books_DictlayerdataDictWordsExamples');
