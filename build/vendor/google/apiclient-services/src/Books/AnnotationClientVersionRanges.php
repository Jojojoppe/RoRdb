...
class AnnotationClientVersionRanges extends \RoRdb\Google\Model
{
...
\class_alias(AnnotationClientVersionRanges::class, 'RoRdb\\Google_Service_Books_AnnotationClientVersionRanges');
