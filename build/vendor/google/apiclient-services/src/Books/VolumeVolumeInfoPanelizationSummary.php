...
class VolumeVolumeInfoPanelizationSummary extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(VolumeVolumeInfoPanelizationSummary::class, 'RoRdb\\Google_Service_Books_VolumeVolumeInfoPanelizationSummary');
