...
class VolumeVolumeInfoImageLinks extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VolumeVolumeInfoImageLinks::class, 'RoRdb\\Google_Service_Books_VolumeVolumeInfoImageLinks');
