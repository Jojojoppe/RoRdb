...
class VolumeannotationContentRanges extends \RoRdb\Google\Model
{
...
\class_alias(VolumeannotationContentRanges::class, 'RoRdb\\Google_Service_Books_VolumeannotationContentRanges');
