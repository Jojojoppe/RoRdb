...
class AnnotationsSummaryLayers extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(AnnotationsSummaryLayers::class, 'RoRdb\\Google_Service_Books_AnnotationsSummaryLayers');
