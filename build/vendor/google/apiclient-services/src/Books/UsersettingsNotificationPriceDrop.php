...
class UsersettingsNotificationPriceDrop extends \RoRdb\Google\Model
{
...
\class_alias(UsersettingsNotificationPriceDrop::class, 'RoRdb\\Google_Service_Books_UsersettingsNotificationPriceDrop');
