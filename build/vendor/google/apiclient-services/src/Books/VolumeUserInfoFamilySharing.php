...
class VolumeUserInfoFamilySharing extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VolumeUserInfoFamilySharing::class, 'RoRdb\\Google_Service_Books_VolumeUserInfoFamilySharing');
