...
class VolumeseriesinfoVolumeSeriesIssue extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VolumeseriesinfoVolumeSeriesIssue::class, 'RoRdb\\Google_Service_Books_VolumeseriesinfoVolumeSeriesIssue');
