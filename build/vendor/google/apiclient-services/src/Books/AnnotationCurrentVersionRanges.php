...
class AnnotationCurrentVersionRanges extends \RoRdb\Google\Model
{
...
\class_alias(AnnotationCurrentVersionRanges::class, 'RoRdb\\Google_Service_Books_AnnotationCurrentVersionRanges');
