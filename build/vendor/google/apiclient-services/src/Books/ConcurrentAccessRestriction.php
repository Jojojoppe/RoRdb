...
class ConcurrentAccessRestriction extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ConcurrentAccessRestriction::class, 'RoRdb\\Google_Service_Books_ConcurrentAccessRestriction');
