...
class SeriesSeriesSeriesSubscriptionReleaseInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SeriesSeriesSeriesSubscriptionReleaseInfo::class, 'RoRdb\\Google_Service_Books_SeriesSeriesSeriesSubscriptionReleaseInfo');
