...
class DictlayerdataDictWordsSenses extends \RoRdb\Google\Collection
{
...
\class_alias(DictlayerdataDictWordsSenses::class, 'RoRdb\\Google_Service_Books_DictlayerdataDictWordsSenses');
