...
class VolumeseriesinfoVolumeSeries extends \RoRdb\Google\Collection
{
...
\class_alias(VolumeseriesinfoVolumeSeries::class, 'RoRdb\\Google_Service_Books_VolumeseriesinfoVolumeSeries');
