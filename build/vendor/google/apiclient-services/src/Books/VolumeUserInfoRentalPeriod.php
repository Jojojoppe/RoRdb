...
class VolumeUserInfoRentalPeriod extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VolumeUserInfoRentalPeriod::class, 'RoRdb\\Google_Service_Books_VolumeUserInfoRentalPeriod');
