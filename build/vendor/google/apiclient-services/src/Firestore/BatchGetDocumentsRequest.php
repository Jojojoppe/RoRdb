...
class BatchGetDocumentsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetDocumentsRequest::class, 'RoRdb\\Google_Service_Firestore_BatchGetDocumentsRequest');
