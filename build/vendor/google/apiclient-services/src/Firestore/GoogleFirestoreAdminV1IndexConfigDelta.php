...
class GoogleFirestoreAdminV1IndexConfigDelta extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirestoreAdminV1IndexConfigDelta::class, 'RoRdb\\Google_Service_Firestore_GoogleFirestoreAdminV1IndexConfigDelta');
