...
class GoogleFirestoreAdminV1IndexOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirestoreAdminV1IndexOperationMetadata::class, 'RoRdb\\Google_Service_Firestore_GoogleFirestoreAdminV1IndexOperationMetadata');
