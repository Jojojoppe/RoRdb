...
class GoogleFirestoreAdminV1Database extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleFirestoreAdminV1Database::class, 'RoRdb\\Google_Service_Firestore_GoogleFirestoreAdminV1Database');
