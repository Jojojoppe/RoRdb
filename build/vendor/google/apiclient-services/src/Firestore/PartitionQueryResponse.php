...
class PartitionQueryResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PartitionQueryResponse::class, 'RoRdb\\Google_Service_Firestore_PartitionQueryResponse');
