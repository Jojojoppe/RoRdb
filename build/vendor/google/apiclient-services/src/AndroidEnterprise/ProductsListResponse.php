...
class ProductsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ProductsListResponse::class, 'RoRdb\\Google_Service_AndroidEnterprise_ProductsListResponse');
