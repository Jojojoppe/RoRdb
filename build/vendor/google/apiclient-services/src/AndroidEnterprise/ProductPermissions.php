...
class ProductPermissions extends \RoRdb\Google\Collection
{
...
\class_alias(ProductPermissions::class, 'RoRdb\\Google_Service_AndroidEnterprise_ProductPermissions');
