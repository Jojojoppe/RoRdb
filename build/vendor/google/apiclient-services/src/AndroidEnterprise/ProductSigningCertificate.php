...
class ProductSigningCertificate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ProductSigningCertificate::class, 'RoRdb\\Google_Service_AndroidEnterprise_ProductSigningCertificate');
