...
class ManagedConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedConfiguration::class, 'RoRdb\\Google_Service_AndroidEnterprise_ManagedConfiguration');
