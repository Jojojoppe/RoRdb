...
class ServiceAccountKeysListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ServiceAccountKeysListResponse::class, 'RoRdb\\Google_Service_AndroidEnterprise_ServiceAccountKeysListResponse');
