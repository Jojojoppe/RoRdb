...
class NewPermissionsEvent extends \RoRdb\Google\Collection
{
...
\class_alias(NewPermissionsEvent::class, 'RoRdb\\Google_Service_AndroidEnterprise_NewPermissionsEvent');
