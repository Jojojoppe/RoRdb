...
class ProductsApproveRequest extends \RoRdb\Google\Model
{
...
\class_alias(ProductsApproveRequest::class, 'RoRdb\\Google_Service_AndroidEnterprise_ProductsApproveRequest');
