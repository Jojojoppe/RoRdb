...
class AppRestrictionsSchemaRestriction extends \RoRdb\Google\Collection
{
...
\class_alias(AppRestrictionsSchemaRestriction::class, 'RoRdb\\Google_Service_AndroidEnterprise_AppRestrictionsSchemaRestriction');
