...
class ManagedConfigurationsSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ManagedConfigurationsSettings::class, 'RoRdb\\Google_Service_AndroidEnterprise_ManagedConfigurationsSettings');
