...
class WebAppsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(WebAppsListResponse::class, 'RoRdb\\Google_Service_AndroidEnterprise_WebAppsListResponse');
