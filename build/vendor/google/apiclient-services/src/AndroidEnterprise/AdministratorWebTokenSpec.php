...
class AdministratorWebTokenSpec extends \RoRdb\Google\Collection
{
...
\class_alias(AdministratorWebTokenSpec::class, 'RoRdb\\Google_Service_AndroidEnterprise_AdministratorWebTokenSpec');
