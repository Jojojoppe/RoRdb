...
class ManagedPropertyBundle extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedPropertyBundle::class, 'RoRdb\\Google_Service_AndroidEnterprise_ManagedPropertyBundle');
