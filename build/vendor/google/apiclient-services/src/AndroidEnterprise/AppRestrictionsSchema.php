...
class AppRestrictionsSchema extends \RoRdb\Google\Collection
{
...
\class_alias(AppRestrictionsSchema::class, 'RoRdb\\Google_Service_AndroidEnterprise_AppRestrictionsSchema');
