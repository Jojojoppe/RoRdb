...
class AutoInstallConstraint extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AutoInstallConstraint::class, 'RoRdb\\Google_Service_AndroidEnterprise_AutoInstallConstraint');
