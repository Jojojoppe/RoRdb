...
class GroupLicensesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GroupLicensesListResponse::class, 'RoRdb\\Google_Service_AndroidEnterprise_GroupLicensesListResponse');
