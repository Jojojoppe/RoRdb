...
class ListCapacityCommitmentsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCapacityCommitmentsResponse::class, 'RoRdb\\Google_Service_BigQueryReservation_ListCapacityCommitmentsResponse');
