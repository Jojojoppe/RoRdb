 ...
 * the License.
 */
namespace RoRdb\Google\Service\BigQueryReservation;

class MergeCapacityCommitmentsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(MergeCapacityCommitmentsRequest::class, 'RoRdb\\Google_Service_BigQueryReservation_MergeCapacityCommitmentsRequest');
