...
class SplitCapacityCommitmentResponse extends \RoRdb\Google\Model
{
...
\class_alias(SplitCapacityCommitmentResponse::class, 'RoRdb\\Google_Service_BigQueryReservation_SplitCapacityCommitmentResponse');
