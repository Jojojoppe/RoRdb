...
class GoogleChromePolicyV1ResolveRequest extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleChromePolicyV1ResolveRequest::class, 'RoRdb\\Google_Service_ChromePolicy_GoogleChromePolicyV1ResolveRequest');
