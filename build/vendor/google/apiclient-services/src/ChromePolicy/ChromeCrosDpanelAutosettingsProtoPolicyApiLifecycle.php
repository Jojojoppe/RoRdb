...
class ChromeCrosDpanelAutosettingsProtoPolicyApiLifecycle extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ChromeCrosDpanelAutosettingsProtoPolicyApiLifecycle::class, 'RoRdb\\Google_Service_ChromePolicy_ChromeCrosDpanelAutosettingsProtoPolicyApiLifecycle');
