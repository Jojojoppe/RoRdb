...
class GoogleChromePolicyV1PolicySchema extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleChromePolicyV1PolicySchema::class, 'RoRdb\\Google_Service_ChromePolicy_GoogleChromePolicyV1PolicySchema');
