...
class Proto2FieldDescriptorProto extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(Proto2FieldDescriptorProto::class, 'RoRdb\\Google_Service_ChromePolicy_Proto2FieldDescriptorProto');
