...
class GoogleChromePolicyV1InheritOrgUnitPolicyRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleChromePolicyV1InheritOrgUnitPolicyRequest::class, 'RoRdb\\Google_Service_ChromePolicy_GoogleChromePolicyV1InheritOrgUnitPolicyRequest');
