...
class GoogleCloudApigeeV1TargetServer extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1TargetServer::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1TargetServer');
