...
class GoogleRpcPreconditionFailure extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleRpcPreconditionFailure::class, 'RoRdb\\Google_Service_Apigee_GoogleRpcPreconditionFailure');
