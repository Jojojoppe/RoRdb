...
class GoogleCloudApigeeV1TraceConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1TraceConfig::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1TraceConfig');
