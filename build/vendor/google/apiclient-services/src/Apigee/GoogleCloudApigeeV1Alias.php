...
class GoogleCloudApigeeV1Alias extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1Alias::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1Alias');
