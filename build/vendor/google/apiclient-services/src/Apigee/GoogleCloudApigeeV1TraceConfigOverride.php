...
class GoogleCloudApigeeV1TraceConfigOverride extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1TraceConfigOverride::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1TraceConfigOverride');
