...
class GoogleCloudApigeeV1Environment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1Environment::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1Environment');
