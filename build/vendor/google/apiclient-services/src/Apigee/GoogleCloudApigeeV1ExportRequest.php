...
class GoogleCloudApigeeV1ExportRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1ExportRequest::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1ExportRequest');
