...
class GoogleCloudApigeeV1ProvisionOrganizationRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1ProvisionOrganizationRequest::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1ProvisionOrganizationRequest');
