...
class GoogleCloudApigeeV1AsyncQuery extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1AsyncQuery::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1AsyncQuery');
