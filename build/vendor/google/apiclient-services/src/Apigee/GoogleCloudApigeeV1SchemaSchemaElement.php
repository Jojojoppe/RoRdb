...
class GoogleCloudApigeeV1SchemaSchemaElement extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1SchemaSchemaElement::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1SchemaSchemaElement');
