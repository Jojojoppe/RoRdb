...
class GoogleCloudApigeeV1Query extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudApigeeV1Query::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1Query');
