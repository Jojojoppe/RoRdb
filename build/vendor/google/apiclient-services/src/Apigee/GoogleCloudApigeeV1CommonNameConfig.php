...
class GoogleCloudApigeeV1CommonNameConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudApigeeV1CommonNameConfig::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1CommonNameConfig');
