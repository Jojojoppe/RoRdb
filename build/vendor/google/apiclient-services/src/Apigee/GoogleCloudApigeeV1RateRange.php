...
class GoogleCloudApigeeV1RateRange extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1RateRange::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1RateRange');
