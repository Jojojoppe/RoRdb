...
class GoogleCloudApigeeV1TargetServerConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudApigeeV1TargetServerConfig::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1TargetServerConfig');
