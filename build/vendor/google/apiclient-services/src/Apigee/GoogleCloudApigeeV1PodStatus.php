...
class GoogleCloudApigeeV1PodStatus extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1PodStatus::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1PodStatus');
