...
class GoogleCloudApigeeV1Datastore extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1Datastore::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1Datastore');
