...
class GoogleCloudApigeeV1FlowHook extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudApigeeV1FlowHook::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1FlowHook');
