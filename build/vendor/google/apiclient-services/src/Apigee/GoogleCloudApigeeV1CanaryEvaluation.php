...
class GoogleCloudApigeeV1CanaryEvaluation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1CanaryEvaluation::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1CanaryEvaluation');
