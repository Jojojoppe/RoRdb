...
class GoogleCloudApigeeV1FlowHookConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudApigeeV1FlowHookConfig::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1FlowHookConfig');
