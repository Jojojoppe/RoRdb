...
class GoogleCloudApigeeV1RuntimeConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1RuntimeConfig::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1RuntimeConfig');
