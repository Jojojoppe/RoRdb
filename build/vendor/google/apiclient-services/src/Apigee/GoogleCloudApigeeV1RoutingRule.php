...
class GoogleCloudApigeeV1RoutingRule extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1RoutingRule::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1RoutingRule');
