...
class GoogleCloudApigeeV1Result extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudApigeeV1Result::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1Result');
