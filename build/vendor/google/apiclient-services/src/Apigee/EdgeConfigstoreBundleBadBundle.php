...
class EdgeConfigstoreBundleBadBundle extends \RoRdb\Google\Collection
{
...
\class_alias(EdgeConfigstoreBundleBadBundle::class, 'RoRdb\\Google_Service_Apigee_EdgeConfigstoreBundleBadBundle');
