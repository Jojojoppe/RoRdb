...
class GoogleCloudApigeeV1OperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudApigeeV1OperationMetadata::class, 'RoRdb\\Google_Service_Apigee_GoogleCloudApigeeV1OperationMetadata');
