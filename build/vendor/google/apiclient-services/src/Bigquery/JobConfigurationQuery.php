...
class JobConfigurationQuery extends \RoRdb\Google\Collection
{
...
\class_alias(JobConfigurationQuery::class, 'RoRdb\\Google_Service_Bigquery_JobConfigurationQuery');
