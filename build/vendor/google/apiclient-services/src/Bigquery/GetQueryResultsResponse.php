...
class GetQueryResultsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetQueryResultsResponse::class, 'RoRdb\\Google_Service_Bigquery_GetQueryResultsResponse');
