...
class MaterializedViewDefinition extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(MaterializedViewDefinition::class, 'RoRdb\\Google_Service_Bigquery_MaterializedViewDefinition');
