...
class ListRowAccessPoliciesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRowAccessPoliciesResponse::class, 'RoRdb\\Google_Service_Bigquery_ListRowAccessPoliciesResponse');
