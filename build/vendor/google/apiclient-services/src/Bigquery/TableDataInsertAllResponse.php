...
class TableDataInsertAllResponse extends \RoRdb\Google\Collection
{
...
\class_alias(TableDataInsertAllResponse::class, 'RoRdb\\Google_Service_Bigquery_TableDataInsertAllResponse');
