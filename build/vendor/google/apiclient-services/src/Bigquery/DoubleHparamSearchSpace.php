...
class DoubleHparamSearchSpace extends \RoRdb\Google\Model
{
...
\class_alias(DoubleHparamSearchSpace::class, 'RoRdb\\Google_Service_Bigquery_DoubleHparamSearchSpace');
