...
class JobListJobs extends \RoRdb\Google\Model
{
    protected $internal_gapi_mappings = ["userEmail" => "user_email"];
...
\class_alias(JobListJobs::class, 'RoRdb\\Google_Service_Bigquery_JobListJobs');
