...
class RowLevelSecurityStatistics extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(RowLevelSecurityStatistics::class, 'RoRdb\\Google_Service_Bigquery_RowLevelSecurityStatistics');
