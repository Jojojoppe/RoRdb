...
class JobConfigurationExtract extends \RoRdb\Google\Collection
{
...
\class_alias(JobConfigurationExtract::class, 'RoRdb\\Google_Service_Bigquery_JobConfigurationExtract');
