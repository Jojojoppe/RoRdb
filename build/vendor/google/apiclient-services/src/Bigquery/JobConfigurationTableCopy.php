...
class JobConfigurationTableCopy extends \RoRdb\Google\Collection
{
...
\class_alias(JobConfigurationTableCopy::class, 'RoRdb\\Google_Service_Bigquery_JobConfigurationTableCopy');
