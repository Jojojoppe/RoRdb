...
class BqmlTrainingRunTrainingOptions extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(BqmlTrainingRunTrainingOptions::class, 'RoRdb\\Google_Service_Bigquery_BqmlTrainingRunTrainingOptions');
