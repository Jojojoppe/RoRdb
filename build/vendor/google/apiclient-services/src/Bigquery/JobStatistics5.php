...
class JobStatistics5 extends \RoRdb\Google\Model
{
    protected $internal_gapi_mappings = ["copiedLogicalBytes" => "copied_logical_bytes", "copiedRows" => "copied_rows"];
    /**
     * @var string
     */
...
\class_alias(JobStatistics5::class, 'RoRdb\\Google_Service_Bigquery_JobStatistics5');
