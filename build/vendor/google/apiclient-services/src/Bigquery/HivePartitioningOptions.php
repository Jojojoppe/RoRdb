...
class HivePartitioningOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(HivePartitioningOptions::class, 'RoRdb\\Google_Service_Bigquery_HivePartitioningOptions');
