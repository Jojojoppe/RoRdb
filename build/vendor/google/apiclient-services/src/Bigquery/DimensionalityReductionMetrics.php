...
class DimensionalityReductionMetrics extends \RoRdb\Google\Model
{
...
\class_alias(DimensionalityReductionMetrics::class, 'RoRdb\\Google_Service_Bigquery_DimensionalityReductionMetrics');
