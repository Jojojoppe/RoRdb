...
class MultiClassClassificationMetrics extends \RoRdb\Google\Collection
{
...
\class_alias(MultiClassClassificationMetrics::class, 'RoRdb\\Google_Service_Bigquery_MultiClassClassificationMetrics');
