...
class BinaryClassificationMetrics extends \RoRdb\Google\Collection
{
...
\class_alias(BinaryClassificationMetrics::class, 'RoRdb\\Google_Service_Bigquery_BinaryClassificationMetrics');
