...
class ExternalDataConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(ExternalDataConfiguration::class, 'RoRdb\\Google_Service_Bigquery_ExternalDataConfiguration');
