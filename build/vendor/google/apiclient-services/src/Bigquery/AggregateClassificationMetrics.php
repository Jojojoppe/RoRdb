...
class AggregateClassificationMetrics extends \RoRdb\Google\Model
{
    public $accuracy;
    public $f1Score;
    public $logLoss;
...
\class_alias(AggregateClassificationMetrics::class, 'RoRdb\\Google_Service_Bigquery_AggregateClassificationMetrics');
