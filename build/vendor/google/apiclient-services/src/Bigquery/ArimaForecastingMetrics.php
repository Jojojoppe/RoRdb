...
class ArimaForecastingMetrics extends \RoRdb\Google\Collection
{
...
\class_alias(ArimaForecastingMetrics::class, 'RoRdb\\Google_Service_Bigquery_ArimaForecastingMetrics');
