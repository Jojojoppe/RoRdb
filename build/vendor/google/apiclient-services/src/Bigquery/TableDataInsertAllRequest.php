...
class TableDataInsertAllRequest extends \RoRdb\Google\Collection
{
...
\class_alias(TableDataInsertAllRequest::class, 'RoRdb\\Google_Service_Bigquery_TableDataInsertAllRequest');
