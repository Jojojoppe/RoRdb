...
class CsvOptions extends \RoRdb\Google\Model
{
    protected $internal_gapi_mappings = ["nullMarker" => "null_marker"];
    /**
     * @var bool
     */
...
\class_alias(CsvOptions::class, 'RoRdb\\Google_Service_Bigquery_CsvOptions');
