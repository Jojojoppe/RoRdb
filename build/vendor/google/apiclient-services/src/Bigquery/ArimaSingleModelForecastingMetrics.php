...
class ArimaSingleModelForecastingMetrics extends \RoRdb\Google\Collection
{
...
\class_alias(ArimaSingleModelForecastingMetrics::class, 'RoRdb\\Google_Service_Bigquery_ArimaSingleModelForecastingMetrics');
