...
class GoogleCloudRecommendationengineV1beta1UserEventImportSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRecommendationengineV1beta1UserEventImportSummary::class, 'RoRdb\\Google_Service_RecommendationsAI_GoogleCloudRecommendationengineV1beta1UserEventImportSummary');
