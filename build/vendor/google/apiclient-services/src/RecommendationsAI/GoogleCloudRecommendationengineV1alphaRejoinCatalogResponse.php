...
class GoogleCloudRecommendationengineV1alphaRejoinCatalogResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRecommendationengineV1alphaRejoinCatalogResponse::class, 'RoRdb\\Google_Service_RecommendationsAI_GoogleCloudRecommendationengineV1alphaRejoinCatalogResponse');
