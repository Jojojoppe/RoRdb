...
class GamesPlayerExperienceInfoResource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GamesPlayerExperienceInfoResource::class, 'RoRdb\\Google_Service_GamesManagement_GamesPlayerExperienceInfoResource');
