...
class ScoresResetMultipleForAllRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ScoresResetMultipleForAllRequest::class, 'RoRdb\\Google_Service_GamesManagement_ScoresResetMultipleForAllRequest');
