...
class GamesPlayerLevelResource extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GamesPlayerLevelResource::class, 'RoRdb\\Google_Service_GamesManagement_GamesPlayerLevelResource');
