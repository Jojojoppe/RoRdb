...
class PlayerScoreResetResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlayerScoreResetResponse::class, 'RoRdb\\Google_Service_GamesManagement_PlayerScoreResetResponse');
