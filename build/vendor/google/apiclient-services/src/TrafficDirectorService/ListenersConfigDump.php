...
class ListenersConfigDump extends \RoRdb\Google\Collection
{
...
\class_alias(ListenersConfigDump::class, 'RoRdb\\Google_Service_TrafficDirectorService_ListenersConfigDump');
