...
class UpdateFailureState extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateFailureState::class, 'RoRdb\\Google_Service_TrafficDirectorService_UpdateFailureState');
