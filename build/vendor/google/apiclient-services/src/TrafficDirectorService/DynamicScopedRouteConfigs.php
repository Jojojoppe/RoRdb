...
class DynamicScopedRouteConfigs extends \RoRdb\Google\Collection
{
...
\class_alias(DynamicScopedRouteConfigs::class, 'RoRdb\\Google_Service_TrafficDirectorService_DynamicScopedRouteConfigs');
