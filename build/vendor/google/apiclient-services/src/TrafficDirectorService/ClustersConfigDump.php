...
class ClustersConfigDump extends \RoRdb\Google\Collection
{
...
\class_alias(ClustersConfigDump::class, 'RoRdb\\Google_Service_TrafficDirectorService_ClustersConfigDump');
