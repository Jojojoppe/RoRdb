...
class ClientStatusRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ClientStatusRequest::class, 'RoRdb\\Google_Service_TrafficDirectorService_ClientStatusRequest');
