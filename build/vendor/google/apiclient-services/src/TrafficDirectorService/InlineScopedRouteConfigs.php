...
class InlineScopedRouteConfigs extends \RoRdb\Google\Collection
{
...
\class_alias(InlineScopedRouteConfigs::class, 'RoRdb\\Google_Service_TrafficDirectorService_InlineScopedRouteConfigs');
