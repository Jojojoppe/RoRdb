...
class ScopedRoutesConfigDump extends \RoRdb\Google\Collection
{
...
\class_alias(ScopedRoutesConfigDump::class, 'RoRdb\\Google_Service_TrafficDirectorService_ScopedRoutesConfigDump');
