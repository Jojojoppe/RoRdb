...
class CertificateIdentityConstraints extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(CertificateIdentityConstraints::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateIdentityConstraints');
