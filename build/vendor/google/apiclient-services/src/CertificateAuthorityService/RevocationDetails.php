...
class RevocationDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RevocationDetails::class, 'RoRdb\\Google_Service_CertificateAuthorityService_RevocationDetails');
