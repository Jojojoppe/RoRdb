...
class ExtendedKeyUsageOptions extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ExtendedKeyUsageOptions::class, 'RoRdb\\Google_Service_CertificateAuthorityService_ExtendedKeyUsageOptions');
