...
class PublishingOptions extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PublishingOptions::class, 'RoRdb\\Google_Service_CertificateAuthorityService_PublishingOptions');
