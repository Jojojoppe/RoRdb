...
class CertificateAuthority extends \RoRdb\Google\Collection
{
...
\class_alias(CertificateAuthority::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateAuthority');
