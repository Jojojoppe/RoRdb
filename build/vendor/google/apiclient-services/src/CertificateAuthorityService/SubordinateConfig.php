...
class SubordinateConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubordinateConfig::class, 'RoRdb\\Google_Service_CertificateAuthorityService_SubordinateConfig');
