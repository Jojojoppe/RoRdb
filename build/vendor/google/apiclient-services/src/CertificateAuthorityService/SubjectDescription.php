...
class SubjectDescription extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubjectDescription::class, 'RoRdb\\Google_Service_CertificateAuthorityService_SubjectDescription');
