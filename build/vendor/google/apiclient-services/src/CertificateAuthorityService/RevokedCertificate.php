...
class RevokedCertificate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RevokedCertificate::class, 'RoRdb\\Google_Service_CertificateAuthorityService_RevokedCertificate');
