...
class CertificateRevocationList extends \RoRdb\Google\Collection
{
...
\class_alias(CertificateRevocationList::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateRevocationList');
