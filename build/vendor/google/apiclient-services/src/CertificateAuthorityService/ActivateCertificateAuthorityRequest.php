...
class ActivateCertificateAuthorityRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ActivateCertificateAuthorityRequest::class, 'RoRdb\\Google_Service_CertificateAuthorityService_ActivateCertificateAuthorityRequest');
