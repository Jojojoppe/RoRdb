...
class CertificateDescription extends \RoRdb\Google\Collection
{
...
\class_alias(CertificateDescription::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateDescription');
