...
class CertificateConfig extends \RoRdb\Google\Model
{
...
\class_alias(CertificateConfig::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateConfig');
