...
class CertificateTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CertificateTemplate::class, 'RoRdb\\Google_Service_CertificateAuthorityService_CertificateTemplate');
