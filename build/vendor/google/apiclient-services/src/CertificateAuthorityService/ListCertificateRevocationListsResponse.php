 ...
 * the License.
 */
namespace RoRdb\Google\Service\CertificateAuthorityService;

class ListCertificateRevocationListsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCertificateRevocationListsResponse::class, 'RoRdb\\Google_Service_CertificateAuthorityService_ListCertificateRevocationListsResponse');
