...
class SubjectAltNames extends \RoRdb\Google\Collection
{
...
\class_alias(SubjectAltNames::class, 'RoRdb\\Google_Service_CertificateAuthorityService_SubjectAltNames');
