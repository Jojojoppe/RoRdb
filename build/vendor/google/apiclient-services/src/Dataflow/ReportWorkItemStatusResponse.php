...
class ReportWorkItemStatusResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReportWorkItemStatusResponse::class, 'RoRdb\\Google_Service_Dataflow_ReportWorkItemStatusResponse');
