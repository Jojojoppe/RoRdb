...
class LeaseWorkItemResponse extends \RoRdb\Google\Collection
{
...
\class_alias(LeaseWorkItemResponse::class, 'RoRdb\\Google_Service_Dataflow_LeaseWorkItemResponse');
