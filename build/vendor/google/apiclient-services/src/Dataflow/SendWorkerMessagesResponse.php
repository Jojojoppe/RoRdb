...
class SendWorkerMessagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SendWorkerMessagesResponse::class, 'RoRdb\\Google_Service_Dataflow_SendWorkerMessagesResponse');
