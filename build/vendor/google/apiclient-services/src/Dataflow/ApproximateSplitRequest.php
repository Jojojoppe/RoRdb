...
class ApproximateSplitRequest extends \RoRdb\Google\Model
{
...
\class_alias(ApproximateSplitRequest::class, 'RoRdb\\Google_Service_Dataflow_ApproximateSplitRequest');
