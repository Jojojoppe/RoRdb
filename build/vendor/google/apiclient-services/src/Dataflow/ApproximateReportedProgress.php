...
class ApproximateReportedProgress extends \RoRdb\Google\Model
{
...
\class_alias(ApproximateReportedProgress::class, 'RoRdb\\Google_Service_Dataflow_ApproximateReportedProgress');
