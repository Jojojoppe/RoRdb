...
class SourceOperationResponse extends \RoRdb\Google\Model
{
...
\class_alias(SourceOperationResponse::class, 'RoRdb\\Google_Service_Dataflow_SourceOperationResponse');
