...
class StreamingComputationTask extends \RoRdb\Google\Collection
{
...
\class_alias(StreamingComputationTask::class, 'RoRdb\\Google_Service_Dataflow_StreamingComputationTask');
