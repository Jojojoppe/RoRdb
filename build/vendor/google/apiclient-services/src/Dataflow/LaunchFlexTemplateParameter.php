...
class LaunchFlexTemplateParameter extends \RoRdb\Google\Model
{
...
\class_alias(LaunchFlexTemplateParameter::class, 'RoRdb\\Google_Service_Dataflow_LaunchFlexTemplateParameter');
