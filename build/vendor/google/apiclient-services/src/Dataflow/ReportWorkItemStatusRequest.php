...
class ReportWorkItemStatusRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReportWorkItemStatusRequest::class, 'RoRdb\\Google_Service_Dataflow_ReportWorkItemStatusRequest');
