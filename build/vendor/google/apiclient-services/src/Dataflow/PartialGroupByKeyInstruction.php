...
class PartialGroupByKeyInstruction extends \RoRdb\Google\Collection
{
...
\class_alias(PartialGroupByKeyInstruction::class, 'RoRdb\\Google_Service_Dataflow_PartialGroupByKeyInstruction');
