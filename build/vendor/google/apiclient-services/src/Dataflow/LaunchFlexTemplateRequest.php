...
class LaunchFlexTemplateRequest extends \RoRdb\Google\Model
{
...
\class_alias(LaunchFlexTemplateRequest::class, 'RoRdb\\Google_Service_Dataflow_LaunchFlexTemplateRequest');
