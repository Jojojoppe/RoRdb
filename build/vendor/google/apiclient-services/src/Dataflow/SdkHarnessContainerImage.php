...
class SdkHarnessContainerImage extends \RoRdb\Google\Collection
{
...
\class_alias(SdkHarnessContainerImage::class, 'RoRdb\\Google_Service_Dataflow_SdkHarnessContainerImage');
