...
class ResourceUtilizationReport extends \RoRdb\Google\Collection
{
...
\class_alias(ResourceUtilizationReport::class, 'RoRdb\\Google_Service_Dataflow_ResourceUtilizationReport');
