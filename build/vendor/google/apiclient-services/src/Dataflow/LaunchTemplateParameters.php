...
class LaunchTemplateParameters extends \RoRdb\Google\Model
{
...
\class_alias(LaunchTemplateParameters::class, 'RoRdb\\Google_Service_Dataflow_LaunchTemplateParameters');
