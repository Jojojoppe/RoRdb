...
class ListJobMessagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListJobMessagesResponse::class, 'RoRdb\\Google_Service_Dataflow_ListJobMessagesResponse');
