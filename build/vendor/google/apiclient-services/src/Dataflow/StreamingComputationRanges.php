...
class StreamingComputationRanges extends \RoRdb\Google\Collection
{
...
\class_alias(StreamingComputationRanges::class, 'RoRdb\\Google_Service_Dataflow_StreamingComputationRanges');
