...
class FlexTemplateRuntimeEnvironment extends \RoRdb\Google\Collection
{
...
\class_alias(FlexTemplateRuntimeEnvironment::class, 'RoRdb\\Google_Service_Dataflow_FlexTemplateRuntimeEnvironment');
