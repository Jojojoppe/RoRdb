 ...
 * the License.
 */
namespace RoRdb\Google\Service\Dataflow\Resource;

use RoRdb\Google\Service\Dataflow\CreateJobFromTemplateRequest;
use RoRdb\Google\Service\Dataflow\GetTemplateResponse;
use RoRdb\Google\Service\Dataflow\Job;
use RoRdb\Google\Service\Dataflow\LaunchTemplateParameters;
use RoRdb\Google\Service\Dataflow\LaunchTemplateResponse;
/**
 ...
 *  </code>
 */
class ProjectsLocationsTemplates extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsTemplates::class, 'RoRdb\\Google_Service_Dataflow_Resource_ProjectsLocationsTemplates');
