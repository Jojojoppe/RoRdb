...
class CreateJobFromTemplateRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateJobFromTemplateRequest::class, 'RoRdb\\Google_Service_Dataflow_CreateJobFromTemplateRequest');
