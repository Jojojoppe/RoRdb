...
class StreamingApplianceSnapshotConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(StreamingApplianceSnapshotConfig::class, 'RoRdb\\Google_Service_Dataflow_StreamingApplianceSnapshotConfig');
