...
class StreamingComputationConfig extends \RoRdb\Google\Collection
{
...
\class_alias(StreamingComputationConfig::class, 'RoRdb\\Google_Service_Dataflow_StreamingComputationConfig');
