...
class SendWorkerMessagesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(SendWorkerMessagesRequest::class, 'RoRdb\\Google_Service_Dataflow_SendWorkerMessagesRequest');
