...
class ExecutionStageSummary extends \RoRdb\Google\Collection
{
...
\class_alias(ExecutionStageSummary::class, 'RoRdb\\Google_Service_Dataflow_ExecutionStageSummary');
