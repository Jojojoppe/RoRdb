 ...
 * the License.
 */
namespace RoRdb\Google\Service\SecretManager\Resource;

use RoRdb\Google\Service\SecretManager\AddSecretVersionRequest;
use RoRdb\Google\Service\SecretManager\ListSecretsResponse;
use RoRdb\Google\Service\SecretManager\Policy;
use RoRdb\Google\Service\SecretManager\Secret;
use RoRdb\Google\Service\SecretManager\SecretVersion;
use RoRdb\Google\Service\SecretManager\SecretmanagerEmpty;
use RoRdb\Google\Service\SecretManager\SetIamPolicyRequest;
use RoRdb\Google\Service\SecretManager\TestIamPermissionsRequest;
use RoRdb\Google\Service\SecretManager\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsSecrets extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsSecrets::class, 'RoRdb\\Google_Service_SecretManager_Resource_ProjectsSecrets');
