...
class ApigatewayApiConfigOpenApiDocument extends \RoRdb\Google\Model
{
...
\class_alias(ApigatewayApiConfigOpenApiDocument::class, 'RoRdb\\Google_Service_Apigateway_ApigatewayApiConfigOpenApiDocument');
