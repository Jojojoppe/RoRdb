...
class ApigatewayOperationMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(ApigatewayOperationMetadata::class, 'RoRdb\\Google_Service_Apigateway_ApigatewayOperationMetadata');
