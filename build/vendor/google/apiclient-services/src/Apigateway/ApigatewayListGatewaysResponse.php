...
class ApigatewayListGatewaysResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ApigatewayListGatewaysResponse::class, 'RoRdb\\Google_Service_Apigateway_ApigatewayListGatewaysResponse');
