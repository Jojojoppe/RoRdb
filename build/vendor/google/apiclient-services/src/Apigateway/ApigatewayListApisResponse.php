...
class ApigatewayListApisResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ApigatewayListApisResponse::class, 'RoRdb\\Google_Service_Apigateway_ApigatewayListApisResponse');
