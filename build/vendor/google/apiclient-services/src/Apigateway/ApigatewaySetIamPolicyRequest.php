...
class ApigatewaySetIamPolicyRequest extends \RoRdb\Google\Model
{
...
\class_alias(ApigatewaySetIamPolicyRequest::class, 'RoRdb\\Google_Service_Apigateway_ApigatewaySetIamPolicyRequest');
