...
class ApigatewayAuditConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ApigatewayAuditConfig::class, 'RoRdb\\Google_Service_Apigateway_ApigatewayAuditConfig');
