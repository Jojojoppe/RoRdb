...
class StateAndNotificationPayload extends \RoRdb\Google\Model
{
...
\class_alias(StateAndNotificationPayload::class, 'RoRdb\\Google_Service_HomeGraphService_StateAndNotificationPayload');
