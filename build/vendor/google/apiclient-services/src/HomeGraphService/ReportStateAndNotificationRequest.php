...
class ReportStateAndNotificationRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReportStateAndNotificationRequest::class, 'RoRdb\\Google_Service_HomeGraphService_ReportStateAndNotificationRequest');
