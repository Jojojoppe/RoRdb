 ...
 * @author Google, Inc.
 */
class VersionHistory extends \RoRdb\Google\Service
{
    public $platforms;
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->platforms = new VersionHistory\Resource\Platforms($this, $this->serviceName, 'platforms', ['methods' => ['list' => ['path' => 'v1/{+parent}/platforms', 'httpMethod' => 'GET', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'pageSize' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->platforms_channels = new VersionHistory\Resource\PlatformsChannels($this, $this->serviceName, 'channels', ['methods' => ['list' => ['path' => 'v1/{+parent}/channels', 'httpMethod' => 'GET', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'pageSize' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->platforms_channels_versions = new VersionHistory\Resource\PlatformsChannelsVersions($this, $this->serviceName, 'versions', ['methods' => ['list' => ['path' => 'v1/{+parent}/versions', 'httpMethod' => 'GET', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'filter' => ['location' => 'query', 'type' => 'string'], 'orderBy' => ['location' => 'query', 'type' => 'string'], 'pageSize' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
...
\class_alias(VersionHistory::class, 'RoRdb\\Google_Service_VersionHistory');
