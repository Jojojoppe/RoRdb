 ...
 * the License.
 */
namespace RoRdb\Google\Service\ManufacturerCenter\Resource;

use RoRdb\Google\Service\ManufacturerCenter\Attributes;
use RoRdb\Google\Service\ManufacturerCenter\ListProductsResponse;
use RoRdb\Google\Service\ManufacturerCenter\ManufacturersEmpty;
use RoRdb\Google\Service\ManufacturerCenter\Product;
/**
 ...
 *  </code>
 */
class AccountsProducts extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(AccountsProducts::class, 'RoRdb\\Google_Service_ManufacturerCenter_Resource_AccountsProducts');
