...
class FloodlightActivityPublisherDynamicTag extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FloodlightActivityPublisherDynamicTag::class, 'RoRdb\\Google_Service_Dfareporting_FloodlightActivityPublisherDynamicTag');
