...
class AdvertiserLandingPagesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AdvertiserLandingPagesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_AdvertiserLandingPagesListResponse');
