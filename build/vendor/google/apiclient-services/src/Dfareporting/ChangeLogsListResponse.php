...
class ChangeLogsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ChangeLogsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_ChangeLogsListResponse');
