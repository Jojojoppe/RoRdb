...
class PricingSchedulePricingPeriod extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PricingSchedulePricingPeriod::class, 'RoRdb\\Google_Service_Dfareporting_PricingSchedulePricingPeriod');
