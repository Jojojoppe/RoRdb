...
class CreativeAssetMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeAssetMetadata::class, 'RoRdb\\Google_Service_Dfareporting_CreativeAssetMetadata');
