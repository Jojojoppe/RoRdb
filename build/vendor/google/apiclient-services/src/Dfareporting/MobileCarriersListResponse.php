...
class MobileCarriersListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(MobileCarriersListResponse::class, 'RoRdb\\Google_Service_Dfareporting_MobileCarriersListResponse');
