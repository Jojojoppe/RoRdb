...
class AccountActiveAdSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountActiveAdSummary::class, 'RoRdb\\Google_Service_Dfareporting_AccountActiveAdSummary');
