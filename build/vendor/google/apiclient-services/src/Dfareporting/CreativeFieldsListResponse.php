...
class CreativeFieldsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeFieldsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_CreativeFieldsListResponse');
