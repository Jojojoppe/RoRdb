...
class AccountPermissionsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccountPermissionsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_AccountPermissionsListResponse');
