...
class RemarketingListsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RemarketingListsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_RemarketingListsListResponse');
