...
class TargetingTemplatesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(TargetingTemplatesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_TargetingTemplatesListResponse');
