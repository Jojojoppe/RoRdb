...
class ReportCompatibleFields extends \RoRdb\Google\Collection
{
...
\class_alias(ReportCompatibleFields::class, 'RoRdb\\Google_Service_Dfareporting_ReportCompatibleFields');
