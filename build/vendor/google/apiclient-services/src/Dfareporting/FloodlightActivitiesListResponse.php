...
class FloodlightActivitiesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(FloodlightActivitiesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_FloodlightActivitiesListResponse');
