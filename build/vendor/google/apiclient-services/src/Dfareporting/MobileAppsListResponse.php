...
class MobileAppsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(MobileAppsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_MobileAppsListResponse');
