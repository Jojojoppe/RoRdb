...
class RemarketingListShare extends \RoRdb\Google\Collection
{
...
\class_alias(RemarketingListShare::class, 'RoRdb\\Google_Service_Dfareporting_RemarketingListShare');
