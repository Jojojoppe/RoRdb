...
class DynamicTargetingKeysListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DynamicTargetingKeysListResponse::class, 'RoRdb\\Google_Service_Dfareporting_DynamicTargetingKeysListResponse');
