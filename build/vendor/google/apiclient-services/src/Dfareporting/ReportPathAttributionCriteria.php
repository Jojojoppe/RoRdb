...
class ReportPathAttributionCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(ReportPathAttributionCriteria::class, 'RoRdb\\Google_Service_Dfareporting_ReportPathAttributionCriteria');
