...
class VideoFormatsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(VideoFormatsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_VideoFormatsListResponse');
