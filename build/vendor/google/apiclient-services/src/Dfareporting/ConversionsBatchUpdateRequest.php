...
class ConversionsBatchUpdateRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ConversionsBatchUpdateRequest::class, 'RoRdb\\Google_Service_Dfareporting_ConversionsBatchUpdateRequest');
