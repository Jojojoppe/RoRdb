...
class CreativeGroupAssignment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreativeGroupAssignment::class, 'RoRdb\\Google_Service_Dfareporting_CreativeGroupAssignment');
