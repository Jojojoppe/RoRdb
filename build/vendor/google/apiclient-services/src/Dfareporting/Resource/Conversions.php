 ...
 * the License.
 */
namespace RoRdb\Google\Service\Dfareporting\Resource;

use RoRdb\Google\Service\Dfareporting\ConversionsBatchInsertRequest;
use RoRdb\Google\Service\Dfareporting\ConversionsBatchInsertResponse;
use RoRdb\Google\Service\Dfareporting\ConversionsBatchUpdateRequest;
use RoRdb\Google\Service\Dfareporting\ConversionsBatchUpdateResponse;
/**
 ...
 *  </code>
 */
class Conversions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Conversions::class, 'RoRdb\\Google_Service_Dfareporting_Resource_Conversions');
