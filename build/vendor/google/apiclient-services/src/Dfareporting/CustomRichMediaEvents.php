...
class CustomRichMediaEvents extends \RoRdb\Google\Collection
{
...
\class_alias(CustomRichMediaEvents::class, 'RoRdb\\Google_Service_Dfareporting_CustomRichMediaEvents');
