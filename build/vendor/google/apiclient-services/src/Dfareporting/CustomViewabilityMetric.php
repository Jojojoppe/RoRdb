...
class CustomViewabilityMetric extends \RoRdb\Google\Model
{
...
\class_alias(CustomViewabilityMetric::class, 'RoRdb\\Google_Service_Dfareporting_CustomViewabilityMetric');
