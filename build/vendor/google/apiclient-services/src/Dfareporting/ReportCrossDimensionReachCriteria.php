...
class ReportCrossDimensionReachCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(ReportCrossDimensionReachCriteria::class, 'RoRdb\\Google_Service_Dfareporting_ReportCrossDimensionReachCriteria');
