...
class ContentCategoriesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ContentCategoriesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_ContentCategoriesListResponse');
