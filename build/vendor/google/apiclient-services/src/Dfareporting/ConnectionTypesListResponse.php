...
class ConnectionTypesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ConnectionTypesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_ConnectionTypesListResponse');
