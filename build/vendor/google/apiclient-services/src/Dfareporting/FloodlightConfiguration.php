...
class FloodlightConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(FloodlightConfiguration::class, 'RoRdb\\Google_Service_Dfareporting_FloodlightConfiguration');
