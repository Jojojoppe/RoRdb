...
class CreativeAssetSelection extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeAssetSelection::class, 'RoRdb\\Google_Service_Dfareporting_CreativeAssetSelection');
