...
class CreativeGroupsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeGroupsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_CreativeGroupsListResponse');
