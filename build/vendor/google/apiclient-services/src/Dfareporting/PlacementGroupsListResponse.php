...
class PlacementGroupsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlacementGroupsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_PlacementGroupsListResponse');
