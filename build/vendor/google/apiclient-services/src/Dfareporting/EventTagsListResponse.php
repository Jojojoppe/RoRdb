...
class EventTagsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(EventTagsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_EventTagsListResponse');
