...
class ReportPathToConversionCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(ReportPathToConversionCriteria::class, 'RoRdb\\Google_Service_Dfareporting_ReportPathToConversionCriteria');
