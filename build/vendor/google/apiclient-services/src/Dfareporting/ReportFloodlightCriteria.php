...
class ReportFloodlightCriteria extends \RoRdb\Google\Collection
{
...
\class_alias(ReportFloodlightCriteria::class, 'RoRdb\\Google_Service_Dfareporting_ReportFloodlightCriteria');
