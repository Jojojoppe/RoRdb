...
class AdvertisersListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AdvertisersListResponse::class, 'RoRdb\\Google_Service_Dfareporting_AdvertisersListResponse');
