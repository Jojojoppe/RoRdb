...
class PlatformTypesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlatformTypesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_PlatformTypesListResponse');
