...
class ConversionsBatchInsertResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ConversionsBatchInsertResponse::class, 'RoRdb\\Google_Service_Dfareporting_ConversionsBatchInsertResponse');
