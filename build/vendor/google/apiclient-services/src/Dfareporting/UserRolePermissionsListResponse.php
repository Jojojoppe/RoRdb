...
class UserRolePermissionsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(UserRolePermissionsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_UserRolePermissionsListResponse');
