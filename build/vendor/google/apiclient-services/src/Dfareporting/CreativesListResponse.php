...
class CreativesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreativesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_CreativesListResponse');
