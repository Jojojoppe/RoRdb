...
class ConversionsBatchInsertRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ConversionsBatchInsertRequest::class, 'RoRdb\\Google_Service_Dfareporting_ConversionsBatchInsertRequest');
