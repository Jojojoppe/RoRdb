...
class InventoryItemsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(InventoryItemsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_InventoryItemsListResponse');
