...
class SiteTranscodeSetting extends \RoRdb\Google\Collection
{
...
\class_alias(SiteTranscodeSetting::class, 'RoRdb\\Google_Service_Dfareporting_SiteTranscodeSetting');
