...
class DefaultClickThroughEventTagProperties extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DefaultClickThroughEventTagProperties::class, 'RoRdb\\Google_Service_Dfareporting_DefaultClickThroughEventTagProperties');
