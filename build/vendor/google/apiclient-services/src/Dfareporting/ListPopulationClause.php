...
class ListPopulationClause extends \RoRdb\Google\Collection
{
...
\class_alias(ListPopulationClause::class, 'RoRdb\\Google_Service_Dfareporting_ListPopulationClause');
