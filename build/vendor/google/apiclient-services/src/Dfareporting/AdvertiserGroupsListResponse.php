...
class AdvertiserGroupsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AdvertiserGroupsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_AdvertiserGroupsListResponse');
