...
class TargetableRemarketingList extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TargetableRemarketingList::class, 'RoRdb\\Google_Service_Dfareporting_TargetableRemarketingList');
