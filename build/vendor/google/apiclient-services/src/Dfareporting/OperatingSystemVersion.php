...
class OperatingSystemVersion extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OperatingSystemVersion::class, 'RoRdb\\Google_Service_Dfareporting_OperatingSystemVersion');
