...
class CreativeOptimizationConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeOptimizationConfiguration::class, 'RoRdb\\Google_Service_Dfareporting_CreativeOptimizationConfiguration');
