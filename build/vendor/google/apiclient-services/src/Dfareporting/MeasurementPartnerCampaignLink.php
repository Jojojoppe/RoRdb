...
class MeasurementPartnerCampaignLink extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MeasurementPartnerCampaignLink::class, 'RoRdb\\Google_Service_Dfareporting_MeasurementPartnerCampaignLink');
