...
class ConversionsBatchUpdateResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ConversionsBatchUpdateResponse::class, 'RoRdb\\Google_Service_Dfareporting_ConversionsBatchUpdateResponse');
