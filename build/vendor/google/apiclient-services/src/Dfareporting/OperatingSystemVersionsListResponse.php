...
class OperatingSystemVersionsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(OperatingSystemVersionsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_OperatingSystemVersionsListResponse');
