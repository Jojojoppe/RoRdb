...
class CreativeFieldValuesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreativeFieldValuesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_CreativeFieldValuesListResponse');
