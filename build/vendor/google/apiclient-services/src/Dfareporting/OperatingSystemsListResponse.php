...
class OperatingSystemsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(OperatingSystemsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_OperatingSystemsListResponse');
