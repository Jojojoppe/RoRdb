...
class FloodlightActivityGroup extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FloodlightActivityGroup::class, 'RoRdb\\Google_Service_Dfareporting_FloodlightActivityGroup');
