...
class FloodlightActivitiesGenerateTagResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FloodlightActivitiesGenerateTagResponse::class, 'RoRdb\\Google_Service_Dfareporting_FloodlightActivitiesGenerateTagResponse');
