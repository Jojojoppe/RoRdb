...
class CustomViewabilityMetricConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(CustomViewabilityMetricConfiguration::class, 'RoRdb\\Google_Service_Dfareporting_CustomViewabilityMetricConfiguration');
