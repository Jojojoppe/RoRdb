...
class ReachReportCompatibleFields extends \RoRdb\Google\Collection
{
...
\class_alias(ReachReportCompatibleFields::class, 'RoRdb\\Google_Service_Dfareporting_ReachReportCompatibleFields');
