...
class AccountUserProfilesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(AccountUserProfilesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_AccountUserProfilesListResponse');
