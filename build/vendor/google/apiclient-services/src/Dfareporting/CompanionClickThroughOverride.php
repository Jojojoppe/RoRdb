...
class CompanionClickThroughOverride extends \RoRdb\Google\Model
{
...
\class_alias(CompanionClickThroughOverride::class, 'RoRdb\\Google_Service_Dfareporting_CompanionClickThroughOverride');
