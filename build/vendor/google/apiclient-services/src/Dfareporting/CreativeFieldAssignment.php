...
class CreativeFieldAssignment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreativeFieldAssignment::class, 'RoRdb\\Google_Service_Dfareporting_CreativeFieldAssignment');
