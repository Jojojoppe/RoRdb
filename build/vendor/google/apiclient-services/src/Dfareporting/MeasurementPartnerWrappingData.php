...
class MeasurementPartnerWrappingData extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MeasurementPartnerWrappingData::class, 'RoRdb\\Google_Service_Dfareporting_MeasurementPartnerWrappingData');
