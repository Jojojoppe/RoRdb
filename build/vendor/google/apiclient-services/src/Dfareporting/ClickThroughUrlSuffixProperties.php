...
class ClickThroughUrlSuffixProperties extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ClickThroughUrlSuffixProperties::class, 'RoRdb\\Google_Service_Dfareporting_ClickThroughUrlSuffixProperties');
