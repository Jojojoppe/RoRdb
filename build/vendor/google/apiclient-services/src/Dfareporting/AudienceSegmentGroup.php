...
class AudienceSegmentGroup extends \RoRdb\Google\Collection
{
...
\class_alias(AudienceSegmentGroup::class, 'RoRdb\\Google_Service_Dfareporting_AudienceSegmentGroup');
