...
class PlacementStrategiesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(PlacementStrategiesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_PlacementStrategiesListResponse');
