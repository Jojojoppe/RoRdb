...
class SiteCompanionSetting extends \RoRdb\Google\Collection
{
...
\class_alias(SiteCompanionSetting::class, 'RoRdb\\Google_Service_Dfareporting_SiteCompanionSetting');
