...
class OrderDocumentsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(OrderDocumentsListResponse::class, 'RoRdb\\Google_Service_Dfareporting_OrderDocumentsListResponse');
