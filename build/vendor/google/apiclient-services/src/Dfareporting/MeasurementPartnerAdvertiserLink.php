...
class MeasurementPartnerAdvertiserLink extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MeasurementPartnerAdvertiserLink::class, 'RoRdb\\Google_Service_Dfareporting_MeasurementPartnerAdvertiserLink');
