...
class CreativeClickThroughUrl extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreativeClickThroughUrl::class, 'RoRdb\\Google_Service_Dfareporting_CreativeClickThroughUrl');
