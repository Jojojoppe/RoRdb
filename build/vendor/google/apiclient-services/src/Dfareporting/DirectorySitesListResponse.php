...
class DirectorySitesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(DirectorySitesListResponse::class, 'RoRdb\\Google_Service_Dfareporting_DirectorySitesListResponse');
