...
class ReportPathToConversionCriteriaReportProperties extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ReportPathToConversionCriteriaReportProperties::class, 'RoRdb\\Google_Service_Dfareporting_ReportPathToConversionCriteriaReportProperties');
