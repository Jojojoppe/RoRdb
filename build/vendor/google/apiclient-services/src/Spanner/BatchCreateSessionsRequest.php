...
class BatchCreateSessionsRequest extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(BatchCreateSessionsRequest::class, 'RoRdb\\Google_Service_Spanner_BatchCreateSessionsRequest');
