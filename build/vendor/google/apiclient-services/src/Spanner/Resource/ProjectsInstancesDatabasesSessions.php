 ...
 * the License.
 */
namespace RoRdb\Google\Service\Spanner\Resource;

use RoRdb\Google\Service\Spanner\BatchCreateSessionsRequest;
use RoRdb\Google\Service\Spanner\BatchCreateSessionsResponse;
use RoRdb\Google\Service\Spanner\BeginTransactionRequest;
use RoRdb\Google\Service\Spanner\CommitRequest;
use RoRdb\Google\Service\Spanner\CommitResponse;
use RoRdb\Google\Service\Spanner\CreateSessionRequest;
use RoRdb\Google\Service\Spanner\ExecuteBatchDmlRequest;
use RoRdb\Google\Service\Spanner\ExecuteBatchDmlResponse;
use RoRdb\Google\Service\Spanner\ExecuteSqlRequest;
use RoRdb\Google\Service\Spanner\ListSessionsResponse;
use RoRdb\Google\Service\Spanner\PartialResultSet;
use RoRdb\Google\Service\Spanner\PartitionQueryRequest;
use RoRdb\Google\Service\Spanner\PartitionReadRequest;
use RoRdb\Google\Service\Spanner\PartitionResponse;
use RoRdb\Google\Service\Spanner\ReadRequest;
use RoRdb\Google\Service\Spanner\ResultSet;
use RoRdb\Google\Service\Spanner\RollbackRequest;
use RoRdb\Google\Service\Spanner\Session;
use RoRdb\Google\Service\Spanner\SpannerEmpty;
use RoRdb\Google\Service\Spanner\Transaction;
/**
 ...
 *  </code>
 */
class ProjectsInstancesDatabasesSessions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsInstancesDatabasesSessions::class, 'RoRdb\\Google_Service_Spanner_Resource_ProjectsInstancesDatabasesSessions');
