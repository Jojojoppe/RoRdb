...
use RoRdb\Google\Service\Spanner\CreateDatabaseRequest;
use RoRdb\Google\Service\Spanner\Database;
use RoRdb\Google\Service\Spanner\GetDatabaseDdlResponse;
use RoRdb\Google\Service\Spanner\GetIamPolicyRequest;
use RoRdb\Google\Service\Spanner\ListDatabasesResponse;
use RoRdb\Google\Service\Spanner\Operation;
use RoRdb\Google\Service\Spanner\Policy;
use RoRdb\Google\Service\Spanner\RestoreDatabaseRequest;
use RoRdb\Google\Service\Spanner\Scan;
use RoRdb\Google\Service\Spanner\SetIamPolicyRequest;
use RoRdb\Google\Service\Spanner\SpannerEmpty;
use RoRdb\Google\Service\Spanner\TestIamPermissionsRequest;
use RoRdb\Google\Service\Spanner\TestIamPermissionsResponse;
use RoRdb\Google\Service\Spanner\UpdateDatabaseDdlRequest;
/**
 ...
 *  </code>
 */
class ProjectsInstancesDatabases extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsInstancesDatabases::class, 'RoRdb\\Google_Service_Spanner_Resource_ProjectsInstancesDatabases');
