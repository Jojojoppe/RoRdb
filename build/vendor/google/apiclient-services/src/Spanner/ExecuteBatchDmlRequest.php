...
class ExecuteBatchDmlRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ExecuteBatchDmlRequest::class, 'RoRdb\\Google_Service_Spanner_ExecuteBatchDmlRequest');
