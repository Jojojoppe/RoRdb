...
class RestoreDatabaseMetadata extends \RoRdb\Google\Model
{
...
\class_alias(RestoreDatabaseMetadata::class, 'RoRdb\\Google_Service_Spanner_RestoreDatabaseMetadata');
