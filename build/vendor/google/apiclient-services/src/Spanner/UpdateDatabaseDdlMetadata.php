...
class UpdateDatabaseDdlMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(UpdateDatabaseDdlMetadata::class, 'RoRdb\\Google_Service_Spanner_UpdateDatabaseDdlMetadata');
