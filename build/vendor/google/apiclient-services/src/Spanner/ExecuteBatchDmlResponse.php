...
class ExecuteBatchDmlResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ExecuteBatchDmlResponse::class, 'RoRdb\\Google_Service_Spanner_ExecuteBatchDmlResponse');
