...
class ListInstanceConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListInstanceConfigsResponse::class, 'RoRdb\\Google_Service_Spanner_ListInstanceConfigsResponse');
