 ...
 * @author Google, Inc.
 */
class Acceleratedmobilepageurl extends \RoRdb\Google\Service
{
    public $ampUrls;
    /**
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->ampUrls = new Acceleratedmobilepageurl\Resource\AmpUrls($this, $this->serviceName, 'ampUrls', ['methods' => ['batchGet' => ['path' => 'v1/ampUrls:batchGet', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Acceleratedmobilepageurl::class, 'RoRdb\\Google_Service_Acceleratedmobilepageurl');
