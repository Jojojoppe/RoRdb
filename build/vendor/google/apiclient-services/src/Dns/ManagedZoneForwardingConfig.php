...
class ManagedZoneForwardingConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedZoneForwardingConfig::class, 'RoRdb\\Google_Service_Dns_ManagedZoneForwardingConfig');
