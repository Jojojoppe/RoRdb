...
class OperationManagedZoneContext extends \RoRdb\Google\Model
{
...
\class_alias(OperationManagedZoneContext::class, 'RoRdb\\Google_Service_Dns_OperationManagedZoneContext');
