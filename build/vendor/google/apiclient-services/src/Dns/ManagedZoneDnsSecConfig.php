...
class ManagedZoneDnsSecConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedZoneDnsSecConfig::class, 'RoRdb\\Google_Service_Dns_ManagedZoneDnsSecConfig');
