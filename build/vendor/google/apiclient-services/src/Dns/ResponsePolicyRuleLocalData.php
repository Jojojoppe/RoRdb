...
class ResponsePolicyRuleLocalData extends \RoRdb\Google\Collection
{
...
\class_alias(ResponsePolicyRuleLocalData::class, 'RoRdb\\Google_Service_Dns_ResponsePolicyRuleLocalData');
