...
class ResponsePoliciesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ResponsePoliciesListResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePoliciesListResponse');
