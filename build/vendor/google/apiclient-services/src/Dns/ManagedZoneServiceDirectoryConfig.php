...
class ManagedZoneServiceDirectoryConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ManagedZoneServiceDirectoryConfig::class, 'RoRdb\\Google_Service_Dns_ManagedZoneServiceDirectoryConfig');
