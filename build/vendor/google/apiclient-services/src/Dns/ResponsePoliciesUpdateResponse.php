...
class ResponsePoliciesUpdateResponse extends \RoRdb\Google\Model
{
...
\class_alias(ResponsePoliciesUpdateResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePoliciesUpdateResponse');
