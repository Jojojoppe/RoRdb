...
class ResponsePoliciesPatchResponse extends \RoRdb\Google\Model
{
...
\class_alias(ResponsePoliciesPatchResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePoliciesPatchResponse');
