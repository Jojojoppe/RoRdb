...
class ManagedZonesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedZonesListResponse::class, 'RoRdb\\Google_Service_Dns_ManagedZonesListResponse');
