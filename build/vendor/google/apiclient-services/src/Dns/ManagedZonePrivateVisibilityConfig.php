...
class ManagedZonePrivateVisibilityConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedZonePrivateVisibilityConfig::class, 'RoRdb\\Google_Service_Dns_ManagedZonePrivateVisibilityConfig');
