...
class ResponsePolicyRulesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ResponsePolicyRulesListResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePolicyRulesListResponse');
