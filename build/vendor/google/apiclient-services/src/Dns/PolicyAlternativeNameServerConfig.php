...
class PolicyAlternativeNameServerConfig extends \RoRdb\Google\Collection
{
...
\class_alias(PolicyAlternativeNameServerConfig::class, 'RoRdb\\Google_Service_Dns_PolicyAlternativeNameServerConfig');
