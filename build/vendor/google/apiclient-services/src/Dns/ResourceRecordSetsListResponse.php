...
class ResourceRecordSetsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ResourceRecordSetsListResponse::class, 'RoRdb\\Google_Service_Dns_ResourceRecordSetsListResponse');
