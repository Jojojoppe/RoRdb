...
class ResponsePolicyRulesUpdateResponse extends \RoRdb\Google\Model
{
...
\class_alias(ResponsePolicyRulesUpdateResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePolicyRulesUpdateResponse');
