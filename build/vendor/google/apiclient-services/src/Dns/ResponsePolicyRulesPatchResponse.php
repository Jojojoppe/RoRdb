...
class ResponsePolicyRulesPatchResponse extends \RoRdb\Google\Model
{
...
\class_alias(ResponsePolicyRulesPatchResponse::class, 'RoRdb\\Google_Service_Dns_ResponsePolicyRulesPatchResponse');
