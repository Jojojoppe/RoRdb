...
class AccessApprovalSettings extends \RoRdb\Google\Collection
{
...
\class_alias(AccessApprovalSettings::class, 'RoRdb\\Google_Service_AccessApproval_AccessApprovalSettings');
