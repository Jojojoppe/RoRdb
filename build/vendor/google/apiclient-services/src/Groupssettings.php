 ...
 * @author Google, Inc.
 */
class Groupssettings extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->groups = new Groupssettings\Resource\Groups($this, $this->serviceName, 'groups', ['methods' => ['get' => ['path' => '{groupUniqueId}', 'httpMethod' => 'GET', 'parameters' => ['groupUniqueId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'patch' => ['path' => '{groupUniqueId}', 'httpMethod' => 'PATCH', 'parameters' => ['groupUniqueId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'update' => ['path' => '{groupUniqueId}', 'httpMethod' => 'PUT', 'parameters' => ['groupUniqueId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Groupssettings::class, 'RoRdb\\Google_Service_Groupssettings');
