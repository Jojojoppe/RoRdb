...
class SynthesizeSpeechRequest extends \RoRdb\Google\Model
{
...
\class_alias(SynthesizeSpeechRequest::class, 'RoRdb\\Google_Service_Texttospeech_SynthesizeSpeechRequest');
