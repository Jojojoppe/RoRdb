...
class AcceptProposalRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AcceptProposalRequest::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_AcceptProposalRequest');
