...
class ProgrammaticGuaranteedTerms extends \RoRdb\Google\Model
{
...
\class_alias(ProgrammaticGuaranteedTerms::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_ProgrammaticGuaranteedTerms');
