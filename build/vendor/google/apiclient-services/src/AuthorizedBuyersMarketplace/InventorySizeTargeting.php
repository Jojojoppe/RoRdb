...
class InventorySizeTargeting extends \RoRdb\Google\Collection
{
...
\class_alias(InventorySizeTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_InventorySizeTargeting');
