...
class PrivateAuctionTerms extends \RoRdb\Google\Model
{
...
\class_alias(PrivateAuctionTerms::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_PrivateAuctionTerms');
