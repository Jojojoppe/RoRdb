...
class CreativeRequirements extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreativeRequirements::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_CreativeRequirements');
