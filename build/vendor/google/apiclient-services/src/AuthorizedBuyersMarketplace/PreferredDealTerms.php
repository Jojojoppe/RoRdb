...
class PreferredDealTerms extends \RoRdb\Google\Model
{
...
\class_alias(PreferredDealTerms::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_PreferredDealTerms');
