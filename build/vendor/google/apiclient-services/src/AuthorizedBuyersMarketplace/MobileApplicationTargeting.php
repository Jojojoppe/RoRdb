...
class MobileApplicationTargeting extends \RoRdb\Google\Model
{
...
\class_alias(MobileApplicationTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_MobileApplicationTargeting');
