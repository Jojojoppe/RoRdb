...
class MarketplaceTargeting extends \RoRdb\Google\Model
{
...
\class_alias(MarketplaceTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_MarketplaceTargeting');
