...
class ListPublisherProfilesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPublisherProfilesResponse::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_ListPublisherProfilesResponse');
