...
class DayPartTargeting extends \RoRdb\Google\Collection
{
...
\class_alias(DayPartTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_DayPartTargeting');
