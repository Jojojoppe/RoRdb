...
class ListClientUsersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListClientUsersResponse::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_ListClientUsersResponse');
