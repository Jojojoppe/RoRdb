...
class PlacementTargeting extends \RoRdb\Google\Model
{
...
\class_alias(PlacementTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_PlacementTargeting');
