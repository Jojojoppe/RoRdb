...
class CriteriaTargeting extends \RoRdb\Google\Collection
{
...
\class_alias(CriteriaTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_CriteriaTargeting');
