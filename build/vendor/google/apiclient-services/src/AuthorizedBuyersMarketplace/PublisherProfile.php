...
class PublisherProfile extends \RoRdb\Google\Collection
{
...
\class_alias(PublisherProfile::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_PublisherProfile');
