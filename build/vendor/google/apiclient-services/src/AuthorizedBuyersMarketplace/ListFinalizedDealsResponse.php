...
class ListFinalizedDealsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListFinalizedDealsResponse::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_ListFinalizedDealsResponse');
