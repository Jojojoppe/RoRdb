...
class TechnologyTargeting extends \RoRdb\Google\Model
{
...
\class_alias(TechnologyTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_TechnologyTargeting');
