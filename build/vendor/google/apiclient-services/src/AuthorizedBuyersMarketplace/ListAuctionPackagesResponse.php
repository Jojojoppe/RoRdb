...
class ListAuctionPackagesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAuctionPackagesResponse::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_ListAuctionPackagesResponse');
