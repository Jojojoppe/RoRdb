...
class OperatingSystemTargeting extends \RoRdb\Google\Model
{
...
\class_alias(OperatingSystemTargeting::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_OperatingSystemTargeting');
