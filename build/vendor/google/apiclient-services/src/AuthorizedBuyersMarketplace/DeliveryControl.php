...
class DeliveryControl extends \RoRdb\Google\Collection
{
...
\class_alias(DeliveryControl::class, 'RoRdb\\Google_Service_AuthorizedBuyersMarketplace_DeliveryControl');
