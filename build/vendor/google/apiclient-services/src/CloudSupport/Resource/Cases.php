 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudSupport\Resource;

use RoRdb\Google\Service\CloudSupport\CloseCaseRequest;
use RoRdb\Google\Service\CloudSupport\CloudsupportCase;
use RoRdb\Google\Service\CloudSupport\EscalateCaseRequest;
use RoRdb\Google\Service\CloudSupport\ListCasesResponse;
use RoRdb\Google\Service\CloudSupport\SearchCasesResponse;
/**
 ...
 *  </code>
 */
class Cases extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Cases::class, 'RoRdb\\Google_Service_CloudSupport_Resource_Cases');
