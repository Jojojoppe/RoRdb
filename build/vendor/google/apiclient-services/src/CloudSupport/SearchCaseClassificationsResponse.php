 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudSupport;

class SearchCaseClassificationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchCaseClassificationsResponse::class, 'RoRdb\\Google_Service_CloudSupport_SearchCaseClassificationsResponse');
