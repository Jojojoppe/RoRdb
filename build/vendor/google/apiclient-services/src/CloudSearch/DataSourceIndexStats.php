...
class DataSourceIndexStats extends \RoRdb\Google\Collection
{
...
\class_alias(DataSourceIndexStats::class, 'RoRdb\\Google_Service_CloudSearch_DataSourceIndexStats');
