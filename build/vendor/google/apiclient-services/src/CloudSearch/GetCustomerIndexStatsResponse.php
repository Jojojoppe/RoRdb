...
class GetCustomerIndexStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetCustomerIndexStatsResponse::class, 'RoRdb\\Google_Service_CloudSearch_GetCustomerIndexStatsResponse');
