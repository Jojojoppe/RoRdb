...
class TimestampPropertyOptions extends \RoRdb\Google\Model
{
...
\class_alias(TimestampPropertyOptions::class, 'RoRdb\\Google_Service_CloudSearch_TimestampPropertyOptions');
