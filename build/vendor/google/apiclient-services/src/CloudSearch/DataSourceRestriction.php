...
class DataSourceRestriction extends \RoRdb\Google\Collection
{
...
\class_alias(DataSourceRestriction::class, 'RoRdb\\Google_Service_CloudSearch_DataSourceRestriction');
