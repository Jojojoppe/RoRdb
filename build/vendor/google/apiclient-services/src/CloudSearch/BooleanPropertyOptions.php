...
class BooleanPropertyOptions extends \RoRdb\Google\Model
{
...
\class_alias(BooleanPropertyOptions::class, 'RoRdb\\Google_Service_CloudSearch_BooleanPropertyOptions');
