...
class GetDataSourceIndexStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetDataSourceIndexStatsResponse::class, 'RoRdb\\Google_Service_CloudSearch_GetDataSourceIndexStatsResponse');
