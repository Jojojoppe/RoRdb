...
class SearchApplicationQueryStats extends \RoRdb\Google\Collection
{
...
\class_alias(SearchApplicationQueryStats::class, 'RoRdb\\Google_Service_CloudSearch_SearchApplicationQueryStats');
