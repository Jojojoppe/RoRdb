...
class ObjectDisplayOptions extends \RoRdb\Google\Collection
{
...
\class_alias(ObjectDisplayOptions::class, 'RoRdb\\Google_Service_CloudSearch_ObjectDisplayOptions');
