...
class IntegerOperatorOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IntegerOperatorOptions::class, 'RoRdb\\Google_Service_CloudSearch_IntegerOperatorOptions');
