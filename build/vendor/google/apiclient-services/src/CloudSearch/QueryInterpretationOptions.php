...
class QueryInterpretationOptions extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(QueryInterpretationOptions::class, 'RoRdb\\Google_Service_CloudSearch_QueryInterpretationOptions');
