...
class ListUnmappedIdentitiesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUnmappedIdentitiesResponse::class, 'RoRdb\\Google_Service_CloudSearch_ListUnmappedIdentitiesResponse');
