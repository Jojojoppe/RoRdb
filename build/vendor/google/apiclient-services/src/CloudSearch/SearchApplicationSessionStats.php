...
class SearchApplicationSessionStats extends \RoRdb\Google\Model
{
...
\class_alias(SearchApplicationSessionStats::class, 'RoRdb\\Google_Service_CloudSearch_SearchApplicationSessionStats');
