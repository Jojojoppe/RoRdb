...
class GetCustomerQueryStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetCustomerQueryStatsResponse::class, 'RoRdb\\Google_Service_CloudSearch_GetCustomerQueryStatsResponse');
