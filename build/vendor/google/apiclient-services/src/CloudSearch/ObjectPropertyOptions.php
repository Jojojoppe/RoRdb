...
class ObjectPropertyOptions extends \RoRdb\Google\Collection
{
...
\class_alias(ObjectPropertyOptions::class, 'RoRdb\\Google_Service_CloudSearch_ObjectPropertyOptions');
