...
class QueryInterpretationConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(QueryInterpretationConfig::class, 'RoRdb\\Google_Service_CloudSearch_QueryInterpretationConfig');
