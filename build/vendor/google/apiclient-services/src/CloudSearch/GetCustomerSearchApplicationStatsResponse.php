...
class GetCustomerSearchApplicationStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetCustomerSearchApplicationStatsResponse::class, 'RoRdb\\Google_Service_CloudSearch_GetCustomerSearchApplicationStatsResponse');
