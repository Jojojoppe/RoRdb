...
class ListSearchApplicationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListSearchApplicationsResponse::class, 'RoRdb\\Google_Service_CloudSearch_ListSearchApplicationsResponse');
