...
class GetCustomerUserStatsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetCustomerUserStatsResponse::class, 'RoRdb\\Google_Service_CloudSearch_GetCustomerUserStatsResponse');
