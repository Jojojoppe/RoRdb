...
class UpdateDataSourceRequest extends \RoRdb\Google\Model
{
...
\class_alias(UpdateDataSourceRequest::class, 'RoRdb\\Google_Service_CloudSearch_UpdateDataSourceRequest');
