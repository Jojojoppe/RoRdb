...
class TimestampOperatorOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TimestampOperatorOptions::class, 'RoRdb\\Google_Service_CloudSearch_TimestampOperatorOptions');
