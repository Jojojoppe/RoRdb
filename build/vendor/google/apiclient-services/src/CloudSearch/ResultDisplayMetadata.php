...
class ResultDisplayMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(ResultDisplayMetadata::class, 'RoRdb\\Google_Service_CloudSearch_ResultDisplayMetadata');
