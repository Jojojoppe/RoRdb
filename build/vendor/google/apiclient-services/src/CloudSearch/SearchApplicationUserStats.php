...
class SearchApplicationUserStats extends \RoRdb\Google\Model
{
...
\class_alias(SearchApplicationUserStats::class, 'RoRdb\\Google_Service_CloudSearch_SearchApplicationUserStats');
