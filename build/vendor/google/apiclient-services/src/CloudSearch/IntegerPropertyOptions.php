...
class IntegerPropertyOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IntegerPropertyOptions::class, 'RoRdb\\Google_Service_CloudSearch_IntegerPropertyOptions');
