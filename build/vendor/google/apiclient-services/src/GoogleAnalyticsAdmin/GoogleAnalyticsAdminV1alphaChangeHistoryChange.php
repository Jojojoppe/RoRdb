...
class GoogleAnalyticsAdminV1alphaChangeHistoryChange extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaChangeHistoryChange::class, 'RoRdb\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaChangeHistoryChange');
