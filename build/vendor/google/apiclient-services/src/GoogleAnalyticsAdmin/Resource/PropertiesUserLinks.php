 ...
 * the License.
 */
namespace RoRdb\Google\Service\GoogleAnalyticsAdmin\Resource;

use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAuditUserLinksRequest;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaAuditUserLinksResponse;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchCreateUserLinksRequest;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchCreateUserLinksResponse;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchDeleteUserLinksRequest;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchGetUserLinksResponse;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequest;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksResponse;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaListUserLinksResponse;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaUserLink;
use RoRdb\Google\Service\GoogleAnalyticsAdmin\GoogleProtobufEmpty;
/**
 ...
 *  </code>
 */
class PropertiesUserLinks extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(PropertiesUserLinks::class, 'RoRdb\\Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesUserLinks');
