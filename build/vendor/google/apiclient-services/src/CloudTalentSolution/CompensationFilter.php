...
class CompensationFilter extends \RoRdb\Google\Collection
{
...
\class_alias(CompensationFilter::class, 'RoRdb\\Google_Service_CloudTalentSolution_CompensationFilter');
