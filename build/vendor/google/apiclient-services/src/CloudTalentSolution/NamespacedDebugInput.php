...
class NamespacedDebugInput extends \RoRdb\Google\Collection
{
...
\class_alias(NamespacedDebugInput::class, 'RoRdb\\Google_Service_CloudTalentSolution_NamespacedDebugInput');
