...
class ListTenantsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTenantsResponse::class, 'RoRdb\\Google_Service_CloudTalentSolution_ListTenantsResponse');
