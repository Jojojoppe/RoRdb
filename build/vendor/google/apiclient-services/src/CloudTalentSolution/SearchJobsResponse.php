...
class SearchJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchJobsResponse::class, 'RoRdb\\Google_Service_CloudTalentSolution_SearchJobsResponse');
