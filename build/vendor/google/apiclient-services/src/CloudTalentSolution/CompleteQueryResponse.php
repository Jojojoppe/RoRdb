...
class CompleteQueryResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CompleteQueryResponse::class, 'RoRdb\\Google_Service_CloudTalentSolution_CompleteQueryResponse');
