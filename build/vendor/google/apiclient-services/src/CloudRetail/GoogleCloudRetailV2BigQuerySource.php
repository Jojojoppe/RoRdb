...
class GoogleCloudRetailV2BigQuerySource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2BigQuerySource::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2BigQuerySource');
