...
class GoogleCloudRetailV2UserEventImportSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2UserEventImportSummary::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2UserEventImportSummary');
