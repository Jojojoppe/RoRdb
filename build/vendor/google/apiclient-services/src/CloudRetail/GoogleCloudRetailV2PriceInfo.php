...
class GoogleCloudRetailV2PriceInfo extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(GoogleCloudRetailV2PriceInfo::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2PriceInfo');
