...
class GoogleCloudRetailV2PredictRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2PredictRequest::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2PredictRequest');
