...
class GoogleCloudRetailV2Catalog extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2Catalog::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2Catalog');
