...
class GoogleCloudRetailV2betaRejoinUserEventsResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2betaRejoinUserEventsResponse::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2betaRejoinUserEventsResponse');
