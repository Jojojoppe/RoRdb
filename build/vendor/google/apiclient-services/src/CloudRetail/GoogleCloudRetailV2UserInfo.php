...
class GoogleCloudRetailV2UserInfo extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudRetailV2UserInfo::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2UserInfo');
