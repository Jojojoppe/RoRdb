...
class GoogleCloudRetailV2RejoinUserEventsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2RejoinUserEventsRequest::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2RejoinUserEventsRequest');
