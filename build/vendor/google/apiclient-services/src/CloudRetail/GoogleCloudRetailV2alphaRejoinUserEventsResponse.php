...
class GoogleCloudRetailV2alphaRejoinUserEventsResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2alphaRejoinUserEventsResponse::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2alphaRejoinUserEventsResponse');
