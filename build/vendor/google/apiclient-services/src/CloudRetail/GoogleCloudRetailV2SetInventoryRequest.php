...
class GoogleCloudRetailV2SetInventoryRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudRetailV2SetInventoryRequest::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2SetInventoryRequest');
