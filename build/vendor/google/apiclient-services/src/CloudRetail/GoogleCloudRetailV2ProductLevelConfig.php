...
class GoogleCloudRetailV2ProductLevelConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2ProductLevelConfig::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2ProductLevelConfig');
