...
class GoogleCloudRetailV2CompletionDetail extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2CompletionDetail::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2CompletionDetail');
