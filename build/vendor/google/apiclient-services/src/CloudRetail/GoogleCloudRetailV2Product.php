...
class GoogleCloudRetailV2Product extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudRetailV2Product::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2Product');
