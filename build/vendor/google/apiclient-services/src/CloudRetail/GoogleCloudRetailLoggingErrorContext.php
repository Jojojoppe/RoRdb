...
class GoogleCloudRetailLoggingErrorContext extends \RoRdb\Google\Model
{
...
\class_alias(GoogleCloudRetailLoggingErrorContext::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailLoggingErrorContext');
