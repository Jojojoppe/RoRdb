...
class GoogleCloudRetailV2betaUserEventImportSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2betaUserEventImportSummary::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2betaUserEventImportSummary');
