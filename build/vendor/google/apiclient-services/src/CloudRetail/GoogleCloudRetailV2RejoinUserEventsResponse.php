...
class GoogleCloudRetailV2RejoinUserEventsResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2RejoinUserEventsResponse::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2RejoinUserEventsResponse');
