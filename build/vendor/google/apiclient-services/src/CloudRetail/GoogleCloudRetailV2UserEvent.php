...
class GoogleCloudRetailV2UserEvent extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudRetailV2UserEvent::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2UserEvent');
