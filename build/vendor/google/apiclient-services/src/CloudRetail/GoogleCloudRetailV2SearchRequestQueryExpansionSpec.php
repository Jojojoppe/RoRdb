...
class GoogleCloudRetailV2SearchRequestQueryExpansionSpec extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2SearchRequestQueryExpansionSpec::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2SearchRequestQueryExpansionSpec');
