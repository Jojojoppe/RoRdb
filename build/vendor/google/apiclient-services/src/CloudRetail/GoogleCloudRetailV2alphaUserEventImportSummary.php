...
class GoogleCloudRetailV2alphaUserEventImportSummary extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2alphaUserEventImportSummary::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2alphaUserEventImportSummary');
