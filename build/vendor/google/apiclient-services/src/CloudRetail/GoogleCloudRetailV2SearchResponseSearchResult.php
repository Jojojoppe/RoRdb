...
class GoogleCloudRetailV2SearchResponseSearchResult extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRetailV2SearchResponseSearchResult::class, 'RoRdb\\Google_Service_CloudRetail_GoogleCloudRetailV2SearchResponseSearchResult');
