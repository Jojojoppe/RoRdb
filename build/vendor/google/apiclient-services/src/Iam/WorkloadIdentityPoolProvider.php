...
class WorkloadIdentityPoolProvider extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(WorkloadIdentityPoolProvider::class, 'RoRdb\\Google_Service_Iam_WorkloadIdentityPoolProvider');
