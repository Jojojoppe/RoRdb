...
class ListWorkloadIdentityPoolsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListWorkloadIdentityPoolsResponse::class, 'RoRdb\\Google_Service_Iam_ListWorkloadIdentityPoolsResponse');
