 ...
 * the License.
 */
namespace RoRdb\Google\Service\Iam\Resource;

use RoRdb\Google\Service\Iam\CreateServiceAccountRequest;
use RoRdb\Google\Service\Iam\DisableServiceAccountRequest;
use RoRdb\Google\Service\Iam\EnableServiceAccountRequest;
use RoRdb\Google\Service\Iam\IamEmpty;
use RoRdb\Google\Service\Iam\ListServiceAccountsResponse;
use RoRdb\Google\Service\Iam\PatchServiceAccountRequest;
use RoRdb\Google\Service\Iam\Policy;
use RoRdb\Google\Service\Iam\ServiceAccount;
use RoRdb\Google\Service\Iam\SetIamPolicyRequest;
use RoRdb\Google\Service\Iam\SignBlobRequest;
use RoRdb\Google\Service\Iam\SignBlobResponse;
use RoRdb\Google\Service\Iam\SignJwtRequest;
use RoRdb\Google\Service\Iam\SignJwtResponse;
use RoRdb\Google\Service\Iam\TestIamPermissionsRequest;
use RoRdb\Google\Service\Iam\TestIamPermissionsResponse;
use RoRdb\Google\Service\Iam\UndeleteServiceAccountRequest;
use RoRdb\Google\Service\Iam\UndeleteServiceAccountResponse;
/**
 ...
 *  </code>
 */
class ProjectsServiceAccounts extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsServiceAccounts::class, 'RoRdb\\Google_Service_Iam_Resource_ProjectsServiceAccounts');
