...
class UndeleteServiceAccountResponse extends \RoRdb\Google\Model
{
...
\class_alias(UndeleteServiceAccountResponse::class, 'RoRdb\\Google_Service_Iam_UndeleteServiceAccountResponse');
