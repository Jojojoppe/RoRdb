 ...
 * the License.
 */
namespace RoRdb\Google\Service\TPU;

class ListTensorFlowVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTensorFlowVersionsResponse::class, 'RoRdb\\Google_Service_TPU_ListTensorFlowVersionsResponse');
