...
class ListAcceleratorTypesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAcceleratorTypesResponse::class, 'RoRdb\\Google_Service_TPU_ListAcceleratorTypesResponse');
