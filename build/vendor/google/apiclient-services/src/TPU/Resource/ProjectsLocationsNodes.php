 ...
 * the License.
 */
namespace RoRdb\Google\Service\TPU\Resource;

use RoRdb\Google\Service\TPU\ListNodesResponse;
use RoRdb\Google\Service\TPU\Node;
use RoRdb\Google\Service\TPU\Operation;
use RoRdb\Google\Service\TPU\ReimageNodeRequest;
use RoRdb\Google\Service\TPU\StartNodeRequest;
use RoRdb\Google\Service\TPU\StopNodeRequest;
/**
 ...
 *  </code>
 */
class ProjectsLocationsNodes extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsNodes::class, 'RoRdb\\Google_Service_TPU_Resource_ProjectsLocationsNodes');
