 ...
 * @author Google, Inc.
 */
class CloudProfiler extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->projects_profiles = new CloudProfiler\Resource\ProjectsProfiles($this, $this->serviceName, 'profiles', ['methods' => ['create' => ['path' => 'v2/{+parent}/profiles', 'httpMethod' => 'POST', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'createOffline' => ['path' => 'v2/{+parent}/profiles:createOffline', 'httpMethod' => 'POST', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'patch' => ['path' => 'v2/{+name}', 'httpMethod' => 'PATCH', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'updateMask' => ['location' => 'query', 'type' => 'string']]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(CloudProfiler::class, 'RoRdb\\Google_Service_CloudProfiler');
