 ...
 * the License.
 */
namespace RoRdb\Google\Service\Fitness;

class ListDataPointChangesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDataPointChangesResponse::class, 'RoRdb\\Google_Service_Fitness_ListDataPointChangesResponse');
