...
class ActivityEventsParameters extends \RoRdb\Google\Collection
{
...
\class_alias(ActivityEventsParameters::class, 'RoRdb\\Google_Service_Reports_ActivityEventsParameters');
