...
class SiteSummaryResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SiteSummaryResponse::class, 'RoRdb\\Google_Service_AbusiveExperienceReport_SiteSummaryResponse');
