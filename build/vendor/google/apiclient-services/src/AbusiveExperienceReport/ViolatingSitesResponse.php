 ...
 * the License.
 */
namespace RoRdb\Google\Service\AbusiveExperienceReport;

class ViolatingSitesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ViolatingSitesResponse::class, 'RoRdb\\Google_Service_AbusiveExperienceReport_ViolatingSitesResponse');
