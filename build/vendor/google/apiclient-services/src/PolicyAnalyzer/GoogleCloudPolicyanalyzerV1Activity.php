...
class GoogleCloudPolicyanalyzerV1Activity extends \RoRdb\Google\Model
{
    /**
     * @var array[]
     */
...
\class_alias(GoogleCloudPolicyanalyzerV1Activity::class, 'RoRdb\\Google_Service_PolicyAnalyzer_GoogleCloudPolicyanalyzerV1Activity');
