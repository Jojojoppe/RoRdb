...
class AndroidRuntimeConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(AndroidRuntimeConfiguration::class, 'RoRdb\\Google_Service_Testing_AndroidRuntimeConfiguration');
