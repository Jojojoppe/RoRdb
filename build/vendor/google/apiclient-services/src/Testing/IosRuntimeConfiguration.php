...
class IosRuntimeConfiguration extends \RoRdb\Google\Collection
{
...
\class_alias(IosRuntimeConfiguration::class, 'RoRdb\\Google_Service_Testing_IosRuntimeConfiguration');
