...
class ProvidedSoftwareCatalog extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ProvidedSoftwareCatalog::class, 'RoRdb\\Google_Service_Testing_ProvidedSoftwareCatalog');
