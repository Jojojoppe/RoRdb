...
class BitbucketServerSecrets extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BitbucketServerSecrets::class, 'RoRdb\\Google_Service_CloudBuild_BitbucketServerSecrets');
