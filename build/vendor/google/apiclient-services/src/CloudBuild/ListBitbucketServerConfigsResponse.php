...
class ListBitbucketServerConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListBitbucketServerConfigsResponse::class, 'RoRdb\\Google_Service_CloudBuild_ListBitbucketServerConfigsResponse');
