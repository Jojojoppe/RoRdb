...
class CreateBitbucketServerConnectedRepositoryRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateBitbucketServerConnectedRepositoryRequest::class, 'RoRdb\\Google_Service_CloudBuild_CreateBitbucketServerConnectedRepositoryRequest');
