...
class ProcessAppManifestCallbackOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ProcessAppManifestCallbackOperationMetadata::class, 'RoRdb\\Google_Service_CloudBuild_ProcessAppManifestCallbackOperationMetadata');
