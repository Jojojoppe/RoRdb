...
class BitbucketServerTriggerConfig extends \RoRdb\Google\Model
{
...
\class_alias(BitbucketServerTriggerConfig::class, 'RoRdb\\Google_Service_CloudBuild_BitbucketServerTriggerConfig');
