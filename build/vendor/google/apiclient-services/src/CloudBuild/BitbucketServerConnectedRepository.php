...
class BitbucketServerConnectedRepository extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BitbucketServerConnectedRepository::class, 'RoRdb\\Google_Service_CloudBuild_BitbucketServerConnectedRepository');
