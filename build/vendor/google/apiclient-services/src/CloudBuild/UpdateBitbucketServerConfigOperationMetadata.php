...
class UpdateBitbucketServerConfigOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateBitbucketServerConfigOperationMetadata::class, 'RoRdb\\Google_Service_CloudBuild_UpdateBitbucketServerConfigOperationMetadata');
