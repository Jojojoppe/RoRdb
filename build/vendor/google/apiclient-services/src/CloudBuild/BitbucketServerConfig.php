...
class BitbucketServerConfig extends \RoRdb\Google\Collection
{
...
\class_alias(BitbucketServerConfig::class, 'RoRdb\\Google_Service_CloudBuild_BitbucketServerConfig');
