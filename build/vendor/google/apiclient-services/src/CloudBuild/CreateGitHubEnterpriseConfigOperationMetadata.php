...
class CreateGitHubEnterpriseConfigOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateGitHubEnterpriseConfigOperationMetadata::class, 'RoRdb\\Google_Service_CloudBuild_CreateGitHubEnterpriseConfigOperationMetadata');
