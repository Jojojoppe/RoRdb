...
class AddBitbucketServerConnectedRepositoryResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AddBitbucketServerConnectedRepositoryResponse::class, 'RoRdb\\Google_Service_CloudBuild_AddBitbucketServerConnectedRepositoryResponse');
