...
class DeleteBitbucketServerConfigOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeleteBitbucketServerConfigOperationMetadata::class, 'RoRdb\\Google_Service_CloudBuild_DeleteBitbucketServerConfigOperationMetadata');
