...
class GitHubEnterpriseConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GitHubEnterpriseConfig::class, 'RoRdb\\Google_Service_CloudBuild_GitHubEnterpriseConfig');
