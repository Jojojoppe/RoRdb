...
class GitHubEnterpriseSecrets extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GitHubEnterpriseSecrets::class, 'RoRdb\\Google_Service_CloudBuild_GitHubEnterpriseSecrets');
