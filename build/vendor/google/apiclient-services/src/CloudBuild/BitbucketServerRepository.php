...
class BitbucketServerRepository extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BitbucketServerRepository::class, 'RoRdb\\Google_Service_CloudBuild_BitbucketServerRepository');
