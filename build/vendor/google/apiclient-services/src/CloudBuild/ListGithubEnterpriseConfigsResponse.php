...
class ListGithubEnterpriseConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGithubEnterpriseConfigsResponse::class, 'RoRdb\\Google_Service_CloudBuild_ListGithubEnterpriseConfigsResponse');
