...
use RoRdb\Google\Service\CloudBuild\ApproveBuildRequest;
use RoRdb\Google\Service\CloudBuild\Build;
use RoRdb\Google\Service\CloudBuild\CancelBuildRequest;
use RoRdb\Google\Service\CloudBuild\ListBuildsResponse;
use RoRdb\Google\Service\CloudBuild\Operation;
use RoRdb\Google\Service\CloudBuild\RetryBuildRequest;
/**
 ...
 *  </code>
 */
class ProjectsLocationsBuilds extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsBuilds::class, 'RoRdb\\Google_Service_CloudBuild_Resource_ProjectsLocationsBuilds');
