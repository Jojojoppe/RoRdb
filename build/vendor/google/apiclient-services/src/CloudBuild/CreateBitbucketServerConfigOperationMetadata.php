...
class CreateBitbucketServerConfigOperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateBitbucketServerConfigOperationMetadata::class, 'RoRdb\\Google_Service_CloudBuild_CreateBitbucketServerConfigOperationMetadata');
