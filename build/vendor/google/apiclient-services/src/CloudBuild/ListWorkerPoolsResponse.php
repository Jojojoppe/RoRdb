...
class ListWorkerPoolsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListWorkerPoolsResponse::class, 'RoRdb\\Google_Service_CloudBuild_ListWorkerPoolsResponse');
