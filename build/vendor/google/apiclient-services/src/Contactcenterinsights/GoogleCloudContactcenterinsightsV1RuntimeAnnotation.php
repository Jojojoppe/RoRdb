...
class GoogleCloudContactcenterinsightsV1RuntimeAnnotation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudContactcenterinsightsV1RuntimeAnnotation::class, 'RoRdb\\Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1RuntimeAnnotation');
