...
class GoogleCloudContactcenterinsightsV1DialogflowSource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudContactcenterinsightsV1DialogflowSource::class, 'RoRdb\\Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1DialogflowSource');
