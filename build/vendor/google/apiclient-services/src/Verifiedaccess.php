 ...
 * @author Google, Inc.
 */
class Verifiedaccess extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->challenge = new Verifiedaccess\Resource\Challenge($this, $this->serviceName, 'challenge', ['methods' => ['create' => ['path' => 'v1/challenge', 'httpMethod' => 'POST', 'parameters' => []], 'verify' => ['path' => 'v1/challenge:verify', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Verifiedaccess::class, 'RoRdb\\Google_Service_Verifiedaccess');
