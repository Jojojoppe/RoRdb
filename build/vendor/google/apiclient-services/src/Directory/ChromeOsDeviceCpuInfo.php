...
class ChromeOsDeviceCpuInfo extends \RoRdb\Google\Collection
{
...
\class_alias(ChromeOsDeviceCpuInfo::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceCpuInfo');
