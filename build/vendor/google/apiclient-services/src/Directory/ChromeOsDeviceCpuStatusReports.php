...
class ChromeOsDeviceCpuStatusReports extends \RoRdb\Google\Collection
{
...
\class_alias(ChromeOsDeviceCpuStatusReports::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceCpuStatusReports');
