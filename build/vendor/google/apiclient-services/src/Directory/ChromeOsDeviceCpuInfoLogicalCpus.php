...
class ChromeOsDeviceCpuInfoLogicalCpus extends \RoRdb\Google\Collection
{
...
\class_alias(ChromeOsDeviceCpuInfoLogicalCpus::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceCpuInfoLogicalCpus');
