...
class ChromeOsDeviceDiskVolumeReports extends \RoRdb\Google\Collection
{
...
\class_alias(ChromeOsDeviceDiskVolumeReports::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceDiskVolumeReports');
