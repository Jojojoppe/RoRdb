...
class BatchDeletePrintersRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchDeletePrintersRequest::class, 'RoRdb\\Google_Service_Directory_BatchDeletePrintersRequest');
