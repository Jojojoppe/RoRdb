...
class BatchDeletePrintersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchDeletePrintersResponse::class, 'RoRdb\\Google_Service_Directory_BatchDeletePrintersResponse');
