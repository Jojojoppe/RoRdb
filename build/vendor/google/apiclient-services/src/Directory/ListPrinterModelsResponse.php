...
class ListPrinterModelsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPrinterModelsResponse::class, 'RoRdb\\Google_Service_Directory_ListPrinterModelsResponse');
