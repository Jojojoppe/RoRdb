...
class ChromeOsDeviceTpmVersionInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ChromeOsDeviceTpmVersionInfo::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceTpmVersionInfo');
