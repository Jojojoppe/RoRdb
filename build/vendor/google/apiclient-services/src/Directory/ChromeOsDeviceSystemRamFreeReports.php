...
class ChromeOsDeviceSystemRamFreeReports extends \RoRdb\Google\Collection
{
...
\class_alias(ChromeOsDeviceSystemRamFreeReports::class, 'RoRdb\\Google_Service_Directory_ChromeOsDeviceSystemRamFreeReports');
