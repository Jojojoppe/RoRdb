...
class BatchCreatePrintersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchCreatePrintersResponse::class, 'RoRdb\\Google_Service_Directory_BatchCreatePrintersResponse');
