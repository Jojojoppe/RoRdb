...
class DirectoryChromeosdevicesCommand extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DirectoryChromeosdevicesCommand::class, 'RoRdb\\Google_Service_Directory_DirectoryChromeosdevicesCommand');
