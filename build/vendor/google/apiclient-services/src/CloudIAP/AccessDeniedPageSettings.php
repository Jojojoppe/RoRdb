...
class AccessDeniedPageSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccessDeniedPageSettings::class, 'RoRdb\\Google_Service_CloudIAP_AccessDeniedPageSettings');
