...
class PolicyDelegationSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PolicyDelegationSettings::class, 'RoRdb\\Google_Service_CloudIAP_PolicyDelegationSettings');
