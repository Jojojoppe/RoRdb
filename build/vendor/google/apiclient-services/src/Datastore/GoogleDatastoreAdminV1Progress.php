...
class GoogleDatastoreAdminV1Progress extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleDatastoreAdminV1Progress::class, 'RoRdb\\Google_Service_Datastore_GoogleDatastoreAdminV1Progress');
