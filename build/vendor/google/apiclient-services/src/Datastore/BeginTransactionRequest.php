...
class BeginTransactionRequest extends \RoRdb\Google\Model
{
...
\class_alias(BeginTransactionRequest::class, 'RoRdb\\Google_Service_Datastore_BeginTransactionRequest');
