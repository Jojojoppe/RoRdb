 ...
 * the License.
 */
namespace RoRdb\Google\Service\Datastore\Resource;

use RoRdb\Google\Service\Datastore\AllocateIdsRequest;
use RoRdb\Google\Service\Datastore\AllocateIdsResponse;
use RoRdb\Google\Service\Datastore\BeginTransactionRequest;
use RoRdb\Google\Service\Datastore\BeginTransactionResponse;
use RoRdb\Google\Service\Datastore\CommitRequest;
use RoRdb\Google\Service\Datastore\CommitResponse;
use RoRdb\Google\Service\Datastore\GoogleDatastoreAdminV1ExportEntitiesRequest;
use RoRdb\Google\Service\Datastore\GoogleDatastoreAdminV1ImportEntitiesRequest;
use RoRdb\Google\Service\Datastore\GoogleLongrunningOperation;
use RoRdb\Google\Service\Datastore\LookupRequest;
use RoRdb\Google\Service\Datastore\LookupResponse;
use RoRdb\Google\Service\Datastore\ReserveIdsRequest;
use RoRdb\Google\Service\Datastore\ReserveIdsResponse;
use RoRdb\Google\Service\Datastore\RollbackRequest;
use RoRdb\Google\Service\Datastore\RollbackResponse;
use RoRdb\Google\Service\Datastore\RunQueryRequest;
use RoRdb\Google\Service\Datastore\RunQueryResponse;
/**
 ...
 *  </code>
 */
class Projects extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Projects::class, 'RoRdb\\Google_Service_Datastore_Resource_Projects');
