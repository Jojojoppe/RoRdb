...
class SubscriptionTransferInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubscriptionTransferInfo::class, 'RoRdb\\Google_Service_Reseller_SubscriptionTransferInfo');
