 ...
 * the License.
 */
namespace RoRdb\Google\Service\Reseller;

class ResellernotifyGetwatchdetailsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ResellernotifyGetwatchdetailsResponse::class, 'RoRdb\\Google_Service_Reseller_ResellernotifyGetwatchdetailsResponse');
