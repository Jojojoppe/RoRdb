 ...
 * the License.
 */
namespace RoRdb\Google\Service\Reseller\Resource;

use RoRdb\Google\Service\Reseller\ChangePlanRequest;
use RoRdb\Google\Service\Reseller\RenewalSettings;
use RoRdb\Google\Service\Reseller\Seats;
use RoRdb\Google\Service\Reseller\Subscription;
use RoRdb\Google\Service\Reseller\Subscriptions as SubscriptionsModel;
/**
 ...
 *  </code>
 */
class Subscriptions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Subscriptions::class, 'RoRdb\\Google_Service_Reseller_Resource_Subscriptions');
