...
class AddMatterPermissionsRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AddMatterPermissionsRequest::class, 'RoRdb\\Google_Service_Vault_AddMatterPermissionsRequest');
