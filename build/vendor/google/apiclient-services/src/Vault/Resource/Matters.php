 ...
 * the License.
 */
namespace RoRdb\Google\Service\Vault\Resource;

use RoRdb\Google\Service\Vault\AddMatterPermissionsRequest;
use RoRdb\Google\Service\Vault\CloseMatterRequest;
use RoRdb\Google\Service\Vault\CloseMatterResponse;
use RoRdb\Google\Service\Vault\CountArtifactsRequest;
use RoRdb\Google\Service\Vault\ListMattersResponse;
use RoRdb\Google\Service\Vault\Matter;
use RoRdb\Google\Service\Vault\MatterPermission;
use RoRdb\Google\Service\Vault\Operation;
use RoRdb\Google\Service\Vault\RemoveMatterPermissionsRequest;
use RoRdb\Google\Service\Vault\ReopenMatterRequest;
use RoRdb\Google\Service\Vault\ReopenMatterResponse;
use RoRdb\Google\Service\Vault\UndeleteMatterRequest;
use RoRdb\Google\Service\Vault\VaultEmpty;
/**
 ...
 *  </code>
 */
class Matters extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Matters::class, 'RoRdb\\Google_Service_Vault_Resource_Matters');
