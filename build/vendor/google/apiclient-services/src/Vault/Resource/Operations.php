...
use RoRdb\Google\Service\Vault\CancelOperationRequest;
use RoRdb\Google\Service\Vault\ListOperationsResponse;
...
\class_alias(Operations::class, 'RoRdb\\Google_Service_Vault_Resource_Operations');
