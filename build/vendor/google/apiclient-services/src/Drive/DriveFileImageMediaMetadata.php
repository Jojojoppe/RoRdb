...
class DriveFileImageMediaMetadata extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(DriveFileImageMediaMetadata::class, 'RoRdb\\Google_Service_Drive_DriveFileImageMediaMetadata');
