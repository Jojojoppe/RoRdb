...
use RoRdb\Google\Service\Drive\Permission;
use RoRdb\Google\Service\Drive\PermissionList;
/**
...
\class_alias(Permissions::class, 'RoRdb\\Google_Service_Drive_Resource_Permissions');
