...
class DriveFileLinkShareMetadata extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileLinkShareMetadata::class, 'RoRdb\\Google_Service_Drive_DriveFileLinkShareMetadata');
