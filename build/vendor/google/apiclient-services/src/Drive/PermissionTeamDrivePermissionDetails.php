 ...
 * the License.
 */
namespace RoRdb\Google\Service\Drive;

class PermissionTeamDrivePermissionDetails extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PermissionTeamDrivePermissionDetails::class, 'RoRdb\\Google_Service_Drive_PermissionTeamDrivePermissionDetails');
