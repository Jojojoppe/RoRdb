...
class DriveFileShortcutDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileShortcutDetails::class, 'RoRdb\\Google_Service_Drive_DriveFileShortcutDetails');
