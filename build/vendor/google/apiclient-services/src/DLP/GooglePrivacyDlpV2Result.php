...
class GooglePrivacyDlpV2Result extends \RoRdb\Google\Collection
{
...
\class_alias(GooglePrivacyDlpV2Result::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2Result');
