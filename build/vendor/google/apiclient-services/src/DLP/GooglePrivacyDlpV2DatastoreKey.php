...
class GooglePrivacyDlpV2DatastoreKey extends \RoRdb\Google\Model
{
...
\class_alias(GooglePrivacyDlpV2DatastoreKey::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2DatastoreKey');
