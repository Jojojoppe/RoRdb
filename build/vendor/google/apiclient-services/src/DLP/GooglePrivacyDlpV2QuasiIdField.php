...
class GooglePrivacyDlpV2QuasiIdField extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2QuasiIdField::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2QuasiIdField');
