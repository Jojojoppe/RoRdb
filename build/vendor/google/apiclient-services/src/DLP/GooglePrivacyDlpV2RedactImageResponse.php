...
class GooglePrivacyDlpV2RedactImageResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2RedactImageResponse::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2RedactImageResponse');
