...
class GooglePrivacyDlpV2ValueFrequency extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2ValueFrequency::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2ValueFrequency');
