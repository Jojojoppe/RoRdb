...
class GooglePrivacyDlpV2BigQueryKey extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2BigQueryKey::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2BigQueryKey');
