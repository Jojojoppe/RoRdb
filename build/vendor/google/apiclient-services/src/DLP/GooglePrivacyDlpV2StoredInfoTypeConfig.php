...
class GooglePrivacyDlpV2StoredInfoTypeConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2StoredInfoTypeConfig::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2StoredInfoTypeConfig');
