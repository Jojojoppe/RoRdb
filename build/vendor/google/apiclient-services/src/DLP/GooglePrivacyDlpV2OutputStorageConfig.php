...
class GooglePrivacyDlpV2OutputStorageConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2OutputStorageConfig::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2OutputStorageConfig');
