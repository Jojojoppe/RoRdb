...
class GooglePrivacyDlpV2Schedule extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2Schedule::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2Schedule');
