...
class GooglePrivacyDlpV2TimePartConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2TimePartConfig::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2TimePartConfig');
