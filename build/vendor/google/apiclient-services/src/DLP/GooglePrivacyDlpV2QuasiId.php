...
class GooglePrivacyDlpV2QuasiId extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2QuasiId::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2QuasiId');
