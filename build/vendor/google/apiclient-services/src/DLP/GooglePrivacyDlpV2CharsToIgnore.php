...
class GooglePrivacyDlpV2CharsToIgnore extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2CharsToIgnore::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2CharsToIgnore');
