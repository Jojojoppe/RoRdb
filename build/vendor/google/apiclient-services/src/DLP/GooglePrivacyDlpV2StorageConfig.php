...
class GooglePrivacyDlpV2StorageConfig extends \RoRdb\Google\Model
{
...
\class_alias(GooglePrivacyDlpV2StorageConfig::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2StorageConfig');
