...
class GooglePrivacyDlpV2InspectTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2InspectTemplate::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2InspectTemplate');
