...
class GooglePrivacyDlpV2Finding extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2Finding::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2Finding');
