...
class GooglePrivacyDlpV2ContentLocation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2ContentLocation::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2ContentLocation');
