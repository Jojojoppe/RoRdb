...
class GooglePrivacyDlpV2KmsWrappedCryptoKey extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2KmsWrappedCryptoKey::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2KmsWrappedCryptoKey');
