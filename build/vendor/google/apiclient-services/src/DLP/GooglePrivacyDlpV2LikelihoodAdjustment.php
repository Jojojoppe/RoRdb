...
class GooglePrivacyDlpV2LikelihoodAdjustment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2LikelihoodAdjustment::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2LikelihoodAdjustment');
