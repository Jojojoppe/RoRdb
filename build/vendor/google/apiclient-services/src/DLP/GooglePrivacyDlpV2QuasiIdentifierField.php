...
class GooglePrivacyDlpV2QuasiIdentifierField extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2QuasiIdentifierField::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2QuasiIdentifierField');
