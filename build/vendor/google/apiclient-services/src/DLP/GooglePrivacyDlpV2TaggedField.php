...
class GooglePrivacyDlpV2TaggedField extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2TaggedField::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2TaggedField');
