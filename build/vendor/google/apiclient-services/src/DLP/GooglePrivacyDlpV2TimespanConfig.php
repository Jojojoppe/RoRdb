...
class GooglePrivacyDlpV2TimespanConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GooglePrivacyDlpV2TimespanConfig::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2TimespanConfig');
