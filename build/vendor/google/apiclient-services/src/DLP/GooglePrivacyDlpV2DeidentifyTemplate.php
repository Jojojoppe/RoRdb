...
class GooglePrivacyDlpV2DeidentifyTemplate extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GooglePrivacyDlpV2DeidentifyTemplate::class, 'RoRdb\\Google_Service_DLP_GooglePrivacyDlpV2DeidentifyTemplate');
