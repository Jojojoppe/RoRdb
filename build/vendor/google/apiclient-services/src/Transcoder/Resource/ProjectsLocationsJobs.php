...
use RoRdb\Google\Service\Transcoder\Job;
use RoRdb\Google\Service\Transcoder\ListJobsResponse;
...
\class_alias(ProjectsLocationsJobs::class, 'RoRdb\\Google_Service_Transcoder_Resource_ProjectsLocationsJobs');
