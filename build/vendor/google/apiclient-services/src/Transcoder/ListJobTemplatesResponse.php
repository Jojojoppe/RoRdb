...
class ListJobTemplatesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListJobTemplatesResponse::class, 'RoRdb\\Google_Service_Transcoder_ListJobTemplatesResponse');
