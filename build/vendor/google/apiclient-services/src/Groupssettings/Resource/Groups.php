 ...
 * the License.
 */
namespace RoRdb\Google\Service\Groupssettings\Resource;

use RoRdb\Google\Service\Groupssettings\Groups as GroupsModel;
/**
...
\class_alias(Groups::class, 'RoRdb\\Google_Service_Groupssettings_Resource_Groups');
