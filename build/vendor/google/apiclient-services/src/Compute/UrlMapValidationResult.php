...
class UrlMapValidationResult extends \RoRdb\Google\Collection
{
...
\class_alias(UrlMapValidationResult::class, 'RoRdb\\Google_Service_Compute_UrlMapValidationResult');
