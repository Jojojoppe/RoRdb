...
class SecurityPoliciesWafConfig extends \RoRdb\Google\Model
{
...
\class_alias(SecurityPoliciesWafConfig::class, 'RoRdb\\Google_Service_Compute_SecurityPoliciesWafConfig');
