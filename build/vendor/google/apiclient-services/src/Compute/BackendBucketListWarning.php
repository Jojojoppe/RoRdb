...
class BackendBucketListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(BackendBucketListWarning::class, 'RoRdb\\Google_Service_Compute_BackendBucketListWarning');
