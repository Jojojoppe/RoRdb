...
class TargetHttpProxyAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetHttpProxyAggregatedList::class, 'RoRdb\\Google_Service_Compute_TargetHttpProxyAggregatedList');
