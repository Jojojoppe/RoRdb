...
class SslCertificatesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(SslCertificatesScopedList::class, 'RoRdb\\Google_Service_Compute_SslCertificatesScopedList');
