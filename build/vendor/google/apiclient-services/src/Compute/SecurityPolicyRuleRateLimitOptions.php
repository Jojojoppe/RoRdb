...
class SecurityPolicyRuleRateLimitOptions extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SecurityPolicyRuleRateLimitOptions::class, 'RoRdb\\Google_Service_Compute_SecurityPolicyRuleRateLimitOptions');
