...
class InstanceGroupManagersScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceGroupManagersScopedList::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagersScopedList');
