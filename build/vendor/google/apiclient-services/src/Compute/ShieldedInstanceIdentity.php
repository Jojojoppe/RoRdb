...
class ShieldedInstanceIdentity extends \RoRdb\Google\Model
{
...
\class_alias(ShieldedInstanceIdentity::class, 'RoRdb\\Google_Service_Compute_ShieldedInstanceIdentity');
