...
class RegionInstanceGroupsListInstances extends \RoRdb\Google\Collection
{
...
\class_alias(RegionInstanceGroupsListInstances::class, 'RoRdb\\Google_Service_Compute_RegionInstanceGroupsListInstances');
