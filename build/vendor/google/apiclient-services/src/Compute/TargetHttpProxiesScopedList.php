...
class TargetHttpProxiesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetHttpProxiesScopedList::class, 'RoRdb\\Google_Service_Compute_TargetHttpProxiesScopedList');
