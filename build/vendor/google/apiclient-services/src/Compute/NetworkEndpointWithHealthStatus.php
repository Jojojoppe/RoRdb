...
class NetworkEndpointWithHealthStatus extends \RoRdb\Google\Collection
{
...
\class_alias(NetworkEndpointWithHealthStatus::class, 'RoRdb\\Google_Service_Compute_NetworkEndpointWithHealthStatus');
