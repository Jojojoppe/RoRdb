...
class ResourcePoliciesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(ResourcePoliciesScopedList::class, 'RoRdb\\Google_Service_Compute_ResourcePoliciesScopedList');
