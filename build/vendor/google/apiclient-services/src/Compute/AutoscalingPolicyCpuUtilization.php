...
class AutoscalingPolicyCpuUtilization extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AutoscalingPolicyCpuUtilization::class, 'RoRdb\\Google_Service_Compute_AutoscalingPolicyCpuUtilization');
