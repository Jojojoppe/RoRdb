...
class SecurityPolicyRuleMatcher extends \RoRdb\Google\Model
{
...
\class_alias(SecurityPolicyRuleMatcher::class, 'RoRdb\\Google_Service_Compute_SecurityPolicyRuleMatcher');
