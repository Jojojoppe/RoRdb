...
class LogConfigCounterOptions extends \RoRdb\Google\Collection
{
...
\class_alias(LogConfigCounterOptions::class, 'RoRdb\\Google_Service_Compute_LogConfigCounterOptions');
