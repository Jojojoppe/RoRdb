...
class FirewallPolicyAssociation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FirewallPolicyAssociation::class, 'RoRdb\\Google_Service_Compute_FirewallPolicyAssociation');
