...
class SourceInstanceProperties extends \RoRdb\Google\Collection
{
...
\class_alias(SourceInstanceProperties::class, 'RoRdb\\Google_Service_Compute_SourceInstanceProperties');
