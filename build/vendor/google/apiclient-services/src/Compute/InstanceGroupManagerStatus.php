...
class InstanceGroupManagerStatus extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InstanceGroupManagerStatus::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerStatus');
