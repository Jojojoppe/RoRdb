...
class InstanceGroupManagerUpdatePolicy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InstanceGroupManagerUpdatePolicy::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerUpdatePolicy');
