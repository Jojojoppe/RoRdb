...
class PublicDelegatedPrefixesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(PublicDelegatedPrefixesScopedList::class, 'RoRdb\\Google_Service_Compute_PublicDelegatedPrefixesScopedList');
