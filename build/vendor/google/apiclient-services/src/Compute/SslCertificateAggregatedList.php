...
class SslCertificateAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(SslCertificateAggregatedList::class, 'RoRdb\\Google_Service_Compute_SslCertificateAggregatedList');
