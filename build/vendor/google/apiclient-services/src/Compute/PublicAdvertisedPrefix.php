...
class PublicAdvertisedPrefix extends \RoRdb\Google\Collection
{
...
\class_alias(PublicAdvertisedPrefix::class, 'RoRdb\\Google_Service_Compute_PublicAdvertisedPrefix');
