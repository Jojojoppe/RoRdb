...
class InterconnectAttachmentsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectAttachmentsScopedList::class, 'RoRdb\\Google_Service_Compute_InterconnectAttachmentsScopedList');
