...
class TargetVpnGatewayAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetVpnGatewayAggregatedList::class, 'RoRdb\\Google_Service_Compute_TargetVpnGatewayAggregatedList');
