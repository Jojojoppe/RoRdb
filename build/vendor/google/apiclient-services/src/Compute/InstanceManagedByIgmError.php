...
class InstanceManagedByIgmError extends \RoRdb\Google\Model
{
...
\class_alias(InstanceManagedByIgmError::class, 'RoRdb\\Google_Service_Compute_InstanceManagedByIgmError');
