...
class ResourcePolicyInstanceSchedulePolicy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ResourcePolicyInstanceSchedulePolicy::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyInstanceSchedulePolicy');
