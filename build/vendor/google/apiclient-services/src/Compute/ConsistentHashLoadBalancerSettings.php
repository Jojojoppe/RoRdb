...
class ConsistentHashLoadBalancerSettings extends \RoRdb\Google\Model
{
...
\class_alias(ConsistentHashLoadBalancerSettings::class, 'RoRdb\\Google_Service_Compute_ConsistentHashLoadBalancerSettings');
