...
class ReservationsResizeRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReservationsResizeRequest::class, 'RoRdb\\Google_Service_Compute_ReservationsResizeRequest');
