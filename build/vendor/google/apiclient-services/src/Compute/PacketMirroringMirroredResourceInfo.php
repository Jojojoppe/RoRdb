...
class PacketMirroringMirroredResourceInfo extends \RoRdb\Google\Collection
{
...
\class_alias(PacketMirroringMirroredResourceInfo::class, 'RoRdb\\Google_Service_Compute_PacketMirroringMirroredResourceInfo');
