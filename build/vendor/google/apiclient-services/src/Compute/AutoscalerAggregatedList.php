...
class AutoscalerAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(AutoscalerAggregatedList::class, 'RoRdb\\Google_Service_Compute_AutoscalerAggregatedList');
