...
class BackendServiceAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(BackendServiceAggregatedList::class, 'RoRdb\\Google_Service_Compute_BackendServiceAggregatedList');
