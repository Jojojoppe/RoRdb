...
class AddressAggregatedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AddressAggregatedListWarning::class, 'RoRdb\\Google_Service_Compute_AddressAggregatedListWarning');
