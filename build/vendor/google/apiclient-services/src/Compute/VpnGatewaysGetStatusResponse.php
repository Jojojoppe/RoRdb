...
class VpnGatewaysGetStatusResponse extends \RoRdb\Google\Model
{
...
\class_alias(VpnGatewaysGetStatusResponse::class, 'RoRdb\\Google_Service_Compute_VpnGatewaysGetStatusResponse');
