...
class TargetHttpsProxiesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetHttpsProxiesScopedList::class, 'RoRdb\\Google_Service_Compute_TargetHttpsProxiesScopedList');
