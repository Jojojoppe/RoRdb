...
class MachineTypeAccelerators extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(MachineTypeAccelerators::class, 'RoRdb\\Google_Service_Compute_MachineTypeAccelerators');
