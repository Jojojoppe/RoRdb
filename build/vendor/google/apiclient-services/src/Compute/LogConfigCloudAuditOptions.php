...
class LogConfigCloudAuditOptions extends \RoRdb\Google\Model
{
...
\class_alias(LogConfigCloudAuditOptions::class, 'RoRdb\\Google_Service_Compute_LogConfigCloudAuditOptions');
