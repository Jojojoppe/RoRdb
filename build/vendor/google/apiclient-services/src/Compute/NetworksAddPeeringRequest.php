...
class NetworksAddPeeringRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(NetworksAddPeeringRequest::class, 'RoRdb\\Google_Service_Compute_NetworksAddPeeringRequest');
