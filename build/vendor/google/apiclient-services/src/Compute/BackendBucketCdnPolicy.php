...
class BackendBucketCdnPolicy extends \RoRdb\Google\Collection
{
...
\class_alias(BackendBucketCdnPolicy::class, 'RoRdb\\Google_Service_Compute_BackendBucketCdnPolicy');
