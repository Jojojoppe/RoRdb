...
class InterconnectCircuitInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InterconnectCircuitInfo::class, 'RoRdb\\Google_Service_Compute_InterconnectCircuitInfo');
