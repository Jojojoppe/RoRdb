...
class NodeGroupsAddNodesRequest extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(NodeGroupsAddNodesRequest::class, 'RoRdb\\Google_Service_Compute_NodeGroupsAddNodesRequest');
