...
class ReservationsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(ReservationsScopedList::class, 'RoRdb\\Google_Service_Compute_ReservationsScopedList');
