...
class ForwardingRuleServiceDirectoryRegistration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ForwardingRuleServiceDirectoryRegistration::class, 'RoRdb\\Google_Service_Compute_ForwardingRuleServiceDirectoryRegistration');
