...
class ResourcePolicyResourceStatus extends \RoRdb\Google\Model
{
...
\class_alias(ResourcePolicyResourceStatus::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyResourceStatus');
