...
class ResourcePolicySnapshotSchedulePolicy extends \RoRdb\Google\Model
{
...
\class_alias(ResourcePolicySnapshotSchedulePolicy::class, 'RoRdb\\Google_Service_Compute_ResourcePolicySnapshotSchedulePolicy');
