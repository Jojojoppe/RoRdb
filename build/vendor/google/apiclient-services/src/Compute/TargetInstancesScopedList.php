...
class TargetInstancesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetInstancesScopedList::class, 'RoRdb\\Google_Service_Compute_TargetInstancesScopedList');
