...
class AttachedDiskInitializeParams extends \RoRdb\Google\Collection
{
...
\class_alias(AttachedDiskInitializeParams::class, 'RoRdb\\Google_Service_Compute_AttachedDiskInitializeParams');
