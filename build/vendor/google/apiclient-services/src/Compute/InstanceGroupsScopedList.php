...
class InstanceGroupsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceGroupsScopedList::class, 'RoRdb\\Google_Service_Compute_InstanceGroupsScopedList');
