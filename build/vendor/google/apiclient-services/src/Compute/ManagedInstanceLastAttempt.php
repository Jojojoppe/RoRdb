...
class ManagedInstanceLastAttempt extends \RoRdb\Google\Model
{
...
\class_alias(ManagedInstanceLastAttempt::class, 'RoRdb\\Google_Service_Compute_ManagedInstanceLastAttempt');
