...
class AutoscalingPolicyScalingSchedule extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AutoscalingPolicyScalingSchedule::class, 'RoRdb\\Google_Service_Compute_AutoscalingPolicyScalingSchedule');
