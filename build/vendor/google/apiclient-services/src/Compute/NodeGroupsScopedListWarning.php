...
class NodeGroupsScopedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(NodeGroupsScopedListWarning::class, 'RoRdb\\Google_Service_Compute_NodeGroupsScopedListWarning');
