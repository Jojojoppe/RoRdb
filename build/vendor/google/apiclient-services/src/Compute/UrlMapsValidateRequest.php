...
class UrlMapsValidateRequest extends \RoRdb\Google\Collection
{
...
\class_alias(UrlMapsValidateRequest::class, 'RoRdb\\Google_Service_Compute_UrlMapsValidateRequest');
