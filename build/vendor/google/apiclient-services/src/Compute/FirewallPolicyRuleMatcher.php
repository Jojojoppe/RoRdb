...
class FirewallPolicyRuleMatcher extends \RoRdb\Google\Collection
{
...
\class_alias(FirewallPolicyRuleMatcher::class, 'RoRdb\\Google_Service_Compute_FirewallPolicyRuleMatcher');
