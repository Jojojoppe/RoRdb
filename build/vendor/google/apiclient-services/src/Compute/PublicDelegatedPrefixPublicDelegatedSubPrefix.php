...
class PublicDelegatedPrefixPublicDelegatedSubPrefix extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PublicDelegatedPrefixPublicDelegatedSubPrefix::class, 'RoRdb\\Google_Service_Compute_PublicDelegatedPrefixPublicDelegatedSubPrefix');
