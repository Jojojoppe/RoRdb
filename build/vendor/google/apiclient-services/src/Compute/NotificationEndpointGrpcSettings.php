...
class NotificationEndpointGrpcSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NotificationEndpointGrpcSettings::class, 'RoRdb\\Google_Service_Compute_NotificationEndpointGrpcSettings');
