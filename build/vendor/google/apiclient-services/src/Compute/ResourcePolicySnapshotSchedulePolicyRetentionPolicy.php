...
class ResourcePolicySnapshotSchedulePolicyRetentionPolicy extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ResourcePolicySnapshotSchedulePolicyRetentionPolicy::class, 'RoRdb\\Google_Service_Compute_ResourcePolicySnapshotSchedulePolicyRetentionPolicy');
