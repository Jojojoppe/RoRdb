...
class NetworksGetEffectiveFirewallsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(NetworksGetEffectiveFirewallsResponse::class, 'RoRdb\\Google_Service_Compute_NetworksGetEffectiveFirewallsResponse');
