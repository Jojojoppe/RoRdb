...
class ProjectsEnableXpnResourceRequest extends \RoRdb\Google\Model
{
...
\class_alias(ProjectsEnableXpnResourceRequest::class, 'RoRdb\\Google_Service_Compute_ProjectsEnableXpnResourceRequest');
