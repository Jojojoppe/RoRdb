...
class AutoscalingPolicyCustomMetricUtilization extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AutoscalingPolicyCustomMetricUtilization::class, 'RoRdb\\Google_Service_Compute_AutoscalingPolicyCustomMetricUtilization');
