...
class InterconnectDiagnosticsLinkStatus extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectDiagnosticsLinkStatus::class, 'RoRdb\\Google_Service_Compute_InterconnectDiagnosticsLinkStatus');
