...
class InstanceGroupAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceGroupAggregatedList::class, 'RoRdb\\Google_Service_Compute_InstanceGroupAggregatedList');
