...
use RoRdb\Google\Service\Compute\CacheInvalidationRule;
use RoRdb\Google\Service\Compute\Operation;
use RoRdb\Google\Service\Compute\UrlMap;
use RoRdb\Google\Service\Compute\UrlMapList;
use RoRdb\Google\Service\Compute\UrlMapsAggregatedList;
use RoRdb\Google\Service\Compute\UrlMapsValidateRequest;
use RoRdb\Google\Service\Compute\UrlMapsValidateResponse;
/**
 ...
 *  </code>
 */
class UrlMaps extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(UrlMaps::class, 'RoRdb\\Google_Service_Compute_Resource_UrlMaps');
