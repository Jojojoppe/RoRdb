...
use RoRdb\Google\Service\Compute\BackendService;
use RoRdb\Google\Service\Compute\BackendServiceAggregatedList;
use RoRdb\Google\Service\Compute\BackendServiceGroupHealth;
use RoRdb\Google\Service\Compute\BackendServiceList;
use RoRdb\Google\Service\Compute\Operation;
use RoRdb\Google\Service\Compute\ResourceGroupReference;
use RoRdb\Google\Service\Compute\SecurityPolicyReference;
use RoRdb\Google\Service\Compute\SignedUrlKey;
/**
 ...
 *  </code>
 */
class BackendServices extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(BackendServices::class, 'RoRdb\\Google_Service_Compute_Resource_BackendServices');
