...
use RoRdb\Google\Service\Compute\Region;
use RoRdb\Google\Service\Compute\RegionList;
/**
...
\class_alias(Regions::class, 'RoRdb\\Google_Service_Compute_Resource_Regions');
