...
use RoRdb\Google\Service\Compute\Subnetwork;
use RoRdb\Google\Service\Compute\SubnetworkAggregatedList;
use RoRdb\Google\Service\Compute\SubnetworkList;
use RoRdb\Google\Service\Compute\SubnetworksExpandIpCidrRangeRequest;
use RoRdb\Google\Service\Compute\SubnetworksSetPrivateIpGoogleAccessRequest;
use RoRdb\Google\Service\Compute\TestPermissionsRequest;
use RoRdb\Google\Service\Compute\TestPermissionsResponse;
use RoRdb\Google\Service\Compute\UsableSubnetworksAggregatedList;
/**
 ...
 *  </code>
 */
class Subnetworks extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Subnetworks::class, 'RoRdb\\Google_Service_Compute_Resource_Subnetworks');
