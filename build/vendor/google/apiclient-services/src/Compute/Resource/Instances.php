...
use RoRdb\Google\Service\Compute\AccessConfig;
use RoRdb\Google\Service\Compute\AttachedDisk;
use RoRdb\Google\Service\Compute\BulkInsertInstanceResource;
use RoRdb\Google\Service\Compute\DisplayDevice;
use RoRdb\Google\Service\Compute\GuestAttributes;
use RoRdb\Google\Service\Compute\Instance;
use RoRdb\Google\Service\Compute\InstanceAggregatedList;
use RoRdb\Google\Service\Compute\InstanceList;
use RoRdb\Google\Service\Compute\InstanceListReferrers;
use RoRdb\Google\Service\Compute\InstancesAddResourcePoliciesRequest;
use RoRdb\Google\Service\Compute\InstancesGetEffectiveFirewallsResponse;
use RoRdb\Google\Service\Compute\InstancesRemoveResourcePoliciesRequest;
use RoRdb\Google\Service\Compute\InstancesSetLabelsRequest;
use RoRdb\Google\Service\Compute\InstancesSetMachineResourcesRequest;
use RoRdb\Google\Service\Compute\InstancesSetMachineTypeRequest;
use RoRdb\Google\Service\Compute\InstancesSetMinCpuPlatformRequest;
use RoRdb\Google\Service\Compute\InstancesSetServiceAccountRequest;
use RoRdb\Google\Service\Compute\InstancesStartWithEncryptionKeyRequest;
use RoRdb\Google\Service\Compute\Metadata;
use RoRdb\Google\Service\Compute\NetworkInterface;
use RoRdb\Google\Service\Compute\Operation;
use RoRdb\Google\Service\Compute\Policy;
use RoRdb\Google\Service\Compute\Scheduling;
use RoRdb\Google\Service\Compute\Screenshot;
use RoRdb\Google\Service\Compute\SerialPortOutput;
use RoRdb\Google\Service\Compute\ShieldedInstanceConfig;
use RoRdb\Google\Service\Compute\ShieldedInstanceIdentity;
use RoRdb\Google\Service\Compute\ShieldedInstanceIntegrityPolicy;
use RoRdb\Google\Service\Compute\Tags;
use RoRdb\Google\Service\Compute\TestPermissionsRequest;
use RoRdb\Google\Service\Compute\TestPermissionsResponse;
use RoRdb\Google\Service\Compute\ZoneSetPolicyRequest;
/**
 ...
 *  </code>
 */
class Instances extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Instances::class, 'RoRdb\\Google_Service_Compute_Resource_Instances');
