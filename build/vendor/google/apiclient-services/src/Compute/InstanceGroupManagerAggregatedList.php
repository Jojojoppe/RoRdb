...
class InstanceGroupManagerAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceGroupManagerAggregatedList::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerAggregatedList');
