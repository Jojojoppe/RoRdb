...
class InstanceGroupManagerActionsSummary extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(InstanceGroupManagerActionsSummary::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerActionsSummary');
