...
class ForwardingRulesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(ForwardingRulesScopedList::class, 'RoRdb\\Google_Service_Compute_ForwardingRulesScopedList');
