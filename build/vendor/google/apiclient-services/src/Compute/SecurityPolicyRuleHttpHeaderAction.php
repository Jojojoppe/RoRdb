...
class SecurityPolicyRuleHttpHeaderAction extends \RoRdb\Google\Collection
{
...
\class_alias(SecurityPolicyRuleHttpHeaderAction::class, 'RoRdb\\Google_Service_Compute_SecurityPolicyRuleHttpHeaderAction');
