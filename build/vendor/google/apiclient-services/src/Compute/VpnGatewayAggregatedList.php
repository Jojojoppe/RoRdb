...
class VpnGatewayAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(VpnGatewayAggregatedList::class, 'RoRdb\\Google_Service_Compute_VpnGatewayAggregatedList');
