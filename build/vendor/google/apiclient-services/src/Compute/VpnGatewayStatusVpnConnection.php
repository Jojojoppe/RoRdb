...
class VpnGatewayStatusVpnConnection extends \RoRdb\Google\Collection
{
...
\class_alias(VpnGatewayStatusVpnConnection::class, 'RoRdb\\Google_Service_Compute_VpnGatewayStatusVpnConnection');
