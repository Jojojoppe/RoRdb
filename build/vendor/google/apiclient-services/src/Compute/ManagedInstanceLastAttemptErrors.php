...
class ManagedInstanceLastAttemptErrors extends \RoRdb\Google\Collection
{
...
\class_alias(ManagedInstanceLastAttemptErrors::class, 'RoRdb\\Google_Service_Compute_ManagedInstanceLastAttemptErrors');
