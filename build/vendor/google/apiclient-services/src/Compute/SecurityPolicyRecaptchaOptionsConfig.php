...
class SecurityPolicyRecaptchaOptionsConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SecurityPolicyRecaptchaOptionsConfig::class, 'RoRdb\\Google_Service_Compute_SecurityPolicyRecaptchaOptionsConfig');
