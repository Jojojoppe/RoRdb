...
class VmEndpointNatMappingsList extends \RoRdb\Google\Collection
{
...
\class_alias(VmEndpointNatMappingsList::class, 'RoRdb\\Google_Service_Compute_VmEndpointNatMappingsList');
