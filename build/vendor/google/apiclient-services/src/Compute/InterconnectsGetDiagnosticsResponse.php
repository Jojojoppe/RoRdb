...
class InterconnectsGetDiagnosticsResponse extends \RoRdb\Google\Model
{
...
\class_alias(InterconnectsGetDiagnosticsResponse::class, 'RoRdb\\Google_Service_Compute_InterconnectsGetDiagnosticsResponse');
