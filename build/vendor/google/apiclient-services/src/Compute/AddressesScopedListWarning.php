...
class AddressesScopedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AddressesScopedListWarning::class, 'RoRdb\\Google_Service_Compute_AddressesScopedListWarning');
