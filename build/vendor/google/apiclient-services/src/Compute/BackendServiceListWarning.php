...
class BackendServiceListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(BackendServiceListWarning::class, 'RoRdb\\Google_Service_Compute_BackendServiceListWarning');
