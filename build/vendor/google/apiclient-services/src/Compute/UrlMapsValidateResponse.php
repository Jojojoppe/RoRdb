...
class UrlMapsValidateResponse extends \RoRdb\Google\Model
{
...
\class_alias(UrlMapsValidateResponse::class, 'RoRdb\\Google_Service_Compute_UrlMapsValidateResponse');
