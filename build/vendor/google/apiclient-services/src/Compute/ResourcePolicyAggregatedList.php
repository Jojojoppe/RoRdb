...
class ResourcePolicyAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(ResourcePolicyAggregatedList::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyAggregatedList');
