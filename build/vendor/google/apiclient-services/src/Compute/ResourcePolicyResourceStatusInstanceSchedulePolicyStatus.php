...
class ResourcePolicyResourceStatusInstanceSchedulePolicyStatus extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ResourcePolicyResourceStatusInstanceSchedulePolicyStatus::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyResourceStatusInstanceSchedulePolicyStatus');
