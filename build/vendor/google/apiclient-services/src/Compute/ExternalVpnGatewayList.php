...
class ExternalVpnGatewayList extends \RoRdb\Google\Collection
{
...
\class_alias(ExternalVpnGatewayList::class, 'RoRdb\\Google_Service_Compute_ExternalVpnGatewayList');
