...
class ServiceAttachmentConsumerProjectLimit extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ServiceAttachmentConsumerProjectLimit::class, 'RoRdb\\Google_Service_Compute_ServiceAttachmentConsumerProjectLimit');
