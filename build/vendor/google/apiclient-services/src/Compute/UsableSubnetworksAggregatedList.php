...
class UsableSubnetworksAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(UsableSubnetworksAggregatedList::class, 'RoRdb\\Google_Service_Compute_UsableSubnetworksAggregatedList');
