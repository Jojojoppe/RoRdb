...
class HealthChecksAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(HealthChecksAggregatedList::class, 'RoRdb\\Google_Service_Compute_HealthChecksAggregatedList');
