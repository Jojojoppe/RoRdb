...
class TargetHttpsProxyListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(TargetHttpsProxyListWarning::class, 'RoRdb\\Google_Service_Compute_TargetHttpsProxyListWarning');
