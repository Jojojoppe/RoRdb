...
class AcceleratorTypeListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AcceleratorTypeListWarning::class, 'RoRdb\\Google_Service_Compute_AcceleratorTypeListWarning');
