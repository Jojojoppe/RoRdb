...
class PublicAdvertisedPrefixList extends \RoRdb\Google\Collection
{
...
\class_alias(PublicAdvertisedPrefixList::class, 'RoRdb\\Google_Service_Compute_PublicAdvertisedPrefixList');
