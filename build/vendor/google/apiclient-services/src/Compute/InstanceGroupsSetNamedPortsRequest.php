...
class InstanceGroupsSetNamedPortsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceGroupsSetNamedPortsRequest::class, 'RoRdb\\Google_Service_Compute_InstanceGroupsSetNamedPortsRequest');
