...
class SecurityPoliciesAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(SecurityPoliciesAggregatedList::class, 'RoRdb\\Google_Service_Compute_SecurityPoliciesAggregatedList');
