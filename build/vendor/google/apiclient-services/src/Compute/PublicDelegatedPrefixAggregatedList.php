...
class PublicDelegatedPrefixAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(PublicDelegatedPrefixAggregatedList::class, 'RoRdb\\Google_Service_Compute_PublicDelegatedPrefixAggregatedList');
