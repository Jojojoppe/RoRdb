...
class RouterNatSubnetworkToNat extends \RoRdb\Google\Collection
{
...
\class_alias(RouterNatSubnetworkToNat::class, 'RoRdb\\Google_Service_Compute_RouterNatSubnetworkToNat');
