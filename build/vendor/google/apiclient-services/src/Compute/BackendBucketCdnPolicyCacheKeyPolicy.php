...
class BackendBucketCdnPolicyCacheKeyPolicy extends \RoRdb\Google\Collection
{
...
\class_alias(BackendBucketCdnPolicyCacheKeyPolicy::class, 'RoRdb\\Google_Service_Compute_BackendBucketCdnPolicyCacheKeyPolicy');
