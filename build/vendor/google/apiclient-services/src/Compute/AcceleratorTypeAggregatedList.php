...
class AcceleratorTypeAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(AcceleratorTypeAggregatedList::class, 'RoRdb\\Google_Service_Compute_AcceleratorTypeAggregatedList');
