...
class SourceDiskEncryptionKey extends \RoRdb\Google\Model
{
...
\class_alias(SourceDiskEncryptionKey::class, 'RoRdb\\Google_Service_Compute_SourceDiskEncryptionKey');
