...
class ServiceAttachmentsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(ServiceAttachmentsScopedList::class, 'RoRdb\\Google_Service_Compute_ServiceAttachmentsScopedList');
