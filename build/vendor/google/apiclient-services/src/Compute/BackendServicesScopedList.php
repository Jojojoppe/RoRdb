...
class BackendServicesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(BackendServicesScopedList::class, 'RoRdb\\Google_Service_Compute_BackendServicesScopedList');
