...
class ResourcePolicyGroupPlacementPolicy extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ResourcePolicyGroupPlacementPolicy::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyGroupPlacementPolicy');
