...
class SecurityPolicyAdaptiveProtectionConfig extends \RoRdb\Google\Model
{
...
\class_alias(SecurityPolicyAdaptiveProtectionConfig::class, 'RoRdb\\Google_Service_Compute_SecurityPolicyAdaptiveProtectionConfig');
