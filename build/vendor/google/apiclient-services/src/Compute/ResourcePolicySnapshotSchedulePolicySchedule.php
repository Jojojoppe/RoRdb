...
class ResourcePolicySnapshotSchedulePolicySchedule extends \RoRdb\Google\Model
{
...
\class_alias(ResourcePolicySnapshotSchedulePolicySchedule::class, 'RoRdb\\Google_Service_Compute_ResourcePolicySnapshotSchedulePolicySchedule');
