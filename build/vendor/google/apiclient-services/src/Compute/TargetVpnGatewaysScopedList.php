...
class TargetVpnGatewaysScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetVpnGatewaysScopedList::class, 'RoRdb\\Google_Service_Compute_TargetVpnGatewaysScopedList');
