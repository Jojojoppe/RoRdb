...
class NodeTemplatesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(NodeTemplatesScopedList::class, 'RoRdb\\Google_Service_Compute_NodeTemplatesScopedList');
