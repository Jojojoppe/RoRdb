...
class RegionInstanceGroupList extends \RoRdb\Google\Collection
{
...
\class_alias(RegionInstanceGroupList::class, 'RoRdb\\Google_Service_Compute_RegionInstanceGroupList');
