...
class TargetHttpsProxyAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetHttpsProxyAggregatedList::class, 'RoRdb\\Google_Service_Compute_TargetHttpsProxyAggregatedList');
