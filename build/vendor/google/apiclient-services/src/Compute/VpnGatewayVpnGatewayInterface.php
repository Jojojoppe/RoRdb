...
class VpnGatewayVpnGatewayInterface extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VpnGatewayVpnGatewayInterface::class, 'RoRdb\\Google_Service_Compute_VpnGatewayVpnGatewayInterface');
