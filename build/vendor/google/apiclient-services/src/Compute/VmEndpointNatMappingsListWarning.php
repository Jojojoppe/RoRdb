...
class VmEndpointNatMappingsListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(VmEndpointNatMappingsListWarning::class, 'RoRdb\\Google_Service_Compute_VmEndpointNatMappingsListWarning');
