...
class InterconnectDiagnostics extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectDiagnostics::class, 'RoRdb\\Google_Service_Compute_InterconnectDiagnostics');
