...
class NetworkEndpointGroupsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(NetworkEndpointGroupsScopedList::class, 'RoRdb\\Google_Service_Compute_NetworkEndpointGroupsScopedList');
