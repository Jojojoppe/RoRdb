...
class StatefulPolicyPreservedState extends \RoRdb\Google\Model
{
...
\class_alias(StatefulPolicyPreservedState::class, 'RoRdb\\Google_Service_Compute_StatefulPolicyPreservedState');
