...
class ResourcePolicyWeeklyCycle extends \RoRdb\Google\Collection
{
...
\class_alias(ResourcePolicyWeeklyCycle::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyWeeklyCycle');
