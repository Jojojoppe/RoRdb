...
class PacketMirroringAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(PacketMirroringAggregatedList::class, 'RoRdb\\Google_Service_Compute_PacketMirroringAggregatedList');
