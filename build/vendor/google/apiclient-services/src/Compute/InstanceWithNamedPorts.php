...
class InstanceWithNamedPorts extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceWithNamedPorts::class, 'RoRdb\\Google_Service_Compute_InstanceWithNamedPorts');
