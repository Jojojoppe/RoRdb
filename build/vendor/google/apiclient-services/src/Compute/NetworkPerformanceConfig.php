...
class NetworkPerformanceConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NetworkPerformanceConfig::class, 'RoRdb\\Google_Service_Compute_NetworkPerformanceConfig');
