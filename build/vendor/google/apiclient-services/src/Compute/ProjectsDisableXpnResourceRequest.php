...
class ProjectsDisableXpnResourceRequest extends \RoRdb\Google\Model
{
...
\class_alias(ProjectsDisableXpnResourceRequest::class, 'RoRdb\\Google_Service_Compute_ProjectsDisableXpnResourceRequest');
