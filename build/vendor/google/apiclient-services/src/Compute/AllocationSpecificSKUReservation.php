...
class AllocationSpecificSKUReservation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AllocationSpecificSKUReservation::class, 'RoRdb\\Google_Service_Compute_AllocationSpecificSKUReservation');
