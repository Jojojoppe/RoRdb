...
class CustomerEncryptionKeyProtectedDisk extends \RoRdb\Google\Model
{
...
\class_alias(CustomerEncryptionKeyProtectedDisk::class, 'RoRdb\\Google_Service_Compute_CustomerEncryptionKeyProtectedDisk');
