...
class AutoscalerAggregatedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AutoscalerAggregatedListWarning::class, 'RoRdb\\Google_Service_Compute_AutoscalerAggregatedListWarning');
