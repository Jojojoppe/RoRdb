...
class InterconnectAttachment extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectAttachment::class, 'RoRdb\\Google_Service_Compute_InterconnectAttachment');
