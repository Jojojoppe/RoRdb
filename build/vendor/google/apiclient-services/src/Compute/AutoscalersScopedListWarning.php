...
class AutoscalersScopedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AutoscalersScopedListWarning::class, 'RoRdb\\Google_Service_Compute_AutoscalersScopedListWarning');
