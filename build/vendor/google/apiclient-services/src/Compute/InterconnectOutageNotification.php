...
class InterconnectOutageNotification extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectOutageNotification::class, 'RoRdb\\Google_Service_Compute_InterconnectOutageNotification');
