...
class BackendServiceCdnPolicy extends \RoRdb\Google\Collection
{
...
\class_alias(BackendServiceCdnPolicy::class, 'RoRdb\\Google_Service_Compute_BackendServiceCdnPolicy');
