...
class NodeGroupMaintenanceWindow extends \RoRdb\Google\Model
{
...
\class_alias(NodeGroupMaintenanceWindow::class, 'RoRdb\\Google_Service_Compute_NodeGroupMaintenanceWindow');
