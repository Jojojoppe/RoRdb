...
class NetworksUpdatePeeringRequest extends \RoRdb\Google\Model
{
...
\class_alias(NetworksUpdatePeeringRequest::class, 'RoRdb\\Google_Service_Compute_NetworksUpdatePeeringRequest');
