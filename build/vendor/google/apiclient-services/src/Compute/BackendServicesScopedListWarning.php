...
class BackendServicesScopedListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(BackendServicesScopedListWarning::class, 'RoRdb\\Google_Service_Compute_BackendServicesScopedListWarning');
