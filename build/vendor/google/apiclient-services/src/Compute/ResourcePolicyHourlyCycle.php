...
class ResourcePolicyHourlyCycle extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ResourcePolicyHourlyCycle::class, 'RoRdb\\Google_Service_Compute_ResourcePolicyHourlyCycle');
