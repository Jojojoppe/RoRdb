...
class BackendServiceConnectionTrackingPolicy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BackendServiceConnectionTrackingPolicy::class, 'RoRdb\\Google_Service_Compute_BackendServiceConnectionTrackingPolicy');
