...
class InstanceGroupManagerStatusStateful extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(InstanceGroupManagerStatusStateful::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerStatusStateful');
