...
class TargetInstanceAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(TargetInstanceAggregatedList::class, 'RoRdb\\Google_Service_Compute_TargetInstanceAggregatedList');
