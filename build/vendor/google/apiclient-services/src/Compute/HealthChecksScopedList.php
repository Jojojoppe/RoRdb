...
class HealthChecksScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(HealthChecksScopedList::class, 'RoRdb\\Google_Service_Compute_HealthChecksScopedList');
