...
class HealthCheckServicesListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(HealthCheckServicesListWarning::class, 'RoRdb\\Google_Service_Compute_HealthCheckServicesListWarning');
