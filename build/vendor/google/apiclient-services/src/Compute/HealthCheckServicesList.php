...
class HealthCheckServicesList extends \RoRdb\Google\Collection
{
...
\class_alias(HealthCheckServicesList::class, 'RoRdb\\Google_Service_Compute_HealthCheckServicesList');
