...
class AcceleratorTypesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(AcceleratorTypesScopedList::class, 'RoRdb\\Google_Service_Compute_AcceleratorTypesScopedList');
