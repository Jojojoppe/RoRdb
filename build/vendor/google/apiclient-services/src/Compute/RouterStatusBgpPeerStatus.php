...
class RouterStatusBgpPeerStatus extends \RoRdb\Google\Collection
{
...
\class_alias(RouterStatusBgpPeerStatus::class, 'RoRdb\\Google_Service_Compute_RouterStatusBgpPeerStatus');
