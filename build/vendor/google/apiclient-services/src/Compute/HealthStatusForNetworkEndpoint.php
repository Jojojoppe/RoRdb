...
class HealthStatusForNetworkEndpoint extends \RoRdb\Google\Model
{
...
\class_alias(HealthStatusForNetworkEndpoint::class, 'RoRdb\\Google_Service_Compute_HealthStatusForNetworkEndpoint');
