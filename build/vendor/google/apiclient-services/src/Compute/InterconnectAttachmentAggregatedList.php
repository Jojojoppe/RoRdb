...
class InterconnectAttachmentAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(InterconnectAttachmentAggregatedList::class, 'RoRdb\\Google_Service_Compute_InterconnectAttachmentAggregatedList');
