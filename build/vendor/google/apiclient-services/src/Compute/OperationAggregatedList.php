...
class OperationAggregatedList extends \RoRdb\Google\Collection
{
...
\class_alias(OperationAggregatedList::class, 'RoRdb\\Google_Service_Compute_OperationAggregatedList');
