...
class ShieldedInstanceIntegrityPolicy extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ShieldedInstanceIntegrityPolicy::class, 'RoRdb\\Google_Service_Compute_ShieldedInstanceIntegrityPolicy');
