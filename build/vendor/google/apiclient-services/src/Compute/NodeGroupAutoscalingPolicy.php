...
class NodeGroupAutoscalingPolicy extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(NodeGroupAutoscalingPolicy::class, 'RoRdb\\Google_Service_Compute_NodeGroupAutoscalingPolicy');
