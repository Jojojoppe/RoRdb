...
class InstanceGroupManagerVersion extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InstanceGroupManagerVersion::class, 'RoRdb\\Google_Service_Compute_InstanceGroupManagerVersion');
