...
class RegionInstanceGroupManagerList extends \RoRdb\Google\Collection
{
...
\class_alias(RegionInstanceGroupManagerList::class, 'RoRdb\\Google_Service_Compute_RegionInstanceGroupManagerList');
