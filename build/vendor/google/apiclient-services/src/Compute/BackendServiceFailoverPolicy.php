...
class BackendServiceFailoverPolicy extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(BackendServiceFailoverPolicy::class, 'RoRdb\\Google_Service_Compute_BackendServiceFailoverPolicy');
