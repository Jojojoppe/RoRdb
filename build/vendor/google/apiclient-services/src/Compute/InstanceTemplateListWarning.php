...
class InstanceTemplateListWarning extends \RoRdb\Google\Collection
{
...
\class_alias(InstanceTemplateListWarning::class, 'RoRdb\\Google_Service_Compute_InstanceTemplateListWarning');
