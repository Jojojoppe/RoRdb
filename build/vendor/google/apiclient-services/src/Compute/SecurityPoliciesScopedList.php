...
class SecurityPoliciesScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(SecurityPoliciesScopedList::class, 'RoRdb\\Google_Service_Compute_SecurityPoliciesScopedList');
