...
class BulkInsertInstanceResource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BulkInsertInstanceResource::class, 'RoRdb\\Google_Service_Compute_BulkInsertInstanceResource');
