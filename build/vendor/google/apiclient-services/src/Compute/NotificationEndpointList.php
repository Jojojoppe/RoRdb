...
class NotificationEndpointList extends \RoRdb\Google\Collection
{
...
\class_alias(NotificationEndpointList::class, 'RoRdb\\Google_Service_Compute_NotificationEndpointList');
