...
class PacketMirroringsScopedList extends \RoRdb\Google\Collection
{
...
\class_alias(PacketMirroringsScopedList::class, 'RoRdb\\Google_Service_Compute_PacketMirroringsScopedList');
