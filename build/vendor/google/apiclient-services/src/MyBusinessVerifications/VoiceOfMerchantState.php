...
class VoiceOfMerchantState extends \RoRdb\Google\Model
{
...
\class_alias(VoiceOfMerchantState::class, 'RoRdb\\Google_Service_MyBusinessVerifications_VoiceOfMerchantState');
