...
class VerificationOption extends \RoRdb\Google\Model
{
...
\class_alias(VerificationOption::class, 'RoRdb\\Google_Service_MyBusinessVerifications_VerificationOption');
