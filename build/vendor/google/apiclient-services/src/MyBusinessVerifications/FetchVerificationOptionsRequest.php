...
class FetchVerificationOptionsRequest extends \RoRdb\Google\Model
{
...
\class_alias(FetchVerificationOptionsRequest::class, 'RoRdb\\Google_Service_MyBusinessVerifications_FetchVerificationOptionsRequest');
