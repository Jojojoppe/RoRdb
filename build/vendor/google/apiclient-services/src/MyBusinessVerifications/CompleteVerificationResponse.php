...
class CompleteVerificationResponse extends \RoRdb\Google\Model
{
...
\class_alias(CompleteVerificationResponse::class, 'RoRdb\\Google_Service_MyBusinessVerifications_CompleteVerificationResponse');
