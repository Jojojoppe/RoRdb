...
class ComplyWithGuidelines extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ComplyWithGuidelines::class, 'RoRdb\\Google_Service_MyBusinessVerifications_ComplyWithGuidelines');
