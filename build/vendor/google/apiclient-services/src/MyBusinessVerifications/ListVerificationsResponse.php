...
class ListVerificationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListVerificationsResponse::class, 'RoRdb\\Google_Service_MyBusinessVerifications_ListVerificationsResponse');
