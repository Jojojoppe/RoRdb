...
class VerifyLocationRequest extends \RoRdb\Google\Model
{
...
\class_alias(VerifyLocationRequest::class, 'RoRdb\\Google_Service_MyBusinessVerifications_VerifyLocationRequest');
