...
class EmailVerificationData extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(EmailVerificationData::class, 'RoRdb\\Google_Service_MyBusinessVerifications_EmailVerificationData');
