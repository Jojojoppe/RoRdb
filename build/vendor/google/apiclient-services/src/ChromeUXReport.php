 ...
 * @author Google, Inc.
 */
class ChromeUXReport extends \RoRdb\Google\Service
{
    public $records;
    /**
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->records = new ChromeUXReport\Resource\Records($this, $this->serviceName, 'records', ['methods' => ['queryRecord' => ['path' => 'v1/records:queryRecord', 'httpMethod' => 'POST', 'parameters' => []]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(ChromeUXReport::class, 'RoRdb\\Google_Service_ChromeUXReport');
