...
class SasPortalDeviceGrant extends \RoRdb\Google\Collection
{
...
\class_alias(SasPortalDeviceGrant::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDeviceGrant');
