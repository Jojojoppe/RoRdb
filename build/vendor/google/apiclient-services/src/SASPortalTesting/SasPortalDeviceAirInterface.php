...
class SasPortalDeviceAirInterface extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SasPortalDeviceAirInterface::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDeviceAirInterface');
