...
class SasPortalDpaMoveList extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SasPortalDpaMoveList::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDpaMoveList');
