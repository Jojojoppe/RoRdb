...
class SasPortalDeviceMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SasPortalDeviceMetadata::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDeviceMetadata');
