...
class SasPortalDeployment extends \RoRdb\Google\Collection
{
...
\class_alias(SasPortalDeployment::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDeployment');
