...
class SasPortalDeviceConfig extends \RoRdb\Google\Collection
{
...
\class_alias(SasPortalDeviceConfig::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalDeviceConfig');
