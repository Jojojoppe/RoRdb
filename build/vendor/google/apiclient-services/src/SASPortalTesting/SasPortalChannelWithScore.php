...
class SasPortalChannelWithScore extends \RoRdb\Google\Model
{
...
\class_alias(SasPortalChannelWithScore::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalChannelWithScore');
