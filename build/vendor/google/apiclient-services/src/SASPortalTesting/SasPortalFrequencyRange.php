...
class SasPortalFrequencyRange extends \RoRdb\Google\Model
{
...
\class_alias(SasPortalFrequencyRange::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalFrequencyRange');
