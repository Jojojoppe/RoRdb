...
class SasPortalInstallationParams extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SasPortalInstallationParams::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalInstallationParams');
