...
class SasPortalSetPolicyRequest extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SasPortalSetPolicyRequest::class, 'RoRdb\\Google_Service_SASPortalTesting_SasPortalSetPolicyRequest');
