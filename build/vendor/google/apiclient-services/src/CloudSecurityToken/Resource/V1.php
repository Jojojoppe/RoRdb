 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudSecurityToken\Resource;

use RoRdb\Google\Service\CloudSecurityToken\GoogleIdentityStsV1ExchangeTokenRequest;
use RoRdb\Google\Service\CloudSecurityToken\GoogleIdentityStsV1ExchangeTokenResponse;
use RoRdb\Google\Service\CloudSecurityToken\GoogleIdentityStsV1IntrospectTokenRequest;
use RoRdb\Google\Service\CloudSecurityToken\GoogleIdentityStsV1IntrospectTokenResponse;
/**
...
\class_alias(V1::class, 'RoRdb\\Google_Service_CloudSecurityToken_Resource_V1');
