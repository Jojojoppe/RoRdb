...
class GoogleIdentityStsV1ExchangeTokenRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleIdentityStsV1ExchangeTokenRequest::class, 'RoRdb\\Google_Service_CloudSecurityToken_GoogleIdentityStsV1ExchangeTokenRequest');
