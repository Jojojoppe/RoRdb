...
class QueryDriveActivityResponse extends \RoRdb\Google\Collection
{
...
\class_alias(QueryDriveActivityResponse::class, 'RoRdb\\Google_Service_DriveActivity_QueryDriveActivityResponse');
