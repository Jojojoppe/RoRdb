...
class ConsolidationStrategy extends \RoRdb\Google\Model
{
...
\class_alias(ConsolidationStrategy::class, 'RoRdb\\Google_Service_DriveActivity_ConsolidationStrategy');
