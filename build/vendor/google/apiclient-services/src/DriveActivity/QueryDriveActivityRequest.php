...
class QueryDriveActivityRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(QueryDriveActivityRequest::class, 'RoRdb\\Google_Service_DriveActivity_QueryDriveActivityRequest');
