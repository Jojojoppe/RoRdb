 ...
 * @author Google, Inc.
 */
class Playcustomapp extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->accounts_customApps = new Playcustomapp\Resource\AccountsCustomApps($this, $this->serviceName, 'customApps', ['methods' => ['create' => ['path' => 'playcustomapp/v1/accounts/{account}/customApps', 'httpMethod' => 'POST', 'parameters' => ['account' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Playcustomapp::class, 'RoRdb\\Google_Service_Playcustomapp');
