 ...
 * @author Google, Inc.
 */
class Firebasestorage extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->projects_buckets = new Firebasestorage\Resource\ProjectsBuckets($this, $this->serviceName, 'buckets', ['methods' => ['addFirebase' => ['path' => 'v1beta/{+bucket}:addFirebase', 'httpMethod' => 'POST', 'parameters' => ['bucket' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'get' => ['path' => 'v1beta/{+name}', 'httpMethod' => 'GET', 'parameters' => ['name' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'list' => ['path' => 'v1beta/{+parent}/buckets', 'httpMethod' => 'GET', 'parameters' => ['parent' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'pageSize' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]], 'removeFirebase' => ['path' => 'v1beta/{+bucket}:removeFirebase', 'httpMethod' => 'POST', 'parameters' => ['bucket' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Firebasestorage::class, 'RoRdb\\Google_Service_Firebasestorage');
