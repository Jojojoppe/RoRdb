...
class BatchGetAmpUrlsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchGetAmpUrlsResponse::class, 'RoRdb\\Google_Service_Acceleratedmobilepageurl_BatchGetAmpUrlsResponse');
