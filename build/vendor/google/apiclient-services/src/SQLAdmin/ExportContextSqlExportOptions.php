...
class ExportContextSqlExportOptions extends \RoRdb\Google\Collection
{
...
\class_alias(ExportContextSqlExportOptions::class, 'RoRdb\\Google_Service_SQLAdmin_ExportContextSqlExportOptions');
