...
class InstancesFailoverRequest extends \RoRdb\Google\Model
{
...
\class_alias(InstancesFailoverRequest::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesFailoverRequest');
