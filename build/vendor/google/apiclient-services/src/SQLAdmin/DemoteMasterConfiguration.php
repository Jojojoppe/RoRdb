...
class DemoteMasterConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DemoteMasterConfiguration::class, 'RoRdb\\Google_Service_SQLAdmin_DemoteMasterConfiguration');
