...
class ImportContextBakImportOptionsEncryptionOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ImportContextBakImportOptionsEncryptionOptions::class, 'RoRdb\\Google_Service_SQLAdmin_ImportContextBakImportOptionsEncryptionOptions');
