...
class InstancesListServerCasResponse extends \RoRdb\Google\Collection
{
...
\class_alias(InstancesListServerCasResponse::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesListServerCasResponse');
