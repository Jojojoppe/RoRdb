...
class PasswordValidationPolicy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PasswordValidationPolicy::class, 'RoRdb\\Google_Service_SQLAdmin_PasswordValidationPolicy');
