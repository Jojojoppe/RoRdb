...
class InstancesRotateServerCaRequest extends \RoRdb\Google\Model
{
...
\class_alias(InstancesRotateServerCaRequest::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesRotateServerCaRequest');
