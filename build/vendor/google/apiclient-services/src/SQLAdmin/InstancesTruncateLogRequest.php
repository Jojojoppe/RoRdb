...
class InstancesTruncateLogRequest extends \RoRdb\Google\Model
{
...
\class_alias(InstancesTruncateLogRequest::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesTruncateLogRequest');
