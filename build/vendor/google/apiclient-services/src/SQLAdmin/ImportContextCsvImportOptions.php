...
class ImportContextCsvImportOptions extends \RoRdb\Google\Collection
{
...
\class_alias(ImportContextCsvImportOptions::class, 'RoRdb\\Google_Service_SQLAdmin_ImportContextCsvImportOptions');
