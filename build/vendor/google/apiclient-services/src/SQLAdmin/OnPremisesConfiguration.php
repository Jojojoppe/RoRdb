...
class OnPremisesConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OnPremisesConfiguration::class, 'RoRdb\\Google_Service_SQLAdmin_OnPremisesConfiguration');
