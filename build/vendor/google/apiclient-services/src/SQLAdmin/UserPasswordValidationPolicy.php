...
class UserPasswordValidationPolicy extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UserPasswordValidationPolicy::class, 'RoRdb\\Google_Service_SQLAdmin_UserPasswordValidationPolicy');
