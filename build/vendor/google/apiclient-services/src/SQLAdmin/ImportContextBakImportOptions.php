...
class ImportContextBakImportOptions extends \RoRdb\Google\Model
{
...
\class_alias(ImportContextBakImportOptions::class, 'RoRdb\\Google_Service_SQLAdmin_ImportContextBakImportOptions');
