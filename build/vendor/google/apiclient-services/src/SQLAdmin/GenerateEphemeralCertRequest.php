...
class GenerateEphemeralCertRequest extends \RoRdb\Google\Model
{
...
\class_alias(GenerateEphemeralCertRequest::class, 'RoRdb\\Google_Service_SQLAdmin_GenerateEphemeralCertRequest');
