...
class GenerateEphemeralCertResponse extends \RoRdb\Google\Model
{
...
\class_alias(GenerateEphemeralCertResponse::class, 'RoRdb\\Google_Service_SQLAdmin_GenerateEphemeralCertResponse');
