...
class InstancesDemoteMasterRequest extends \RoRdb\Google\Model
{
...
\class_alias(InstancesDemoteMasterRequest::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesDemoteMasterRequest');
