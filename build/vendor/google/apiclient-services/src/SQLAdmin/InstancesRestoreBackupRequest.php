...
class InstancesRestoreBackupRequest extends \RoRdb\Google\Model
{
...
\class_alias(InstancesRestoreBackupRequest::class, 'RoRdb\\Google_Service_SQLAdmin_InstancesRestoreBackupRequest');
