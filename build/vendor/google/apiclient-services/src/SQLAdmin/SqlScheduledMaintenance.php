...
class SqlScheduledMaintenance extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(SqlScheduledMaintenance::class, 'RoRdb\\Google_Service_SQLAdmin_SqlScheduledMaintenance');
