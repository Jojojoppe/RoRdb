 ...
 * the License.
 */
namespace RoRdb\Google\Service\SQLAdmin\Resource;

use RoRdb\Google\Service\SQLAdmin\DatabaseInstance;
use RoRdb\Google\Service\SQLAdmin\InstancesCloneRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesDemoteMasterRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesExportRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesFailoverRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesImportRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesListResponse;
use RoRdb\Google\Service\SQLAdmin\InstancesListServerCasResponse;
use RoRdb\Google\Service\SQLAdmin\InstancesRestoreBackupRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesRotateServerCaRequest;
use RoRdb\Google\Service\SQLAdmin\InstancesTruncateLogRequest;
use RoRdb\Google\Service\SQLAdmin\Operation;
/**
...
\class_alias(Instances::class, 'RoRdb\\Google_Service_SQLAdmin_Resource_Instances');
