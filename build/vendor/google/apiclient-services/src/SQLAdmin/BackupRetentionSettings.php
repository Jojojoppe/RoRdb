...
class BackupRetentionSettings extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(BackupRetentionSettings::class, 'RoRdb\\Google_Service_SQLAdmin_BackupRetentionSettings');
