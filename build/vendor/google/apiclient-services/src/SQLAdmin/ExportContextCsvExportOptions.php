...
class ExportContextCsvExportOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ExportContextCsvExportOptions::class, 'RoRdb\\Google_Service_SQLAdmin_ExportContextCsvExportOptions');
