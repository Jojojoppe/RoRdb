...
class SqlServerDatabaseDetails extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SqlServerDatabaseDetails::class, 'RoRdb\\Google_Service_SQLAdmin_SqlServerDatabaseDetails');
