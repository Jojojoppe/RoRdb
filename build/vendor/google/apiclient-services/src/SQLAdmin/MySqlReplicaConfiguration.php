...
class MySqlReplicaConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MySqlReplicaConfiguration::class, 'RoRdb\\Google_Service_SQLAdmin_MySqlReplicaConfiguration');
