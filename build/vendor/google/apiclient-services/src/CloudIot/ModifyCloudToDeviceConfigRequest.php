...
class ModifyCloudToDeviceConfigRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ModifyCloudToDeviceConfigRequest::class, 'RoRdb\\Google_Service_CloudIot_ModifyCloudToDeviceConfigRequest');
