...
class ListDeviceStatesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDeviceStatesResponse::class, 'RoRdb\\Google_Service_CloudIot_ListDeviceStatesResponse');
