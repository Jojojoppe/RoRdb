...
class ListDeviceRegistriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDeviceRegistriesResponse::class, 'RoRdb\\Google_Service_CloudIot_ListDeviceRegistriesResponse');
