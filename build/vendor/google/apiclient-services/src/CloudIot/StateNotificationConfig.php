...
class StateNotificationConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(StateNotificationConfig::class, 'RoRdb\\Google_Service_CloudIot_StateNotificationConfig');
