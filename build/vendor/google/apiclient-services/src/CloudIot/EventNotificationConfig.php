...
class EventNotificationConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(EventNotificationConfig::class, 'RoRdb\\Google_Service_CloudIot_EventNotificationConfig');
