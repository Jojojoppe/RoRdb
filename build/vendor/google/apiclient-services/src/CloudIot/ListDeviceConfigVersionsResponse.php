...
class ListDeviceConfigVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListDeviceConfigVersionsResponse::class, 'RoRdb\\Google_Service_CloudIot_ListDeviceConfigVersionsResponse');
