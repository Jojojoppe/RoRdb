...
class CreateConferenceRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateConferenceRequest::class, 'RoRdb\\Google_Service_Calendar_CreateConferenceRequest');
