...
use RoRdb\Google\Service\Calendar\Event;
use RoRdb\Google\Service\Calendar\Events as EventsModel;
/**
...
\class_alias(Events::class, 'RoRdb\\Google_Service_Calendar_Resource_Events');
