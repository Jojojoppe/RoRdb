 ...
 * the License.
 */
namespace RoRdb\Google\Service\Verifiedaccess\Resource;

use RoRdb\Google\Service\Verifiedaccess\Challenge as ChallengeModel;
use RoRdb\Google\Service\Verifiedaccess\VerifiedaccessEmpty;
use RoRdb\Google\Service\Verifiedaccess\VerifyChallengeResponseRequest;
use RoRdb\Google\Service\Verifiedaccess\VerifyChallengeResponseResult;
/**
 ...
 *  </code>
 */
class Challenge extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Challenge::class, 'RoRdb\\Google_Service_Verifiedaccess_Resource_Challenge');
