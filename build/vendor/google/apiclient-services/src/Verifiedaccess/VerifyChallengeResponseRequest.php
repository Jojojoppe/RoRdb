...
class VerifyChallengeResponseRequest extends \RoRdb\Google\Model
{
...
\class_alias(VerifyChallengeResponseRequest::class, 'RoRdb\\Google_Service_Verifiedaccess_VerifyChallengeResponseRequest');
