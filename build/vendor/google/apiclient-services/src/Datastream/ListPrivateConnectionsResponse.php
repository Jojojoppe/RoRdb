...
class ListPrivateConnectionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPrivateConnectionsResponse::class, 'RoRdb\\Google_Service_Datastream_ListPrivateConnectionsResponse');
