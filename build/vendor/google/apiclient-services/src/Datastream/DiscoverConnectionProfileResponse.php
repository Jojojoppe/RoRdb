...
class DiscoverConnectionProfileResponse extends \RoRdb\Google\Model
{
...
\class_alias(DiscoverConnectionProfileResponse::class, 'RoRdb\\Google_Service_Datastream_DiscoverConnectionProfileResponse');
