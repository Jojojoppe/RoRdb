...
class ListStreamObjectsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListStreamObjectsResponse::class, 'RoRdb\\Google_Service_Datastream_ListStreamObjectsResponse');
