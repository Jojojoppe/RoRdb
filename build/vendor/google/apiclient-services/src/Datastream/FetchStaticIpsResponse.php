...
class FetchStaticIpsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(FetchStaticIpsResponse::class, 'RoRdb\\Google_Service_Datastream_FetchStaticIpsResponse');
