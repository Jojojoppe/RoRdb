...
class LookupStreamObjectRequest extends \RoRdb\Google\Model
{
...
\class_alias(LookupStreamObjectRequest::class, 'RoRdb\\Google_Service_Datastream_LookupStreamObjectRequest');
