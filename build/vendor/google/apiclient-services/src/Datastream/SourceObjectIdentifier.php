...
class SourceObjectIdentifier extends \RoRdb\Google\Model
{
...
\class_alias(SourceObjectIdentifier::class, 'RoRdb\\Google_Service_Datastream_SourceObjectIdentifier');
