...
class DiscoverConnectionProfileRequest extends \RoRdb\Google\Model
{
...
\class_alias(DiscoverConnectionProfileRequest::class, 'RoRdb\\Google_Service_Datastream_DiscoverConnectionProfileRequest');
