...
class GdataDownloadParameters extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GdataDownloadParameters::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDownloadParameters');
