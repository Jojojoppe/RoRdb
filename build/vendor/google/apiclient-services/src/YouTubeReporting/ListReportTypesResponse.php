...
class ListReportTypesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListReportTypesResponse::class, 'RoRdb\\Google_Service_YouTubeReporting_ListReportTypesResponse');
