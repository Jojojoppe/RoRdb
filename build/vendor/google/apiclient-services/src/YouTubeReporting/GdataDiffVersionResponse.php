...
class GdataDiffVersionResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GdataDiffVersionResponse::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDiffVersionResponse');
