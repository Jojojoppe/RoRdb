...
class GdataDiffUploadResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GdataDiffUploadResponse::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDiffUploadResponse');
