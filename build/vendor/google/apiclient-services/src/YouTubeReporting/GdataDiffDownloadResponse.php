...
class GdataDiffDownloadResponse extends \RoRdb\Google\Model
{
...
\class_alias(GdataDiffDownloadResponse::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDiffDownloadResponse');
