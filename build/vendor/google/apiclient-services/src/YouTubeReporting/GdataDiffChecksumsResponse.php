...
class GdataDiffChecksumsResponse extends \RoRdb\Google\Model
{
...
\class_alias(GdataDiffChecksumsResponse::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDiffChecksumsResponse');
