...
class GdataDiffUploadRequest extends \RoRdb\Google\Model
{
...
\class_alias(GdataDiffUploadRequest::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataDiffUploadRequest');
