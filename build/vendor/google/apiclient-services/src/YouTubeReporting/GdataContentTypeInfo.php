...
class GdataContentTypeInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GdataContentTypeInfo::class, 'RoRdb\\Google_Service_YouTubeReporting_GdataContentTypeInfo');
