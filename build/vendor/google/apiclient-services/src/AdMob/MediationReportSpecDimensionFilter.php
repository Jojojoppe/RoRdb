...
class MediationReportSpecDimensionFilter extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MediationReportSpecDimensionFilter::class, 'RoRdb\\Google_Service_AdMob_MediationReportSpecDimensionFilter');
