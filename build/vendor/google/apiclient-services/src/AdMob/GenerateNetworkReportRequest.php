...
class GenerateNetworkReportRequest extends \RoRdb\Google\Model
{
...
\class_alias(GenerateNetworkReportRequest::class, 'RoRdb\\Google_Service_AdMob_GenerateNetworkReportRequest');
