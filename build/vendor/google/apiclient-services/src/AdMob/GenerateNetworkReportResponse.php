...
class GenerateNetworkReportResponse extends \RoRdb\Google\Model
{
...
\class_alias(GenerateNetworkReportResponse::class, 'RoRdb\\Google_Service_AdMob_GenerateNetworkReportResponse');
