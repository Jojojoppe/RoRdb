...
class NetworkReportSpecDimensionFilter extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NetworkReportSpecDimensionFilter::class, 'RoRdb\\Google_Service_AdMob_NetworkReportSpecDimensionFilter');
