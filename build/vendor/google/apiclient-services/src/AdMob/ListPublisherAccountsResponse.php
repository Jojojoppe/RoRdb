...
class ListPublisherAccountsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPublisherAccountsResponse::class, 'RoRdb\\Google_Service_AdMob_ListPublisherAccountsResponse');
