...
class GenerateMediationReportRequest extends \RoRdb\Google\Model
{
...
\class_alias(GenerateMediationReportRequest::class, 'RoRdb\\Google_Service_AdMob_GenerateMediationReportRequest');
