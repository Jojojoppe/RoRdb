...
class GenerateMediationReportResponse extends \RoRdb\Google\Model
{
...
\class_alias(GenerateMediationReportResponse::class, 'RoRdb\\Google_Service_AdMob_GenerateMediationReportResponse');
