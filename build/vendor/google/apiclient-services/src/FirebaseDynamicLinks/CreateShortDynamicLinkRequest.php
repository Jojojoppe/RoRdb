...
class CreateShortDynamicLinkRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateShortDynamicLinkRequest::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_CreateShortDynamicLinkRequest');
