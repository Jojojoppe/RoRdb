...
class GetIosPostInstallAttributionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GetIosPostInstallAttributionRequest::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_GetIosPostInstallAttributionRequest');
