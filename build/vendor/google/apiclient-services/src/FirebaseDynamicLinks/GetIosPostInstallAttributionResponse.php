 ...
 * the License.
 */
namespace RoRdb\Google\Service\FirebaseDynamicLinks;

class GetIosPostInstallAttributionResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GetIosPostInstallAttributionResponse::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_GetIosPostInstallAttributionResponse');
