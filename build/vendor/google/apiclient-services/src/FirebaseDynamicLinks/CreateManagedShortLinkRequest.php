...
class CreateManagedShortLinkRequest extends \RoRdb\Google\Model
{
...
\class_alias(CreateManagedShortLinkRequest::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_CreateManagedShortLinkRequest');
