...
class GetIosReopenAttributionResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GetIosReopenAttributionResponse::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_GetIosReopenAttributionResponse');
