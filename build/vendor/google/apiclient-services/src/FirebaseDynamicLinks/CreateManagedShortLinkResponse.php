...
class CreateManagedShortLinkResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreateManagedShortLinkResponse::class, 'RoRdb\\Google_Service_FirebaseDynamicLinks_CreateManagedShortLinkResponse');
