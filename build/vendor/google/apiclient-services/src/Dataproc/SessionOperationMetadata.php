...
class SessionOperationMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(SessionOperationMetadata::class, 'RoRdb\\Google_Service_Dataproc_SessionOperationMetadata');
