...
class WorkflowTemplatePlacement extends \RoRdb\Google\Model
{
...
\class_alias(WorkflowTemplatePlacement::class, 'RoRdb\\Google_Service_Dataproc_WorkflowTemplatePlacement');
