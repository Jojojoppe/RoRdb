...
class BatchOperationMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(BatchOperationMetadata::class, 'RoRdb\\Google_Service_Dataproc_BatchOperationMetadata');
