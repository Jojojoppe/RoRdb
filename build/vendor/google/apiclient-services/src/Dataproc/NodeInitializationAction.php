...
class NodeInitializationAction extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(NodeInitializationAction::class, 'RoRdb\\Google_Service_Dataproc_NodeInitializationAction');
