...
class ClusterOperationMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(ClusterOperationMetadata::class, 'RoRdb\\Google_Service_Dataproc_ClusterOperationMetadata');
