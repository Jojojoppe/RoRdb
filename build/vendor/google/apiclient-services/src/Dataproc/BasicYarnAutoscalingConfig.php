...
class BasicYarnAutoscalingConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BasicYarnAutoscalingConfig::class, 'RoRdb\\Google_Service_Dataproc_BasicYarnAutoscalingConfig');
