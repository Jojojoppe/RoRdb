...
class BasicAutoscalingAlgorithm extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BasicAutoscalingAlgorithm::class, 'RoRdb\\Google_Service_Dataproc_BasicAutoscalingAlgorithm');
