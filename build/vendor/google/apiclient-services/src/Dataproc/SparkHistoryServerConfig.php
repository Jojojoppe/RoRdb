...
class SparkHistoryServerConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SparkHistoryServerConfig::class, 'RoRdb\\Google_Service_Dataproc_SparkHistoryServerConfig');
