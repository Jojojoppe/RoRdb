...
class ListWorkflowTemplatesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListWorkflowTemplatesResponse::class, 'RoRdb\\Google_Service_Dataproc_ListWorkflowTemplatesResponse');
