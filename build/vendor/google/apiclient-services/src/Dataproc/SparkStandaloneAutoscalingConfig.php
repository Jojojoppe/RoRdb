...
class SparkStandaloneAutoscalingConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SparkStandaloneAutoscalingConfig::class, 'RoRdb\\Google_Service_Dataproc_SparkStandaloneAutoscalingConfig');
