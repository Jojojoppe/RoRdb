...
class InjectCredentialsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InjectCredentialsRequest::class, 'RoRdb\\Google_Service_Dataproc_InjectCredentialsRequest');
