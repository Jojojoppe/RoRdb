 ...
 * the License.
 */
namespace RoRdb\Google\Service\Dataproc\Resource;

use RoRdb\Google\Service\Dataproc\Cluster;
use RoRdb\Google\Service\Dataproc\DiagnoseClusterRequest;
use RoRdb\Google\Service\Dataproc\GetIamPolicyRequest;
use RoRdb\Google\Service\Dataproc\InjectCredentialsRequest;
use RoRdb\Google\Service\Dataproc\ListClustersResponse;
use RoRdb\Google\Service\Dataproc\Operation;
use RoRdb\Google\Service\Dataproc\Policy;
use RoRdb\Google\Service\Dataproc\RepairClusterRequest;
use RoRdb\Google\Service\Dataproc\SetIamPolicyRequest;
use RoRdb\Google\Service\Dataproc\StartClusterRequest;
use RoRdb\Google\Service\Dataproc\StopClusterRequest;
use RoRdb\Google\Service\Dataproc\TestIamPermissionsRequest;
use RoRdb\Google\Service\Dataproc\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsRegionsClusters extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsRegionsClusters::class, 'RoRdb\\Google_Service_Dataproc_Resource_ProjectsRegionsClusters');
