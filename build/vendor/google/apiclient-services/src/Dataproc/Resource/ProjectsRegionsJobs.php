...
use RoRdb\Google\Service\Dataproc\CancelJobRequest;
use RoRdb\Google\Service\Dataproc\DataprocEmpty;
use RoRdb\Google\Service\Dataproc\GetIamPolicyRequest;
use RoRdb\Google\Service\Dataproc\Job;
use RoRdb\Google\Service\Dataproc\ListJobsResponse;
...
use RoRdb\Google\Service\Dataproc\SubmitJobRequest;
 ...
 *  </code>
 */
class ProjectsRegionsJobs extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsRegionsJobs::class, 'RoRdb\\Google_Service_Dataproc_Resource_ProjectsRegionsJobs');
