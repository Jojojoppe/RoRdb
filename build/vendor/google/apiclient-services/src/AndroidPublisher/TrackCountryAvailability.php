...
class TrackCountryAvailability extends \RoRdb\Google\Collection
{
...
\class_alias(TrackCountryAvailability::class, 'RoRdb\\Google_Service_AndroidPublisher_TrackCountryAvailability');
