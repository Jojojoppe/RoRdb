...
class ExternallyHostedApk extends \RoRdb\Google\Collection
{
...
\class_alias(ExternallyHostedApk::class, 'RoRdb\\Google_Service_AndroidPublisher_ExternallyHostedApk');
