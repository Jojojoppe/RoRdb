...
class ExpansionFilesUploadResponse extends \RoRdb\Google\Model
{
...
\class_alias(ExpansionFilesUploadResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_ExpansionFilesUploadResponse');
