...
class ReviewsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReviewsListResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_ReviewsListResponse');
