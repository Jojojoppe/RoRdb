...
class ConvertedRegionPrice extends \RoRdb\Google\Model
{
...
\class_alias(ConvertedRegionPrice::class, 'RoRdb\\Google_Service_AndroidPublisher_ConvertedRegionPrice');
