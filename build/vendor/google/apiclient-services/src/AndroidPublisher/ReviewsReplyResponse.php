...
class ReviewsReplyResponse extends \RoRdb\Google\Model
{
...
\class_alias(ReviewsReplyResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_ReviewsReplyResponse');
