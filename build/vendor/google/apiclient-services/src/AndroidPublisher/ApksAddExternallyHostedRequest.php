...
class ApksAddExternallyHostedRequest extends \RoRdb\Google\Model
{
...
\class_alias(ApksAddExternallyHostedRequest::class, 'RoRdb\\Google_Service_AndroidPublisher_ApksAddExternallyHostedRequest');
