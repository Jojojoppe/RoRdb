...
class IntroductoryPriceInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(IntroductoryPriceInfo::class, 'RoRdb\\Google_Service_AndroidPublisher_IntroductoryPriceInfo');
