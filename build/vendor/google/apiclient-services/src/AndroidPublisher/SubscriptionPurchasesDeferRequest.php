...
class SubscriptionPurchasesDeferRequest extends \RoRdb\Google\Model
{
...
\class_alias(SubscriptionPurchasesDeferRequest::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionPurchasesDeferRequest');
