...
class SubscriptionPurchasesDeferResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubscriptionPurchasesDeferResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionPurchasesDeferResponse');
