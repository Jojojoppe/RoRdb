...
class VoidedPurchasesListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(VoidedPurchasesListResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_VoidedPurchasesListResponse');
