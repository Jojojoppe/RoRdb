...
class SubscriptionTaxAndComplianceSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubscriptionTaxAndComplianceSettings::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionTaxAndComplianceSettings');
