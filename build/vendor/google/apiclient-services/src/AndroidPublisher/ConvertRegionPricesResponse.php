...
class ConvertRegionPricesResponse extends \RoRdb\Google\Model
{
...
\class_alias(ConvertRegionPricesResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_ConvertRegionPricesResponse');
