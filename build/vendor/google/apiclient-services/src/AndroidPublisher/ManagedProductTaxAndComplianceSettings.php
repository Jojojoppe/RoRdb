...
class ManagedProductTaxAndComplianceSettings extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ManagedProductTaxAndComplianceSettings::class, 'RoRdb\\Google_Service_AndroidPublisher_ManagedProductTaxAndComplianceSettings');
