...
class GeneratedApksListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GeneratedApksListResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_GeneratedApksListResponse');
