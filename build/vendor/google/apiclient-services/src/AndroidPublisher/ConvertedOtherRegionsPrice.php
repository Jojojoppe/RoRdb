...
class ConvertedOtherRegionsPrice extends \RoRdb\Google\Model
{
...
\class_alias(ConvertedOtherRegionsPrice::class, 'RoRdb\\Google_Service_AndroidPublisher_ConvertedOtherRegionsPrice');
