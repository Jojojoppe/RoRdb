...
class ApksAddExternallyHostedResponse extends \RoRdb\Google\Model
{
...
\class_alias(ApksAddExternallyHostedResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_ApksAddExternallyHostedResponse');
