...
class SubscriptionDeferralInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SubscriptionDeferralInfo::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionDeferralInfo');
