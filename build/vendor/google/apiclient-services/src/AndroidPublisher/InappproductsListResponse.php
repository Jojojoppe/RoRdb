...
class InappproductsListResponse extends \RoRdb\Google\Collection
{
...
\class_alias(InappproductsListResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_InappproductsListResponse');
