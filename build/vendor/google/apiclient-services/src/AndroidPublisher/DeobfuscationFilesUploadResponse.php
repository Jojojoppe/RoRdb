...
class DeobfuscationFilesUploadResponse extends \RoRdb\Google\Model
{
...
\class_alias(DeobfuscationFilesUploadResponse::class, 'RoRdb\\Google_Service_AndroidPublisher_DeobfuscationFilesUploadResponse');
