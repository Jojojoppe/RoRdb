...
class InternalAppSharingArtifact extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InternalAppSharingArtifact::class, 'RoRdb\\Google_Service_AndroidPublisher_InternalAppSharingArtifact');
