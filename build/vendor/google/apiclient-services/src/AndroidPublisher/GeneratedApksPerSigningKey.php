...
class GeneratedApksPerSigningKey extends \RoRdb\Google\Collection
{
...
\class_alias(GeneratedApksPerSigningKey::class, 'RoRdb\\Google_Service_AndroidPublisher_GeneratedApksPerSigningKey');
