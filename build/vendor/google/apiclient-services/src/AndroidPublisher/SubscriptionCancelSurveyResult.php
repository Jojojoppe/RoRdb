...
class SubscriptionCancelSurveyResult extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SubscriptionCancelSurveyResult::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionCancelSurveyResult');
