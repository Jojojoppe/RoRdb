...
class SubscriptionPurchase extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(SubscriptionPurchase::class, 'RoRdb\\Google_Service_AndroidPublisher_SubscriptionPurchase');
