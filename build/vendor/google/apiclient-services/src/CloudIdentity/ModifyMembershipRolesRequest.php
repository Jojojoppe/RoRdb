...
class ModifyMembershipRolesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyMembershipRolesRequest::class, 'RoRdb\\Google_Service_CloudIdentity_ModifyMembershipRolesRequest');
