...
class UpdateMembershipRolesParams extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateMembershipRolesParams::class, 'RoRdb\\Google_Service_CloudIdentity_UpdateMembershipRolesParams');
