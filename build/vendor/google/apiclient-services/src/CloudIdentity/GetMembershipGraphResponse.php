...
class GetMembershipGraphResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetMembershipGraphResponse::class, 'RoRdb\\Google_Service_CloudIdentity_GetMembershipGraphResponse');
