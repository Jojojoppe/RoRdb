...
class RestrictionEvaluations extends \RoRdb\Google\Model
{
...
\class_alias(RestrictionEvaluations::class, 'RoRdb\\Google_Service_CloudIdentity_RestrictionEvaluations');
