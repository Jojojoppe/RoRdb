...
use RoRdb\Google\Service\CloudIdentity\Group;
use RoRdb\Google\Service\CloudIdentity\ListGroupsResponse;
use RoRdb\Google\Service\CloudIdentity\LookupGroupNameResponse;
use RoRdb\Google\Service\CloudIdentity\Operation;
use RoRdb\Google\Service\CloudIdentity\SearchGroupsResponse;
use RoRdb\Google\Service\CloudIdentity\SecuritySettings;
/**
 ...
 *  </code>
 */
class Groups extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(Groups::class, 'RoRdb\\Google_Service_CloudIdentity_Resource_Groups');
