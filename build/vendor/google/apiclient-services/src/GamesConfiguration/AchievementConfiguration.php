...
class AchievementConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AchievementConfiguration::class, 'RoRdb\\Google_Service_GamesConfiguration_AchievementConfiguration');
