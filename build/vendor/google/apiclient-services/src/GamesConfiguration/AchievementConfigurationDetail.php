...
class AchievementConfigurationDetail extends \RoRdb\Google\Model
{
...
\class_alias(AchievementConfigurationDetail::class, 'RoRdb\\Google_Service_GamesConfiguration_AchievementConfigurationDetail');
