...
class GamesNumberAffixConfiguration extends \RoRdb\Google\Model
{
...
\class_alias(GamesNumberAffixConfiguration::class, 'RoRdb\\Google_Service_GamesConfiguration_GamesNumberAffixConfiguration');
