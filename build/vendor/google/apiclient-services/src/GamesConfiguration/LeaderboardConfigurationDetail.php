...
class LeaderboardConfigurationDetail extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LeaderboardConfigurationDetail::class, 'RoRdb\\Google_Service_GamesConfiguration_LeaderboardConfigurationDetail');
