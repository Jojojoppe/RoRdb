...
class LeaderboardConfiguration extends \RoRdb\Google\Model
{
...
\class_alias(LeaderboardConfiguration::class, 'RoRdb\\Google_Service_GamesConfiguration_LeaderboardConfiguration');
