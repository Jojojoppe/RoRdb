...
class GamesNumberFormatConfiguration extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GamesNumberFormatConfiguration::class, 'RoRdb\\Google_Service_GamesConfiguration_GamesNumberFormatConfiguration');
