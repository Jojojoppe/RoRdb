...
class GoogleCloudDatapipelinesV1LaunchTemplateRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatapipelinesV1LaunchTemplateRequest::class, 'RoRdb\\Google_Service_Datapipelines_GoogleCloudDatapipelinesV1LaunchTemplateRequest');
