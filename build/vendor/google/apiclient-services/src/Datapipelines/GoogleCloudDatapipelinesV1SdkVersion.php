...
class GoogleCloudDatapipelinesV1SdkVersion extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatapipelinesV1SdkVersion::class, 'RoRdb\\Google_Service_Datapipelines_GoogleCloudDatapipelinesV1SdkVersion');
