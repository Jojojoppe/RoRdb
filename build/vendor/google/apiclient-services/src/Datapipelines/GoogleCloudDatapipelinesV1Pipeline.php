...
class GoogleCloudDatapipelinesV1Pipeline extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatapipelinesV1Pipeline::class, 'RoRdb\\Google_Service_Datapipelines_GoogleCloudDatapipelinesV1Pipeline');
