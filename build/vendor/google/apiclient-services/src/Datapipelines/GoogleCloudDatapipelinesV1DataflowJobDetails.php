...
class GoogleCloudDatapipelinesV1DataflowJobDetails extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudDatapipelinesV1DataflowJobDetails::class, 'RoRdb\\Google_Service_Datapipelines_GoogleCloudDatapipelinesV1DataflowJobDetails');
