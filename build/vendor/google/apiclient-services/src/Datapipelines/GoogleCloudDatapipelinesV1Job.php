...
class GoogleCloudDatapipelinesV1Job extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDatapipelinesV1Job::class, 'RoRdb\\Google_Service_Datapipelines_GoogleCloudDatapipelinesV1Job');
