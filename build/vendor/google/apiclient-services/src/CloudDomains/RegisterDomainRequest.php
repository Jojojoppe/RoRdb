...
class RegisterDomainRequest extends \RoRdb\Google\Collection
{
...
\class_alias(RegisterDomainRequest::class, 'RoRdb\\Google_Service_CloudDomains_RegisterDomainRequest');
