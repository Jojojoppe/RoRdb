...
class TransferDomainRequest extends \RoRdb\Google\Collection
{
...
\class_alias(TransferDomainRequest::class, 'RoRdb\\Google_Service_CloudDomains_TransferDomainRequest');
