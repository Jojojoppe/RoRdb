...
class SearchDomainsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchDomainsResponse::class, 'RoRdb\\Google_Service_CloudDomains_SearchDomainsResponse');
