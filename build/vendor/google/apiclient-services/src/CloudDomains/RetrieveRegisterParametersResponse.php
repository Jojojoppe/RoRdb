...
class RetrieveRegisterParametersResponse extends \RoRdb\Google\Model
{
...
\class_alias(RetrieveRegisterParametersResponse::class, 'RoRdb\\Google_Service_CloudDomains_RetrieveRegisterParametersResponse');
