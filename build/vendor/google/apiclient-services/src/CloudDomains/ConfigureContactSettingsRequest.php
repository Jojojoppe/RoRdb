...
class ConfigureContactSettingsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ConfigureContactSettingsRequest::class, 'RoRdb\\Google_Service_CloudDomains_ConfigureContactSettingsRequest');
