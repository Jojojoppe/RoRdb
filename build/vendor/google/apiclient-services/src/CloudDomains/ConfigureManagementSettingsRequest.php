...
class ConfigureManagementSettingsRequest extends \RoRdb\Google\Model
{
...
\class_alias(ConfigureManagementSettingsRequest::class, 'RoRdb\\Google_Service_CloudDomains_ConfigureManagementSettingsRequest');
