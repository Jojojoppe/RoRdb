...
class RelationshipData extends \RoRdb\Google\Collection
{
...
\class_alias(RelationshipData::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_RelationshipData');
