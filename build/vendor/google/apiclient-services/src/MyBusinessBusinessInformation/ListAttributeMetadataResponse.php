...
class ListAttributeMetadataResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAttributeMetadataResponse::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_ListAttributeMetadataResponse');
