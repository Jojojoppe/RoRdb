...
class GoogleUpdatedLocation extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleUpdatedLocation::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_GoogleUpdatedLocation');
