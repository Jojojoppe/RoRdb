...
class SearchGoogleLocationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchGoogleLocationsResponse::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_SearchGoogleLocationsResponse');
