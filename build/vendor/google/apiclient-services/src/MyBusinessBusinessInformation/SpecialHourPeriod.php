...
class SpecialHourPeriod extends \RoRdb\Google\Model
{
...
\class_alias(SpecialHourPeriod::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_SpecialHourPeriod');
