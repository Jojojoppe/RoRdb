...
class SearchChainsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchChainsResponse::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_SearchChainsResponse');
