...
class AttributeMetadata extends \RoRdb\Google\Collection
{
...
\class_alias(AttributeMetadata::class, 'RoRdb\\Google_Service_MyBusinessBusinessInformation_AttributeMetadata');
