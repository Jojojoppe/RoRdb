...
class GoogleCloudDataplexV1Content extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1Content::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1Content');
