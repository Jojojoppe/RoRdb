...
class GoogleCloudDataplexV1Asset extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1Asset::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1Asset');
