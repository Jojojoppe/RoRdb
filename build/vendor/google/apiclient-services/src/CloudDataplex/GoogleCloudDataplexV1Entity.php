...
class GoogleCloudDataplexV1Entity extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1Entity::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1Entity');
