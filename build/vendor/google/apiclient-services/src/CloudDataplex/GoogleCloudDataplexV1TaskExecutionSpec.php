...
class GoogleCloudDataplexV1TaskExecutionSpec extends \RoRdb\Google\Model
{
    /**
     * @var string[]
     */
...
\class_alias(GoogleCloudDataplexV1TaskExecutionSpec::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1TaskExecutionSpec');
