...
class GoogleCloudDataplexV1StorageFormat extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1StorageFormat::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1StorageFormat');
