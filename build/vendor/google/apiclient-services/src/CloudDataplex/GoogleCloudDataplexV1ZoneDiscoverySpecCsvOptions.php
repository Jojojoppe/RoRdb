...
class GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptions');
