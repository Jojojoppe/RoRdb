...
class GoogleCloudDataplexV1AssetDiscoveryStatus extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1AssetDiscoveryStatus::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1AssetDiscoveryStatus');
