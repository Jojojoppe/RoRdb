...
class GoogleCloudDataplexV1Task extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1Task::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1Task');
