...
class GoogleCloudDataplexV1Environment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1Environment::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1Environment');
