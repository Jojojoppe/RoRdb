...
class GoogleCloudDataplexV1SessionEvent extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDataplexV1SessionEvent::class, 'RoRdb\\Google_Service_CloudDataplex_GoogleCloudDataplexV1SessionEvent');
