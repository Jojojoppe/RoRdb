...
class ListTagValuesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTagValuesResponse::class, 'RoRdb\\Google_Service_CloudResourceManager_ListTagValuesResponse');
