...
class ListTagBindingsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTagBindingsResponse::class, 'RoRdb\\Google_Service_CloudResourceManager_ListTagBindingsResponse');
