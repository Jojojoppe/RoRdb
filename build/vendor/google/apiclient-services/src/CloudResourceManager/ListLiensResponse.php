...
class ListLiensResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListLiensResponse::class, 'RoRdb\\Google_Service_CloudResourceManager_ListLiensResponse');
