...
class ListTagKeysResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTagKeysResponse::class, 'RoRdb\\Google_Service_CloudResourceManager_ListTagKeysResponse');
