...
class GoogleCloudMlV1RequestLoggingConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1RequestLoggingConfig::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1RequestLoggingConfig');
