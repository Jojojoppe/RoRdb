...
class GoogleCloudMlV1PredictionOutput extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1PredictionOutput::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1PredictionOutput');
