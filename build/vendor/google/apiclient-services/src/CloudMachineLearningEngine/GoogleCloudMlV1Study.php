...
class GoogleCloudMlV1Study extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1Study::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1Study');
