...
class GoogleCloudMlV1Measurement extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudMlV1Measurement::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1Measurement');
