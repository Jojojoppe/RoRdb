...
class GoogleCloudMlV1Config extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1Config::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1Config');
