...
class GoogleCloudMlV1XraiAttribution extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudMlV1XraiAttribution::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1XraiAttribution');
