...
class GoogleCloudMlV1OperationMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1OperationMetadata::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1OperationMetadata');
