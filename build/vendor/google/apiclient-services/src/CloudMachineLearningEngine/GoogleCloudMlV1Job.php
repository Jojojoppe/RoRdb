...
class GoogleCloudMlV1Job extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudMlV1Job::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1Job');
