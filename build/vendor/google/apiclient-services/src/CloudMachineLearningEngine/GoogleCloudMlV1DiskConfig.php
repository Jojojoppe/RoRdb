...
class GoogleCloudMlV1DiskConfig extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudMlV1DiskConfig::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_GoogleCloudMlV1DiskConfig');
