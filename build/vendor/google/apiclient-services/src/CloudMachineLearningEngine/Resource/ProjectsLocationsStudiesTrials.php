 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudMachineLearningEngine\Resource;

use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1AddTrialMeasurementRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1CheckTrialEarlyStoppingStateRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1CompleteTrialRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1ListOptimalTrialsRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1ListOptimalTrialsResponse;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1ListTrialsResponse;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1StopTrialRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1SuggestTrialsRequest;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleCloudMlV1Trial;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleLongrunningOperation;
use RoRdb\Google\Service\CloudMachineLearningEngine\GoogleProtobufEmpty;
/**
 ...
 *  </code>
 */
class ProjectsLocationsStudiesTrials extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsStudiesTrials::class, 'RoRdb\\Google_Service_CloudMachineLearningEngine_Resource_ProjectsLocationsStudiesTrials');
