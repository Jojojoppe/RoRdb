...
class EditCustomerMatchMembersRequest extends \RoRdb\Google\Model
{
...
\class_alias(EditCustomerMatchMembersRequest::class, 'RoRdb\\Google_Service_DisplayVideo_EditCustomerMatchMembersRequest');
