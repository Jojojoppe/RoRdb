...
class ListTargetingOptionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTargetingOptionsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListTargetingOptionsResponse');
