...
class VideoPlayerSizeTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VideoPlayerSizeTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_VideoPlayerSizeTargetingOptionDetails');
