...
class AdvertiserCreativeConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AdvertiserCreativeConfig::class, 'RoRdb\\Google_Service_DisplayVideo_AdvertiserCreativeConfig');
