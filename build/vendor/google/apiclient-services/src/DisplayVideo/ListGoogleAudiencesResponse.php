...
class ListGoogleAudiencesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListGoogleAudiencesResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListGoogleAudiencesResponse');
