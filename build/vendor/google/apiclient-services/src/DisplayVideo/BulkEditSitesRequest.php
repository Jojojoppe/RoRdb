...
class BulkEditSitesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditSitesRequest::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditSitesRequest');
