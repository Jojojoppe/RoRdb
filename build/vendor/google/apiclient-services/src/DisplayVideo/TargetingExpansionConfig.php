...
class TargetingExpansionConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TargetingExpansionConfig::class, 'RoRdb\\Google_Service_DisplayVideo_TargetingExpansionConfig');
