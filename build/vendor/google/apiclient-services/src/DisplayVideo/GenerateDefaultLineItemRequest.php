...
class GenerateDefaultLineItemRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GenerateDefaultLineItemRequest::class, 'RoRdb\\Google_Service_DisplayVideo_GenerateDefaultLineItemRequest');
