...
class ListCustomBiddingScriptsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCustomBiddingScriptsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListCustomBiddingScriptsResponse');
