...
class CombinedAudienceGroup extends \RoRdb\Google\Collection
{
...
\class_alias(CombinedAudienceGroup::class, 'RoRdb\\Google_Service_DisplayVideo_CombinedAudienceGroup');
