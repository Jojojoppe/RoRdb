...
class AdvertiserTargetingConfig extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AdvertiserTargetingConfig::class, 'RoRdb\\Google_Service_DisplayVideo_AdvertiserTargetingConfig');
