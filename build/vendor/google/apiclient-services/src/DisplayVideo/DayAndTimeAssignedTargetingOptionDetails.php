...
class DayAndTimeAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DayAndTimeAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_DayAndTimeAssignedTargetingOptionDetails');
