...
class PoiAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PoiAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_PoiAssignedTargetingOptionDetails');
