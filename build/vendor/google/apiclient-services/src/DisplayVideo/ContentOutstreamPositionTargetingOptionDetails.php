...
class ContentOutstreamPositionTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContentOutstreamPositionTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_ContentOutstreamPositionTargetingOptionDetails');
