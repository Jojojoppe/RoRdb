...
class DoubleVerifyVideoViewability extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DoubleVerifyVideoViewability::class, 'RoRdb\\Google_Service_DisplayVideo_DoubleVerifyVideoViewability');
