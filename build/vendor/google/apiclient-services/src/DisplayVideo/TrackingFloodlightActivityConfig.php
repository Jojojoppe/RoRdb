...
class TrackingFloodlightActivityConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TrackingFloodlightActivityConfig::class, 'RoRdb\\Google_Service_DisplayVideo_TrackingFloodlightActivityConfig');
