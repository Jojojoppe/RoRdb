...
class AdvertiserAdServerConfig extends \RoRdb\Google\Model
{
...
\class_alias(AdvertiserAdServerConfig::class, 'RoRdb\\Google_Service_DisplayVideo_AdvertiserAdServerConfig');
