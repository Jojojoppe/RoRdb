...
class SensitiveCategoryTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SensitiveCategoryTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_SensitiveCategoryTargetingOptionDetails');
