...
class InventorySourceAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InventorySourceAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_InventorySourceAssignedTargetingOptionDetails');
