...
class CreateSdfDownloadTaskRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateSdfDownloadTaskRequest::class, 'RoRdb\\Google_Service_DisplayVideo_CreateSdfDownloadTaskRequest');
