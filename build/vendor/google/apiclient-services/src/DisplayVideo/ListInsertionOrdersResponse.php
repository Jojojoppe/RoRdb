...
class ListInsertionOrdersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListInsertionOrdersResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListInsertionOrdersResponse');
