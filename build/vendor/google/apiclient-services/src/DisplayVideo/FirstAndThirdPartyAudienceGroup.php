...
class FirstAndThirdPartyAudienceGroup extends \RoRdb\Google\Collection
{
...
\class_alias(FirstAndThirdPartyAudienceGroup::class, 'RoRdb\\Google_Service_DisplayVideo_FirstAndThirdPartyAudienceGroup');
