...
class ListLocationListsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListLocationListsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListLocationListsResponse');
