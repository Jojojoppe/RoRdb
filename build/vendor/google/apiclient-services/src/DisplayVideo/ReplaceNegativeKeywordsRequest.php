...
class ReplaceNegativeKeywordsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ReplaceNegativeKeywordsRequest::class, 'RoRdb\\Google_Service_DisplayVideo_ReplaceNegativeKeywordsRequest');
