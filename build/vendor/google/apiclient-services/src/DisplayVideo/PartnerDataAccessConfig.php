...
class PartnerDataAccessConfig extends \RoRdb\Google\Model
{
...
\class_alias(PartnerDataAccessConfig::class, 'RoRdb\\Google_Service_DisplayVideo_PartnerDataAccessConfig');
