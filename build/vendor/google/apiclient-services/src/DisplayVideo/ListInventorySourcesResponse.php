...
class ListInventorySourcesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListInventorySourcesResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListInventorySourcesResponse');
