...
class EditCustomerMatchMembersResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(EditCustomerMatchMembersResponse::class, 'RoRdb\\Google_Service_DisplayVideo_EditCustomerMatchMembersResponse');
