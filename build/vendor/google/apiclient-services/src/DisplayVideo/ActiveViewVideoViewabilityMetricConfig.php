...
class ActiveViewVideoViewabilityMetricConfig extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ActiveViewVideoViewabilityMetricConfig::class, 'RoRdb\\Google_Service_DisplayVideo_ActiveViewVideoViewabilityMetricConfig');
