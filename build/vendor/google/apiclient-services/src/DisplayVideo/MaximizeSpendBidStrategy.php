...
class MaximizeSpendBidStrategy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(MaximizeSpendBidStrategy::class, 'RoRdb\\Google_Service_DisplayVideo_MaximizeSpendBidStrategy');
