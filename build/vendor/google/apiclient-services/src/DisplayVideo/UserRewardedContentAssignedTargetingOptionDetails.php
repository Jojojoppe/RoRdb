...
class UserRewardedContentAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UserRewardedContentAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_UserRewardedContentAssignedTargetingOptionDetails');
