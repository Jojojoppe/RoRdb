...
class BulkEditAssignedLocationsRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditAssignedLocationsRequest::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditAssignedLocationsRequest');
