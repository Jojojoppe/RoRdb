...
class ListCombinedAudiencesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCombinedAudiencesResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListCombinedAudiencesResponse');
