...
class BulkEditAssignedUserRolesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditAssignedUserRolesResponse::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditAssignedUserRolesResponse');
