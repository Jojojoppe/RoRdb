...
class ConversionCountingConfig extends \RoRdb\Google\Collection
{
...
\class_alias(ConversionCountingConfig::class, 'RoRdb\\Google_Service_DisplayVideo_ConversionCountingConfig');
