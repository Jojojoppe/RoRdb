...
class ParentalStatusTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ParentalStatusTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_ParentalStatusTargetingOptionDetails');
