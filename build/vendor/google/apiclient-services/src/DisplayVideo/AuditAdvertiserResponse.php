...
class AuditAdvertiserResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AuditAdvertiserResponse::class, 'RoRdb\\Google_Service_DisplayVideo_AuditAdvertiserResponse');
