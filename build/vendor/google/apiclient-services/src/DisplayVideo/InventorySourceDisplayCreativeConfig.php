...
class InventorySourceDisplayCreativeConfig extends \RoRdb\Google\Model
{
...
\class_alias(InventorySourceDisplayCreativeConfig::class, 'RoRdb\\Google_Service_DisplayVideo_InventorySourceDisplayCreativeConfig');
