...
class CombinedAudienceTargetingSetting extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CombinedAudienceTargetingSetting::class, 'RoRdb\\Google_Service_DisplayVideo_CombinedAudienceTargetingSetting');
