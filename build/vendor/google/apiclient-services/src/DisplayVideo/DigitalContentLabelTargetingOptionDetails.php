...
class DigitalContentLabelTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DigitalContentLabelTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_DigitalContentLabelTargetingOptionDetails');
