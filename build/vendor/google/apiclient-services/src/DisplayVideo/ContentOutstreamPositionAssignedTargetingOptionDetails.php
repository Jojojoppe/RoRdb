...
class ContentOutstreamPositionAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContentOutstreamPositionAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_ContentOutstreamPositionAssignedTargetingOptionDetails');
