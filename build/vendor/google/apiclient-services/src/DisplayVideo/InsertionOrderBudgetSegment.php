...
class InsertionOrderBudgetSegment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InsertionOrderBudgetSegment::class, 'RoRdb\\Google_Service_DisplayVideo_InsertionOrderBudgetSegment');
