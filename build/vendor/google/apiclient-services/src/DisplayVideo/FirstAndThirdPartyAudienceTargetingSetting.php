...
class FirstAndThirdPartyAudienceTargetingSetting extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FirstAndThirdPartyAudienceTargetingSetting::class, 'RoRdb\\Google_Service_DisplayVideo_FirstAndThirdPartyAudienceTargetingSetting');
