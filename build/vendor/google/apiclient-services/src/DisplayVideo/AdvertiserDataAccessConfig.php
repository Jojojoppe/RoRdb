...
class AdvertiserDataAccessConfig extends \RoRdb\Google\Model
{
...
\class_alias(AdvertiserDataAccessConfig::class, 'RoRdb\\Google_Service_DisplayVideo_AdvertiserDataAccessConfig');
