...
class SearchTargetingOptionsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SearchTargetingOptionsRequest::class, 'RoRdb\\Google_Service_DisplayVideo_SearchTargetingOptionsRequest');
