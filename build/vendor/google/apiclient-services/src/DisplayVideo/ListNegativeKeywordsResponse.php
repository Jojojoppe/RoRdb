...
class ListNegativeKeywordsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListNegativeKeywordsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListNegativeKeywordsResponse');
