...
class FirstAndThirdPartyAudience extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(FirstAndThirdPartyAudience::class, 'RoRdb\\Google_Service_DisplayVideo_FirstAndThirdPartyAudience');
