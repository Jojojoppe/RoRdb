...
class AuthorizedSellerStatusAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AuthorizedSellerStatusAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_AuthorizedSellerStatusAssignedTargetingOptionDetails');
