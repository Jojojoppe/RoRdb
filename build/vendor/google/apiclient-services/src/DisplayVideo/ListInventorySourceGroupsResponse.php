...
class ListInventorySourceGroupsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListInventorySourceGroupsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListInventorySourceGroupsResponse');
