...
class ContentInstreamPositionTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContentInstreamPositionTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_ContentInstreamPositionTargetingOptionDetails');
