...
class InventorySourceGroupAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InventorySourceGroupAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_InventorySourceGroupAssignedTargetingOptionDetails');
