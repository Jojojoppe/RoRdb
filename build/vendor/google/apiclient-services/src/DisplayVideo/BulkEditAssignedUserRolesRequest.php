...
class BulkEditAssignedUserRolesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditAssignedUserRolesRequest::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditAssignedUserRolesRequest');
