...
class BulkEditAssignedLocationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditAssignedLocationsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditAssignedLocationsResponse');
