...
class ReplaceNegativeKeywordsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ReplaceNegativeKeywordsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ReplaceNegativeKeywordsResponse');
