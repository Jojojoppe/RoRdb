...
class ListAdvertisersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAdvertisersResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListAdvertisersResponse');
