...
class GoogleAudienceTargetingSetting extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAudienceTargetingSetting::class, 'RoRdb\\Google_Service_DisplayVideo_GoogleAudienceTargetingSetting');
