...
class PerformanceGoalBidStrategy extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PerformanceGoalBidStrategy::class, 'RoRdb\\Google_Service_DisplayVideo_PerformanceGoalBidStrategy');
