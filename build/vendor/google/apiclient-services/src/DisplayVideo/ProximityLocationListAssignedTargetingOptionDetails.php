...
class ProximityLocationListAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ProximityLocationListAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_ProximityLocationListAssignedTargetingOptionDetails');
