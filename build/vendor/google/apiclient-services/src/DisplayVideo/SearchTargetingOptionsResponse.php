...
class SearchTargetingOptionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchTargetingOptionsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_SearchTargetingOptionsResponse');
