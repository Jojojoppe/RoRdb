...
class ListCustomListsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListCustomListsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListCustomListsResponse');
