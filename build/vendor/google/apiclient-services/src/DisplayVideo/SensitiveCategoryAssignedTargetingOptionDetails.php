...
class SensitiveCategoryAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SensitiveCategoryAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_SensitiveCategoryAssignedTargetingOptionDetails');
