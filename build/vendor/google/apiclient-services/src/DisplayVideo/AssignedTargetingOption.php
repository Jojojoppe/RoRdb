...
class AssignedTargetingOption extends \RoRdb\Google\Model
{
...
\class_alias(AssignedTargetingOption::class, 'RoRdb\\Google_Service_DisplayVideo_AssignedTargetingOption');
