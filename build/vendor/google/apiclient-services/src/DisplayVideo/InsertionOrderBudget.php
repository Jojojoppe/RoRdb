...
class InsertionOrderBudget extends \RoRdb\Google\Collection
{
...
\class_alias(InsertionOrderBudget::class, 'RoRdb\\Google_Service_DisplayVideo_InsertionOrderBudget');
