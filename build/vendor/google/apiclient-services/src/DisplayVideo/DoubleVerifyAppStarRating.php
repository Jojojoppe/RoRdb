...
class DoubleVerifyAppStarRating extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DoubleVerifyAppStarRating::class, 'RoRdb\\Google_Service_DisplayVideo_DoubleVerifyAppStarRating');
