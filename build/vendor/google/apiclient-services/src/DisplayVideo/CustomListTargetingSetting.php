...
class CustomListTargetingSetting extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CustomListTargetingSetting::class, 'RoRdb\\Google_Service_DisplayVideo_CustomListTargetingSetting');
