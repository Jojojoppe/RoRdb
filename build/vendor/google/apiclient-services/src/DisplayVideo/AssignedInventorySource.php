...
class AssignedInventorySource extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AssignedInventorySource::class, 'RoRdb\\Google_Service_DisplayVideo_AssignedInventorySource');
