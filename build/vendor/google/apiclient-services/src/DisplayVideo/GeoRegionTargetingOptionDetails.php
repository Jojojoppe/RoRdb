...
class GeoRegionTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GeoRegionTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_GeoRegionTargetingOptionDetails');
