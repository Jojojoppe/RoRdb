...
class BusinessChainSearchTerms extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BusinessChainSearchTerms::class, 'RoRdb\\Google_Service_DisplayVideo_BusinessChainSearchTerms');
