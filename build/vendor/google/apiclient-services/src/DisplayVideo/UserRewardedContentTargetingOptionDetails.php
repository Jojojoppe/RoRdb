...
class UserRewardedContentTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UserRewardedContentTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_UserRewardedContentTargetingOptionDetails');
