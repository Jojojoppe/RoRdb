...
class DigitalContentLabelAssignedTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DigitalContentLabelAssignedTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_DigitalContentLabelAssignedTargetingOptionDetails');
