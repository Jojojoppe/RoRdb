...
class DoubleVerifyBrandSafetyCategories extends \RoRdb\Google\Collection
{
...
\class_alias(DoubleVerifyBrandSafetyCategories::class, 'RoRdb\\Google_Service_DisplayVideo_DoubleVerifyBrandSafetyCategories');
