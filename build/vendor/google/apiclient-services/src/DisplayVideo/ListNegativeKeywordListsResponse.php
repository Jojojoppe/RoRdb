...
class ListNegativeKeywordListsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListNegativeKeywordListsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListNegativeKeywordListsResponse');
