...
class ListAssignedLocationsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAssignedLocationsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_ListAssignedLocationsResponse');
