...
class DoubleVerifyFraudInvalidTraffic extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DoubleVerifyFraudInvalidTraffic::class, 'RoRdb\\Google_Service_DisplayVideo_DoubleVerifyFraudInvalidTraffic');
