...
class BulkEditNegativeKeywordsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BulkEditNegativeKeywordsResponse::class, 'RoRdb\\Google_Service_DisplayVideo_BulkEditNegativeKeywordsResponse');
