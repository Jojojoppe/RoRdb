...
class AuthorizedSellerStatusTargetingOptionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AuthorizedSellerStatusTargetingOptionDetails::class, 'RoRdb\\Google_Service_DisplayVideo_AuthorizedSellerStatusTargetingOptionDetails');
