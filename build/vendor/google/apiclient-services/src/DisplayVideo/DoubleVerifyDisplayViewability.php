...
class DoubleVerifyDisplayViewability extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DoubleVerifyDisplayViewability::class, 'RoRdb\\Google_Service_DisplayVideo_DoubleVerifyDisplayViewability');
