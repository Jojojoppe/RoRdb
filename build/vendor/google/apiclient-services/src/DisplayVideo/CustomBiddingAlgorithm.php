...
class CustomBiddingAlgorithm extends \RoRdb\Google\Collection
{
...
\class_alias(CustomBiddingAlgorithm::class, 'RoRdb\\Google_Service_DisplayVideo_CustomBiddingAlgorithm');
