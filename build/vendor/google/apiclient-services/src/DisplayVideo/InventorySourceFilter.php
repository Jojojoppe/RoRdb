...
class InventorySourceFilter extends \RoRdb\Google\Collection
{
...
\class_alias(InventorySourceFilter::class, 'RoRdb\\Google_Service_DisplayVideo_InventorySourceFilter');
