 ...
 * @author Google, Inc.
 */
class DataTransfer extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->applications = new DataTransfer\Resource\Applications($this, $this->serviceName, 'applications', ['methods' => ['get' => ['path' => 'admin/datatransfer/v1/applications/{applicationId}', 'httpMethod' => 'GET', 'parameters' => ['applicationId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'list' => ['path' => 'admin/datatransfer/v1/applications', 'httpMethod' => 'GET', 'parameters' => ['customerId' => ['location' => 'query', 'type' => 'string'], 'maxResults' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->transfers = new DataTransfer\Resource\Transfers($this, $this->serviceName, 'transfers', ['methods' => ['get' => ['path' => 'admin/datatransfer/v1/transfers/{dataTransferId}', 'httpMethod' => 'GET', 'parameters' => ['dataTransferId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'insert' => ['path' => 'admin/datatransfer/v1/transfers', 'httpMethod' => 'POST', 'parameters' => []], 'list' => ['path' => 'admin/datatransfer/v1/transfers', 'httpMethod' => 'GET', 'parameters' => ['customerId' => ['location' => 'query', 'type' => 'string'], 'maxResults' => ['location' => 'query', 'type' => 'integer'], 'newOwnerUserId' => ['location' => 'query', 'type' => 'string'], 'oldOwnerUserId' => ['location' => 'query', 'type' => 'string'], 'pageToken' => ['location' => 'query', 'type' => 'string'], 'status' => ['location' => 'query', 'type' => 'string']]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(DataTransfer::class, 'RoRdb\\Google_Service_DataTransfer');
