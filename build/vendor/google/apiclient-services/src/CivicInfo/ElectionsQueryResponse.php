...
class ElectionsQueryResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ElectionsQueryResponse::class, 'RoRdb\\Google_Service_CivicInfo_ElectionsQueryResponse');
