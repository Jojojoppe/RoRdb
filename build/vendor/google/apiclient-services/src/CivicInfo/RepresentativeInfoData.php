...
class RepresentativeInfoData extends \RoRdb\Google\Collection
{
...
\class_alias(RepresentativeInfoData::class, 'RoRdb\\Google_Service_CivicInfo_RepresentativeInfoData');
