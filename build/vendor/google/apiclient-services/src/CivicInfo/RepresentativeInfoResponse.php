...
class RepresentativeInfoResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RepresentativeInfoResponse::class, 'RoRdb\\Google_Service_CivicInfo_RepresentativeInfoResponse');
