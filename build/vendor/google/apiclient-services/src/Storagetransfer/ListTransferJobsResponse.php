...
class ListTransferJobsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTransferJobsResponse::class, 'RoRdb\\Google_Service_Storagetransfer_ListTransferJobsResponse');
