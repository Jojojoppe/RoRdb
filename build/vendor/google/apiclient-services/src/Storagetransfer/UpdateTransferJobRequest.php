...
class UpdateTransferJobRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateTransferJobRequest::class, 'RoRdb\\Google_Service_Storagetransfer_UpdateTransferJobRequest');
