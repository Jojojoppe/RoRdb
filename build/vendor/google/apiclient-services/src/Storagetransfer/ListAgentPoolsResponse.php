...
class ListAgentPoolsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAgentPoolsResponse::class, 'RoRdb\\Google_Service_Storagetransfer_ListAgentPoolsResponse');
