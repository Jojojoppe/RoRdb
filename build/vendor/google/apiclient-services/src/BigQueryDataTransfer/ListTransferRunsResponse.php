...
class ListTransferRunsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTransferRunsResponse::class, 'RoRdb\\Google_Service_BigQueryDataTransfer_ListTransferRunsResponse');
