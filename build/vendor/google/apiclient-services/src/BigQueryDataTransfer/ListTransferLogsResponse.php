...
class ListTransferLogsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTransferLogsResponse::class, 'RoRdb\\Google_Service_BigQueryDataTransfer_ListTransferLogsResponse');
