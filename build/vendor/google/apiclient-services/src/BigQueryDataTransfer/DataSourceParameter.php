...
class DataSourceParameter extends \RoRdb\Google\Collection
{
...
\class_alias(DataSourceParameter::class, 'RoRdb\\Google_Service_BigQueryDataTransfer_DataSourceParameter');
