...
class StartManualTransferRunsRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(StartManualTransferRunsRequest::class, 'RoRdb\\Google_Service_BigQueryDataTransfer_StartManualTransferRunsRequest');
