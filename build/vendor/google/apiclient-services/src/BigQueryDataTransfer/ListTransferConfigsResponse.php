...
class ListTransferConfigsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListTransferConfigsResponse::class, 'RoRdb\\Google_Service_BigQueryDataTransfer_ListTransferConfigsResponse');
