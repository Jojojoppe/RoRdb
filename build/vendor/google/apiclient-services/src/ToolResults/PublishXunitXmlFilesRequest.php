...
class PublishXunitXmlFilesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(PublishXunitXmlFilesRequest::class, 'RoRdb\\Google_Service_ToolResults_PublishXunitXmlFilesRequest');
