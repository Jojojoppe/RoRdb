...
class ListPerfSamplesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPerfSamplesResponse::class, 'RoRdb\\Google_Service_ToolResults_ListPerfSamplesResponse');
