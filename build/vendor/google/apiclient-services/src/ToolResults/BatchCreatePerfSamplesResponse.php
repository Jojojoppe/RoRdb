...
class BatchCreatePerfSamplesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchCreatePerfSamplesResponse::class, 'RoRdb\\Google_Service_ToolResults_BatchCreatePerfSamplesResponse');
