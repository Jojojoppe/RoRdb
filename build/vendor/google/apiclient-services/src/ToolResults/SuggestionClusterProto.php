...
class SuggestionClusterProto extends \RoRdb\Google\Collection
{
...
\class_alias(SuggestionClusterProto::class, 'RoRdb\\Google_Service_ToolResults_SuggestionClusterProto');
