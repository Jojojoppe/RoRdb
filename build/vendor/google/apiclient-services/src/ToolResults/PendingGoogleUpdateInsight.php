...
class PendingGoogleUpdateInsight extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PendingGoogleUpdateInsight::class, 'RoRdb\\Google_Service_ToolResults_PendingGoogleUpdateInsight');
