...
class EncounteredNonAndroidUiWidgetScreen extends \RoRdb\Google\Collection
{
...
\class_alias(EncounteredNonAndroidUiWidgetScreen::class, 'RoRdb\\Google_Service_ToolResults_EncounteredNonAndroidUiWidgetScreen');
