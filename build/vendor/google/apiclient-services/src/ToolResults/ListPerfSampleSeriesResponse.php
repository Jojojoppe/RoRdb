...
class ListPerfSampleSeriesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListPerfSampleSeriesResponse::class, 'RoRdb\\Google_Service_ToolResults_ListPerfSampleSeriesResponse');
