...
class AndroidInstrumentationTest extends \RoRdb\Google\Collection
{
...
\class_alias(AndroidInstrumentationTest::class, 'RoRdb\\Google_Service_ToolResults_AndroidInstrumentationTest');
