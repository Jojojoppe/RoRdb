...
class NonSdkApiUsageViolationReport extends \RoRdb\Google\Collection
{
...
\class_alias(NonSdkApiUsageViolationReport::class, 'RoRdb\\Google_Service_ToolResults_NonSdkApiUsageViolationReport');
