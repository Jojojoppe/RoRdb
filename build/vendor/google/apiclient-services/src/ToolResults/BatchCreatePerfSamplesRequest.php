...
class BatchCreatePerfSamplesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(BatchCreatePerfSamplesRequest::class, 'RoRdb\\Google_Service_ToolResults_BatchCreatePerfSamplesRequest');
