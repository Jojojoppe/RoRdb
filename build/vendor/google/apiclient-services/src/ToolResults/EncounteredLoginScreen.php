...
class EncounteredLoginScreen extends \RoRdb\Google\Collection
{
...
\class_alias(EncounteredLoginScreen::class, 'RoRdb\\Google_Service_ToolResults_EncounteredLoginScreen');
