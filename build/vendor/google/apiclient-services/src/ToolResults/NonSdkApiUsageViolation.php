...
class NonSdkApiUsageViolation extends \RoRdb\Google\Collection
{
...
\class_alias(NonSdkApiUsageViolation::class, 'RoRdb\\Google_Service_ToolResults_NonSdkApiUsageViolation');
