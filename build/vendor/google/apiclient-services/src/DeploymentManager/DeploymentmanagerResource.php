...
class DeploymentmanagerResource extends \RoRdb\Google\Collection
{
...
\class_alias(DeploymentmanagerResource::class, 'RoRdb\\Google_Service_DeploymentManager_DeploymentmanagerResource');
