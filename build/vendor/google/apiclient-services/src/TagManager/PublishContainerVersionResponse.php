...
class PublishContainerVersionResponse extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PublishContainerVersionResponse::class, 'RoRdb\\Google_Service_TagManager_PublishContainerVersionResponse');
