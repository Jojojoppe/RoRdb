...
class ListContainerVersionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListContainerVersionsResponse::class, 'RoRdb\\Google_Service_TagManager_ListContainerVersionsResponse');
