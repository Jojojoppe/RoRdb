...
class CreateContainerVersionResponse extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(CreateContainerVersionResponse::class, 'RoRdb\\Google_Service_TagManager_CreateContainerVersionResponse');
