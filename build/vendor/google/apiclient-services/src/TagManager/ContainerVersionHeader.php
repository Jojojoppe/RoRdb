...
class ContainerVersionHeader extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContainerVersionHeader::class, 'RoRdb\\Google_Service_TagManager_ContainerVersionHeader');
