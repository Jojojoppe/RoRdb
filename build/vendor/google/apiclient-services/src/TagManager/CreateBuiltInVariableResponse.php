...
class CreateBuiltInVariableResponse extends \RoRdb\Google\Collection
{
...
\class_alias(CreateBuiltInVariableResponse::class, 'RoRdb\\Google_Service_TagManager_CreateBuiltInVariableResponse');
