...
use RoRdb\Google\Service\TagManager\Account;
use RoRdb\Google\Service\TagManager\ListAccountsResponse;
/**
...
\class_alias(Accounts::class, 'RoRdb\\Google_Service_TagManager_Resource_Accounts');
