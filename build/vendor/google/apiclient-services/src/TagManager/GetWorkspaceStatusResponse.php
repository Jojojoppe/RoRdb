...
class GetWorkspaceStatusResponse extends \RoRdb\Google\Collection
{
...
\class_alias(GetWorkspaceStatusResponse::class, 'RoRdb\\Google_Service_TagManager_GetWorkspaceStatusResponse');
