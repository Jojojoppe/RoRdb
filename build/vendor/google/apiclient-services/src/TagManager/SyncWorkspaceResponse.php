...
class SyncWorkspaceResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SyncWorkspaceResponse::class, 'RoRdb\\Google_Service_TagManager_SyncWorkspaceResponse');
