...
class BatchDeleteAlertsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchDeleteAlertsResponse::class, 'RoRdb\\Google_Service_AlertCenter_BatchDeleteAlertsResponse');
