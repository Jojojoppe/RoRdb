...
class SuspiciousActivitySecurityDetail extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SuspiciousActivitySecurityDetail::class, 'RoRdb\\Google_Service_AlertCenter_SuspiciousActivitySecurityDetail');
