...
class DeviceCompromisedSecurityDetail extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeviceCompromisedSecurityDetail::class, 'RoRdb\\Google_Service_AlertCenter_DeviceCompromisedSecurityDetail');
