...
class DomainWideTakeoutInitiated extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DomainWideTakeoutInitiated::class, 'RoRdb\\Google_Service_AlertCenter_DomainWideTakeoutInitiated');
