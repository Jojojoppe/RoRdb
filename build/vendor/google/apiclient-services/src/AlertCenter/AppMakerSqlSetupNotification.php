...
class AppMakerSqlSetupNotification extends \RoRdb\Google\Collection
{
...
\class_alias(AppMakerSqlSetupNotification::class, 'RoRdb\\Google_Service_AlertCenter_AppMakerSqlSetupNotification');
