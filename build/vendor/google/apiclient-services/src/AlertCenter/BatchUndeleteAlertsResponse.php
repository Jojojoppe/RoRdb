...
class BatchUndeleteAlertsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(BatchUndeleteAlertsResponse::class, 'RoRdb\\Google_Service_AlertCenter_BatchUndeleteAlertsResponse');
