...
class AccountSuspensionWarning extends \RoRdb\Google\Collection
{
...
\class_alias(AccountSuspensionWarning::class, 'RoRdb\\Google_Service_AlertCenter_AccountSuspensionWarning');
