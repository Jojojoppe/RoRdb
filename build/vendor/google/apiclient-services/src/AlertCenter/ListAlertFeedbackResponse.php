...
class ListAlertFeedbackResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAlertFeedbackResponse::class, 'RoRdb\\Google_Service_AlertCenter_ListAlertFeedbackResponse');
