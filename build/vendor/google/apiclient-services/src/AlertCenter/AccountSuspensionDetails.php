...
class AccountSuspensionDetails extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountSuspensionDetails::class, 'RoRdb\\Google_Service_AlertCenter_AccountSuspensionDetails');
