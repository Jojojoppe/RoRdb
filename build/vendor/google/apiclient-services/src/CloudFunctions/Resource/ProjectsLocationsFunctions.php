 ...
 * the License.
 */
namespace RoRdb\Google\Service\CloudFunctions\Resource;

use RoRdb\Google\Service\CloudFunctions\CallFunctionRequest;
use RoRdb\Google\Service\CloudFunctions\CallFunctionResponse;
use RoRdb\Google\Service\CloudFunctions\CloudFunction;
use RoRdb\Google\Service\CloudFunctions\GenerateDownloadUrlRequest;
use RoRdb\Google\Service\CloudFunctions\GenerateDownloadUrlResponse;
use RoRdb\Google\Service\CloudFunctions\GenerateUploadUrlRequest;
use RoRdb\Google\Service\CloudFunctions\GenerateUploadUrlResponse;
use RoRdb\Google\Service\CloudFunctions\ListFunctionsResponse;
use RoRdb\Google\Service\CloudFunctions\Operation;
use RoRdb\Google\Service\CloudFunctions\Policy;
use RoRdb\Google\Service\CloudFunctions\SetIamPolicyRequest;
use RoRdb\Google\Service\CloudFunctions\TestIamPermissionsRequest;
use RoRdb\Google\Service\CloudFunctions\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsLocationsFunctions extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsFunctions::class, 'RoRdb\\Google_Service_CloudFunctions_Resource_ProjectsLocationsFunctions');
