 ...
 * the License.
 */
namespace RoRdb\Google\Service\DataFusion\Resource;

use RoRdb\Google\Service\DataFusion\Instance;
use RoRdb\Google\Service\DataFusion\ListInstancesResponse;
use RoRdb\Google\Service\DataFusion\Operation;
use RoRdb\Google\Service\DataFusion\Policy;
use RoRdb\Google\Service\DataFusion\RestartInstanceRequest;
use RoRdb\Google\Service\DataFusion\SetIamPolicyRequest;
use RoRdb\Google\Service\DataFusion\TestIamPermissionsRequest;
use RoRdb\Google\Service\DataFusion\TestIamPermissionsResponse;
/**
...
\class_alias(ProjectsLocationsInstances::class, 'RoRdb\\Google_Service_DataFusion_Resource_ProjectsLocationsInstances');
