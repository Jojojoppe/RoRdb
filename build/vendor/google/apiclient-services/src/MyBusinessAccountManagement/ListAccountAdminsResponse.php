...
class ListAccountAdminsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAccountAdminsResponse::class, 'RoRdb\\Google_Service_MyBusinessAccountManagement_ListAccountAdminsResponse');
