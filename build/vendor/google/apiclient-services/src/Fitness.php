 ...
 * @author Google, Inc.
 */
class Fitness extends \RoRdb\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->users_dataSources = new Fitness\Resource\UsersDataSources($this, $this->serviceName, 'dataSources', ['methods' => ['create' => ['path' => '{userId}/dataSources', 'httpMethod' => 'POST', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'delete' => ['path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'DELETE', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'get' => ['path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'GET', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'list' => ['path' => '{userId}/dataSources', 'httpMethod' => 'GET', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataTypeName' => ['location' => 'query', 'type' => 'string', 'repeated' => \true]]], 'update' => ['path' => '{userId}/dataSources/{dataSourceId}', 'httpMethod' => 'PUT', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
        $this->users_dataSources_dataPointChanges = new Fitness\Resource\UsersDataSourcesDataPointChanges($this, $this->serviceName, 'dataPointChanges', ['methods' => ['list' => ['path' => '{userId}/dataSources/{dataSourceId}/dataPointChanges', 'httpMethod' => 'GET', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'limit' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]]]]);
        $this->users_dataSources_datasets = new Fitness\Resource\UsersDataSourcesDatasets($this, $this->serviceName, 'datasets', ['methods' => ['delete' => ['path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'DELETE', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'datasetId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'get' => ['path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'GET', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'datasetId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'limit' => ['location' => 'query', 'type' => 'integer'], 'pageToken' => ['location' => 'query', 'type' => 'string']]], 'patch' => ['path' => '{userId}/dataSources/{dataSourceId}/datasets/{datasetId}', 'httpMethod' => 'PATCH', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'dataSourceId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'datasetId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
        $this->users_dataset = new Fitness\Resource\UsersDataset($this, $this->serviceName, 'dataset', ['methods' => ['aggregate' => ['path' => '{userId}/dataset:aggregate', 'httpMethod' => 'POST', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
        $this->users_sessions = new Fitness\Resource\UsersSessions($this, $this->serviceName, 'sessions', ['methods' => ['delete' => ['path' => '{userId}/sessions/{sessionId}', 'httpMethod' => 'DELETE', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'sessionId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]], 'list' => ['path' => '{userId}/sessions', 'httpMethod' => 'GET', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'activityType' => ['location' => 'query', 'type' => 'integer', 'repeated' => \true], 'endTime' => ['location' => 'query', 'type' => 'string'], 'includeDeleted' => ['location' => 'query', 'type' => 'boolean'], 'pageToken' => ['location' => 'query', 'type' => 'string'], 'startTime' => ['location' => 'query', 'type' => 'string']]], 'update' => ['path' => '{userId}/sessions/{sessionId}', 'httpMethod' => 'PUT', 'parameters' => ['userId' => ['location' => 'path', 'type' => 'string', 'required' => \true], 'sessionId' => ['location' => 'path', 'type' => 'string', 'required' => \true]]]]]);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(Fitness::class, 'RoRdb\\Google_Service_Fitness');
