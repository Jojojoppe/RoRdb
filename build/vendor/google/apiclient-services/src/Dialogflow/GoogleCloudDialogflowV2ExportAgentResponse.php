...
class GoogleCloudDialogflowV2ExportAgentResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2ExportAgentResponse::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2ExportAgentResponse');
