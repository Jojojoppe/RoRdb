...
class GoogleCloudDialogflowV2beta1Message extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2beta1Message::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2beta1Message');
