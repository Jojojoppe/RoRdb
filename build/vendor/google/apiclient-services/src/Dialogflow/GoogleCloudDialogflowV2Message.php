...
class GoogleCloudDialogflowV2Message extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2Message::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2Message');
