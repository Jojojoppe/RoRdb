...
class GoogleCloudDialogflowCxV3CompareVersionsResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3CompareVersionsResponse::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3CompareVersionsResponse');
