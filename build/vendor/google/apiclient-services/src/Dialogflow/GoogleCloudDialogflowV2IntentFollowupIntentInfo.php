...
class GoogleCloudDialogflowV2IntentFollowupIntentInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2IntentFollowupIntentInfo::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2IntentFollowupIntentInfo');
