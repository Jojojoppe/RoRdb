...
class GoogleCloudDialogflowCxV3beta1PageInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3beta1PageInfo::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1PageInfo');
