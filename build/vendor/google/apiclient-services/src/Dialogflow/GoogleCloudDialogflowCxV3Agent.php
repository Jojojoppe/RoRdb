...
class GoogleCloudDialogflowCxV3Agent extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudDialogflowCxV3Agent::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Agent');
