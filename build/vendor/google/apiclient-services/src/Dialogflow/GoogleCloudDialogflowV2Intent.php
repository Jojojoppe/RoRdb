...
class GoogleCloudDialogflowV2Intent extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudDialogflowV2Intent::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2Intent');
