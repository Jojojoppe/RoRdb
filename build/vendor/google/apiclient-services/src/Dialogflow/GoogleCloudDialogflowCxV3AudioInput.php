...
class GoogleCloudDialogflowCxV3AudioInput extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3AudioInput::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3AudioInput');
