...
class GoogleCloudDialogflowCxV3PageInfo extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3PageInfo::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3PageInfo');
