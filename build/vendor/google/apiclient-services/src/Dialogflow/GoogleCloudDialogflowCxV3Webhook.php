...
class GoogleCloudDialogflowCxV3Webhook extends \RoRdb\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleCloudDialogflowCxV3Webhook::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Webhook');
