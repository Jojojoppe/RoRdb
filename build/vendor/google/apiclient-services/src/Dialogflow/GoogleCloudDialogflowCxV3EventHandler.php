...
class GoogleCloudDialogflowCxV3EventHandler extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3EventHandler::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EventHandler');
