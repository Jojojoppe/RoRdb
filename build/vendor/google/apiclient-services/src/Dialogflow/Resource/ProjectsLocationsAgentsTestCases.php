 ...
 * the License.
 */
namespace RoRdb\Google\Service\Dialogflow\Resource;

use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3BatchRunTestCasesRequest;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3CalculateCoverageResponse;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3ExportTestCasesRequest;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3ImportTestCasesRequest;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3ListTestCasesResponse;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3RunTestCaseRequest;
use RoRdb\Google\Service\Dialogflow\GoogleCloudDialogflowCxV3TestCase;
use RoRdb\Google\Service\Dialogflow\GoogleLongrunningOperation;
use RoRdb\Google\Service\Dialogflow\GoogleProtobufEmpty;
/**
 ...
 *  </code>
 */
class ProjectsLocationsAgentsTestCases extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsLocationsAgentsTestCases::class, 'RoRdb\\Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsTestCases');
