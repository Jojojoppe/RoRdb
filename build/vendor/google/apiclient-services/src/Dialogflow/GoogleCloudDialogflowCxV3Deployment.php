...
class GoogleCloudDialogflowCxV3Deployment extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowCxV3Deployment::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Deployment');
