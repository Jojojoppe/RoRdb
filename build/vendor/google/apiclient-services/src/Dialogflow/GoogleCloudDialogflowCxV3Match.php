...
class GoogleCloudDialogflowCxV3Match extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(GoogleCloudDialogflowCxV3Match::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Match');
