...
class GoogleCloudDialogflowV2ConversationEvent extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2ConversationEvent::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2ConversationEvent');
