...
class GoogleCloudDialogflowCxV3NluSettings extends \RoRdb\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(GoogleCloudDialogflowCxV3NluSettings::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3NluSettings');
