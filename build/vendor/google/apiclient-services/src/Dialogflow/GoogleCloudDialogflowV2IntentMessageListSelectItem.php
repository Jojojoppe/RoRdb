...
class GoogleCloudDialogflowV2IntentMessageListSelectItem extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDialogflowV2IntentMessageListSelectItem::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowV2IntentMessageListSelectItem');
