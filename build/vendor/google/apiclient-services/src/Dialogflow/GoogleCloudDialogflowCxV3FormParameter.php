...
class GoogleCloudDialogflowCxV3FormParameter extends \RoRdb\Google\Model
{
    /**
     * @var array
     */
...
\class_alias(GoogleCloudDialogflowCxV3FormParameter::class, 'RoRdb\\Google_Service_Dialogflow_GoogleCloudDialogflowCxV3FormParameter');
