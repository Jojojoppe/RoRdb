...
class GoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest::class, 'RoRdb\\Google_Service_Document_GoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest');
