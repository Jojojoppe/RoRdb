...
class GoogleCloudDocumentaiV1HumanReviewStatus extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDocumentaiV1HumanReviewStatus::class, 'RoRdb\\Google_Service_Document_GoogleCloudDocumentaiV1HumanReviewStatus');
