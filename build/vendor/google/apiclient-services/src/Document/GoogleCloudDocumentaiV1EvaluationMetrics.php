...
class GoogleCloudDocumentaiV1EvaluationMetrics extends \RoRdb\Google\Model
{
    public $f1Score;
...
\class_alias(GoogleCloudDocumentaiV1EvaluationMetrics::class, 'RoRdb\\Google_Service_Document_GoogleCloudDocumentaiV1EvaluationMetrics');
