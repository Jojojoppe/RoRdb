...
class GoogleCloudDocumentaiV1Processor extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudDocumentaiV1Processor::class, 'RoRdb\\Google_Service_Document_GoogleCloudDocumentaiV1Processor');
