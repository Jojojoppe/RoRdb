...
class GoogleCloudDocumentaiV1Document extends \RoRdb\Google\Collection
{
...
\class_alias(GoogleCloudDocumentaiV1Document::class, 'RoRdb\\Google_Service_Document_GoogleCloudDocumentaiV1Document');
