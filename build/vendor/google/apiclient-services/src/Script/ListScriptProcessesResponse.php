...
class ListScriptProcessesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListScriptProcessesResponse::class, 'RoRdb\\Google_Service_Script_ListScriptProcessesResponse');
