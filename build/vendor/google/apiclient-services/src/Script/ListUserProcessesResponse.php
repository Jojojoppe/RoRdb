...
class ListUserProcessesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListUserProcessesResponse::class, 'RoRdb\\Google_Service_Script_ListUserProcessesResponse');
