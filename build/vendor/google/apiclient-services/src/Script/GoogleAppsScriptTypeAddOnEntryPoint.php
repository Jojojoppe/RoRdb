...
class GoogleAppsScriptTypeAddOnEntryPoint extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAppsScriptTypeAddOnEntryPoint::class, 'RoRdb\\Google_Service_Script_GoogleAppsScriptTypeAddOnEntryPoint');
