...
class UpdateClusterMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateClusterMetadata::class, 'RoRdb\\Google_Service_BigtableAdmin_UpdateClusterMetadata');
