...
class CreateInstanceMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateInstanceMetadata::class, 'RoRdb\\Google_Service_BigtableAdmin_CreateInstanceMetadata');
