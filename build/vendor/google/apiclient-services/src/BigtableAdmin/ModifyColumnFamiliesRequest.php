...
class ModifyColumnFamiliesRequest extends \RoRdb\Google\Collection
{
...
\class_alias(ModifyColumnFamiliesRequest::class, 'RoRdb\\Google_Service_BigtableAdmin_ModifyColumnFamiliesRequest');
