...
class ListAppProfilesResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListAppProfilesResponse::class, 'RoRdb\\Google_Service_BigtableAdmin_ListAppProfilesResponse');
