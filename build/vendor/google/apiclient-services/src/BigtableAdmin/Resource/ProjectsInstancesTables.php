 ...
 * the License.
 */
namespace RoRdb\Google\Service\BigtableAdmin\Resource;

use RoRdb\Google\Service\BigtableAdmin\BigtableadminEmpty;
use RoRdb\Google\Service\BigtableAdmin\CheckConsistencyRequest;
use RoRdb\Google\Service\BigtableAdmin\CheckConsistencyResponse;
use RoRdb\Google\Service\BigtableAdmin\CreateTableRequest;
use RoRdb\Google\Service\BigtableAdmin\DropRowRangeRequest;
use RoRdb\Google\Service\BigtableAdmin\GenerateConsistencyTokenRequest;
use RoRdb\Google\Service\BigtableAdmin\GenerateConsistencyTokenResponse;
use RoRdb\Google\Service\BigtableAdmin\GetIamPolicyRequest;
use RoRdb\Google\Service\BigtableAdmin\ListTablesResponse;
use RoRdb\Google\Service\BigtableAdmin\ModifyColumnFamiliesRequest;
use RoRdb\Google\Service\BigtableAdmin\Operation;
use RoRdb\Google\Service\BigtableAdmin\Policy;
use RoRdb\Google\Service\BigtableAdmin\RestoreTableRequest;
use RoRdb\Google\Service\BigtableAdmin\SetIamPolicyRequest;
use RoRdb\Google\Service\BigtableAdmin\Table;
use RoRdb\Google\Service\BigtableAdmin\TestIamPermissionsRequest;
use RoRdb\Google\Service\BigtableAdmin\TestIamPermissionsResponse;
/**
 ...
 *  </code>
 */
class ProjectsInstancesTables extends \RoRdb\Google\Service\Resource
{
    /**
...
\class_alias(ProjectsInstancesTables::class, 'RoRdb\\Google_Service_BigtableAdmin_Resource_ProjectsInstancesTables');
