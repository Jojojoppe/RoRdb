...
class GenerateConsistencyTokenResponse extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GenerateConsistencyTokenResponse::class, 'RoRdb\\Google_Service_BigtableAdmin_GenerateConsistencyTokenResponse');
