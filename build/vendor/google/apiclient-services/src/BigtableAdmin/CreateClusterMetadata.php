...
class CreateClusterMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CreateClusterMetadata::class, 'RoRdb\\Google_Service_BigtableAdmin_CreateClusterMetadata');
