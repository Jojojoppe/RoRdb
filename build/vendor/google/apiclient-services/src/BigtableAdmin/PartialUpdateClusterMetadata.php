...
class PartialUpdateClusterMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PartialUpdateClusterMetadata::class, 'RoRdb\\Google_Service_BigtableAdmin_PartialUpdateClusterMetadata');
