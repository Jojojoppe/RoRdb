...
class ListClustersResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListClustersResponse::class, 'RoRdb\\Google_Service_BigtableAdmin_ListClustersResponse');
