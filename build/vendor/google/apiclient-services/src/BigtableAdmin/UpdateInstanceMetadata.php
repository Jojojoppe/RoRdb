...
class UpdateInstanceMetadata extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateInstanceMetadata::class, 'RoRdb\\Google_Service_BigtableAdmin_UpdateInstanceMetadata');
