...
class CheckConsistencyRequest extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CheckConsistencyRequest::class, 'RoRdb\\Google_Service_BigtableAdmin_CheckConsistencyRequest');
