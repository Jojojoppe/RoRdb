...
class ClusterAutoscalingConfig extends \RoRdb\Google\Model
{
...
\class_alias(ClusterAutoscalingConfig::class, 'RoRdb\\Google_Service_BigtableAdmin_ClusterAutoscalingConfig');
