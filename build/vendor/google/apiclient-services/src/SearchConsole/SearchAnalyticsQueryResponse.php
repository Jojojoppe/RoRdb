...
class SearchAnalyticsQueryResponse extends \RoRdb\Google\Collection
{
...
\class_alias(SearchAnalyticsQueryResponse::class, 'RoRdb\\Google_Service_SearchConsole_SearchAnalyticsQueryResponse');
