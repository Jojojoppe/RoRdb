...
class RichResultsInspectionResult extends \RoRdb\Google\Collection
{
...
\class_alias(RichResultsInspectionResult::class, 'RoRdb\\Google_Service_SearchConsole_RichResultsInspectionResult');
