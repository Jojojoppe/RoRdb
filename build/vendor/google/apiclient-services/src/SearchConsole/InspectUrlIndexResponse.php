...
class InspectUrlIndexResponse extends \RoRdb\Google\Model
{
...
\class_alias(InspectUrlIndexResponse::class, 'RoRdb\\Google_Service_SearchConsole_InspectUrlIndexResponse');
