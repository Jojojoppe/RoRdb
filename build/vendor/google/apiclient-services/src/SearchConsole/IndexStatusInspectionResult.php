...
class IndexStatusInspectionResult extends \RoRdb\Google\Collection
{
...
\class_alias(IndexStatusInspectionResult::class, 'RoRdb\\Google_Service_SearchConsole_IndexStatusInspectionResult');
