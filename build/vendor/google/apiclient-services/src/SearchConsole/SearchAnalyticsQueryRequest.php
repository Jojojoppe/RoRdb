...
class SearchAnalyticsQueryRequest extends \RoRdb\Google\Collection
{
...
\class_alias(SearchAnalyticsQueryRequest::class, 'RoRdb\\Google_Service_SearchConsole_SearchAnalyticsQueryRequest');
