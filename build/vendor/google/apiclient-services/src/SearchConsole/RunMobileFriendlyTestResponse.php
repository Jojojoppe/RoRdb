...
class RunMobileFriendlyTestResponse extends \RoRdb\Google\Collection
{
...
\class_alias(RunMobileFriendlyTestResponse::class, 'RoRdb\\Google_Service_SearchConsole_RunMobileFriendlyTestResponse');
