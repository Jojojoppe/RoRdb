...
class GoogleCloudRunOpV2RevisionScaling extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudRunOpV2RevisionScaling::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunOpV2RevisionScaling');
