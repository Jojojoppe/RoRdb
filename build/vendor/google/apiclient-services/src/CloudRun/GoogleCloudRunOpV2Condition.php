...
class GoogleCloudRunOpV2Condition extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRunOpV2Condition::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunOpV2Condition');
