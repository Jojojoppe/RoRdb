...
class ListRevisionsResponse extends \RoRdb\Google\Collection
{
...
\class_alias(ListRevisionsResponse::class, 'RoRdb\\Google_Service_CloudRun_ListRevisionsResponse');
