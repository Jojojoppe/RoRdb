...
class GoogleCloudRunOpV2BinaryAuthorization extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRunOpV2BinaryAuthorization::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunOpV2BinaryAuthorization');
