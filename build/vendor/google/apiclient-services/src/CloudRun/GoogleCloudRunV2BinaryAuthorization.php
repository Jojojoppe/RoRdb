...
class GoogleCloudRunV2BinaryAuthorization extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRunV2BinaryAuthorization::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunV2BinaryAuthorization');
