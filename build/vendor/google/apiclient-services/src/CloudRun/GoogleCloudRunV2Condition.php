...
class GoogleCloudRunV2Condition extends \RoRdb\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleCloudRunV2Condition::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunV2Condition');
