...
class GoogleCloudRunV2RevisionScaling extends \RoRdb\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GoogleCloudRunV2RevisionScaling::class, 'RoRdb\\Google_Service_CloudRun_GoogleCloudRunV2RevisionScaling');
