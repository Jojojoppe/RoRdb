...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('RoRdb\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['RoRdb\\Google\\Client' => 'Google_Client', 'RoRdb\\Google\\Service' => 'Google_Service', 'RoRdb\\Google\\Service\\Resource' => 'Google_Service_Resource', 'RoRdb\\Google\\Model' => 'Google_Model', 'RoRdb\\Google\\Collection' => 'Google_Collection'];
