 ...
 */
namespace RoRdb\Google;

use RoRdb\Google\AccessToken\Revoke;
use RoRdb\Google\AccessToken\Verify;
use RoRdb\Google\Auth\ApplicationDefaultCredentials;
use RoRdb\Google\Auth\Cache\MemoryCacheItemPool;
use RoRdb\Google\Auth\CredentialsLoader;
use RoRdb\Google\Auth\FetchAuthTokenCache;
use RoRdb\Google\Auth\HttpHandler\HttpHandlerFactory;
use RoRdb\Google\Auth\OAuth2;
use RoRdb\Google\Auth\Credentials\ServiceAccountCredentials;
use RoRdb\Google\Auth\Credentials\UserRefreshCredentials;
use RoRdb\Google\AuthHandler\AuthHandlerFactory;
use RoRdb\Google\Http\REST;
use RoRdb\GuzzleHttp\Client as GuzzleClient;
use RoRdb\GuzzleHttp\ClientInterface;
use RoRdb\GuzzleHttp\Ring\Client\StreamHandler;
use RoRdb\Psr\Cache\CacheItemPoolInterface;
use RoRdb\Psr\Http\Message\RequestInterface;
use RoRdb\Psr\Log\LoggerInterface;
use RoRdb\Monolog\Logger;
use RoRdb\Monolog\Handler\StreamHandler as MonologStreamHandler;
use RoRdb\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\RoRdb\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\RoRdb\\GuzzleHttp\\ClientInterface::VERSION')) {
