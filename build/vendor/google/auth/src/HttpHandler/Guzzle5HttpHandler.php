 ...
 */
namespace RoRdb\Google\Auth\HttpHandler;

use Exception;
use RoRdb\GuzzleHttp\ClientInterface;
use RoRdb\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use RoRdb\GuzzleHttp\Promise\Promise;
use RoRdb\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('RoRdb\\GuzzleHttp\\Promise\\Promise')) {
