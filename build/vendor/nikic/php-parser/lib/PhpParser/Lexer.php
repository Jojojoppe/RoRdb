...
use RoRdb\PhpParser\Parser\Tokens;
class Lexer
{
    protected $code;
    protected $tokens;
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('RoRdb\\T_ONUMBER')) {
            $tokenMap[\RoRdb\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('RoRdb\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\RoRdb\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
