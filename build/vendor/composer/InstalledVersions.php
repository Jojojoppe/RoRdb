 ...
 */
namespace RoRdb\Composer;

use RoRdb\Composer\Autoload\ClassLoader;
use RoRdb\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RoRdb\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
