 ...
 */
namespace RoRdb\Symfony\Component\String;

use RoRdb\Symfony\Component\String\Exception\ExceptionInterface;
use RoRdb\Symfony\Component\String\Exception\InvalidArgumentException;
use RoRdb\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'RoRdb\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
