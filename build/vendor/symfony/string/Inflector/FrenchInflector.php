 ...
 */
namespace RoRdb\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'RoRdb\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'RoRdb\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'RoRdb\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'RoRdb\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'RoRdb\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'RoRdb\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
