 ...
 */
namespace RoRdb\phpseclib3\Crypt\EC\Formats\Keys;

use RoRdb\phpseclib3\Math\BigInteger;
use RoRdb\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use RoRdb\phpseclib3\File\ASN1;
use RoRdb\phpseclib3\File\ASN1\Maps;
use RoRdb\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('RoRdb\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
