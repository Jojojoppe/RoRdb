 ...
 */
namespace RoRdb\phpseclib3\Crypt\EC\BaseCurves;

use RoRdb\phpseclib3\Math\Common\FiniteField\Integer;
use RoRdb\phpseclib3\Common\Functions\Strings;
use RoRdb\phpseclib3\Math\PrimeField;
use RoRdb\phpseclib3\Math\BigInteger;
use RoRdb\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @package Prime
    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !$x instanceof BigInteger && !$x instanceof PrimeInteger:
                throw new \UnexpectedValueException('RoRdb\\Argument 1 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
            case !$y instanceof BigInteger && !$y instanceof PrimeInteger:
                throw new \UnexpectedValueException('RoRdb\\Argument 2 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }
