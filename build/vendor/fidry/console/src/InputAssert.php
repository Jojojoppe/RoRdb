...
final class InputAssert
{
    ...
    public static function assertIsValidArgumentType($argument) : void
    {
        ...
        if (!is_array($argument) || !array_is_list($argument)) {
            throw new InvalidInputValueType(sprintf('Expected an argument value type to be "null|string|list<string>". Got "%s"', get_debug_type($argument)));
        }
    ...
    public static function assertIsValidOptionType($option) : void
    {
        ...
        if (!is_array($option) || !array_is_list($option)) {
            throw new InvalidInputValueType(sprintf('Expected an option value type to be "null|bool|string|list<string>". Got "%s"', get_debug_type($option)));
        }
