...
return ['whitelist' => [Finder::class], 'exclude-namespaces' => ['RoRdb\\Symfony\\Polyfill'], 'exclude-constants' => [
    // Symfony global constants
    '/^SYMFONY\\_[\\p{L}_]+$/',
], 'exclude-files' => [...$jetBrainStubs, ...$polyfillsBootstraps, ...$polyfillsStubs], 'patchers' => [
    //
