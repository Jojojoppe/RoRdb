...
final class YamlScoper implements Scoper
{
    ...
    public function scope(string $filePath, string $contents) : string
    {
        ...
        $contents = self::replaceClasses(array_filter($matches['class']), array_filter($matches['separator']), $this->prefix, $contents, $this->enrichedReflector, $this->symbolsRegistry);
        return $contents;
    }
    /**
