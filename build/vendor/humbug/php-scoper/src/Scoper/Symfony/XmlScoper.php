 ...
 */
namespace RoRdb\Humbug\PhpScoper\Scoper\Symfony;
...
final class XmlScoper implements Scoper
{
    ...
    public function scope(string $filePath, string $contents) : string
    {
        ...
        $contents = self::scopeNamespaces($contents, $this->prefix, $this->enrichedReflector, $this->symbolsRegistry);
        return $contents;
    }
    private static function scopeClasses(string $contents, string $prefix, EnrichedReflector $enrichedReflector, SymbolsRegistry $symbolsRegistry) : string
    {
        ...
        $contents = self::replaceClasses(array_filter($matches['class']), array_filter($matches['separator']), $prefix, $contents, $enrichedReflector, $symbolsRegistry);
        return $contents;
    }
