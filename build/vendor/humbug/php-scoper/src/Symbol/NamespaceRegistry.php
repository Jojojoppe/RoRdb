...
final class NamespaceRegistry
{
     ...
     */
    private function __construct(array $namespaceNames, array $namespaceRegexes)
    {
        $this->names = $namespaceNames;
        $this->regexes = $namespaceRegexes;
        $this->containsGlobalNamespace = count(array_filter($namespaceNames, static fn(string $name) => '' === $name)) !== 0;
    }
