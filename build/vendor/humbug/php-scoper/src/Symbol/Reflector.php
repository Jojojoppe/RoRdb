...
use RoRdb\JetBrains\PHPStormStub\PhpStormStubsMap;
...
final class Reflector
{
    private const MISSING_CLASSES = [
        ...
        'RoRdb\\Swoole\\Atomic',
        'RoRdb\\Swoole\\Atomic\\Long',
        'RoRdb\\Swoole\\Client',
        'RoRdb\\Swoole\\Client\\Exception',
        'RoRdb\\Swoole\\Connection\\Iterator',
        'RoRdb\\Swoole\\Coroutine',
        'RoRdb\\Swoole\\Coroutine\\Channel',
        'RoRdb\\Swoole\\Coroutine\\Client',
        'RoRdb\\Swoole\\Coroutine\\Context',
        'RoRdb\\Swoole\\Coroutine\\Curl\\Exception',
        'RoRdb\\Swoole\\Coroutine\\Http2\\Client',
        'RoRdb\\Swoole\\Coroutine\\Http2\\Client\\Exception',
        'RoRdb\\Swoole\\Coroutine\\Http\\Client',
        'RoRdb\\Swoole\\Coroutine\\Http\\Client\\Exception',
        'RoRdb\\Swoole\\Coroutine\\Http\\Server',
        'RoRdb\\Swoole\\Coroutine\\Iterator',
        'RoRdb\\Swoole\\Coroutine\\MySQL',
        'RoRdb\\Swoole\\Coroutine\\MySQL\\Exception',
        'RoRdb\\Swoole\\Coroutine\\MySQL\\Statement',
        'RoRdb\\Swoole\\Coroutine\\Redis',
        'RoRdb\\Swoole\\Coroutine\\Scheduler',
        'RoRdb\\Swoole\\Coroutine\\Socket',
        'RoRdb\\Swoole\\Coroutine\\Socket\\Exception',
        'RoRdb\\Swoole\\Coroutine\\System',
        'RoRdb\\Swoole\\Error',
        'RoRdb\\Swoole\\Event',
        'RoRdb\\Swoole\\Exception',
        'RoRdb\\Swoole\\ExitException',
        'RoRdb\\Swoole\\Http2\\Request',
        'RoRdb\\Swoole\\Http2\\Response',
        'RoRdb\\Swoole\\Http\\Request',
        'RoRdb\\Swoole\\Http\\Response',
        'RoRdb\\Swoole\\Http\\Server',
        'RoRdb\\Swoole\\Lock',
        'RoRdb\\Swoole\\Process',
        'RoRdb\\Swoole\\Process\\Pool',
        'RoRdb\\Swoole\\Redis\\Server',
        'RoRdb\\Swoole\\Runtime',
        'RoRdb\\Swoole\\Server',
        'RoRdb\\Swoole\\Server\\Event',
        'RoRdb\\Swoole\\Server\\Packet',
        'RoRdb\\Swoole\\Server\\PipeMessage',
        'RoRdb\\Swoole\\Server\\Port',
        'RoRdb\\Swoole\\Server\\StatusInfo',
        'RoRdb\\Swoole\\Server\\Task',
        'RoRdb\\Swoole\\Server\\TaskResult',
        'RoRdb\\Swoole\\Table',
        'RoRdb\\Swoole\\Timer',
        'RoRdb\\Swoole\\Timer\\Iterator',
        'RoRdb\\Swoole\\WebSocket\\CloseFrame',
        'RoRdb\\Swoole\\WebSocket\\Frame',
        'RoRdb\\Swoole\\WebSocket\\Server',
    ...
    private function __construct(SymbolRegistry $classes, SymbolRegistry $functions, SymbolRegistry $constants)
    {
