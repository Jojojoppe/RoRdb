...
use RoRdb\Fidry\Console\Application\Application;
use RoRdb\Fidry\Console\Command\Command;
use RoRdb\Fidry\Console\Command\CommandAware;
use RoRdb\Fidry\Console\Command\CommandAwareness;
...
use RoRdb\Humbug\PhpScoper\Console\ConsoleScoper;
...
final class AddPrefixCommand implements Command, CommandAware
{
    ...
    public function __construct(Filesystem $fileSystem, ScoperFactory $scoperFactory, Application $application, ConfigurationFactory $configFactory)
    {
    ...
    {
        return $this->canonicalizePath($io->getOption(self::OUTPUT_DIR_OPT)->asString(), $cwd);
    }
