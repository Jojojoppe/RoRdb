...
final class Configuration
{
     ...
     */
    public function __construct(?string $path, string $prefix, array $filesWithContents, array $excludedFilesWithContents, Patcher $patcher, SymbolsConfiguration $symbolsConfiguration)
    {
    ...
    {
        return new self($this->path, $prefix, $this->filesWithContents, $this->excludedFilesWithContents, $this->patcher, $this->symbolsConfiguration);
    }
    /**
