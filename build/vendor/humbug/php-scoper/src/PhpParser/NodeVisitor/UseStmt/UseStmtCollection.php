...
use ArrayIterator;
use RoRdb\Humbug\PhpScoper\PhpParser\Node\NamedIdentifier;
use RoRdb\Humbug\PhpScoper\PhpParser\NodeVisitor\OriginalNameResolver;
...
use RoRdb\PhpParser\Node\Stmt\ClassLike;
