...
final class UseStmtName
{
    ...
    private static function getUseNode(Name $name) : UseUse
    {
        ...
        throw new UnexpectedParsingScenario(sprintf('Unexpected use statement name parent "%s"', get_class($use)));
    ...
    private static function getUseParentNode(UseUse $use) : Use_
    {
        ...
        // @codeCoverageIgnoreStart
        throw new UnexpectedParsingScenario(sprintf('Unexpected UseUse parent "%s"', get_class($useParent)));
        // @codeCoverageIgnoreEnd
    }
}
