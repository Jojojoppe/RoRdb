...
], 'Different kind of exposed class constant calls in the global scope' => ['expose-classes' => ['RoRdb\\Foo\\Bar', 'RoRdb\\Foo\\Bar\\Poz'], 'expected-recorded-classes' => [['RoRdb\\Foo\\Bar', 'RoRdb\\Humbug\\Foo\\Bar'], ['RoRdb\\Foo\\Bar\\Poz', 'RoRdb\\Humbug\\Foo\\Bar\\Poz']], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Different kind of class constant calls in a namespace' => ['expose-classes' => ['RoRdb\\Foo\\Bar', 'RoRdb\\Foo\\Bar\\Poz', 'RoRdb\\A\\Foo', 'RoRdb\\A\\Foo\\Bar', 'RoRdb\\A\\Foo\\Bar\\Poz', 'RoRdb\\A\\Aoo', 'RoRdb\\A\\Aoo\\Aoz', 'RoRdb\\A\\Aoz', 'RoRdb\\A\\Aoo\\Aoz\\Poz'], 'expected-recorded-classes' => [['RoRdb\\Foo\\Bar', 'RoRdb\\Humbug\\Foo\\Bar'], ['RoRdb\\Foo\\Bar\\Poz', 'RoRdb\\Humbug\\Foo\\Bar\\Poz'], ['RoRdb\\A\\Foo', 'RoRdb\\Humbug\\A\\Foo'], ['RoRdb\\A\\Foo\\Bar', 'RoRdb\\Humbug\\A\\Foo\\Bar'], ['RoRdb\\A\\Foo\\Bar\\Poz', 'RoRdb\\Humbug\\A\\Foo\\Bar\\Poz'], ['RoRdb\\A\\Aoo', 'RoRdb\\Humbug\\A\\Aoo'], ['RoRdb\\A\\Aoo\\Aoz', 'RoRdb\\Humbug\\A\\Aoo\\Aoz'], ['RoRdb\\A\\Aoo\\Aoz\\Poz', 'RoRdb\\Humbug\\A\\Aoo\\Aoz\\Poz']], 'payload' => <<<'PHP'
<?php
