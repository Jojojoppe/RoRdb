...
PHP
, 'FQCN string argument on exposed class' => ['expose-classes' => ['RoRdb\\Symfony\\Component\\Yaml\\Yaml', 'Swift'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQCN string argument on class from global namespace with classes from global namespace exposed' => ['expose-global-classes' => \true, 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQCN string argument on class from an excluded namespace' => ['exclude-namespaces' => ['RoRdb\\Symfony\\Component\\Yaml', '/^$/'], 'payload' => <<<'PHP'
<?php
...
PHP
, 'FQC constant call on exposed class' => ['expose-classes' => ['RoRdb\\Symfony\\Component\\Yaml\\Ya_1'], 'expected-recorded-classes' => [['RoRdb\\Symfony\\Component\\Yaml\\Ya_1', 'RoRdb\\Humbug\\Symfony\\Component\\Yaml\\Ya_1']], 'payload' => <<<'PHP'
<?php
