...
PHP
, 'FQCN string argument on exposed class' => ['expose-classes' => ['RoRdb\\Symfony\\Component\\Yaml\\Yaml'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQCN string argument on classes belonging to an excluded namespace' => ['exclude-namespaces' => ['RoRdb\\Symfony\\Component'], 'payload' => <<<'PHP'
<?php
