...
PHP
, 'Static method call statement of an exposed class via a use statement' => ['expose-classes' => ['RoRdb\\X\\Foo\\Bar'], 'expected-recorded-classes' => [['RoRdb\\X\\Foo\\Bar', 'RoRdb\\Humbug\\X\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ static method call statement of a non-exposed class via a use statement' => ['expose-classes' => ['RoRdb\\X\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
