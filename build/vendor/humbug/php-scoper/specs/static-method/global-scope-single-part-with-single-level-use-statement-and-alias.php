...
PHP
], 'FQ static method call statement of a class belonging to the global namespace which has been exposed' => ['expose-global-classes' => \true, 'expected-recorded-classes' => [['X', 'RoRdb\\Humbug\\X']], 'payload' => <<<'PHP'
<?php
