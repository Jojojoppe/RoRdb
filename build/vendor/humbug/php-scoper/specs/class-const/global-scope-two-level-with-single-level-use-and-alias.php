...
PHP
, 'FQ Constant call on an exposed namespaced class partially imported with an aliased use statement' => ['expose-classes' => ['RoRdb\\Foo\\Bar'], 'expected-recorded-classes' => [['RoRdb\\Foo\\Bar', 'RoRdb\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on an exposed namespaced class imported with an aliased use statement' => ['expose-classes' => ['RoRdb\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
