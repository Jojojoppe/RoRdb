...
PHP
, 'Constant call on an exposed namespaced class' => ['expose-classes' => ['RoRdb\\X\\PHPUnit\\Command'], 'expected-recorded-classes' => [['RoRdb\\X\\PHPUnit\\Command', 'RoRdb\\Humbug\\X\\PHPUnit\\Command']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Constant call on a namespaced class belonging to an excluded namespace' => ['exclude-namespaces' => ['RoRdb\\X\\PHPUnit'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Constant call on a namespaced class belonging to an excluded namespace (2)' => ['exclude-namespaces' => ['/^.*$/'], 'payload' => <<<'PHP'
<?php
