...
PHP
, 'Simple exposed function' => ['expose-functions' => ['foo'], 'expected-recorded-functions' => [['foo', 'RoRdb\\Humbug\\foo']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Simple exposed function with global functions exposed' => ['expose-global-functions' => \true, 'expected-recorded-functions' => [['foo', 'RoRdb\\Humbug\\foo']], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Function declaration in the global namespace with globally exposed symbols' => ['expose-global-classes' => \true, 'expose-global-functions' => \true, 'expose-global-constants' => \true, 'expected-recorded-functions' => [['foo', 'RoRdb\\Humbug\\foo']], 'payload' => <<<'PHP'
<?php
...
PHP
, 'Function declarations with return types in the global namespace with use statements' => ['expose-classes' => ['RoRdb\\X\\Y'], 'expected-recorded-classes' => [['RoRdb\\X\\Y', 'RoRdb\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
