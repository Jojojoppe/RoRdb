...
], 'Method declarations' => ['expose-classes' => ['RoRdb\\X\\Y', 'BAR_CONST'], 'expected-recorded-classes' => [['RoRdb\\X\\Y', 'RoRdb\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Method declarations with return types' => ['expose-classes' => ['RoRdb\\X\\Y'], 'expected-recorded-classes' => [['RoRdb\\X\\Y', 'RoRdb\\Humbug\\X\\Y']], 'payload' => <<<'PHP'
<?php
