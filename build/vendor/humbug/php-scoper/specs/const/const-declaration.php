...
,
    ...
    'Constant declarations in the global namespace which is excluded' => ['exclude-namespaces' => [''], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Exposed constant declarations in the global namespace' => ['expose-constants' => ['FOO_CONST', 'BAR_CONST', 'RoRdb\\Acme\\BAR_CONST', 'BAZ', 'RoRdb\\Emca\\BAZ'], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Exposed grouped constants declaration in the global namespace' => ['expose-constants' => ['X'], 'payload' => <<<'PHP'
<?php
...
PHP
,
    'Constants declaration in an excluded namespace' => ['exclude-namespaces' => ['Acme'], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Exposed constants declaration in a namespace' => ['expose-constants' => ['RoRdb\\Acme\\BAR_CONST'], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Token compatibility regression test' => ['exclude-constants' => ['NEW_TOKEN', 'ANOTHER_NEW_TOKEN'], 'payload' => <<<'PHP'
<?php
