...
PHP
, 'Exposed constant call in the global namespace' => ['expose-constants' => ['DUMMY_CONST'], 'payload' => <<<'PHP'
<?php
...
PHP
], 'Constant call in the global namespace which is excluded' => ['exclude-namespaces' => [''], 'payload' => <<<'PHP'
<?php
