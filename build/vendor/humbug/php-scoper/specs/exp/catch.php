...
PHP
,
    'Catch an exposed custom exception class' => ['expose-classes' => ['FooException'], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Catch a custom exception class which belongs to the excluded root namespace' => ['exclude-namespaces' => ['/^$/'], 'payload' => <<<'PHP'
<?php
...
PHP
,
    'Catch an exposed custom exception class in a namespace' => ['expose-classes' => ['RoRdb\\Acme\\FooException'], 'payload' => <<<'PHP'
<?php
...
PHP
    ...
    'Catch a custom exception class in an excluded namespace' => ['exclude-namespaces' => ['Acme'], 'payload' => <<<'PHP'
<?php
