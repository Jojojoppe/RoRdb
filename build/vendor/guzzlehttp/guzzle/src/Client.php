...
namespace RoRdb\GuzzleHttp;

use RoRdb\GuzzleHttp\Cookie\CookieJar;
use RoRdb\GuzzleHttp\Exception\GuzzleException;
use RoRdb\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \RoRdb\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
