...
namespace RoRdb\GuzzleHttp\Exception;

use RoRdb\GuzzleHttp\BodySummarizer;
use RoRdb\GuzzleHttp\BodySummarizerInterface;
use RoRdb\Psr\Http\Client\RequestExceptionInterface;
