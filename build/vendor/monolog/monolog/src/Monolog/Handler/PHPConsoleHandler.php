...
use RoRdb\Monolog\Formatter\LineFormatter;
use RoRdb\Monolog\Formatter\FormatterInterface;
use RoRdb\Monolog\Logger;
use RoRdb\Monolog\Utils;
use RoRdb\PhpConsole\Connector;
use RoRdb\PhpConsole\Handler as VendorPhpConsoleHandler;
use RoRdb\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('RoRdb\\PhpConsole\\Connector')) {
